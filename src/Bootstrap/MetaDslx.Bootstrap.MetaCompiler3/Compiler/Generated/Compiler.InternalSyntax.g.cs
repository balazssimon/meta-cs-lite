...
namespace MetaDslx.Bootstrap.MetaCompiler3.Compiler.Syntax.InternalSyntax
{
    ...
    internal class LanguageDeclarationBlock1Green : GreenSyntaxNode
    {
        ...
        protected override __SyntaxNode CreateRed(__SyntaxNode parent, int position)
        {
            return new global::MetaDslx.Bootstrap.MetaCompiler3.Compiler.Syntax.LanguageDeclarationBlock1Syntax(this, (CompilerSyntaxNode)parent, position);
        }
    ...
    internal class LanguageDeclarationBlock1baseLanguagesBlockGreen : GreenSyntaxNode
    {
        ...
        protected override __SyntaxNode CreateRed(__SyntaxNode parent, int position)
        {
            return new global::MetaDslx.Bootstrap.MetaCompiler3.Compiler.Syntax.LanguageDeclarationBlock1baseLanguagesBlockSyntax(this, (CompilerSyntaxNode)parent, position);
        }
    ...
    internal class AlternativeBlock1Block1Alt1Green : AlternativeBlock1Block1Green
    {
        ...
        protected override __SyntaxNode CreateRed(__SyntaxNode parent, int position)
        {
            return new global::MetaDslx.Bootstrap.MetaCompiler3.Compiler.Syntax.AlternativeBlock1Block1Alt1Syntax(this, (CompilerSyntaxNode)parent, position);
        }
    ...
    internal class AlternativeBlock1Block1Alt2Green : AlternativeBlock1Block1Green
    {
        ...
        protected override __SyntaxNode CreateRed(__SyntaxNode parent, int position)
        {
            return new global::MetaDslx.Bootstrap.MetaCompiler3.Compiler.Syntax.AlternativeBlock1Block1Alt2Syntax(this, (CompilerSyntaxNode)parent, position);
        }
