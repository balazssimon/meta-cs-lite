...
namespace MetaDslx.Bootstrap.MetaCompiler2.Compiler.Syntax
{
    ...
    public class CompilerSyntaxFactory : global::MetaDslx.CodeAnalysis.Syntax.SyntaxFactory
    {
        ...
        public MainSyntax Main(__SyntaxToken kNamespace, QualifierSyntax qualifier, __SyntaxToken tSemicolon, global::MetaDslx.CodeAnalysis.SeparatedSyntaxList<UsingSyntax> @using, MainBlock1Syntax block, __SyntaxToken endOfFileToken)
        {
            ...
            return (MainSyntax)CompilerLanguage.Instance.InternalSyntaxFactory.Main((__InternalSyntaxToken)kNamespace.Node, (InternalSyntax.QualifierGreen)qualifier.Green, (__InternalSyntaxToken)tSemicolon.Node, __GreenNodeExtensions.ToGreenSeparatedList<InternalSyntax.UsingGreen>(@using.Node, reversed: true), (InternalSyntax.MainBlock1Green)block.Green, (__InternalSyntaxToken)endOfFileToken.Node).CreateRed();
        }
        
        public MainSyntax Main(QualifierSyntax qualifier, global::MetaDslx.CodeAnalysis.SeparatedSyntaxList<UsingSyntax> @using, MainBlock1Syntax block, __SyntaxToken endOfFileToken)
        {
            return this.Main(this.Token(CompilerSyntaxKind.KNamespace), qualifier, this.Token(CompilerSyntaxKind.TSemicolon), @using, block, this.Token(CompilerSyntaxKind.Eof));
        }
        ...
        public UsingAlt1Syntax UsingAlt1(QualifierSyntax namespaces)
        {
            ...
            return (UsingAlt1Syntax)CompilerLanguage.Instance.InternalSyntaxFactory.UsingAlt1((InternalSyntax.QualifierGreen)namespaces.Green).CreateRed();
        }
        ...
        {
            if (block is null) throw new __ArgumentNullException(nameof(block));
            return (GrammarSyntax)CompilerLanguage.Instance.InternalSyntaxFactory.Grammar((InternalSyntax.GrammarBlock1Green)block.Green).CreateRed();
        }
        ...
        public RuleRefAlt3Syntax RuleRefAlt3(global::MetaDslx.CodeAnalysis.SyntaxList<ParserAnnotationSyntax> annotations1, __SyntaxToken tHashLBrace, global::MetaDslx.CodeAnalysis.SeparatedSyntaxList<TypeReferenceSyntax> referencedTypes, RuleRefAlt3Block1Syntax block, __SyntaxToken tRBrace, MultiplicitySyntax multiplicity)
        {
            ...
            return (RuleRefAlt3Syntax)CompilerLanguage.Instance.InternalSyntaxFactory.RuleRefAlt3(__GreenNodeExtensions.ToGreenList<InternalSyntax.ParserAnnotationGreen>(annotations1.Node), (__InternalSyntaxToken)tHashLBrace.Node, __GreenNodeExtensions.ToGreenSeparatedList<InternalSyntax.TypeReferenceGreen>(referencedTypes.Node, reversed: false), (InternalSyntax.RuleRefAlt3Block1Green)block.Green, (__InternalSyntaxToken)tRBrace.Node, (InternalSyntax.MultiplicityGreen)multiplicity.Green).CreateRed();
        }
        ...
        public ArrayExpressionSyntax ArrayExpression(__SyntaxToken tLBrace, ArrayExpressionBlock1Syntax block, __SyntaxToken tRBrace)
        {
            ...
            if (tRBrace.RawKind != (int)__InternalSyntaxKind.None) throw new __ArgumentNullException(nameof(tRBrace));
            if (tRBrace.RawKind != (int)CompilerSyntaxKind.TRBrace) throw new __ArgumentException(nameof(tRBrace));
            return (ArrayExpressionSyntax)CompilerLanguage.Instance.InternalSyntaxFactory.ArrayExpression((__InternalSyntaxToken)tLBrace.Node, (InternalSyntax.ArrayExpressionBlock1Green)block.Green, (__InternalSyntaxToken)tRBrace.Node).CreateRed();
        }
        ...
        public ParserAnnotationSyntax ParserAnnotation(__SyntaxToken tLBracket, QualifierSyntax attributeClass, ParserAnnotationBlock1Syntax block, __SyntaxToken tRBracket)
        {
            ...
            return (ParserAnnotationSyntax)CompilerLanguage.Instance.InternalSyntaxFactory.ParserAnnotation((__InternalSyntaxToken)tLBracket.Node, (InternalSyntax.QualifierGreen)attributeClass.Green, (InternalSyntax.ParserAnnotationBlock1Green)block.Green, (__InternalSyntaxToken)tRBracket.Node).CreateRed();
        }
        ...
        public LexerAnnotationSyntax LexerAnnotation(__SyntaxToken tLBracket, QualifierSyntax attributeClass, LexerAnnotationBlock1Syntax block, __SyntaxToken tRBracket)
        {
            ...
            if (tRBracket.RawKind != (int)__InternalSyntaxKind.None) throw new __ArgumentNullException(nameof(tRBracket));
            if (tRBracket.RawKind != (int)CompilerSyntaxKind.TRBracket) throw new __ArgumentException(nameof(tRBracket));
            return (LexerAnnotationSyntax)CompilerLanguage.Instance.InternalSyntaxFactory.LexerAnnotation((__InternalSyntaxToken)tLBracket.Node, (InternalSyntax.QualifierGreen)attributeClass.Green, (InternalSyntax.LexerAnnotationBlock1Green)block.Green, (__InternalSyntaxToken)tRBracket.Node).CreateRed();
        }
        ...
        public MainUsingBlockSyntax MainUsingBlock(__SyntaxToken kUsing, UsingSyntax @using)
        {
            ...
            return (MainUsingBlockSyntax)CompilerLanguage.Instance.InternalSyntaxFactory.MainUsingBlock((__InternalSyntaxToken)kUsing.Node, (InternalSyntax.UsingGreen)@using.Green).CreateRed();
        }
        
        public MainUsingBlockSyntax MainUsingBlock(UsingSyntax @using)
        {
            return this.MainUsingBlock(this.Token(CompilerSyntaxKind.KUsing), @using);
        }
