...
namespace MetaDslx.Bootstrap.MetaCompiler3.Model.__Impl
{
    ...
    internal class Token_Impl : __MetaModelObject, Token
    {
        ...
        public MetaDslx.Bootstrap.MetaCompiler3.Model.TokenKind? TokenKind
        {
            get => MGet<MetaDslx.Bootstrap.MetaCompiler3.Model.TokenKind?>(Compiler.Token_TokenKind);
            set => MSet<MetaDslx.Bootstrap.MetaCompiler3.Model.TokenKind?>(Compiler.Token_TokenKind, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Bootstrap.MetaCompiler3.Model.LAlternative> Alternatives
        {
