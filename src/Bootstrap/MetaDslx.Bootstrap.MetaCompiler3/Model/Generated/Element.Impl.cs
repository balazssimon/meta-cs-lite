...
namespace MetaDslx.Bootstrap.MetaCompiler3.Model.__Impl
{
    ...
    internal class Element_Impl : __MetaModelObject, Element
    {
        ...
        public MetaDslx.Bootstrap.MetaCompiler3.Model.Assignment Assignment
        {
            get => MGet<MetaDslx.Bootstrap.MetaCompiler3.Model.Assignment>(Compiler.Element_Assignment);
            set => MSet<MetaDslx.Bootstrap.MetaCompiler3.Model.Assignment>(Compiler.Element_Assignment, value);
        }
        ...
        public MetaDslx.Bootstrap.MetaCompiler3.Model.ElementValue Value
        {
            get => MGet<MetaDslx.Bootstrap.MetaCompiler3.Model.ElementValue>(Compiler.Element_Value);
            set => MSet<MetaDslx.Bootstrap.MetaCompiler3.Model.ElementValue>(Compiler.Element_Value, value);
        }
