...
namespace MetaDslx.Bootstrap.MetaCompiler3.Model
{
    ...
    internal interface ICustomCompilerImplementation
    {
        ...
        MetaDslx.Bootstrap.MetaCompiler3.Model.Language Grammar_Language(Grammar _this);
    
        MetaDslx.Bootstrap.MetaCompiler3.Model.Language GrammarRule_Language(GrammarRule _this);
    
        MetaDslx.Bootstrap.MetaCompiler3.Model.Grammar GrammarRule_Grammar(GrammarRule _this);
        ...
        MetaDslx.Bootstrap.MetaCompiler3.Model.Token? RuleRef_Token(RuleRef _this);
    
        MetaDslx.Bootstrap.MetaCompiler3.Model.Rule? RuleRef_Rule(RuleRef _this);
