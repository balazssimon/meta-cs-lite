...
namespace MetaDslx.Bootstrap.MetaCompiler3.Model.__Impl
{
    ...
    internal class SeparatedList_Impl : __MetaModelObject, SeparatedList
    {
        ...
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Bootstrap.MetaCompiler3.Model.Element> FirstItems
        {
            get => MGetCollection<Element>(Compiler.SeparatedList_FirstItems);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Bootstrap.MetaCompiler3.Model.Element> FirstSeparators
        {
        ...
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Bootstrap.MetaCompiler3.Model.Element> LastItems
        {
            get => MGetCollection<Element>(Compiler.SeparatedList_LastItems);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Bootstrap.MetaCompiler3.Model.Element> LastSeparators
        {
        ...
        public MetaDslx.Bootstrap.MetaCompiler3.Model.Element RepeatedBlock
        {
            get => MGet<MetaDslx.Bootstrap.MetaCompiler3.Model.Element>(Compiler.SeparatedList_RepeatedBlock);
            set => MSet<MetaDslx.Bootstrap.MetaCompiler3.Model.Element>(Compiler.SeparatedList_RepeatedBlock, value);
        }
    
        public MetaDslx.Bootstrap.MetaCompiler3.Model.Element RepeatedItem
        {
            get => MGet<MetaDslx.Bootstrap.MetaCompiler3.Model.Element>(Compiler.SeparatedList_RepeatedItem);
            set => MSet<MetaDslx.Bootstrap.MetaCompiler3.Model.Element>(Compiler.SeparatedList_RepeatedItem, value);
        }
    
        public MetaDslx.Bootstrap.MetaCompiler3.Model.Element RepeatedSeparator
        {
            get => MGet<MetaDslx.Bootstrap.MetaCompiler3.Model.Element>(Compiler.SeparatedList_RepeatedSeparator);
            set => MSet<MetaDslx.Bootstrap.MetaCompiler3.Model.Element>(Compiler.SeparatedList_RepeatedSeparator, value);
        }
