...
namespace MetaDslx.Bootstrap.MetaCompiler3.Model.__Impl
{
    ...
    internal class LReference_Impl : __MetaModelObject, LReference
    {
        ...
        public MetaDslx.Bootstrap.MetaCompiler3.Model.LexerRule Rule
        {
            get => MGet<MetaDslx.Bootstrap.MetaCompiler3.Model.LexerRule>(Compiler.LReference_Rule);
            set => MSet<MetaDslx.Bootstrap.MetaCompiler3.Model.LexerRule>(Compiler.LReference_Rule, value);
        }
