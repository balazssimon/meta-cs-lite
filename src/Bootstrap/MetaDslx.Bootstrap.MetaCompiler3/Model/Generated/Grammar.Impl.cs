...
namespace MetaDslx.Bootstrap.MetaCompiler3.Model.__Impl
{
    ...
    internal class Grammar_Impl : __MetaModelObject, Grammar
    {
        ...
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Bootstrap.MetaCompiler3.Model.Block> Blocks
        {
            get => MGetCollection<Block>(Compiler.Grammar_Blocks);
        }
    
        public MetaDslx.Bootstrap.MetaCompiler3.Model.Token? DefaultEndOfLine
        {
            get => MGet<MetaDslx.Bootstrap.MetaCompiler3.Model.Token?>(Compiler.Grammar_DefaultEndOfLine);
            set => MSet<MetaDslx.Bootstrap.MetaCompiler3.Model.Token?>(Compiler.Grammar_DefaultEndOfLine, value);
        }
    
        public MetaDslx.Bootstrap.MetaCompiler3.Model.Token? DefaultIdentifier
        {
            get => MGet<MetaDslx.Bootstrap.MetaCompiler3.Model.Token?>(Compiler.Grammar_DefaultIdentifier);
            set => MSet<MetaDslx.Bootstrap.MetaCompiler3.Model.Token?>(Compiler.Grammar_DefaultIdentifier, value);
        }
    
        public MetaDslx.Bootstrap.MetaCompiler3.Model.Token? DefaultSeparator
        {
            get => MGet<MetaDslx.Bootstrap.MetaCompiler3.Model.Token?>(Compiler.Grammar_DefaultSeparator);
            set => MSet<MetaDslx.Bootstrap.MetaCompiler3.Model.Token?>(Compiler.Grammar_DefaultSeparator, value);
        }
    
        public MetaDslx.Bootstrap.MetaCompiler3.Model.Token? DefaultWhitespace
        {
            get => MGet<MetaDslx.Bootstrap.MetaCompiler3.Model.Token?>(Compiler.Grammar_DefaultWhitespace);
            set => MSet<MetaDslx.Bootstrap.MetaCompiler3.Model.Token?>(Compiler.Grammar_DefaultWhitespace, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Bootstrap.MetaCompiler3.Model.GrammarRule> GrammarRules
        {
            get => MGetCollection<GrammarRule>(Compiler.Grammar_GrammarRules);
        }
    
        public MetaDslx.Bootstrap.MetaCompiler3.Model.Language Language
        {
            get => Compiler.__CustomImpl.Grammar_Language(this);
        }
    
        public MetaDslx.Bootstrap.MetaCompiler3.Model.Rule? MainRule
        {
            get => MGet<MetaDslx.Bootstrap.MetaCompiler3.Model.Rule?>(Compiler.Grammar_MainRule);
            set => MSet<MetaDslx.Bootstrap.MetaCompiler3.Model.Rule?>(Compiler.Grammar_MainRule, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Bootstrap.MetaCompiler3.Model.Rule> Rules
        {
            get => MGetCollection<Rule>(Compiler.Grammar_Rules);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Bootstrap.MetaCompiler3.Model.TokenKind> TokenKinds
        {
            get => MGetCollection<TokenKind>(Compiler.Grammar_TokenKinds);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Bootstrap.MetaCompiler3.Model.Token> Tokens
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Compiler.Grammar_Language, new __ModelPropertyInfo(new __ModelPropertySlot(Compiler.Grammar_Language, __ImmutableArray.Create<__ModelProperty>(Compiler.Grammar_Language), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
