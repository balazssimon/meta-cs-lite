...
namespace MetaDslx.Bootstrap.MetaCompiler3.Model.__Impl
{
    ...
    internal class Rule_Impl : __MetaModelObject, Rule
    {
        ...
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Bootstrap.MetaCompiler3.Model.Alternative> Alternatives
        {
            get => MGetCollection<Alternative>(Compiler.Rule_Alternatives);
        }
    
        public MetaDslx.Bootstrap.MetaCompiler3.Model.Alternative? BaseRule
        {
            get => MGet<MetaDslx.Bootstrap.MetaCompiler3.Model.Alternative?>(Compiler.Rule_BaseRule);
            set => MSet<MetaDslx.Bootstrap.MetaCompiler3.Model.Alternative?>(Compiler.Rule_BaseRule, value);
        }
