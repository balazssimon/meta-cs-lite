...
namespace MetaDslx.Bootstrap.Antlr4.Sandy
{
    ...
    /// </summary>
    public abstract partial class SandySyntaxTree : SyntaxTree
    {
        internal static readonly SandySyntaxTree Dummy = new DummySyntaxTree();
        ...
        /// </summary>
        public override abstract SandyParseOptions Options { get; }
        /// <summary>
        /// Gets the root node of the syntax tree.
        /// </summary>
        public new abstract SandySyntaxNode GetRoot(CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets the root node of the syntax tree if it is already available.
        /// </summary>
        public abstract bool TryGetRoot(out SandySyntaxNode root);
        /// <summary>
        ...
        /// </remarks>
        public new virtual Task<SandySyntaxNode> GetRootAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            SandySyntaxNode node;
        ...
        /// </summary>
        public static SandySyntaxTree Create(SandySyntaxNode root, ParseData parseData, SandyParseOptions? options = null, string path = "", SourceText? text = null, Encoding? encoding = null, SourceHashAlgorithm checksumAlgorithm = SourceHashAlgorithm.Sha1)
        {
            if (root == null)
            {
                throw new ArgumentNullException(nameof(root));
            }
            var directives = root.Kind == SandySyntaxKind.Main && root is ICompilationUnitRootSyntax compilationUnitRoot ?
        ...
        internal static SandySyntaxTree CreateForDebugger(SandySyntaxNode root, ParseData parseData, SourceText text, SandyParseOptions options)
        {
        ...
        /// <summary>
        /// <para>
        /// Internal helper for <see cref="SandySyntaxNode"/> class to create a new syntax tree rooted at the given root node.
        /// This method does not create a clone of the given root, but instead preserves it's reference identity.
        /// </para>
        /// <para>NOTE: This method is only intended to be used from <see cref="SandySyntaxNode.SyntaxTree"/> property.</para>
        /// <para>NOTE: Do not use this method elsewhere, instead use <see cref="Create(SandySyntaxNode, CSharpParseOptions, string, Encoding)"/> method for creating a syntax tree.</para>
        /// </summary>
        internal static SandySyntaxTree CreateWithoutClone(SandySyntaxNode root, ParseData parseData)
        {
            Debug.Assert(root != null);
            return new ParsedSyntaxTree(
                textOpt: null,
                ...
                path: "",
                options: SandyParseOptions.Default,
                root: root,
        ...
        /// </summary>
        public static SandySyntaxTree ParseText(
            string text,
        ...
        #endregion
        internal sealed class DummySyntaxTree : SandySyntaxTree
        {
            private readonly SandySyntaxNode _node;
            ...
            public override SandyParseOptions Options
            {
                get { return SandyParseOptions.Default; }
            }
            ...
            public override SandySyntaxNode GetRoot(CancellationToken cancellationToken)
            {
                return _node;
            }
            public override bool TryGetRoot(out SandySyntaxNode root)
            {
                root = _node;
                return true;
            }
            ...
            {
                return Language.SyntaxFactory.MakeSyntaxTree((SandySyntaxNode)root, options: (SandyParseOptions)options, path: FilePath, encoding: null);
            }
        ...
        private class ParsedSyntaxTree : SandySyntaxTree
        {
            private readonly SandyParseOptions _options;
            private readonly string _path;
            private readonly SandySyntaxNode _root;
            ...
            internal ParsedSyntaxTree(SourceText? textOpt, Encoding? encodingOpt, SourceHashAlgorithm checksumAlgorithm, string path, SandyParseOptions options, SandySyntaxNode root, ParseData parseData, bool cloneRoot = true)
            {
                Debug.Assert(root != null);
                ...
                _hasCompilationUnitRoot = root.Kind == SandySyntaxKind.Main;
            }
            ...
            public override SyntaxTree WithRootAndOptions(SyntaxNode root, ParseOptions options)
            {
                ...
                return new ParsedSyntaxTree(
                    ...
                    _checksumAlgorithm,
                    _path,
                    (SandyParseOptions)options,
                    (SandySyntaxNode)root,
                    this.ParseData);
            }
            public override SyntaxTree WithFilePath(string path)
            {
        ...
        {
            public DebuggerSyntaxTree(SandySyntaxNode root, ParseData parseData, SourceText text, SandyParseOptions options)
                : base(
                    text,
                    text.Encoding,
