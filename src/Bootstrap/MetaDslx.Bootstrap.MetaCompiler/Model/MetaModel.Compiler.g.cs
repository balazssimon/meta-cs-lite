...
namespace MetaDslx.Bootstrap.MetaCompiler.Model
{
	...
	public sealed class Compiler : __MetaModel, ICompiler
	{
		...
		private Compiler()
		{
			...
			obj178.Name = "Items";
			obj178.Parent = obj43;
			obj179.InnerType = typeof(object);
			obj180.ItemType = __MetaType.FromModelObject((__IModelObject)obj37);
