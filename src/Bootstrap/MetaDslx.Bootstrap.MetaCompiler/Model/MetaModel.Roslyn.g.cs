...
namespace MetaDslx.Bootstrap.MetaCompiler.Roslyn
{
	...
	public sealed class Roslyn : __MetaModel, IRoslyn
	{
		...
		private Roslyn()
		{
			...
			obj39.Name = "IsFixed";
			obj39.Parent = obj11;
			((__IModelObject)obj40).Children.Add((__IModelObject)obj41);
			obj40.Type = __MetaType.FromModelObject((__IModelObject)obj41);
			...
			obj46.ItemType = __MetaType.FromModelObject((__IModelObject)obj13);
			...
			obj55.Type = __MetaType.FromModelObject((__IModelObject)obj15);
			obj55.Name = "Value";
			obj55.Parent = obj14;
