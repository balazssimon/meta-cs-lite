...
namespace MetaDslx.Bootstrap.MetaCompiler.Compiler.Binding
{
        ...
        public virtual void VisitElement(ElementSyntax node)
 {
 	...
 	var __annot9 = new MetaDslx.CodeAnalysis.Binding.DefineBinder(type: typeof(MetaDslx.Bootstrap.MetaCompiler.Model.Element));
        ...
        public virtual void VisitElementValueTokens(ElementValueTokensSyntax node)
 {
 	...
 	if (node.Token.GetCompilerKind() != CompilerSyntaxKind.None)
 	{
 	    ...
 	    switch (node.Token.GetCompilerKind())
 	 {
 	  ...
 	  var __annot3 = new MetaDslx.CodeAnalysis.Binding.DefineBinder(type: typeof(MetaDslx.Bootstrap.MetaCompiler.Model.Keyword));
 	...
 	if (node.Assignment.GetCompilerKind() != CompilerSyntaxKind.None)
 	{
 	 ...
 	 try
 	 {
 	     switch (node.Assignment.GetCompilerKind())
 	  {
 	   ...
 	   var __annot4 = new MetaDslx.CodeAnalysis.Binding.ConstantBinder(value: MetaDslx.Bootstrap.MetaCompiler.Model.Assignment.QuestionAssign);
 	   ...
 	   var __annot5 = new MetaDslx.CodeAnalysis.Binding.ConstantBinder(value: MetaDslx.Bootstrap.MetaCompiler.Model.Assignment.NegatedAssign);
 	   ...
 	   var __annot6 = new MetaDslx.CodeAnalysis.Binding.ConstantBinder(value: MetaDslx.Bootstrap.MetaCompiler.Model.Assignment.PlusAssign);
