...
public partial class CompilerParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ICompilerParserVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitPr_Annotation([NotNull] CompilerParser.Pr_AnnotationContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitPr_ParserRuleBlock1Alt2Block1([NotNull] CompilerParser.Pr_ParserRuleBlock1Alt2Block1Context context) { return VisitChildren(context); }
	/// <summary>
