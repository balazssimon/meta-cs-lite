...
namespace MetaDslx.Bootstrap.MetaCompiler.Compiler.Syntax.InternalSyntax
{
	...
	internal class CompilerInternalSyntaxVisitor : InternalSyntaxVisitor
	{
		...
		public virtual void VisitPBlockInlineGreen(PBlockInlineGreen node) => this.DefaultVisit(node);
		...
		public virtual void VisitPBlockBlock2Green(PBlockBlock2Green node) => this.DefaultVisit(node);
		public virtual void VisitPBlockInlineBlock1Green(PBlockInlineBlock1Green node) => this.DefaultVisit(node);
		...
		public virtual void VisitPAlternativeBlock1Block1Green(PAlternativeBlock1Block1Green node) => this.DefaultVisit(node);
	...
	internal class CompilerInternalSyntaxVisitor<TResult> : InternalSyntaxVisitor<TResult>
	{
		...
		public virtual TResult VisitPBlockInlineGreen(PBlockInlineGreen node) => this.DefaultVisit(node);
		...
		public virtual TResult VisitPBlockBlock2Green(PBlockBlock2Green node) => this.DefaultVisit(node);
		public virtual TResult VisitPBlockInlineBlock1Green(PBlockInlineBlock1Green node) => this.DefaultVisit(node);
		...
		public virtual TResult VisitPAlternativeBlock1Block1Green(PAlternativeBlock1Block1Green node) => this.DefaultVisit(node);
