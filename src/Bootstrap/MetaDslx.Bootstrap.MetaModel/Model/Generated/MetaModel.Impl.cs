    ...
    internal class MetaModel_Impl : __MetaModelObject, MetaModel
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Meta.MetaModel_Uri);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Meta.MetaModel_Uri, Meta.MetaDeclaration_FullName, Meta.MetaDeclaration_Name, Meta.MetaDeclaration_Namespace);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Meta.MetaModel_Uri, Meta.MetaDeclaration_FullName, Meta.MetaDeclaration_Name, Meta.MetaDeclaration_Namespace);
