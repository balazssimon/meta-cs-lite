...
namespace MetaDslx.Bootstrap.MetaModel.Model
{
    ...
    public sealed class Meta : __MetaModel, IMeta
    {
        ...
        static Meta()
        {
            ...
            _MetaConstant_Type = new __ModelProperty(typeof(MetaConstant), "Type", typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaTypeReference), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Single, null);
            ...
            _MetaOperation_ReturnType = new __ModelProperty(typeof(MetaOperation), "ReturnType", typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaTypeReference), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Single, null);
            _MetaParameter_Type = new __ModelProperty(typeof(MetaParameter), "Type", typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaTypeReference), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Single, null);
            ...
            _MetaProperty_Type = new __ModelProperty(typeof(MetaProperty), "Type", typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaTypeReference), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Single, null);
