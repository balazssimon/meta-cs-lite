...
namespace MetaDslx.Bootstrap.MetaModel.Model.__Impl
{
    ...
    internal class MetaParameter_Impl : __MetaModelObject, MetaParameter
    {
        ...
        {
            get => MGet<MetaDslx.Bootstrap.MetaModel.Model.MetaTypeReference>(Meta.MetaParameter_Type);
            set => MSet<MetaDslx.Bootstrap.MetaModel.Model.MetaTypeReference>(Meta.MetaParameter_Type, value);
        }
