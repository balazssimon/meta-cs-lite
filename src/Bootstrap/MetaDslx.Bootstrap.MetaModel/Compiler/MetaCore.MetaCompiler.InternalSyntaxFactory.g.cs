...
namespace MetaDslx.Bootstrap.MetaModel.Compiler.Syntax.InternalSyntax
{
	...
	public partial class MetaCoreInternalSyntaxFactory : InternalSyntaxFactory
	{
		...
		internal MetaPropertyGreen MetaProperty(InternalSyntaxToken element, TypeReferenceGreen type, PropertyNameGreen name, MetaDslx.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<MetaPropertyBlock2Green> metaPropertyBlock2, InternalSyntaxToken tSemicolon)
		{
			...
			if (tSemicolon.RawKind != (int)MetaCoreSyntaxKind.TSemicolon) throw new ArgumentException(nameof(tSemicolon));
#endif
			return new MetaPropertyGreen(MetaCoreSyntaxKind.MetaProperty, element, type, name, metaPropertyBlock2.Node, tSemicolon);
		}
...
#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaCoreSyntaxKind)MetaCoreSyntaxKind.PropertyOpposite, kOpposite, qualifierList.Node, out hash);
			if (cached != null) return (PropertyOppositeGreen)cached;
		
			var result = new PropertyOppositeGreen(MetaCoreSyntaxKind.PropertyOpposite, kOpposite, qualifierList.Node);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
...
#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaCoreSyntaxKind)MetaCoreSyntaxKind.PropertySubsets, kSubsets, qualifierList.Node, out hash);
			if (cached != null) return (PropertySubsetsGreen)cached;
		
			var result = new PropertySubsetsGreen(MetaCoreSyntaxKind.PropertySubsets, kSubsets, qualifierList.Node);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
...
#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaCoreSyntaxKind)MetaCoreSyntaxKind.PropertyRedefines, kRedefines, qualifierList.Node, out hash);
			if (cached != null) return (PropertyRedefinesGreen)cached;
		
			var result = new PropertyRedefinesGreen(MetaCoreSyntaxKind.PropertyRedefines, kRedefines, qualifierList.Node);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
...
#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaCoreSyntaxKind)MetaCoreSyntaxKind.MetaPropertyBlock2Alt1, propertyOpposite, out hash);
			if (cached != null) return (MetaPropertyBlock2Alt1Green)cached;
		
			var result = new MetaPropertyBlock2Alt1Green(MetaCoreSyntaxKind.MetaPropertyBlock2Alt1, propertyOpposite);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
...
#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaCoreSyntaxKind)MetaCoreSyntaxKind.MetaPropertyBlock2Alt2, propertySubsets, out hash);
			if (cached != null) return (MetaPropertyBlock2Alt2Green)cached;
		
			var result = new MetaPropertyBlock2Alt2Green(MetaCoreSyntaxKind.MetaPropertyBlock2Alt2, propertySubsets);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
...
#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaCoreSyntaxKind)MetaCoreSyntaxKind.MetaPropertyBlock2Alt3, propertyRedefines, out hash);
			if (cached != null) return (MetaPropertyBlock2Alt3Green)cached;
		
			var result = new MetaPropertyBlock2Alt3Green(MetaCoreSyntaxKind.MetaPropertyBlock2Alt3, propertyRedefines);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
...
#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaCoreSyntaxKind)MetaCoreSyntaxKind.PropertyOppositeBlock1, tComma, oppositeProperties, out hash);
			if (cached != null) return (PropertyOppositeBlock1Green)cached;
		
			var result = new PropertyOppositeBlock1Green(MetaCoreSyntaxKind.PropertyOppositeBlock1, tComma, oppositeProperties);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
...
#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaCoreSyntaxKind)MetaCoreSyntaxKind.PropertySubsetsBlock1, tComma, subsettedProperties, out hash);
			if (cached != null) return (PropertySubsetsBlock1Green)cached;
		
			var result = new PropertySubsetsBlock1Green(MetaCoreSyntaxKind.PropertySubsetsBlock1, tComma, subsettedProperties);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
...
#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)(MetaCoreSyntaxKind)MetaCoreSyntaxKind.PropertyRedefinesBlock1, tComma, redefinedProperties, out hash);
			if (cached != null) return (PropertyRedefinesBlock1Green)cached;
		
			var result = new PropertyRedefinesBlock1Green(MetaCoreSyntaxKind.PropertyRedefinesBlock1, tComma, redefinedProperties);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
