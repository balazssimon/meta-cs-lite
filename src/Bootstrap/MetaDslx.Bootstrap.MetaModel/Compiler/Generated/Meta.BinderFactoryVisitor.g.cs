...
namespace MetaDslx.Bootstrap.MetaModel.Compiler.Binding
{
    ...
    public class MetaBinderFactoryVisitor : MetaDslx.CodeAnalysis.Binding.BinderFactoryVisitor, IMetaSyntaxVisitor
    {
        ...
        {
            var __annot0 = new MetaDslx.CodeAnalysis.Binding.DefineBinder(type: typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaModel));
        ...
        {
            var __annot1 = new MetaDslx.CodeAnalysis.Binding.DefineBinder(type: typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaConstant));
        ...
        {
            var __annot1 = new MetaDslx.CodeAnalysis.Binding.DefineBinder(type: typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaEnum));
            this.Begin(__annot1, node);
            try
            {
                this.Visit(node.Name);
        ...
        {
            var __annot0 = new MetaDslx.CodeAnalysis.Binding.DefineBinder(type: typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaEnumLiteral));
            this.Begin(__annot0, node);
            try
            {
                this.Visit(node.Name);
        ...
        {
            var __annot3 = new MetaDslx.CodeAnalysis.Binding.DefineBinder(type: typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaClass));
        ...
        {
            var __annot2 = new MetaDslx.CodeAnalysis.Binding.DefineBinder(type: typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaProperty));
            this.Begin(__annot2, node);
            try
            {
                if (node.Block1 != null)
        ...
        {
            var __annot1 = new MetaDslx.CodeAnalysis.Binding.DefineBinder(type: typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaOperation));
            this.Begin(__annot1, node);
            try
            {
        ...
        {
            var __annot1 = new MetaDslx.CodeAnalysis.Binding.DefineBinder(type: typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaParameter));
            this.Begin(__annot1, node);
            try
            {
                var __annot0 = new MetaDslx.CodeAnalysis.Binding.PropertyBinder(name: "Type");
        ...
        {
            var __annot1 = new MetaDslx.CodeAnalysis.Binding.DefineBinder(type: typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaTypeReference));
            this.Begin(__annot1, node);
            try
            {
                var __annot0 = new MetaDslx.CodeAnalysis.Binding.PropertyBinder(name: "Type");
        ...
        {
            var __annot0 = new MetaDslx.CodeAnalysis.Binding.UseBinder(types: ImmutableArray.Create<System.Type>(typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaEnumLiteral)));
            this.Begin(__annot0, node.Qualifier);
            try
            {
                this.Visit(node.Qualifier);
        ...
        public virtual void VisitMetaClassBlock2(MetaClassBlock2Syntax node)
        {
            ...
            for (var baseTypesIndex = 0; baseTypesIndex < baseTypesList.Count; ++baseTypesIndex)
            {
                ...
                if (baseTypesIndex == 0)
                {
                    ...
                    try
                    {
                        var __annot0 = new MetaDslx.CodeAnalysis.Binding.UseBinder(types: ImmutableArray.Create<System.Type>(typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaClass)));
                ...
                if (!__itemHandled && baseTypesIndex < node.BaseTypes.Count)
                {
                    ...
                    try
                    {
                        var __annot2 = new MetaDslx.CodeAnalysis.Binding.UseBinder(types: ImmutableArray.Create<System.Type>(typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaClass)));
        ...
        public virtual void VisitMetaPropertyBlock2Alt1(MetaPropertyBlock2Alt1Syntax node)
        {
            ...
            try
            {
                ...
                try
                {
                    var __annot0 = new MetaDslx.Bootstrap.MetaModel.Compiler.SymbolPropertyBinder();
        ...
        public virtual void VisitMetaPropertyBlock4Alt1(MetaPropertyBlock4Alt1Syntax node)
        {
            ...
            for (var oppositePropertiesIndex = 0; oppositePropertiesIndex < oppositePropertiesList.Count; ++oppositePropertiesIndex)
            {
                ...
                if (oppositePropertiesIndex == 0)
                {
                    ...
                    try
                    {
                        var __annot0 = new MetaDslx.CodeAnalysis.Binding.UseBinder(types: ImmutableArray.Create<System.Type>(typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaProperty)));
                ...
                if (!__itemHandled && oppositePropertiesIndex < node.OppositeProperties.Count)
                {
                    ...
                    try
                    {
                        var __annot2 = new MetaDslx.CodeAnalysis.Binding.UseBinder(types: ImmutableArray.Create<System.Type>(typeof(MetaDslx.Bootstrap.MetaModel.Model.MetaProperty)));
