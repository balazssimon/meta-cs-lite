...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ActivityGroup_Impl : __MetaModelObject, ActivityGroup
    {
        private ActivityGroup_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ActivityGroup_ContainedEdge, Uml.ActivityGroup_ContainedNode, Uml.ActivityGroup_InActivity, Uml.ActivityGroup_Subgroup, Uml.ActivityGroup_SuperGroup);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ActivityGroup_ContainedEdge, Uml.ActivityGroup_ContainedNode, Uml.ActivityGroup_InActivity, Uml.ActivityGroup_Subgroup, Uml.ActivityGroup_SuperGroup, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ActivityGroup_ContainedEdge, Uml.ActivityGroup_ContainedNode, Uml.ActivityGroup_InActivity, Uml.ActivityGroup_Subgroup, Uml.ActivityGroup_SuperGroup, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.ActivityGroup_ContainingActivity);
            ...
            public override __MetaType MetaType => typeof(ActivityGroup);
            ...
            {
                var result = new ActivityGroup_Impl(id);
