...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class LiteralReal_Impl : __MetaModelObject, LiteralReal
    {
        private LiteralReal_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.LiteralReal(this);
        }
        ...
        public double Value
        {
            get => MGet<double>(Uml.LiteralReal_Value);
            set => MSet<double>(Uml.LiteralReal_Value, value);
        }
        ...
        bool LiteralReal.IsComputable(bool result) => Uml.__CustomImpl.LiteralReal_IsComputable(this, result);
        double LiteralReal.RealValue(double result) => Uml.__CustomImpl.LiteralReal_RealValue(this, result);
        ...
        bool ValueSpecification.IsComputable(bool result) => Uml.__CustomImpl.LiteralReal_IsComputable(this, result);
        bool ValueSpecification.IsNull(bool result) => Uml.__CustomImpl.ValueSpecification_IsNull(this, result);
        double ValueSpecification.RealValue(double result) => Uml.__CustomImpl.LiteralReal_RealValue(this, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.LiteralReal_Value, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.LiteralReal_Value, __ImmutableArray.Create<__ModelProperty>(Uml.LiteralReal_Value), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LiteralReal_IsComputable, Uml.LiteralReal_RealValue);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LiteralReal_IsComputable, Uml.LiteralReal_RealValue, Uml.ValueSpecification_BooleanValue, Uml.ValueSpecification_IntegerValue, Uml.ValueSpecification_IsCompatibleWith, Uml.ValueSpecification_IsComputable, Uml.ValueSpecification_IsNull, Uml.ValueSpecification_RealValue, Uml.ValueSpecification_StringValue, Uml.ValueSpecification_UnlimitedValue, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsCompatibleWith, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LiteralReal_IsComputable, Uml.LiteralReal_RealValue, Uml.ValueSpecification_BooleanValue, Uml.ValueSpecification_IntegerValue, Uml.ValueSpecification_IsCompatibleWith, Uml.ValueSpecification_IsNull, Uml.ValueSpecification_StringValue, Uml.ValueSpecification_UnlimitedValue, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.LiteralReal_IsComputable, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.ValueSpecification_IsComputable), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.LiteralReal_RealValue, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.ValueSpecification_RealValue), __ImmutableArray.Create<__ModelOperation>()));
                    ...
                    modelOperationInfos.Add(Uml.ValueSpecification_IsComputable, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.LiteralReal_IsComputable)));
                    ...
                    modelOperationInfos.Add(Uml.ValueSpecification_RealValue, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.LiteralReal_RealValue)));
            ...
            public override __MetaType MetaType => typeof(LiteralReal);
            ...
            {
                var result = new LiteralReal_Impl(id);
