...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class LiteralReal_Impl : __MetaModelObject, LiteralReal
    {
        ...
        bool LiteralReal.IsComputable() => Uml.__CustomImpl.LiteralReal_IsComputable(this);
        double LiteralReal.RealValue() => Uml.__CustomImpl.LiteralReal_RealValue(this);
        ...
        bool ValueSpecification.IsComputable() => Uml.__CustomImpl.LiteralReal_IsComputable(this);
        bool ValueSpecification.IsNull() => Uml.__CustomImpl.ValueSpecification_IsNull(this);
        double ValueSpecification.RealValue() => Uml.__CustomImpl.LiteralReal_RealValue(this);
