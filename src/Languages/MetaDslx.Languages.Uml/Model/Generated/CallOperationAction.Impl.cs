...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class CallOperationAction_Impl : __MetaModelObject, CallOperationAction
    {
        private CallOperationAction_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.CallAction_IsSynchronous)?.Add((bool)true);
            ...
            Uml.__CustomImpl.InvocationAction(this);
            Uml.__CustomImpl.CallAction(this);
            Uml.__CustomImpl.CallOperationAction(this);
        }
        ...
        {
            get => MGet<Operation>(Uml.CallOperationAction_Operation);
            set => MSet<Operation>(Uml.CallOperationAction_Operation, value);
        }
    
        public InputPin Target
        {
            get => MGet<InputPin>(Uml.CallOperationAction_Target);
            set => MSet<InputPin>(Uml.CallOperationAction_Target, value);
        }
    
        public bool IsSynchronous
        {
            get => MGet<bool>(Uml.CallAction_IsSynchronous);
            set => MSet<bool>(Uml.CallAction_IsSynchronous, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<OutputPin> Result
        {
            get => MGetCollection<OutputPin>(Uml.CallAction_Result);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<InputPin> Argument
        {
            get => MGetCollection<InputPin>(Uml.InvocationAction_Argument);
        }
    
        public Port OnPort
        {
            get => MGet<Port>(Uml.InvocationAction_OnPort);
            set => MSet<Port>(Uml.InvocationAction_OnPort, value);
        }
        ...
        global::System.Collections.Generic.IList<Parameter> CallOperationAction.InputParameters(global::System.Collections.Generic.IList<Parameter> result) => Uml.__CustomImpl.CallOperationAction_InputParameters(this, result);
        global::System.Collections.Generic.IList<Parameter> CallOperationAction.OutputParameters(global::System.Collections.Generic.IList<Parameter> result) => Uml.__CustomImpl.CallOperationAction_OutputParameters(this, result);
        global::System.Collections.Generic.IList<Parameter> CallAction.InputParameters(global::System.Collections.Generic.IList<Parameter> result) => Uml.__CustomImpl.CallOperationAction_InputParameters(this, result);
        global::System.Collections.Generic.IList<Parameter> CallAction.OutputParameters(global::System.Collections.Generic.IList<Parameter> result) => Uml.__CustomImpl.CallOperationAction_OutputParameters(this, result);
        global::System.Collections.Generic.IList<Action> Action.AllActions(global::System.Collections.Generic.IList<Action> result) => Uml.__CustomImpl.Action_AllActions(this, result);
        global::System.Collections.Generic.IList<ActivityNode> Action.AllOwnedNodes(global::System.Collections.Generic.IList<ActivityNode> result) => Uml.__CustomImpl.Action_AllOwnedNodes(this, result);
        Behavior Action.ContainingBehavior(Behavior result) => Uml.__CustomImpl.Action_ContainingBehavior(this, result);
        Activity ActivityNode.ContainingActivity(Activity result) => Uml.__CustomImpl.ActivityNode_ContainingActivity(this, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.CallActionInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.CallActionInfo, Uml.InvocationActionInfo, Uml.ActionInfo, Uml.ExecutableNodeInfo, Uml.ActivityNodeInfo, Uml.RedefinableElementInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.CallOperationAction_Operation, Uml.CallOperationAction_Target);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.CallOperationAction_Operation, Uml.CallOperationAction_Target, Uml.CallAction_IsSynchronous, Uml.CallAction_Result, Uml.InvocationAction_Argument, Uml.InvocationAction_OnPort, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.CallOperationAction_Operation, Uml.CallOperationAction_Target, Uml.CallAction_IsSynchronous, Uml.CallAction_Result, Uml.InvocationAction_Argument, Uml.InvocationAction_OnPort, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Operation", Uml.CallOperationAction_Operation);
                publicPropertiesByName.Add("Target", Uml.CallOperationAction_Target);
                publicPropertiesByName.Add("IsSynchronous", Uml.CallAction_IsSynchronous);
                publicPropertiesByName.Add("Result", Uml.CallAction_Result);
                publicPropertiesByName.Add("Argument", Uml.InvocationAction_Argument);
                publicPropertiesByName.Add("OnPort", Uml.InvocationAction_OnPort);
                ...
                modelPropertyInfos.Add(Uml.CallOperationAction_Operation, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.CallOperationAction_Operation, __ImmutableArray.Create<__ModelProperty>(Uml.CallOperationAction_Operation), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.CallOperationAction_Target, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.CallOperationAction_Target, __ImmutableArray.Create<__ModelProperty>(Uml.CallOperationAction_Target), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.CallAction_IsSynchronous, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.CallAction_IsSynchronous, __ImmutableArray.Create<__ModelProperty>(Uml.CallAction_IsSynchronous), true, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.CallAction_Result, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.CallAction_Result, __ImmutableArray.Create<__ModelProperty>(Uml.CallAction_Result), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Output), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InvocationAction_Argument, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InvocationAction_Argument, __ImmutableArray.Create<__ModelProperty>(Uml.InvocationAction_Argument), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InvocationAction_OnPort, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InvocationAction_OnPort, __ImmutableArray.Create<__ModelProperty>(Uml.InvocationAction_OnPort), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.CallOperationAction_InputParameters, Uml.CallOperationAction_OutputParameters);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.CallOperationAction_InputParameters, Uml.CallOperationAction_OutputParameters, Uml.CallAction_InputParameters, Uml.CallAction_OutputParameters, Uml.Action_AllActions, Uml.Action_AllOwnedNodes, Uml.Action_ContainingBehavior, Uml.ActivityNode_ContainingActivity, Uml.ActivityNode_IsConsistentWith, Uml.RedefinableElement_IsConsistentWith, Uml.RedefinableElement_IsRedefinitionContextValid, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.CallOperationAction_InputParameters, Uml.CallOperationAction_OutputParameters, Uml.Action_AllActions, Uml.Action_AllOwnedNodes, Uml.Action_ContainingBehavior, Uml.ActivityNode_ContainingActivity, Uml.ActivityNode_IsConsistentWith, Uml.RedefinableElement_IsRedefinitionContextValid, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.CallOperationAction_InputParameters, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.CallAction_InputParameters), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.CallOperationAction_OutputParameters, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.CallAction_OutputParameters), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.CallAction_InputParameters, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.CallOperationAction_InputParameters)));
                    modelOperationInfos.Add(Uml.CallAction_OutputParameters, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.CallOperationAction_OutputParameters)));
            ...
            public override __MetaType MetaType => typeof(CallOperationAction);
            ...
            {
                var result = new CallOperationAction_Impl(id);
            ...
            {
                return "Uml.CallOperationActionInfo";
            }
        }
    }
}
