...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class DeployedArtifact_Impl : __MetaModelObject, DeployedArtifact
    {
        private DeployedArtifact_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(DeployedArtifact);
            ...
            {
                var result = new DeployedArtifact_Impl(id);
            ...
            {
                return "Uml.DeployedArtifactInfo";
            }
        }
    }
}
