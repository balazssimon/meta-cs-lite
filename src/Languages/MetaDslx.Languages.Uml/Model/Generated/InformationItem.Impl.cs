...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class InformationItem_Impl : __MetaModelObject, InformationItem
    {
        private InformationItem_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.InformationItem(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<Classifier> Represented
        {
            get => MGetCollection<Classifier>(Uml.InformationItem_Represented);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.InformationItem_Represented, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InformationItem_Represented, __ImmutableArray.Create<__ModelProperty>(Uml.InformationItem_Represented), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(InformationItem);
            ...
            {
                var result = new InformationItem_Impl(id);
            ...
            {
                return "Uml.InformationItemInfo";
            }
        }
    }
}
