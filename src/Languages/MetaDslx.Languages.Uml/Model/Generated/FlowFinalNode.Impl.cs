...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class FlowFinalNode_Impl : __MetaModelObject, FlowFinalNode
    {
        private FlowFinalNode_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.FlowFinalNode(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(FlowFinalNode);
            ...
            {
                var result = new FlowFinalNode_Impl(id);
