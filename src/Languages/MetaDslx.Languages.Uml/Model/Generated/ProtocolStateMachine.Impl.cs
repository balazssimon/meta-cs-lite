...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ProtocolStateMachine_Impl : __MetaModelObject, ProtocolStateMachine
    {
        private ProtocolStateMachine_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.Behavior_IsReentrant)?.Add((bool)true);
            ...
            Uml.__CustomImpl.Behavior(this);
            Uml.__CustomImpl.StateMachine(this);
            Uml.__CustomImpl.ProtocolStateMachine(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<ProtocolConformance> Conformance
        {
            get => MGetCollection<ProtocolConformance>(Uml.ProtocolStateMachine_Conformance);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Pseudostate> ConnectionPoint
        {
            get => MGetCollection<Pseudostate>(Uml.StateMachine_ConnectionPoint);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<StateMachine> ExtendedStateMachine
        {
            get => MGetCollection<StateMachine>(Uml.StateMachine_ExtendedStateMachine);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Region> Region
        {
            get => MGetCollection<Region>(Uml.StateMachine_Region);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<State> SubmachineState
        {
            get => MGetCollection<State>(Uml.StateMachine_SubmachineState);
        }
    
        public BehavioredClassifier Context
        {
            get => Uml.__CustomImpl.Behavior_Context(this);
        }
    
        public bool IsReentrant
        {
            get => MGet<bool>(Uml.Behavior_IsReentrant);
            set => MSet<bool>(Uml.Behavior_IsReentrant, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Parameter> OwnedParameter
        {
            get => MGetCollection<Parameter>(Uml.Behavior_OwnedParameter);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ParameterSet> OwnedParameterSet
        {
            get => MGetCollection<ParameterSet>(Uml.Behavior_OwnedParameterSet);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Constraint> Postcondition
        {
            get => MGetCollection<Constraint>(Uml.Behavior_Postcondition);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Constraint> Precondition
        {
            get => MGetCollection<Constraint>(Uml.Behavior_Precondition);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Behavior> RedefinedBehavior
        {
            get => MGetCollection<Behavior>(Uml.Behavior_RedefinedBehavior);
        }
    
        public BehavioralFeature Specification
        {
            get => MGet<BehavioralFeature>(Uml.Behavior_Specification);
            set => MSet<BehavioralFeature>(Uml.Behavior_Specification, value);
        }
        ...
        public global::MetaDslx.Modeling.ICollectionSlot<Port> OwnedPort
        {
            get => MGetCollection<Port>(Uml.EncapsulatedClassifier_OwnedPort);
        }
        ...
        bool StateMachine.Ancestor(bool result, Vertex s1, Vertex s2) => Uml.__CustomImpl.StateMachine_Ancestor(this, result, s1, s2);
        bool StateMachine.IsConsistentWith(bool result, RedefinableElement redefiningElement) => Uml.__CustomImpl.StateMachine_IsConsistentWith(this, result, redefiningElement);
        bool StateMachine.IsRedefinitionContextValid(bool result, RedefinableElement redefinedElement) => Uml.__CustomImpl.StateMachine_IsRedefinitionContextValid(this, result, redefinedElement);
        Region StateMachine.LCA(Region result, Vertex s1, Vertex s2) => Uml.__CustomImpl.StateMachine_LCA(this, result, s1, s2);
        State StateMachine.LCAState(State result, Vertex v1, Vertex v2) => Uml.__CustomImpl.StateMachine_LCAState(this, result, v1, v2);
        BehavioredClassifier Behavior.BehavioredClassifier(Element from, BehavioredClassifier result) => Uml.__CustomImpl.Behavior_BehavioredClassifier(this, from, result);
        global::System.Collections.Generic.IList<Parameter> Behavior.InputParameters(global::System.Collections.Generic.IList<Parameter> result) => Uml.__CustomImpl.Behavior_InputParameters(this, result);
        global::System.Collections.Generic.IList<Parameter> Behavior.OutputParameters(global::System.Collections.Generic.IList<Parameter> result) => Uml.__CustomImpl.Behavior_OutputParameters(this, result);
        global::System.Collections.Generic.IList<ConnectableElement> StructuredClassifier.AllRoles(global::System.Collections.Generic.IList<ConnectableElement> result) => Uml.__CustomImpl.StructuredClassifier_AllRoles(this, result);
        ...
        bool RedefinableElement.IsConsistentWith(bool result, RedefinableElement redefiningElement) => Uml.__CustomImpl.StateMachine_IsConsistentWith(this, result, redefiningElement);
        bool RedefinableElement.IsRedefinitionContextValid(bool result, RedefinableElement redefinedElement) => Uml.__CustomImpl.StateMachine_IsRedefinitionContextValid(this, result, redefinedElement);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.StateMachineInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.StateMachineInfo, Uml.BehaviorInfo, Uml.ClassInfo, Uml.BehavioredClassifierInfo, Uml.EncapsulatedClassifierInfo, Uml.StructuredClassifierInfo, Uml.ClassifierInfo, Uml.NamespaceInfo, Uml.RedefinableElementInfo, Uml.TemplateableElementInfo, Uml.TypeInfo, Uml.PackageableElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ProtocolStateMachine_Conformance);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ProtocolStateMachine_Conformance, Uml.StateMachine_ConnectionPoint, Uml.StateMachine_ExtendedStateMachine, Uml.StateMachine_Region, Uml.StateMachine_SubmachineState, Uml.Behavior_Context, Uml.Behavior_IsReentrant, Uml.Behavior_OwnedParameter, Uml.Behavior_OwnedParameterSet, Uml.Behavior_Postcondition, Uml.Behavior_Precondition, Uml.Behavior_RedefinedBehavior, Uml.Behavior_Specification, Uml.Class_Extension, Uml.Class_IsAbstract, Uml.Class_IsActive, Uml.Class_NestedClassifier, Uml.Class_OwnedAttribute, Uml.Class_OwnedOperation, Uml.Class_OwnedReception, Uml.Class_SuperClass, Uml.BehavioredClassifier_ClassifierBehavior, Uml.BehavioredClassifier_InterfaceRealization, Uml.BehavioredClassifier_OwnedBehavior, Uml.EncapsulatedClassifier_OwnedPort, Uml.StructuredClassifier_OwnedAttribute, Uml.StructuredClassifier_OwnedConnector, Uml.StructuredClassifier_Part, Uml.StructuredClassifier_Role, Uml.Classifier_Attribute, Uml.Classifier_CollaborationUse, Uml.Classifier_Feature, Uml.Classifier_General, Uml.Classifier_Generalization, Uml.Classifier_InheritedMember, Uml.Classifier_IsAbstract, Uml.Classifier_IsFinalSpecialization, Uml.Classifier_OwnedTemplateSignature, Uml.Classifier_OwnedUseCase, Uml.Classifier_PowertypeExtent, Uml.Classifier_RedefinedClassifier, Uml.Classifier_Representation, Uml.Classifier_Substitution, Uml.Classifier_TemplateParameter, Uml.Classifier_UseCase, Uml.Namespace_ElementImport, Uml.Namespace_ImportedMember, Uml.Namespace_Member, Uml.Namespace_OwnedMember, Uml.Namespace_OwnedRule, Uml.Namespace_PackageImport, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.TemplateableElement_OwnedTemplateSignature, Uml.TemplateableElement_TemplateBinding, Uml.Type_Package, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ProtocolStateMachine_Conformance, Uml.StateMachine_ConnectionPoint, Uml.StateMachine_ExtendedStateMachine, Uml.StateMachine_Region, Uml.StateMachine_SubmachineState, Uml.Behavior_Context, Uml.Behavior_IsReentrant, Uml.Behavior_OwnedParameter, Uml.Behavior_OwnedParameterSet, Uml.Behavior_Postcondition, Uml.Behavior_Precondition, Uml.Behavior_RedefinedBehavior, Uml.Behavior_Specification, Uml.Class_Extension, Uml.Class_IsAbstract, Uml.Class_IsActive, Uml.Class_NestedClassifier, Uml.Class_OwnedAttribute, Uml.Class_OwnedOperation, Uml.Class_OwnedReception, Uml.Class_SuperClass, Uml.BehavioredClassifier_ClassifierBehavior, Uml.BehavioredClassifier_InterfaceRealization, Uml.BehavioredClassifier_OwnedBehavior, Uml.EncapsulatedClassifier_OwnedPort, Uml.StructuredClassifier_OwnedConnector, Uml.StructuredClassifier_Part, Uml.StructuredClassifier_Role, Uml.Classifier_Attribute, Uml.Classifier_CollaborationUse, Uml.Classifier_Feature, Uml.Classifier_General, Uml.Classifier_Generalization, Uml.Classifier_InheritedMember, Uml.Classifier_IsFinalSpecialization, Uml.Classifier_OwnedTemplateSignature, Uml.Classifier_OwnedUseCase, Uml.Classifier_PowertypeExtent, Uml.Classifier_RedefinedClassifier, Uml.Classifier_Representation, Uml.Classifier_Substitution, Uml.Classifier_TemplateParameter, Uml.Classifier_UseCase, Uml.Namespace_ElementImport, Uml.Namespace_ImportedMember, Uml.Namespace_Member, Uml.Namespace_OwnedMember, Uml.Namespace_OwnedRule, Uml.Namespace_PackageImport, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.TemplateableElement_TemplateBinding, Uml.Type_Package, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Conformance", Uml.ProtocolStateMachine_Conformance);
                publicPropertiesByName.Add("ConnectionPoint", Uml.StateMachine_ConnectionPoint);
                publicPropertiesByName.Add("ExtendedStateMachine", Uml.StateMachine_ExtendedStateMachine);
                publicPropertiesByName.Add("Region", Uml.StateMachine_Region);
                publicPropertiesByName.Add("SubmachineState", Uml.StateMachine_SubmachineState);
                publicPropertiesByName.Add("Context", Uml.Behavior_Context);
                publicPropertiesByName.Add("IsReentrant", Uml.Behavior_IsReentrant);
                publicPropertiesByName.Add("OwnedParameter", Uml.Behavior_OwnedParameter);
                publicPropertiesByName.Add("OwnedParameterSet", Uml.Behavior_OwnedParameterSet);
                publicPropertiesByName.Add("Postcondition", Uml.Behavior_Postcondition);
                publicPropertiesByName.Add("Precondition", Uml.Behavior_Precondition);
                publicPropertiesByName.Add("RedefinedBehavior", Uml.Behavior_RedefinedBehavior);
                publicPropertiesByName.Add("Specification", Uml.Behavior_Specification);
                ...
                modelPropertyInfos.Add(Uml.ProtocolStateMachine_Conformance, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ProtocolStateMachine_Conformance, __ImmutableArray.Create<__ModelProperty>(Uml.ProtocolStateMachine_Conformance), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.ProtocolConformance_SpecificMachine), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.StateMachine_ConnectionPoint, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.StateMachine_ConnectionPoint, __ImmutableArray.Create<__ModelProperty>(Uml.StateMachine_ConnectionPoint), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Pseudostate_StateMachine), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.StateMachine_ExtendedStateMachine, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.StateMachine_ExtendedStateMachine, __ImmutableArray.Create<__ModelProperty>(Uml.StateMachine_ExtendedStateMachine, Uml.Behavior_RedefinedBehavior), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Behavior_RedefinedBehavior), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.StateMachine_Region, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.StateMachine_Region, __ImmutableArray.Create<__ModelProperty>(Uml.StateMachine_Region), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Region_StateMachine), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.StateMachine_SubmachineState, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.StateMachine_SubmachineState, __ImmutableArray.Create<__ModelProperty>(Uml.StateMachine_SubmachineState), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.State_Submachine), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Behavior_Context, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Behavior_Context, __ImmutableArray.Create<__ModelProperty>(Uml.Behavior_Context), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.RedefinableElement_RedefinitionContext), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Behavior_IsReentrant, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Behavior_IsReentrant, __ImmutableArray.Create<__ModelProperty>(Uml.Behavior_IsReentrant), true, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Behavior_OwnedParameter, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Behavior_OwnedParameter, __ImmutableArray.Create<__ModelProperty>(Uml.Behavior_OwnedParameter), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Behavior_OwnedParameterSet, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Behavior_OwnedParameterSet, __ImmutableArray.Create<__ModelProperty>(Uml.Behavior_OwnedParameterSet), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Behavior_Postcondition, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Behavior_Postcondition, __ImmutableArray.Create<__ModelProperty>(Uml.Behavior_Postcondition), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedRule), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Behavior_Precondition, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Behavior_Precondition, __ImmutableArray.Create<__ModelProperty>(Uml.Behavior_Precondition), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedRule), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Behavior_RedefinedBehavior, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.StateMachine_ExtendedStateMachine, __ImmutableArray.Create<__ModelProperty>(Uml.StateMachine_ExtendedStateMachine, Uml.Behavior_RedefinedBehavior), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_RedefinedClassifier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.StateMachine_ExtendedStateMachine), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Behavior_Specification, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Behavior_Specification, __ImmutableArray.Create<__ModelProperty>(Uml.Behavior_Specification), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.BehavioralFeature_Method), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.EncapsulatedClassifier_OwnedPort, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.EncapsulatedClassifier_OwnedPort, __ImmutableArray.Create<__ModelProperty>(Uml.EncapsulatedClassifier_OwnedPort), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.StructuredClassifier_OwnedAttribute), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.StateMachine_Ancestor, Uml.StateMachine_IsConsistentWith, Uml.StateMachine_IsRedefinitionContextValid, Uml.StateMachine_LCA, Uml.StateMachine_LCAState, Uml.Behavior_BehavioredClassifier, Uml.Behavior_InputParameters, Uml.Behavior_OutputParameters, Uml.StructuredClassifier_AllRoles, Uml.Classifier_AllAttributes, Uml.Classifier_AllFeatures, Uml.Classifier_AllParents, Uml.Classifier_AllRealizedInterfaces, Uml.Classifier_AllSlottableFeatures, Uml.Classifier_AllUsedInterfaces, Uml.Classifier_ConformsTo, Uml.Classifier_DirectlyRealizedInterfaces, Uml.Classifier_DirectlyUsedInterfaces, Uml.Classifier_HasVisibilityOf, Uml.Classifier_Inherit, Uml.Classifier_InheritableMembers, Uml.Classifier_IsSubstitutableFor, Uml.Classifier_IsTemplate, Uml.Classifier_MaySpecializeType, Uml.Classifier_Parents, Uml.Namespace_ExcludeCollisions, Uml.Namespace_GetNamesOfMember, Uml.Namespace_ImportMembers, Uml.Namespace_MembersAreDistinguishable, Uml.RedefinableElement_IsConsistentWith, Uml.RedefinableElement_IsRedefinitionContextValid, Uml.TemplateableElement_IsTemplate, Uml.TemplateableElement_ParameterableElements, Uml.Type_ConformsTo, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsCompatibleWith, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.StateMachine_Ancestor, Uml.StateMachine_IsConsistentWith, Uml.StateMachine_IsRedefinitionContextValid, Uml.StateMachine_LCA, Uml.StateMachine_LCAState, Uml.Behavior_BehavioredClassifier, Uml.Behavior_InputParameters, Uml.Behavior_OutputParameters, Uml.StructuredClassifier_AllRoles, Uml.Classifier_AllAttributes, Uml.Classifier_AllFeatures, Uml.Classifier_AllParents, Uml.Classifier_AllRealizedInterfaces, Uml.Classifier_AllSlottableFeatures, Uml.Classifier_AllUsedInterfaces, Uml.Classifier_ConformsTo, Uml.Classifier_DirectlyRealizedInterfaces, Uml.Classifier_DirectlyUsedInterfaces, Uml.Classifier_HasVisibilityOf, Uml.Classifier_Inherit, Uml.Classifier_InheritableMembers, Uml.Classifier_IsSubstitutableFor, Uml.Classifier_IsTemplate, Uml.Classifier_MaySpecializeType, Uml.Classifier_Parents, Uml.Namespace_ExcludeCollisions, Uml.Namespace_GetNamesOfMember, Uml.Namespace_ImportMembers, Uml.Namespace_MembersAreDistinguishable, Uml.TemplateableElement_ParameterableElements, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsCompatibleWith, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.StateMachine_Ancestor, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.StateMachine_IsConsistentWith, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.RedefinableElement_IsConsistentWith), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.StateMachine_IsRedefinitionContextValid, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.RedefinableElement_IsRedefinitionContextValid), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.StateMachine_LCA, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.StateMachine_LCAState, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.Behavior_BehavioredClassifier, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.Behavior_InputParameters, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.Behavior_OutputParameters, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    ...
                    modelOperationInfos.Add(Uml.RedefinableElement_IsConsistentWith, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.StateMachine_IsConsistentWith)));
                    modelOperationInfos.Add(Uml.RedefinableElement_IsRedefinitionContextValid, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.StateMachine_IsRedefinitionContextValid)));
            ...
            public override __MetaType MetaType => typeof(ProtocolStateMachine);
            ...
            {
                var result = new ProtocolStateMachine_Impl(id);
            ...
            {
                return "Uml.ProtocolStateMachineInfo";
            }
        }
    }
}
