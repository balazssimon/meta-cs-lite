...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ProtocolStateMachine_Impl : __MetaModelObject, ProtocolStateMachine
    {
        ...
        bool StateMachine.Ancestor(Vertex s1, Vertex s2) => Uml.__CustomImpl.StateMachine_Ancestor(this, s1, s2);
        bool StateMachine.IsConsistentWith(RedefinableElement redefiningElement) => Uml.__CustomImpl.StateMachine_IsConsistentWith(this, redefiningElement);
        bool StateMachine.IsRedefinitionContextValid(RedefinableElement redefinedElement) => Uml.__CustomImpl.StateMachine_IsRedefinitionContextValid(this, redefinedElement);
        Region StateMachine.LCA(Vertex s1, Vertex s2) => Uml.__CustomImpl.StateMachine_LCA(this, s1, s2);
        State StateMachine.LCAState(Vertex v1, Vertex v2) => Uml.__CustomImpl.StateMachine_LCAState(this, v1, v2);
        BehavioredClassifier Behavior.BehavioredClassifier(Element from) => Uml.__CustomImpl.Behavior_BehavioredClassifier(this, from);
        global::System.Collections.Generic.IList<Parameter> Behavior.InputParameters() => Uml.__CustomImpl.Behavior_InputParameters(this);
        global::System.Collections.Generic.IList<Parameter> Behavior.OutputParameters() => Uml.__CustomImpl.Behavior_OutputParameters(this);
        ...
        bool RedefinableElement.IsConsistentWith(RedefinableElement redefiningElement) => Uml.__CustomImpl.StateMachine_IsConsistentWith(this, redefiningElement);
        bool RedefinableElement.IsRedefinitionContextValid(RedefinableElement redefinedElement) => Uml.__CustomImpl.StateMachine_IsRedefinitionContextValid(this, redefinedElement);
