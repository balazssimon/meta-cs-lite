    ...
    internal class ConnectorEnd_Impl : __MetaModelObject, ConnectorEnd
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ConnectorEnd_DefiningEnd, Uml.ConnectorEnd_PartWithPort, Uml.ConnectorEnd_Role);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ConnectorEnd_DefiningEnd, Uml.ConnectorEnd_PartWithPort, Uml.ConnectorEnd_Role, Uml.MultiplicityElement_IsOrdered, Uml.MultiplicityElement_IsUnique, Uml.MultiplicityElement_Lower, Uml.MultiplicityElement_LowerValue, Uml.MultiplicityElement_Upper, Uml.MultiplicityElement_UpperValue, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ConnectorEnd_DefiningEnd, Uml.ConnectorEnd_PartWithPort, Uml.ConnectorEnd_Role, Uml.MultiplicityElement_IsOrdered, Uml.MultiplicityElement_IsUnique, Uml.MultiplicityElement_Lower, Uml.MultiplicityElement_LowerValue, Uml.MultiplicityElement_Upper, Uml.MultiplicityElement_UpperValue, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
