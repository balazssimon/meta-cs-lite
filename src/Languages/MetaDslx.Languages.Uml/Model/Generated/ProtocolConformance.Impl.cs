...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ProtocolConformance_Impl : __MetaModelObject, ProtocolConformance
    {
        private ProtocolConformance_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.Relationship(this);
            Uml.__CustomImpl.DirectedRelationship(this);
            Uml.__CustomImpl.ProtocolConformance(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public ProtocolStateMachine GeneralMachine
        {
            get => MGet<ProtocolStateMachine>(Uml.ProtocolConformance_GeneralMachine);
            set => MSet<ProtocolStateMachine>(Uml.ProtocolConformance_GeneralMachine, value);
        }
    
        public ProtocolStateMachine SpecificMachine
        {
            get => MGet<ProtocolStateMachine>(Uml.ProtocolConformance_SpecificMachine);
            set => MSet<ProtocolStateMachine>(Uml.ProtocolConformance_SpecificMachine, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ProtocolConformance_GeneralMachine, Uml.ProtocolConformance_SpecificMachine);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ProtocolConformance_GeneralMachine, Uml.ProtocolConformance_SpecificMachine, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ProtocolConformance_GeneralMachine, Uml.ProtocolConformance_SpecificMachine, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("GeneralMachine", Uml.ProtocolConformance_GeneralMachine);
                publicPropertiesByName.Add("SpecificMachine", Uml.ProtocolConformance_SpecificMachine);
            ...
            public override __MetaType MetaType => typeof(ProtocolConformance);
            ...
            {
                var result = new ProtocolConformance_Impl(id);
            ...
            {
                return "Uml.ProtocolConformanceInfo";
            }
        }
    }
}
