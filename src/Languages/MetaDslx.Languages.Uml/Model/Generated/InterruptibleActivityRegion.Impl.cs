...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class InterruptibleActivityRegion_Impl : __MetaModelObject, InterruptibleActivityRegion
    {
        private InterruptibleActivityRegion_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.NamedElement(this);
            Uml.__CustomImpl.ActivityGroup(this);
            Uml.__CustomImpl.InterruptibleActivityRegion(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<ActivityEdge> InterruptingEdge
        {
            get => MGetCollection<ActivityEdge>(Uml.InterruptibleActivityRegion_InterruptingEdge);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ActivityNode> Node
        {
            get => MGetCollection<ActivityNode>(Uml.InterruptibleActivityRegion_Node);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InterruptibleActivityRegion_InterruptingEdge, Uml.InterruptibleActivityRegion_Node);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InterruptibleActivityRegion_InterruptingEdge, Uml.InterruptibleActivityRegion_Node, Uml.ActivityGroup_ContainedEdge, Uml.ActivityGroup_ContainedNode, Uml.ActivityGroup_InActivity, Uml.ActivityGroup_Subgroup, Uml.ActivityGroup_SuperGroup, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InterruptibleActivityRegion_InterruptingEdge, Uml.InterruptibleActivityRegion_Node, Uml.ActivityGroup_ContainedEdge, Uml.ActivityGroup_ContainedNode, Uml.ActivityGroup_InActivity, Uml.ActivityGroup_Subgroup, Uml.ActivityGroup_SuperGroup, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("InterruptingEdge", Uml.InterruptibleActivityRegion_InterruptingEdge);
                publicPropertiesByName.Add("Node", Uml.InterruptibleActivityRegion_Node);
                ...
                modelPropertyInfos.Add(Uml.InterruptibleActivityRegion_InterruptingEdge, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InterruptibleActivityRegion_InterruptingEdge, __ImmutableArray.Create<__ModelProperty>(Uml.InterruptibleActivityRegion_InterruptingEdge), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_Interrupts), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InterruptibleActivityRegion_Node, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InterruptibleActivityRegion_Node, __ImmutableArray.Create<__ModelProperty>(Uml.InterruptibleActivityRegion_Node), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityNode_InInterruptibleRegion), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityGroup_ContainedNode), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(InterruptibleActivityRegion);
            ...
            {
                var result = new InterruptibleActivityRegion_Impl(id);
            ...
            {
                return "Uml.InterruptibleActivityRegionInfo";
            }
        }
    }
}
