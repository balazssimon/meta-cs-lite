...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ClearAssociationAction_Impl : __MetaModelObject, ClearAssociationAction
    {
        private ClearAssociationAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ClearAssociationAction(this);
        }
        ...
        {
            get => MGet<Association>(Uml.ClearAssociationAction_Association);
            set => MSet<Association>(Uml.ClearAssociationAction_Association, value);
        }
    
        public InputPin Object
        {
            get => MGet<InputPin>(Uml.ClearAssociationAction_Object);
            set => MSet<InputPin>(Uml.ClearAssociationAction_Object, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.ClearAssociationAction_Association, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ClearAssociationAction_Association, __ImmutableArray.Create<__ModelProperty>(Uml.ClearAssociationAction_Association), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ClearAssociationAction_Object, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ClearAssociationAction_Object, __ImmutableArray.Create<__ModelProperty>(Uml.ClearAssociationAction_Object), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ClearAssociationAction);
            ...
            {
                var result = new ClearAssociationAction_Impl(id);
            ...
            {
                return "Uml.ClearAssociationActionInfo";
            }
        }
    }
}
