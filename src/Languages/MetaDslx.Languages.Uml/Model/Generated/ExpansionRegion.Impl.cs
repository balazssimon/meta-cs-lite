    ...
    internal class ExpansionRegion_Impl : __MetaModelObject, ExpansionRegion
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.ExpansionRegion_Mode, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ExpansionRegion_Mode, __ImmutableArray.Create<__ModelProperty>(Uml.ExpansionRegion_Mode), , __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
