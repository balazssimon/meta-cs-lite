...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ExpansionRegion_Impl : __MetaModelObject, ExpansionRegion
    {
        private ExpansionRegion_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.ExpansionRegion_Mode)?.Add((global::MetaDslx.Languages.Uml.Model.ExpansionKind)MetaDslx.Languages.Uml.Model.ExpansionKind.Iterative);
            ...
            Uml.__CustomImpl.ExpansionRegion(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<ExpansionNode> InputElement
        {
            get => MGetCollection<ExpansionNode>(Uml.ExpansionRegion_InputElement);
        }
    
        public global::MetaDslx.Languages.Uml.Model.ExpansionKind Mode
        {
            get => MGet<global::MetaDslx.Languages.Uml.Model.ExpansionKind>(Uml.ExpansionRegion_Mode);
            set => MSet<global::MetaDslx.Languages.Uml.Model.ExpansionKind>(Uml.ExpansionRegion_Mode, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ExpansionNode> OutputElement
        {
            get => MGetCollection<ExpansionNode>(Uml.ExpansionRegion_OutputElement);
        }
        ...
        global::System.Collections.Generic.IList<Action> StructuredActivityNode.AllActions(global::System.Collections.Generic.IList<Action> result) => Uml.__CustomImpl.StructuredActivityNode_AllActions(this, result);
        ...
        global::System.Collections.Generic.IList<Action> Action.AllActions(global::System.Collections.Generic.IList<Action> result) => Uml.__CustomImpl.StructuredActivityNode_AllActions(this, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.ExpansionRegion_InputElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ExpansionRegion_InputElement, __ImmutableArray.Create<__ModelProperty>(Uml.ExpansionRegion_InputElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.ExpansionNode_RegionAsInput), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ExpansionRegion_Mode, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ExpansionRegion_Mode, __ImmutableArray.Create<__ModelProperty>(Uml.ExpansionRegion_Mode), MetaDslx.Languages.Uml.Model.ExpansionKind.Iterative, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ExpansionRegion_OutputElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ExpansionRegion_OutputElement, __ImmutableArray.Create<__ModelProperty>(Uml.ExpansionRegion_OutputElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.ExpansionNode_RegionAsOutput), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ExpansionRegion);
            ...
            {
                var result = new ExpansionRegion_Impl(id);
            ...
            {
                return "Uml.ExpansionRegionInfo";
            }
        }
    }
}
