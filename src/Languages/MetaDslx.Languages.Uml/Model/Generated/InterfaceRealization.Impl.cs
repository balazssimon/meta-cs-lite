...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class InterfaceRealization_Impl : __MetaModelObject, InterfaceRealization
    {
        private InterfaceRealization_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.InterfaceRealization(this);
        }
        ...
        {
            get => MGet<Interface>(Uml.InterfaceRealization_Contract);
            set => MSet<Interface>(Uml.InterfaceRealization_Contract, value);
        }
    
        public BehavioredClassifier ImplementingClassifier
        {
            get => MGet<BehavioredClassifier>(Uml.InterfaceRealization_ImplementingClassifier);
            set => MSet<BehavioredClassifier>(Uml.InterfaceRealization_ImplementingClassifier, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.RealizationInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.RealizationInfo, Uml.AbstractionInfo, Uml.DependencyInfo, Uml.DirectedRelationshipInfo, Uml.PackageableElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.RelationshipInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InterfaceRealization_Contract, Uml.InterfaceRealization_ImplementingClassifier);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InterfaceRealization_Contract, Uml.InterfaceRealization_ImplementingClassifier, Uml.Abstraction_Mapping, Uml.Dependency_Client, Uml.Dependency_Supplier, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InterfaceRealization_Contract, Uml.InterfaceRealization_ImplementingClassifier, Uml.Abstraction_Mapping, Uml.Dependency_Client, Uml.Dependency_Supplier, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Contract", Uml.InterfaceRealization_Contract);
                publicPropertiesByName.Add("ImplementingClassifier", Uml.InterfaceRealization_ImplementingClassifier);
                ...
                modelPropertyInfos.Add(Uml.InterfaceRealization_Contract, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InterfaceRealization_Contract, __ImmutableArray.Create<__ModelProperty>(Uml.InterfaceRealization_Contract), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Supplier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InterfaceRealization_ImplementingClassifier, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InterfaceRealization_ImplementingClassifier, __ImmutableArray.Create<__ModelProperty>(Uml.InterfaceRealization_ImplementingClassifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.BehavioredClassifier_InterfaceRealization), __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Client, Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Dependency_Client, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Dependency_Client, __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Client), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_ClientDependency), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Source), __ImmutableArray.Create<__ModelProperty>(Uml.InterfaceRealization_ImplementingClassifier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Dependency_Supplier, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Dependency_Supplier, __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Supplier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Target), __ImmutableArray.Create<__ModelProperty>(Uml.InterfaceRealization_Contract), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(InterfaceRealization);
            ...
            {
                var result = new InterfaceRealization_Impl(id);
            ...
            {
                return "Uml.InterfaceRealizationInfo";
            }
        }
    }
}
