...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class TemplateableElement_Impl : __MetaModelObject, TemplateableElement
    {
        private TemplateableElement_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TemplateableElement_OwnedTemplateSignature, Uml.TemplateableElement_TemplateBinding);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TemplateableElement_OwnedTemplateSignature, Uml.TemplateableElement_TemplateBinding, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TemplateableElement_OwnedTemplateSignature, Uml.TemplateableElement_TemplateBinding, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.TemplateableElement_IsTemplate, Uml.TemplateableElement_ParameterableElements);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.TemplateableElement_IsTemplate, Uml.TemplateableElement_ParameterableElements, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.TemplateableElement_IsTemplate, Uml.TemplateableElement_ParameterableElements, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
            ...
            public override __MetaType MetaType => typeof(TemplateableElement);
            ...
            {
                var result = new TemplateableElement_Impl(id);
            ...
            {
                return "Uml.TemplateableElementInfo";
            }
        }
    }
}
