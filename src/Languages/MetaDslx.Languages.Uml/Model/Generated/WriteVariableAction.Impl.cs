...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class WriteVariableAction_Impl : __MetaModelObject, WriteVariableAction
    {
        private WriteVariableAction_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(WriteVariableAction);
            ...
            {
                var result = new WriteVariableAction_Impl(id);
            ...
            {
                return "Uml.WriteVariableActionInfo";
            }
        }
    }
}
