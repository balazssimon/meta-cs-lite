...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class StartObjectBehaviorAction_Impl : __MetaModelObject, StartObjectBehaviorAction
    {
        private StartObjectBehaviorAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.StartObjectBehaviorAction(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public InputPin Object
        {
            get => MGet<InputPin>(Uml.StartObjectBehaviorAction_Object);
            set => MSet<InputPin>(Uml.StartObjectBehaviorAction_Object, value);
        }
        ...
        Behavior StartObjectBehaviorAction.Behavior(Behavior result) => Uml.__CustomImpl.StartObjectBehaviorAction_Behavior(this, result);
        global::System.Collections.Generic.IList<Parameter> StartObjectBehaviorAction.InputParameters(global::System.Collections.Generic.IList<Parameter> result) => Uml.__CustomImpl.StartObjectBehaviorAction_InputParameters(this, result);
        global::System.Collections.Generic.IList<Parameter> StartObjectBehaviorAction.OutputParameters(global::System.Collections.Generic.IList<Parameter> result) => Uml.__CustomImpl.StartObjectBehaviorAction_OutputParameters(this, result);
        global::System.Collections.Generic.IList<Parameter> CallAction.InputParameters(global::System.Collections.Generic.IList<Parameter> result) => Uml.__CustomImpl.StartObjectBehaviorAction_InputParameters(this, result);
        global::System.Collections.Generic.IList<Parameter> CallAction.OutputParameters(global::System.Collections.Generic.IList<Parameter> result) => Uml.__CustomImpl.StartObjectBehaviorAction_OutputParameters(this, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.StartObjectBehaviorAction_Object, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.StartObjectBehaviorAction_Object, __ImmutableArray.Create<__ModelProperty>(Uml.StartObjectBehaviorAction_Object), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.StartObjectBehaviorAction_Behavior, Uml.StartObjectBehaviorAction_InputParameters, Uml.StartObjectBehaviorAction_OutputParameters);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.StartObjectBehaviorAction_Behavior, Uml.StartObjectBehaviorAction_InputParameters, Uml.StartObjectBehaviorAction_OutputParameters, Uml.CallAction_InputParameters, Uml.CallAction_OutputParameters, Uml.Action_AllActions, Uml.Action_AllOwnedNodes, Uml.Action_ContainingBehavior, Uml.ActivityNode_ContainingActivity, Uml.ActivityNode_IsConsistentWith, Uml.RedefinableElement_IsConsistentWith, Uml.RedefinableElement_IsRedefinitionContextValid, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.StartObjectBehaviorAction_Behavior, Uml.StartObjectBehaviorAction_InputParameters, Uml.StartObjectBehaviorAction_OutputParameters, Uml.Action_AllActions, Uml.Action_AllOwnedNodes, Uml.Action_ContainingBehavior, Uml.ActivityNode_ContainingActivity, Uml.ActivityNode_IsConsistentWith, Uml.RedefinableElement_IsRedefinitionContextValid, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.StartObjectBehaviorAction_Behavior, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.StartObjectBehaviorAction_InputParameters, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.CallAction_InputParameters), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.StartObjectBehaviorAction_OutputParameters, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.CallAction_OutputParameters), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.CallAction_InputParameters, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.StartObjectBehaviorAction_InputParameters)));
                    modelOperationInfos.Add(Uml.CallAction_OutputParameters, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.StartObjectBehaviorAction_OutputParameters)));
            ...
            public override __MetaType MetaType => typeof(StartObjectBehaviorAction);
            ...
            {
                var result = new StartObjectBehaviorAction_Impl(id);
            ...
            {
                return "Uml.StartObjectBehaviorActionInfo";
            }
        }
    }
}
