...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class LoopNode_Impl : __MetaModelObject, LoopNode
    {
        private LoopNode_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.LoopNode_IsTestedFirst)?.Add((bool)false);
            ...
            Uml.__CustomImpl.LoopNode(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<OutputPin> BodyOutput
        {
            get => MGetCollection<OutputPin>(Uml.LoopNode_BodyOutput);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ExecutableNode> BodyPart
        {
            get => MGetCollection<ExecutableNode>(Uml.LoopNode_BodyPart);
        }
    
        public OutputPin Decider
        {
            get => MGet<OutputPin>(Uml.LoopNode_Decider);
            set => MSet<OutputPin>(Uml.LoopNode_Decider, value);
        }
    
        public bool IsTestedFirst
        {
            get => MGet<bool>(Uml.LoopNode_IsTestedFirst);
            set => MSet<bool>(Uml.LoopNode_IsTestedFirst, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<OutputPin> LoopVariable
        {
            get => MGetCollection<OutputPin>(Uml.LoopNode_LoopVariable);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<InputPin> LoopVariableInput
        {
            get => MGetCollection<InputPin>(Uml.LoopNode_LoopVariableInput);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<OutputPin> Result
        {
            get => MGetCollection<OutputPin>(Uml.LoopNode_Result);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ExecutableNode> SetupPart
        {
            get => MGetCollection<ExecutableNode>(Uml.LoopNode_SetupPart);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ExecutableNode> Test
        {
            get => MGetCollection<ExecutableNode>(Uml.LoopNode_Test);
        }
        ...
        global::System.Collections.Generic.IList<Action> LoopNode.AllActions(global::System.Collections.Generic.IList<Action> result) => Uml.__CustomImpl.LoopNode_AllActions(this, result);
        global::System.Collections.Generic.IList<ActivityNode> LoopNode.SourceNodes(global::System.Collections.Generic.IList<ActivityNode> result) => Uml.__CustomImpl.LoopNode_SourceNodes(this, result);
        global::System.Collections.Generic.IList<Action> StructuredActivityNode.AllActions(global::System.Collections.Generic.IList<Action> result) => Uml.__CustomImpl.LoopNode_AllActions(this, result);
        global::System.Collections.Generic.IList<ActivityNode> StructuredActivityNode.AllOwnedNodes(global::System.Collections.Generic.IList<ActivityNode> result) => Uml.__CustomImpl.StructuredActivityNode_AllOwnedNodes(this, result);
        Activity StructuredActivityNode.ContainingActivity(Activity result) => Uml.__CustomImpl.StructuredActivityNode_ContainingActivity(this, result);
        global::System.Collections.Generic.IList<ActivityNode> StructuredActivityNode.SourceNodes(global::System.Collections.Generic.IList<ActivityNode> result) => Uml.__CustomImpl.LoopNode_SourceNodes(this, result);
        global::System.Collections.Generic.IList<ActivityNode> StructuredActivityNode.TargetNodes(global::System.Collections.Generic.IList<ActivityNode> result) => Uml.__CustomImpl.StructuredActivityNode_TargetNodes(this, result);
        global::System.Collections.Generic.IList<Action> Action.AllActions(global::System.Collections.Generic.IList<Action> result) => Uml.__CustomImpl.LoopNode_AllActions(this, result);
        global::System.Collections.Generic.IList<ActivityNode> Action.AllOwnedNodes(global::System.Collections.Generic.IList<ActivityNode> result) => Uml.__CustomImpl.StructuredActivityNode_AllOwnedNodes(this, result);
        Behavior Action.ContainingBehavior(Behavior result) => Uml.__CustomImpl.Action_ContainingBehavior(this, result);
        Activity ActivityGroup.ContainingActivity(Activity result) => Uml.__CustomImpl.StructuredActivityNode_ContainingActivity(this, result);
        Activity ActivityNode.ContainingActivity(Activity result) => Uml.__CustomImpl.StructuredActivityNode_ContainingActivity(this, result);
        bool ActivityNode.IsConsistentWith(bool result, RedefinableElement redefiningElement) => Uml.__CustomImpl.ActivityNode_IsConsistentWith(this, result, redefiningElement);
        ...
        bool RedefinableElement.IsConsistentWith(bool result, RedefinableElement redefiningElement) => Uml.__CustomImpl.ActivityNode_IsConsistentWith(this, result, redefiningElement);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.LoopNode_BodyOutput, Uml.LoopNode_BodyPart, Uml.LoopNode_Decider, Uml.LoopNode_IsTestedFirst, Uml.LoopNode_LoopVariable, Uml.LoopNode_LoopVariableInput, Uml.LoopNode_Result, Uml.LoopNode_SetupPart, Uml.LoopNode_Test);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.LoopNode_BodyOutput, Uml.LoopNode_BodyPart, Uml.LoopNode_Decider, Uml.LoopNode_IsTestedFirst, Uml.LoopNode_LoopVariable, Uml.LoopNode_LoopVariableInput, Uml.LoopNode_Result, Uml.LoopNode_SetupPart, Uml.LoopNode_Test, Uml.StructuredActivityNode_Activity, Uml.StructuredActivityNode_Edge, Uml.StructuredActivityNode_MustIsolate, Uml.StructuredActivityNode_Node, Uml.StructuredActivityNode_StructuredNodeInput, Uml.StructuredActivityNode_StructuredNodeOutput, Uml.StructuredActivityNode_Variable, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ActivityGroup_ContainedEdge, Uml.ActivityGroup_ContainedNode, Uml.ActivityGroup_InActivity, Uml.ActivityGroup_Subgroup, Uml.ActivityGroup_SuperGroup, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.Namespace_ElementImport, Uml.Namespace_ImportedMember, Uml.Namespace_Member, Uml.Namespace_OwnedMember, Uml.Namespace_OwnedRule, Uml.Namespace_PackageImport, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.LoopNode_BodyOutput, Uml.LoopNode_BodyPart, Uml.LoopNode_Decider, Uml.LoopNode_IsTestedFirst, Uml.LoopNode_LoopVariable, Uml.LoopNode_LoopVariableInput, Uml.LoopNode_Result, Uml.LoopNode_SetupPart, Uml.LoopNode_Test, Uml.StructuredActivityNode_Activity, Uml.StructuredActivityNode_Edge, Uml.StructuredActivityNode_MustIsolate, Uml.StructuredActivityNode_Node, Uml.StructuredActivityNode_StructuredNodeInput, Uml.StructuredActivityNode_StructuredNodeOutput, Uml.StructuredActivityNode_Variable, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ActivityGroup_ContainedEdge, Uml.ActivityGroup_ContainedNode, Uml.ActivityGroup_InActivity, Uml.ActivityGroup_Subgroup, Uml.ActivityGroup_SuperGroup, Uml.ExecutableNode_Handler, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.Namespace_ElementImport, Uml.Namespace_ImportedMember, Uml.Namespace_Member, Uml.Namespace_OwnedMember, Uml.Namespace_OwnedRule, Uml.Namespace_PackageImport, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("BodyOutput", Uml.LoopNode_BodyOutput);
                publicPropertiesByName.Add("BodyPart", Uml.LoopNode_BodyPart);
                publicPropertiesByName.Add("Decider", Uml.LoopNode_Decider);
                publicPropertiesByName.Add("IsTestedFirst", Uml.LoopNode_IsTestedFirst);
                publicPropertiesByName.Add("LoopVariable", Uml.LoopNode_LoopVariable);
                publicPropertiesByName.Add("LoopVariableInput", Uml.LoopNode_LoopVariableInput);
                publicPropertiesByName.Add("Result", Uml.LoopNode_Result);
                publicPropertiesByName.Add("SetupPart", Uml.LoopNode_SetupPart);
                publicPropertiesByName.Add("Test", Uml.LoopNode_Test);
                ...
                modelPropertyInfos.Add(Uml.LoopNode_BodyOutput, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.LoopNode_BodyOutput, __ImmutableArray.Create<__ModelProperty>(Uml.LoopNode_BodyOutput), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.LoopNode_BodyPart, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.LoopNode_BodyPart, __ImmutableArray.Create<__ModelProperty>(Uml.LoopNode_BodyPart), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.LoopNode_Decider, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.LoopNode_Decider, __ImmutableArray.Create<__ModelProperty>(Uml.LoopNode_Decider), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.LoopNode_IsTestedFirst, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.LoopNode_IsTestedFirst, __ImmutableArray.Create<__ModelProperty>(Uml.LoopNode_IsTestedFirst), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.LoopNode_LoopVariable, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.LoopNode_LoopVariable, __ImmutableArray.Create<__ModelProperty>(Uml.LoopNode_LoopVariable), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.LoopNode_LoopVariableInput, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.LoopNode_LoopVariableInput, __ImmutableArray.Create<__ModelProperty>(Uml.LoopNode_LoopVariableInput, Uml.StructuredActivityNode_StructuredNodeInput), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.StructuredActivityNode_StructuredNodeInput), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.LoopNode_Result, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.LoopNode_Result, __ImmutableArray.Create<__ModelProperty>(Uml.LoopNode_Result, Uml.StructuredActivityNode_StructuredNodeOutput), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.StructuredActivityNode_StructuredNodeOutput), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.LoopNode_SetupPart, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.LoopNode_SetupPart, __ImmutableArray.Create<__ModelProperty>(Uml.LoopNode_SetupPart), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.LoopNode_Test, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.LoopNode_Test, __ImmutableArray.Create<__ModelProperty>(Uml.LoopNode_Test), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.StructuredActivityNode_Node, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.StructuredActivityNode_Node, __ImmutableArray.Create<__ModelProperty>(Uml.StructuredActivityNode_Node), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityNode_InStructuredNode), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityGroup_ContainedNode, Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.StructuredActivityNode_StructuredNodeInput, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.LoopNode_LoopVariableInput, __ImmutableArray.Create<__ModelProperty>(Uml.LoopNode_LoopVariableInput, Uml.StructuredActivityNode_StructuredNodeInput), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.LoopNode_LoopVariableInput), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.StructuredActivityNode_StructuredNodeOutput, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.LoopNode_Result, __ImmutableArray.Create<__ModelProperty>(Uml.LoopNode_Result, Uml.StructuredActivityNode_StructuredNodeOutput), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Output), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.LoopNode_Result), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LoopNode_AllActions, Uml.LoopNode_SourceNodes);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LoopNode_AllActions, Uml.LoopNode_SourceNodes, Uml.StructuredActivityNode_AllActions, Uml.StructuredActivityNode_AllOwnedNodes, Uml.StructuredActivityNode_ContainingActivity, Uml.StructuredActivityNode_SourceNodes, Uml.StructuredActivityNode_TargetNodes, Uml.Action_AllActions, Uml.Action_AllOwnedNodes, Uml.Action_ContainingBehavior, Uml.ActivityGroup_ContainingActivity, Uml.ActivityNode_ContainingActivity, Uml.ActivityNode_IsConsistentWith, Uml.Namespace_ExcludeCollisions, Uml.Namespace_GetNamesOfMember, Uml.Namespace_ImportMembers, Uml.Namespace_MembersAreDistinguishable, Uml.RedefinableElement_IsConsistentWith, Uml.RedefinableElement_IsRedefinitionContextValid, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LoopNode_AllActions, Uml.LoopNode_SourceNodes, Uml.StructuredActivityNode_AllOwnedNodes, Uml.StructuredActivityNode_ContainingActivity, Uml.StructuredActivityNode_TargetNodes, Uml.Action_ContainingBehavior, Uml.ActivityNode_IsConsistentWith, Uml.Namespace_ExcludeCollisions, Uml.Namespace_GetNamesOfMember, Uml.Namespace_ImportMembers, Uml.Namespace_MembersAreDistinguishable, Uml.RedefinableElement_IsRedefinitionContextValid, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.LoopNode_AllActions, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.StructuredActivityNode_AllActions, Uml.Action_AllActions), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.LoopNode_SourceNodes, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.StructuredActivityNode_SourceNodes), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.StructuredActivityNode_AllActions, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.Action_AllActions), __ImmutableArray.Create<__ModelOperation>(Uml.LoopNode_AllActions)));
                    ...
                    modelOperationInfos.Add(Uml.StructuredActivityNode_SourceNodes, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.LoopNode_SourceNodes)));
                    ...
                    modelOperationInfos.Add(Uml.Action_AllActions, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.LoopNode_AllActions, Uml.StructuredActivityNode_AllActions)));
            ...
            public override __MetaType MetaType => typeof(LoopNode);
            ...
            {
                var result = new LoopNode_Impl(id);
