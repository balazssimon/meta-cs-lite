...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class VariableAction_Impl : __MetaModelObject, VariableAction
    {
        private VariableAction_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.VariableAction_Variable);
            ...
            public override __MetaType MetaType => typeof(VariableAction);
            ...
            {
                var result = new VariableAction_Impl(id);
