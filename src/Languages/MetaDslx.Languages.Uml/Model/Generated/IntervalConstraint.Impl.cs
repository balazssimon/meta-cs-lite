...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class IntervalConstraint_Impl : __MetaModelObject, IntervalConstraint
    {
        private IntervalConstraint_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.IntervalConstraint_Specification);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.IntervalConstraint_Specification, Uml.Constraint_ConstrainedElement, Uml.Constraint_Context, Uml.Constraint_Specification, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.IntervalConstraint_Specification, Uml.Constraint_ConstrainedElement, Uml.Constraint_Context, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Specification", Uml.IntervalConstraint_Specification);
                ...
                modelPropertyInfos.Add(Uml.IntervalConstraint_Specification, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.IntervalConstraint_Specification, __ImmutableArray.Create<__ModelProperty>(Uml.IntervalConstraint_Specification, Uml.Constraint_Specification), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Constraint_Specification), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Constraint_Specification), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Constraint_Specification, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.IntervalConstraint_Specification, __ImmutableArray.Create<__ModelProperty>(Uml.IntervalConstraint_Specification, Uml.Constraint_Specification), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.IntervalConstraint_Specification), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.IntervalConstraint_Specification)));
            ...
            public override __MetaType MetaType => typeof(IntervalConstraint);
            ...
            {
                var result = new IntervalConstraint_Impl(id);
            ...
            {
                return "Uml.IntervalConstraintInfo";
            }
        }
    }
}
