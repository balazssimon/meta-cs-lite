    ...
    internal class BehavioralFeature_Impl : __MetaModelObject, BehavioralFeature
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.BehavioralFeature_Concurrency, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.BehavioralFeature_Concurrency, __ImmutableArray.Create<__ModelProperty>(Uml.BehavioralFeature_Concurrency), , __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
