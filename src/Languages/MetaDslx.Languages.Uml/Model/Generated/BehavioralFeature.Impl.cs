...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class BehavioralFeature_Impl : __MetaModelObject, BehavioralFeature
    {
        private BehavioralFeature_Impl(string? id)
            : base(id)
        {
        ...
        global::System.Collections.Generic.IList<Parameter> BehavioralFeature.InputParameters() => Uml.__CustomImpl.BehavioralFeature_InputParameters(this);
        bool BehavioralFeature.IsDistinguishableFrom(NamedElement n, Namespace ns) => Uml.__CustomImpl.BehavioralFeature_IsDistinguishableFrom(this, n, ns);
        global::System.Collections.Generic.IList<Parameter> BehavioralFeature.OutputParameters() => Uml.__CustomImpl.BehavioralFeature_OutputParameters(this);
        ...
        bool NamedElement.IsDistinguishableFrom(NamedElement n, Namespace ns) => Uml.__CustomImpl.BehavioralFeature_IsDistinguishableFrom(this, n, ns);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.FeatureInfo, Uml.NamespaceInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.FeatureInfo, Uml.NamespaceInfo, Uml.RedefinableElementInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.BehavioralFeature_Concurrency, Uml.BehavioralFeature_IsAbstract, Uml.BehavioralFeature_Method, Uml.BehavioralFeature_OwnedParameter, Uml.BehavioralFeature_OwnedParameterSet, Uml.BehavioralFeature_RaisedException);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.BehavioralFeature_Concurrency, Uml.BehavioralFeature_IsAbstract, Uml.BehavioralFeature_Method, Uml.BehavioralFeature_OwnedParameter, Uml.BehavioralFeature_OwnedParameterSet, Uml.BehavioralFeature_RaisedException, Uml.Feature_FeaturingClassifier, Uml.Feature_IsStatic, Uml.Namespace_ElementImport, Uml.Namespace_ImportedMember, Uml.Namespace_Member, Uml.Namespace_OwnedMember, Uml.Namespace_OwnedRule, Uml.Namespace_PackageImport, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.BehavioralFeature_Concurrency, Uml.BehavioralFeature_IsAbstract, Uml.BehavioralFeature_Method, Uml.BehavioralFeature_OwnedParameter, Uml.BehavioralFeature_OwnedParameterSet, Uml.BehavioralFeature_RaisedException, Uml.Feature_FeaturingClassifier, Uml.Feature_IsStatic, Uml.Namespace_ElementImport, Uml.Namespace_ImportedMember, Uml.Namespace_Member, Uml.Namespace_OwnedMember, Uml.Namespace_OwnedRule, Uml.Namespace_PackageImport, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.BehavioralFeature_InputParameters, Uml.BehavioralFeature_IsDistinguishableFrom, Uml.BehavioralFeature_OutputParameters);
            ...
            public override __MetaType MetaType => typeof(BehavioralFeature);
            ...
            {
                var result = new BehavioralFeature_Impl(id);
            ...
            {
                return "Uml.BehavioralFeatureInfo";
            }
        }
    }
}
