...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class PackageMerge_Impl : __MetaModelObject, PackageMerge
    {
            ...
            : base(id)
        {
            ...
            Uml.__CustomImpl.PackageMerge(this);
        }
        ...
        {
            get => MGet<Package>(Uml.PackageMerge_MergedPackage);
            set => MSet<Package>(Uml.PackageMerge_MergedPackage, value);
        }
    
        public Package ReceivingPackage
        {
            get => MGet<Package>(Uml.PackageMerge_ReceivingPackage);
            set => MSet<Package>(Uml.PackageMerge_ReceivingPackage, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.PackageMerge_MergedPackage, Uml.PackageMerge_ReceivingPackage);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.PackageMerge_MergedPackage, Uml.PackageMerge_ReceivingPackage, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.PackageMerge_MergedPackage, Uml.PackageMerge_ReceivingPackage, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("MergedPackage", Uml.PackageMerge_MergedPackage);
                publicPropertiesByName.Add("ReceivingPackage", Uml.PackageMerge_ReceivingPackage);
