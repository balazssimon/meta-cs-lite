...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class GeneralizationSet_Impl : __MetaModelObject, GeneralizationSet
    {
        private GeneralizationSet_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.GeneralizationSet_IsCovering)?.Add((bool)false);
            ((__IModelObject)this).MGetSlot(Uml.GeneralizationSet_IsDisjoint)?.Add((bool)false);
            ...
            Uml.__CustomImpl.GeneralizationSet(this);
        }
        ...
        {
            get => MGetCollection<Generalization>(Uml.GeneralizationSet_Generalization);
        }
    
        public bool IsCovering
        {
            get => MGet<bool>(Uml.GeneralizationSet_IsCovering);
            set => MSet<bool>(Uml.GeneralizationSet_IsCovering, value);
        }
    
        public bool IsDisjoint
        {
            get => MGet<bool>(Uml.GeneralizationSet_IsDisjoint);
            set => MSet<bool>(Uml.GeneralizationSet_IsDisjoint, value);
        }
    
        public Classifier Powertype
        {
            get => MGet<Classifier>(Uml.GeneralizationSet_Powertype);
            set => MSet<Classifier>(Uml.GeneralizationSet_Powertype, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.PackageableElementInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.PackageableElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.GeneralizationSet_Generalization, Uml.GeneralizationSet_IsCovering, Uml.GeneralizationSet_IsDisjoint, Uml.GeneralizationSet_Powertype);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.GeneralizationSet_Generalization, Uml.GeneralizationSet_IsCovering, Uml.GeneralizationSet_IsDisjoint, Uml.GeneralizationSet_Powertype, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.GeneralizationSet_Generalization, Uml.GeneralizationSet_IsCovering, Uml.GeneralizationSet_IsDisjoint, Uml.GeneralizationSet_Powertype, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Generalization", Uml.GeneralizationSet_Generalization);
                publicPropertiesByName.Add("IsCovering", Uml.GeneralizationSet_IsCovering);
                publicPropertiesByName.Add("IsDisjoint", Uml.GeneralizationSet_IsDisjoint);
                publicPropertiesByName.Add("Powertype", Uml.GeneralizationSet_Powertype);
                ...
                modelPropertyInfos.Add(Uml.GeneralizationSet_Generalization, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.GeneralizationSet_Generalization, __ImmutableArray.Create<__ModelProperty>(Uml.GeneralizationSet_Generalization), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Generalization_GeneralizationSet), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.GeneralizationSet_IsCovering, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.GeneralizationSet_IsCovering, __ImmutableArray.Create<__ModelProperty>(Uml.GeneralizationSet_IsCovering), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.GeneralizationSet_IsDisjoint, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.GeneralizationSet_IsDisjoint, __ImmutableArray.Create<__ModelProperty>(Uml.GeneralizationSet_IsDisjoint), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.GeneralizationSet_Powertype, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.GeneralizationSet_Powertype, __ImmutableArray.Create<__ModelProperty>(Uml.GeneralizationSet_Powertype), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_PowertypeExtent), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(GeneralizationSet);
            ...
            {
                var result = new GeneralizationSet_Impl(id);
            ...
            {
                return "Uml.GeneralizationSetInfo";
            }
        }
    }
}
