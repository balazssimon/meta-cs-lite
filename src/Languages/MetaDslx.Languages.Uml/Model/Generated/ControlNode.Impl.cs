...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ControlNode_Impl : __MetaModelObject, ControlNode
    {
        private ControlNode_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(ControlNode);
            ...
            {
                var result = new ControlNode_Impl(id);
