...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Duration_Impl : __MetaModelObject, Duration
    {
        private Duration_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.Duration(this);
        }
        ...
        {
            get => MGet<ValueSpecification>(Uml.Duration_Expr);
            set => MSet<ValueSpecification>(Uml.Duration_Expr, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Observation> Observation
        {
            get => MGetCollection<Observation>(Uml.Duration_Observation);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Duration_Expr, Uml.Duration_Observation);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Duration_Expr, Uml.Duration_Observation, Uml.PackageableElement_Visibility, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Duration_Expr, Uml.Duration_Observation, Uml.PackageableElement_Visibility, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Expr", Uml.Duration_Expr);
                publicPropertiesByName.Add("Observation", Uml.Duration_Observation);
                ...
                modelPropertyInfos.Add(Uml.Duration_Expr, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Duration_Expr, __ImmutableArray.Create<__ModelProperty>(Uml.Duration_Expr), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Duration_Observation, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Duration_Observation, __ImmutableArray.Create<__ModelProperty>(Uml.Duration_Observation), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Duration);
            ...
            {
                var result = new Duration_Impl(id);
