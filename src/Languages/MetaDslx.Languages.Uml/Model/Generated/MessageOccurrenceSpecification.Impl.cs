...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class MessageOccurrenceSpecification_Impl : __MetaModelObject, MessageOccurrenceSpecification
    {
        private MessageOccurrenceSpecification_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.MessageEndInfo, Uml.OccurrenceSpecificationInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.MessageEndInfo, Uml.OccurrenceSpecificationInfo, Uml.InteractionFragmentInfo, Uml.NamedElementInfo, Uml.ElementInfo);
            ...
            public override __MetaType MetaType => typeof(MessageOccurrenceSpecification);
            ...
            {
                var result = new MessageOccurrenceSpecification_Impl(id);
            ...
            {
                return "Uml.MessageOccurrenceSpecificationInfo";
            }
        }
    }
}
