...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class AddVariableValueAction_Impl : __MetaModelObject, AddVariableValueAction
    {
        private AddVariableValueAction_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.AddVariableValueAction_IsReplaceAll)?.Add((bool)false);
            ...
            Uml.__CustomImpl.AddVariableValueAction(this);
        }
        ...
        {
            get => MGet<InputPin>(Uml.AddVariableValueAction_InsertAt);
            set => MSet<InputPin>(Uml.AddVariableValueAction_InsertAt, value);
        }
    
        public bool IsReplaceAll
        {
            get => MGet<bool>(Uml.AddVariableValueAction_IsReplaceAll);
            set => MSet<bool>(Uml.AddVariableValueAction_IsReplaceAll, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.AddVariableValueAction_InsertAt, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.AddVariableValueAction_InsertAt, __ImmutableArray.Create<__ModelProperty>(Uml.AddVariableValueAction_InsertAt), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.AddVariableValueAction_IsReplaceAll, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.AddVariableValueAction_IsReplaceAll, __ImmutableArray.Create<__ModelProperty>(Uml.AddVariableValueAction_IsReplaceAll), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(AddVariableValueAction);
            ...
            {
                var result = new AddVariableValueAction_Impl(id);
            ...
            {
                return "Uml.AddVariableValueActionInfo";
            }
        }
    }
}
