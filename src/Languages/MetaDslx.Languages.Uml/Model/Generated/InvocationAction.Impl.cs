...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class InvocationAction_Impl : __MetaModelObject, InvocationAction
    {
        private InvocationAction_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(InvocationAction);
            ...
            {
                var result = new InvocationAction_Impl(id);
            ...
            {
                return "Uml.InvocationActionInfo";
            }
        }
    }
}
