...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ReadLinkObjectEndAction_Impl : __MetaModelObject, ReadLinkObjectEndAction
    {
        private ReadLinkObjectEndAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ReadLinkObjectEndAction(this);
        }
        ...
        public Property End
        {
            get => MGet<Property>(Uml.ReadLinkObjectEndAction_End);
            set => MSet<Property>(Uml.ReadLinkObjectEndAction_End, value);
        }
    
        public InputPin Object
        {
            get => MGet<InputPin>(Uml.ReadLinkObjectEndAction_Object);
            set => MSet<InputPin>(Uml.ReadLinkObjectEndAction_Object, value);
        }
    
        public OutputPin Result
        {
            get => MGet<OutputPin>(Uml.ReadLinkObjectEndAction_Result);
            set => MSet<OutputPin>(Uml.ReadLinkObjectEndAction_Result, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.ReadLinkObjectEndAction_End, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReadLinkObjectEndAction_End, __ImmutableArray.Create<__ModelProperty>(Uml.ReadLinkObjectEndAction_End), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ReadLinkObjectEndAction_Object, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReadLinkObjectEndAction_Object, __ImmutableArray.Create<__ModelProperty>(Uml.ReadLinkObjectEndAction_Object), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ReadLinkObjectEndAction_Result, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReadLinkObjectEndAction_Result, __ImmutableArray.Create<__ModelProperty>(Uml.ReadLinkObjectEndAction_Result), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Output), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ReadLinkObjectEndAction);
            ...
            {
                var result = new ReadLinkObjectEndAction_Impl(id);
            ...
            {
                return "Uml.ReadLinkObjectEndActionInfo";
            }
        }
    }
}
