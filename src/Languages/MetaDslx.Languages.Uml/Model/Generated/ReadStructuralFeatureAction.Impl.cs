...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ReadStructuralFeatureAction_Impl : __MetaModelObject, ReadStructuralFeatureAction
    {
        private ReadStructuralFeatureAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ReadStructuralFeatureAction(this);
        }
        ...
        {
            get => MGet<OutputPin>(Uml.ReadStructuralFeatureAction_Result);
            set => MSet<OutputPin>(Uml.ReadStructuralFeatureAction_Result, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.ReadStructuralFeatureAction_Result, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReadStructuralFeatureAction_Result, __ImmutableArray.Create<__ModelProperty>(Uml.ReadStructuralFeatureAction_Result), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Output), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ReadStructuralFeatureAction);
            ...
            {
                var result = new ReadStructuralFeatureAction_Impl(id);
            ...
            {
                return "Uml.ReadStructuralFeatureActionInfo";
            }
        }
    }
}
