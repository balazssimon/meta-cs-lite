...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Artifact_Impl : __MetaModelObject, Artifact
    {
        private Artifact_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(Artifact);
            ...
            {
                var result = new Artifact_Impl(id);
