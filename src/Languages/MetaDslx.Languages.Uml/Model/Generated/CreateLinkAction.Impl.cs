...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class CreateLinkAction_Impl : __MetaModelObject, CreateLinkAction
    {
        private CreateLinkAction_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(CreateLinkAction);
            ...
            {
                var result = new CreateLinkAction_Impl(id);
            ...
            {
                return "Uml.CreateLinkActionInfo";
            }
        }
    }
}
