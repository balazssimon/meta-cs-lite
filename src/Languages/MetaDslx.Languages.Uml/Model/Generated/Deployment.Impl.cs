...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Deployment_Impl : __MetaModelObject, Deployment
    {
        private Deployment_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.Deployment(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<DeploymentSpecification> Configuration
        {
            get => MGetCollection<DeploymentSpecification>(Uml.Deployment_Configuration);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<DeployedArtifact> DeployedArtifact
        {
            get => MGetCollection<DeployedArtifact>(Uml.Deployment_DeployedArtifact);
        }
    
        public DeploymentTarget Location
        {
            get => MGet<DeploymentTarget>(Uml.Deployment_Location);
            set => MSet<DeploymentTarget>(Uml.Deployment_Location, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.DependencyInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.DependencyInfo, Uml.DirectedRelationshipInfo, Uml.PackageableElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.RelationshipInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Deployment_Configuration, Uml.Deployment_DeployedArtifact, Uml.Deployment_Location);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Deployment_Configuration, Uml.Deployment_DeployedArtifact, Uml.Deployment_Location, Uml.Dependency_Client, Uml.Dependency_Supplier, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Deployment_Configuration, Uml.Deployment_DeployedArtifact, Uml.Deployment_Location, Uml.Dependency_Client, Uml.Dependency_Supplier, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Configuration", Uml.Deployment_Configuration);
                publicPropertiesByName.Add("DeployedArtifact", Uml.Deployment_DeployedArtifact);
                publicPropertiesByName.Add("Location", Uml.Deployment_Location);
                ...
                modelPropertyInfos.Add(Uml.Deployment_Configuration, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Deployment_Configuration, __ImmutableArray.Create<__ModelProperty>(Uml.Deployment_Configuration), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.DeploymentSpecification_Deployment), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Deployment_DeployedArtifact, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Deployment_DeployedArtifact, __ImmutableArray.Create<__ModelProperty>(Uml.Deployment_DeployedArtifact), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Supplier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Deployment_Location, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Deployment_Location, __ImmutableArray.Create<__ModelProperty>(Uml.Deployment_Location), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.DeploymentTarget_Deployment), __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Client, Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Dependency_Client, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Dependency_Client, __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Client), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_ClientDependency), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Source), __ImmutableArray.Create<__ModelProperty>(Uml.Deployment_Location), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Dependency_Supplier, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Dependency_Supplier, __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Supplier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Target), __ImmutableArray.Create<__ModelProperty>(Uml.Deployment_DeployedArtifact), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Deployment);
            ...
            {
                var result = new Deployment_Impl(id);
