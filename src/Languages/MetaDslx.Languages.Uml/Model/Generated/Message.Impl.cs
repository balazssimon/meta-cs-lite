...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Message_Impl : __MetaModelObject, Message
    {
        private Message_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.Message_MessageSort)?.Add((global::MetaDslx.Languages.Uml.Model.MessageSort)MetaDslx.Languages.Uml.Model.MessageSort.SynchCall);
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.NamedElement(this);
            Uml.__CustomImpl.Message(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<ValueSpecification> Argument
        {
            get => MGetCollection<ValueSpecification>(Uml.Message_Argument);
        }
    
        public Connector Connector
        {
            get => MGet<Connector>(Uml.Message_Connector);
            set => MSet<Connector>(Uml.Message_Connector, value);
        }
    
        public Interaction Interaction
        {
            get => MGet<Interaction>(Uml.Message_Interaction);
            set => MSet<Interaction>(Uml.Message_Interaction, value);
        }
    
        public global::MetaDslx.Languages.Uml.Model.MessageKind MessageKind
        {
            get => Uml.__CustomImpl.Message_MessageKind(this);
        }
    
        public global::MetaDslx.Languages.Uml.Model.MessageSort MessageSort
        {
            get => MGet<global::MetaDslx.Languages.Uml.Model.MessageSort>(Uml.Message_MessageSort);
            set => MSet<global::MetaDslx.Languages.Uml.Model.MessageSort>(Uml.Message_MessageSort, value);
        }
    
        public MessageEnd ReceiveEvent
        {
            get => MGet<MessageEnd>(Uml.Message_ReceiveEvent);
            set => MSet<MessageEnd>(Uml.Message_ReceiveEvent, value);
        }
    
        public MessageEnd SendEvent
        {
            get => MGet<MessageEnd>(Uml.Message_SendEvent);
            set => MSet<MessageEnd>(Uml.Message_SendEvent, value);
        }
    
        public NamedElement Signature
        {
            get => MGet<NamedElement>(Uml.Message_Signature);
            set => MSet<NamedElement>(Uml.Message_Signature, value);
        }
        ...
        bool Message.IsDistinguishableFrom(bool result, NamedElement n, Namespace ns) => Uml.__CustomImpl.Message_IsDistinguishableFrom(this, result, n, ns);
        ...
        bool NamedElement.IsDistinguishableFrom(bool result, NamedElement n, Namespace ns) => Uml.__CustomImpl.Message_IsDistinguishableFrom(this, result, n, ns);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Message_Argument, Uml.Message_Connector, Uml.Message_Interaction, Uml.Message_MessageKind, Uml.Message_MessageSort, Uml.Message_ReceiveEvent, Uml.Message_SendEvent, Uml.Message_Signature);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Message_Argument, Uml.Message_Connector, Uml.Message_Interaction, Uml.Message_MessageKind, Uml.Message_MessageSort, Uml.Message_ReceiveEvent, Uml.Message_SendEvent, Uml.Message_Signature, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Message_Argument, Uml.Message_Connector, Uml.Message_Interaction, Uml.Message_MessageKind, Uml.Message_MessageSort, Uml.Message_ReceiveEvent, Uml.Message_SendEvent, Uml.Message_Signature, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Argument", Uml.Message_Argument);
                publicPropertiesByName.Add("Connector", Uml.Message_Connector);
                publicPropertiesByName.Add("Interaction", Uml.Message_Interaction);
                publicPropertiesByName.Add("MessageKind", Uml.Message_MessageKind);
                publicPropertiesByName.Add("MessageSort", Uml.Message_MessageSort);
                publicPropertiesByName.Add("ReceiveEvent", Uml.Message_ReceiveEvent);
                publicPropertiesByName.Add("SendEvent", Uml.Message_SendEvent);
                publicPropertiesByName.Add("Signature", Uml.Message_Signature);
                ...
                modelPropertyInfos.Add(Uml.Message_Argument, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Message_Argument, __ImmutableArray.Create<__ModelProperty>(Uml.Message_Argument), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Message_Connector, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Message_Connector, __ImmutableArray.Create<__ModelProperty>(Uml.Message_Connector), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Message_Interaction, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Message_Interaction, __ImmutableArray.Create<__ModelProperty>(Uml.Message_Interaction), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Interaction_Message), __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Message_MessageKind, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Message_MessageKind, __ImmutableArray.Create<__ModelProperty>(Uml.Message_MessageKind), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.Single | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Message_MessageSort, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Message_MessageSort, __ImmutableArray.Create<__ModelProperty>(Uml.Message_MessageSort), MetaDslx.Languages.Uml.Model.MessageSort.SynchCall, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Message_ReceiveEvent, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Message_ReceiveEvent, __ImmutableArray.Create<__ModelProperty>(Uml.Message_ReceiveEvent), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Message_SendEvent, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Message_SendEvent, __ImmutableArray.Create<__ModelProperty>(Uml.Message_SendEvent), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Message_Signature, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Message_Signature, __ImmutableArray.Create<__ModelProperty>(Uml.Message_Signature), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.NamedElement_Namespace, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.NamedElement_Namespace, __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(Uml.Message_Interaction), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Message_IsDistinguishableFrom);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Message_IsDistinguishableFrom, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Message_IsDistinguishableFrom, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.Message_IsDistinguishableFrom, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.NamedElement_IsDistinguishableFrom), __ImmutableArray.Create<__ModelOperation>()));
                    ...
                    modelOperationInfos.Add(Uml.NamedElement_IsDistinguishableFrom, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.Message_IsDistinguishableFrom)));
            ...
            public override __MetaType MetaType => typeof(Message);
            ...
            {
                var result = new Message_Impl(id);
