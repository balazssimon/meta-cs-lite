...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Message_Impl : __MetaModelObject, Message
    {
        ...
        {
            get => MGet<global::MetaDslx.Languages.Uml.Model.MessageKind>(Uml.Message_MessageKind);
            set => MSet<global::MetaDslx.Languages.Uml.Model.MessageKind>(Uml.Message_MessageKind, value);
        }
