...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class EnumerationLiteral_Impl : __MetaModelObject, EnumerationLiteral
    {
        private EnumerationLiteral_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.InstanceSpecification(this);
            Uml.__CustomImpl.EnumerationLiteral(this);
        }
        ...
        {
            get => Uml.__CustomImpl.EnumerationLiteral_Classifier(this);
        }
    
        public Enumeration Enumeration
        {
            get => MGet<Enumeration>(Uml.EnumerationLiteral_Enumeration);
            set => MSet<Enumeration>(Uml.EnumerationLiteral_Enumeration, value);
        }
    
        [global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)]
        global::MetaDslx.Modeling.ICollectionSlot<Classifier> InstanceSpecification.Classifier
        {
            get => MGetCollection<Classifier>(Uml.InstanceSpecification_Classifier);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Slot> Slot
        {
            get => MGetCollection<Slot>(Uml.InstanceSpecification_Slot);
        }
    
        public ValueSpecification Specification
        {
            get => MGet<ValueSpecification>(Uml.InstanceSpecification_Specification);
            set => MSet<ValueSpecification>(Uml.InstanceSpecification_Specification, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.InstanceSpecificationInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.InstanceSpecificationInfo, Uml.DeployedArtifactInfo, Uml.DeploymentTargetInfo, Uml.PackageableElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.EnumerationLiteral_Classifier, Uml.EnumerationLiteral_Enumeration);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.EnumerationLiteral_Classifier, Uml.EnumerationLiteral_Enumeration, Uml.InstanceSpecification_Classifier, Uml.InstanceSpecification_Slot, Uml.InstanceSpecification_Specification, Uml.DeploymentTarget_DeployedElement, Uml.DeploymentTarget_Deployment, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.EnumerationLiteral_Classifier, Uml.EnumerationLiteral_Enumeration, Uml.InstanceSpecification_Slot, Uml.InstanceSpecification_Specification, Uml.DeploymentTarget_DeployedElement, Uml.DeploymentTarget_Deployment, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Classifier", Uml.EnumerationLiteral_Classifier);
                publicPropertiesByName.Add("Enumeration", Uml.EnumerationLiteral_Enumeration);
                publicPropertiesByName.Add("Slot", Uml.InstanceSpecification_Slot);
                publicPropertiesByName.Add("Specification", Uml.InstanceSpecification_Specification);
                ...
                modelPropertyInfos.Add(Uml.EnumerationLiteral_Classifier, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.EnumerationLiteral_Classifier, __ImmutableArray.Create<__ModelProperty>(Uml.EnumerationLiteral_Classifier, Uml.InstanceSpecification_Classifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single | __ModelPropertyFlags.Collection | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.InstanceSpecification_Classifier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.InstanceSpecification_Classifier), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.EnumerationLiteral_Enumeration, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.EnumerationLiteral_Enumeration, __ImmutableArray.Create<__ModelProperty>(Uml.EnumerationLiteral_Enumeration), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Enumeration_OwnedLiteral), __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InstanceSpecification_Classifier, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.EnumerationLiteral_Classifier, __ImmutableArray.Create<__ModelProperty>(Uml.EnumerationLiteral_Classifier, Uml.InstanceSpecification_Classifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single | __ModelPropertyFlags.Collection | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.EnumerationLiteral_Classifier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.EnumerationLiteral_Classifier)));
                modelPropertyInfos.Add(Uml.InstanceSpecification_Slot, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InstanceSpecification_Slot, __ImmutableArray.Create<__ModelProperty>(Uml.InstanceSpecification_Slot), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Slot_OwningInstance), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InstanceSpecification_Specification, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InstanceSpecification_Specification, __ImmutableArray.Create<__ModelProperty>(Uml.InstanceSpecification_Specification), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.NamedElement_Namespace, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.NamedElement_Namespace, __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(Uml.EnumerationLiteral_Enumeration), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(EnumerationLiteral);
            ...
            {
                var result = new EnumerationLiteral_Impl(id);
            ...
            {
                return "Uml.EnumerationLiteralInfo";
            }
        }
    }
}
