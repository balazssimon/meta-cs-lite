...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class InformationFlow_Impl : __MetaModelObject, InformationFlow
    {
        private InformationFlow_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.InformationFlow(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<Classifier> Conveyed
        {
            get => MGetCollection<Classifier>(Uml.InformationFlow_Conveyed);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<NamedElement> InformationSource
        {
            get => MGetCollection<NamedElement>(Uml.InformationFlow_InformationSource);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<NamedElement> InformationTarget
        {
            get => MGetCollection<NamedElement>(Uml.InformationFlow_InformationTarget);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Relationship> Realization
        {
            get => MGetCollection<Relationship>(Uml.InformationFlow_Realization);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ActivityEdge> RealizingActivityEdge
        {
            get => MGetCollection<ActivityEdge>(Uml.InformationFlow_RealizingActivityEdge);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Connector> RealizingConnector
        {
            get => MGetCollection<Connector>(Uml.InformationFlow_RealizingConnector);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Message> RealizingMessage
        {
            get => MGetCollection<Message>(Uml.InformationFlow_RealizingMessage);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.DirectedRelationshipInfo, Uml.PackageableElementInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.DirectedRelationshipInfo, Uml.PackageableElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.RelationshipInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InformationFlow_Conveyed, Uml.InformationFlow_InformationSource, Uml.InformationFlow_InformationTarget, Uml.InformationFlow_Realization, Uml.InformationFlow_RealizingActivityEdge, Uml.InformationFlow_RealizingConnector, Uml.InformationFlow_RealizingMessage);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InformationFlow_Conveyed, Uml.InformationFlow_InformationSource, Uml.InformationFlow_InformationTarget, Uml.InformationFlow_Realization, Uml.InformationFlow_RealizingActivityEdge, Uml.InformationFlow_RealizingConnector, Uml.InformationFlow_RealizingMessage, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InformationFlow_Conveyed, Uml.InformationFlow_InformationSource, Uml.InformationFlow_InformationTarget, Uml.InformationFlow_Realization, Uml.InformationFlow_RealizingActivityEdge, Uml.InformationFlow_RealizingConnector, Uml.InformationFlow_RealizingMessage, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Conveyed", Uml.InformationFlow_Conveyed);
                publicPropertiesByName.Add("InformationSource", Uml.InformationFlow_InformationSource);
                publicPropertiesByName.Add("InformationTarget", Uml.InformationFlow_InformationTarget);
                publicPropertiesByName.Add("Realization", Uml.InformationFlow_Realization);
                publicPropertiesByName.Add("RealizingActivityEdge", Uml.InformationFlow_RealizingActivityEdge);
                publicPropertiesByName.Add("RealizingConnector", Uml.InformationFlow_RealizingConnector);
                publicPropertiesByName.Add("RealizingMessage", Uml.InformationFlow_RealizingMessage);
                ...
                modelPropertyInfos.Add(Uml.InformationFlow_Conveyed, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InformationFlow_Conveyed, __ImmutableArray.Create<__ModelProperty>(Uml.InformationFlow_Conveyed), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InformationFlow_InformationSource, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InformationFlow_InformationSource, __ImmutableArray.Create<__ModelProperty>(Uml.InformationFlow_InformationSource), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Source), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InformationFlow_InformationTarget, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InformationFlow_InformationTarget, __ImmutableArray.Create<__ModelProperty>(Uml.InformationFlow_InformationTarget), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Target), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InformationFlow_Realization, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InformationFlow_Realization, __ImmutableArray.Create<__ModelProperty>(Uml.InformationFlow_Realization), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InformationFlow_RealizingActivityEdge, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InformationFlow_RealizingActivityEdge, __ImmutableArray.Create<__ModelProperty>(Uml.InformationFlow_RealizingActivityEdge), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InformationFlow_RealizingConnector, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InformationFlow_RealizingConnector, __ImmutableArray.Create<__ModelProperty>(Uml.InformationFlow_RealizingConnector), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InformationFlow_RealizingMessage, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InformationFlow_RealizingMessage, __ImmutableArray.Create<__ModelProperty>(Uml.InformationFlow_RealizingMessage), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.DirectedRelationship_Source, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DirectedRelationship_Source, __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Source), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Relationship_RelatedElement), __ImmutableArray.Create<__ModelProperty>(Uml.InformationFlow_InformationSource), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.DirectedRelationship_Target, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DirectedRelationship_Target, __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Target), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Relationship_RelatedElement), __ImmutableArray.Create<__ModelProperty>(Uml.InformationFlow_InformationTarget), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(InformationFlow);
            ...
            {
                var result = new InformationFlow_Impl(id);
            ...
            {
                return "Uml.InformationFlowInfo";
            }
        }
    }
}
