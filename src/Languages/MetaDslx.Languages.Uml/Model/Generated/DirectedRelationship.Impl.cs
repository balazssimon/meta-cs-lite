...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class DirectedRelationship_Impl : __MetaModelObject, DirectedRelationship
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.RelationshipInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.RelationshipInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
            ...
            {
                return "Uml.DirectedRelationshipInfo";
            }
        }
    }
}
