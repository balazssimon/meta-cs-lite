...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class LiteralNull_Impl : __MetaModelObject, LiteralNull
    {
        private LiteralNull_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.LiteralNull(this);
        }
        ...
        bool LiteralNull.IsComputable(bool result) => Uml.__CustomImpl.LiteralNull_IsComputable(this, result);
        bool LiteralNull.IsNull(bool result) => Uml.__CustomImpl.LiteralNull_IsNull(this, result);
        ...
        bool ValueSpecification.IsComputable(bool result) => Uml.__CustomImpl.LiteralNull_IsComputable(this, result);
        bool ValueSpecification.IsNull(bool result) => Uml.__CustomImpl.LiteralNull_IsNull(this, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LiteralNull_IsComputable, Uml.LiteralNull_IsNull);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LiteralNull_IsComputable, Uml.LiteralNull_IsNull, Uml.ValueSpecification_BooleanValue, Uml.ValueSpecification_IntegerValue, Uml.ValueSpecification_IsCompatibleWith, Uml.ValueSpecification_IsComputable, Uml.ValueSpecification_IsNull, Uml.ValueSpecification_RealValue, Uml.ValueSpecification_StringValue, Uml.ValueSpecification_UnlimitedValue, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsCompatibleWith, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LiteralNull_IsComputable, Uml.LiteralNull_IsNull, Uml.ValueSpecification_BooleanValue, Uml.ValueSpecification_IntegerValue, Uml.ValueSpecification_IsCompatibleWith, Uml.ValueSpecification_RealValue, Uml.ValueSpecification_StringValue, Uml.ValueSpecification_UnlimitedValue, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.LiteralNull_IsComputable, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.ValueSpecification_IsComputable), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.LiteralNull_IsNull, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.ValueSpecification_IsNull), __ImmutableArray.Create<__ModelOperation>()));
                    ...
                    modelOperationInfos.Add(Uml.ValueSpecification_IsComputable, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.LiteralNull_IsComputable)));
                    modelOperationInfos.Add(Uml.ValueSpecification_IsNull, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.LiteralNull_IsNull)));
            ...
            public override __MetaType MetaType => typeof(LiteralNull);
            ...
            {
                var result = new LiteralNull_Impl(id);
