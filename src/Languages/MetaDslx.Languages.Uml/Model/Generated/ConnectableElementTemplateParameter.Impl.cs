...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ConnectableElementTemplateParameter_Impl : __MetaModelObject, ConnectableElementTemplateParameter
    {
        private ConnectableElementTemplateParameter_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.TemplateParameter(this);
            Uml.__CustomImpl.ConnectableElementTemplateParameter(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public ConnectableElement ParameteredElement
        {
            get => MGet<ConnectableElement>(Uml.ConnectableElementTemplateParameter_ParameteredElement);
            set => MSet<ConnectableElement>(Uml.ConnectableElementTemplateParameter_ParameteredElement, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ConnectableElementTemplateParameter_ParameteredElement);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ConnectableElementTemplateParameter_ParameteredElement, Uml.TemplateParameter_Default, Uml.TemplateParameter_OwnedDefault, Uml.TemplateParameter_OwnedParameteredElement, Uml.TemplateParameter_ParameteredElement, Uml.TemplateParameter_Signature, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ConnectableElementTemplateParameter_ParameteredElement, Uml.TemplateParameter_Default, Uml.TemplateParameter_OwnedDefault, Uml.TemplateParameter_OwnedParameteredElement, Uml.TemplateParameter_Signature, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("ParameteredElement", Uml.ConnectableElementTemplateParameter_ParameteredElement);
                ...
                modelPropertyInfos.Add(Uml.ConnectableElementTemplateParameter_ParameteredElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ConnectableElementTemplateParameter_ParameteredElement, __ImmutableArray.Create<__ModelProperty>(Uml.ConnectableElementTemplateParameter_ParameteredElement, Uml.TemplateParameter_ParameteredElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.ConnectableElement_TemplateParameter), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.TemplateParameter_ParameteredElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.TemplateParameter_ParameteredElement), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.TemplateParameter_ParameteredElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ConnectableElementTemplateParameter_ParameteredElement, __ImmutableArray.Create<__ModelProperty>(Uml.ConnectableElementTemplateParameter_ParameteredElement, Uml.TemplateParameter_ParameteredElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.ParameterableElement_TemplateParameter), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.TemplateParameter_OwnedParameteredElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.ConnectableElementTemplateParameter_ParameteredElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.ConnectableElementTemplateParameter_ParameteredElement)));
            ...
            public override __MetaType MetaType => typeof(ConnectableElementTemplateParameter);
            ...
            {
                var result = new ConnectableElementTemplateParameter_Impl(id);
            ...
            {
                return "Uml.ConnectableElementTemplateParameterInfo";
            }
        }
    }
}
