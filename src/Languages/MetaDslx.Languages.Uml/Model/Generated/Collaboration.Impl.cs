...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Collaboration_Impl : __MetaModelObject, Collaboration
    {
        private Collaboration_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.Collaboration(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<ConnectableElement> CollaborationRole
        {
            get => MGetCollection<ConnectableElement>(Uml.Collaboration_CollaborationRole);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                publicPropertiesByName.Add("OwnedAttribute", Uml.StructuredClassifier_OwnedAttribute);
                ...
                modelPropertyInfos.Add(Uml.Collaboration_CollaborationRole, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Collaboration_CollaborationRole, __ImmutableArray.Create<__ModelProperty>(Uml.Collaboration_CollaborationRole), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.StructuredClassifier_Role), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Classifier_Feature, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Classifier_Feature, __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_Feature), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(Uml.Feature_FeaturingClassifier), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_Member), __ImmutableArray.Create<__ModelProperty>(Uml.StructuredClassifier_OwnedConnector, Uml.Classifier_Attribute), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Collaboration);
            ...
            {
                var result = new Collaboration_Impl(id);
