...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Node_Impl : __MetaModelObject, Node
    {
        private Node_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ClassInfo, Uml.DeploymentTargetInfo);
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Node_NestedNode);
            ...
            public override __MetaType MetaType => typeof(Node);
