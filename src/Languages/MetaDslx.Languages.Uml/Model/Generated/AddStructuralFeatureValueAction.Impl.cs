...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class AddStructuralFeatureValueAction_Impl : __MetaModelObject, AddStructuralFeatureValueAction
    {
        private AddStructuralFeatureValueAction_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.AddStructuralFeatureValueAction_IsReplaceAll)?.Add((bool)false);
            ...
            Uml.__CustomImpl.AddStructuralFeatureValueAction(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public InputPin InsertAt
        {
            get => MGet<InputPin>(Uml.AddStructuralFeatureValueAction_InsertAt);
            set => MSet<InputPin>(Uml.AddStructuralFeatureValueAction_InsertAt, value);
        }
    
        public bool IsReplaceAll
        {
            get => MGet<bool>(Uml.AddStructuralFeatureValueAction_IsReplaceAll);
            set => MSet<bool>(Uml.AddStructuralFeatureValueAction_IsReplaceAll, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.AddStructuralFeatureValueAction_InsertAt, Uml.AddStructuralFeatureValueAction_IsReplaceAll);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.AddStructuralFeatureValueAction_InsertAt, Uml.AddStructuralFeatureValueAction_IsReplaceAll, Uml.WriteStructuralFeatureAction_Result, Uml.WriteStructuralFeatureAction_Value, Uml.StructuralFeatureAction_Object, Uml.StructuralFeatureAction_StructuralFeature, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.AddStructuralFeatureValueAction_InsertAt, Uml.AddStructuralFeatureValueAction_IsReplaceAll, Uml.WriteStructuralFeatureAction_Result, Uml.WriteStructuralFeatureAction_Value, Uml.StructuralFeatureAction_Object, Uml.StructuralFeatureAction_StructuralFeature, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("InsertAt", Uml.AddStructuralFeatureValueAction_InsertAt);
                publicPropertiesByName.Add("IsReplaceAll", Uml.AddStructuralFeatureValueAction_IsReplaceAll);
                ...
                modelPropertyInfos.Add(Uml.AddStructuralFeatureValueAction_InsertAt, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.AddStructuralFeatureValueAction_InsertAt, __ImmutableArray.Create<__ModelProperty>(Uml.AddStructuralFeatureValueAction_InsertAt), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.AddStructuralFeatureValueAction_IsReplaceAll, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.AddStructuralFeatureValueAction_IsReplaceAll, __ImmutableArray.Create<__ModelProperty>(Uml.AddStructuralFeatureValueAction_IsReplaceAll), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(AddStructuralFeatureValueAction);
            ...
            {
                var result = new AddStructuralFeatureValueAction_Impl(id);
            ...
            {
                return "Uml.AddStructuralFeatureValueActionInfo";
            }
        }
    }
}
