...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class TimeObservation_Impl : __MetaModelObject, TimeObservation
    {
        private TimeObservation_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.TimeObservation_FirstEvent)?.Add((bool)true);
            ...
            Uml.__CustomImpl.TimeObservation(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public NamedElement Event
        {
            get => MGet<NamedElement>(Uml.TimeObservation_Event);
            set => MSet<NamedElement>(Uml.TimeObservation_Event, value);
        }
    
        public bool FirstEvent
        {
            get => MGet<bool>(Uml.TimeObservation_FirstEvent);
            set => MSet<bool>(Uml.TimeObservation_FirstEvent, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TimeObservation_Event, Uml.TimeObservation_FirstEvent);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TimeObservation_Event, Uml.TimeObservation_FirstEvent, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TimeObservation_Event, Uml.TimeObservation_FirstEvent, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Event", Uml.TimeObservation_Event);
                publicPropertiesByName.Add("FirstEvent", Uml.TimeObservation_FirstEvent);
                ...
                modelPropertyInfos.Add(Uml.TimeObservation_Event, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TimeObservation_Event, __ImmutableArray.Create<__ModelProperty>(Uml.TimeObservation_Event), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.TimeObservation_FirstEvent, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TimeObservation_FirstEvent, __ImmutableArray.Create<__ModelProperty>(Uml.TimeObservation_FirstEvent), true, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(TimeObservation);
            ...
            {
                var result = new TimeObservation_Impl(id);
            ...
            {
                return "Uml.TimeObservationInfo";
            }
        }
    }
}
