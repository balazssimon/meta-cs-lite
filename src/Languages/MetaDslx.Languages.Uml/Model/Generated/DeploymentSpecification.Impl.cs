...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class DeploymentSpecification_Impl : __MetaModelObject, DeploymentSpecification
    {
        private DeploymentSpecification_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.DeployedArtifact(this);
            Uml.__CustomImpl.Classifier(this);
            Uml.__CustomImpl.Artifact(this);
            Uml.__CustomImpl.DeploymentSpecification(this);
        }
        ...
        {
            get => MGet<Deployment>(Uml.DeploymentSpecification_Deployment);
            set => MSet<Deployment>(Uml.DeploymentSpecification_Deployment, value);
        }
    
        public string DeploymentLocation
        {
            get => MGet<string>(Uml.DeploymentSpecification_DeploymentLocation);
            set => MSet<string>(Uml.DeploymentSpecification_DeploymentLocation, value);
        }
    
        public string ExecutionLocation
        {
            get => MGet<string>(Uml.DeploymentSpecification_ExecutionLocation);
            set => MSet<string>(Uml.DeploymentSpecification_ExecutionLocation, value);
        }
    
        public string FileName
        {
            get => MGet<string>(Uml.Artifact_FileName);
            set => MSet<string>(Uml.Artifact_FileName, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Manifestation> Manifestation
        {
            get => MGetCollection<Manifestation>(Uml.Artifact_Manifestation);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Artifact> NestedArtifact
        {
            get => MGetCollection<Artifact>(Uml.Artifact_NestedArtifact);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Property> OwnedAttribute
        {
            get => MGetCollection<Property>(Uml.Artifact_OwnedAttribute);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Operation> OwnedOperation
        {
            get => MGetCollection<Operation>(Uml.Artifact_OwnedOperation);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ArtifactInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ArtifactInfo, Uml.ClassifierInfo, Uml.DeployedArtifactInfo, Uml.NamespaceInfo, Uml.RedefinableElementInfo, Uml.TemplateableElementInfo, Uml.TypeInfo, Uml.PackageableElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DeploymentSpecification_Deployment, Uml.DeploymentSpecification_DeploymentLocation, Uml.DeploymentSpecification_ExecutionLocation);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DeploymentSpecification_Deployment, Uml.DeploymentSpecification_DeploymentLocation, Uml.DeploymentSpecification_ExecutionLocation, Uml.Artifact_FileName, Uml.Artifact_Manifestation, Uml.Artifact_NestedArtifact, Uml.Artifact_OwnedAttribute, Uml.Artifact_OwnedOperation, Uml.Classifier_Attribute, Uml.Classifier_CollaborationUse, Uml.Classifier_Feature, Uml.Classifier_General, Uml.Classifier_Generalization, Uml.Classifier_InheritedMember, Uml.Classifier_IsAbstract, Uml.Classifier_IsFinalSpecialization, Uml.Classifier_OwnedTemplateSignature, Uml.Classifier_OwnedUseCase, Uml.Classifier_PowertypeExtent, Uml.Classifier_RedefinedClassifier, Uml.Classifier_Representation, Uml.Classifier_Substitution, Uml.Classifier_TemplateParameter, Uml.Classifier_UseCase, Uml.Namespace_ElementImport, Uml.Namespace_ImportedMember, Uml.Namespace_Member, Uml.Namespace_OwnedMember, Uml.Namespace_OwnedRule, Uml.Namespace_PackageImport, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.TemplateableElement_OwnedTemplateSignature, Uml.TemplateableElement_TemplateBinding, Uml.Type_Package, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DeploymentSpecification_Deployment, Uml.DeploymentSpecification_DeploymentLocation, Uml.DeploymentSpecification_ExecutionLocation, Uml.Artifact_FileName, Uml.Artifact_Manifestation, Uml.Artifact_NestedArtifact, Uml.Artifact_OwnedAttribute, Uml.Artifact_OwnedOperation, Uml.Classifier_Attribute, Uml.Classifier_CollaborationUse, Uml.Classifier_Feature, Uml.Classifier_General, Uml.Classifier_Generalization, Uml.Classifier_InheritedMember, Uml.Classifier_IsAbstract, Uml.Classifier_IsFinalSpecialization, Uml.Classifier_OwnedTemplateSignature, Uml.Classifier_OwnedUseCase, Uml.Classifier_PowertypeExtent, Uml.Classifier_RedefinedClassifier, Uml.Classifier_Representation, Uml.Classifier_Substitution, Uml.Classifier_TemplateParameter, Uml.Classifier_UseCase, Uml.Namespace_ElementImport, Uml.Namespace_ImportedMember, Uml.Namespace_Member, Uml.Namespace_OwnedMember, Uml.Namespace_OwnedRule, Uml.Namespace_PackageImport, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.TemplateableElement_TemplateBinding, Uml.Type_Package, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Deployment", Uml.DeploymentSpecification_Deployment);
                publicPropertiesByName.Add("DeploymentLocation", Uml.DeploymentSpecification_DeploymentLocation);
                publicPropertiesByName.Add("ExecutionLocation", Uml.DeploymentSpecification_ExecutionLocation);
                publicPropertiesByName.Add("FileName", Uml.Artifact_FileName);
                publicPropertiesByName.Add("Manifestation", Uml.Artifact_Manifestation);
                publicPropertiesByName.Add("NestedArtifact", Uml.Artifact_NestedArtifact);
                publicPropertiesByName.Add("OwnedAttribute", Uml.Artifact_OwnedAttribute);
                publicPropertiesByName.Add("OwnedOperation", Uml.Artifact_OwnedOperation);
                ...
                modelPropertyInfos.Add(Uml.DeploymentSpecification_Deployment, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DeploymentSpecification_Deployment, __ImmutableArray.Create<__ModelProperty>(Uml.DeploymentSpecification_Deployment), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Deployment_Configuration), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.DeploymentSpecification_DeploymentLocation, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DeploymentSpecification_DeploymentLocation, __ImmutableArray.Create<__ModelProperty>(Uml.DeploymentSpecification_DeploymentLocation), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.DeploymentSpecification_ExecutionLocation, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DeploymentSpecification_ExecutionLocation, __ImmutableArray.Create<__ModelProperty>(Uml.DeploymentSpecification_ExecutionLocation), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Artifact_FileName, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Artifact_FileName, __ImmutableArray.Create<__ModelProperty>(Uml.Artifact_FileName), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Artifact_Manifestation, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Artifact_Manifestation, __ImmutableArray.Create<__ModelProperty>(Uml.Artifact_Manifestation), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement, Uml.NamedElement_ClientDependency), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Artifact_NestedArtifact, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Artifact_NestedArtifact, __ImmutableArray.Create<__ModelProperty>(Uml.Artifact_NestedArtifact), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Artifact_OwnedAttribute, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Artifact_OwnedAttribute, __ImmutableArray.Create<__ModelProperty>(Uml.Artifact_OwnedAttribute), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_Attribute, Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Artifact_OwnedOperation, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Artifact_OwnedOperation, __ImmutableArray.Create<__ModelProperty>(Uml.Artifact_OwnedOperation), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_Feature, Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Classifier_Attribute, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Classifier_Attribute, __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_Attribute), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_Feature), __ImmutableArray.Create<__ModelProperty>(Uml.Artifact_OwnedAttribute), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Classifier_Feature, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Classifier_Feature, __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_Feature), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(Uml.Feature_FeaturingClassifier), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_Member), __ImmutableArray.Create<__ModelProperty>(Uml.Artifact_OwnedOperation, Uml.Classifier_Attribute), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(DeploymentSpecification);
            ...
            {
                var result = new DeploymentSpecification_Impl(id);
            ...
            {
                return "Uml.DeploymentSpecificationInfo";
            }
        }
    }
}
