...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Class_Impl : __MetaModelObject, Class
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.BehavioredClassifierInfo, Uml.EncapsulatedClassifierInfo);
