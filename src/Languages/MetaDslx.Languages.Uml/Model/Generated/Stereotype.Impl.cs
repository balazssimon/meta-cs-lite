...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Stereotype_Impl : __MetaModelObject, Stereotype
    {
        private Stereotype_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.Stereotype(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<Image> Icon
        {
            get => MGetCollection<Image>(Uml.Stereotype_Icon);
        }
    
        public Profile Profile
        {
            get => Uml.__CustomImpl.Stereotype_Profile(this);
        }
        ...
        Profile Stereotype.ContainingProfile(Profile result) => Uml.__CustomImpl.Stereotype_ContainingProfile(this, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.Stereotype_Icon, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Stereotype_Icon, __ImmutableArray.Create<__ModelProperty>(Uml.Stereotype_Icon), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Stereotype_Profile, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Stereotype_Profile, __ImmutableArray.Create<__ModelProperty>(Uml.Stereotype_Profile), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Stereotype);
            ...
            {
                var result = new Stereotype_Impl(id);
