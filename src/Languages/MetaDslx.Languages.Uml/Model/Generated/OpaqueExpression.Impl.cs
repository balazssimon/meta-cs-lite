...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class OpaqueExpression_Impl : __MetaModelObject, OpaqueExpression
    {
        ...
        bool OpaqueExpression.IsIntegral() => Uml.__CustomImpl.OpaqueExpression_IsIntegral(this);
        bool OpaqueExpression.IsNonNegative() => Uml.__CustomImpl.OpaqueExpression_IsNonNegative(this);
        bool OpaqueExpression.IsPositive() => Uml.__CustomImpl.OpaqueExpression_IsPositive(this);
        int OpaqueExpression.Value() => Uml.__CustomImpl.OpaqueExpression_Value(this);
