...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class OpaqueExpression_Impl : __MetaModelObject, OpaqueExpression
    {
        private OpaqueExpression_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.OpaqueExpression(this);
        }
        ...
        {
            get => MGet<Behavior>(Uml.OpaqueExpression_Behavior);
            set => MSet<Behavior>(Uml.OpaqueExpression_Behavior, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<string> Body
        {
            get => MGetCollection<string>(Uml.OpaqueExpression_Body);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<string> Language
        {
            get => MGetCollection<string>(Uml.OpaqueExpression_Language);
        }
    
        public Parameter Result
        {
            get => Uml.__CustomImpl.OpaqueExpression_Result(this);
        }
        ...
        bool OpaqueExpression.IsIntegral(bool result) => Uml.__CustomImpl.OpaqueExpression_IsIntegral(this, result);
        bool OpaqueExpression.IsNonNegative(bool result) => Uml.__CustomImpl.OpaqueExpression_IsNonNegative(this, result);
        bool OpaqueExpression.IsPositive(bool result) => Uml.__CustomImpl.OpaqueExpression_IsPositive(this, result);
        int OpaqueExpression.Value(int result) => Uml.__CustomImpl.OpaqueExpression_Value(this, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.OpaqueExpression_Behavior, Uml.OpaqueExpression_Body, Uml.OpaqueExpression_Language, Uml.OpaqueExpression_Result);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.OpaqueExpression_Behavior, Uml.OpaqueExpression_Body, Uml.OpaqueExpression_Language, Uml.OpaqueExpression_Result, Uml.PackageableElement_Visibility, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.OpaqueExpression_Behavior, Uml.OpaqueExpression_Body, Uml.OpaqueExpression_Language, Uml.OpaqueExpression_Result, Uml.PackageableElement_Visibility, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Behavior", Uml.OpaqueExpression_Behavior);
                publicPropertiesByName.Add("Body", Uml.OpaqueExpression_Body);
                publicPropertiesByName.Add("Language", Uml.OpaqueExpression_Language);
                publicPropertiesByName.Add("Result", Uml.OpaqueExpression_Result);
                ...
                modelPropertyInfos.Add(Uml.OpaqueExpression_Behavior, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.OpaqueExpression_Behavior, __ImmutableArray.Create<__ModelProperty>(Uml.OpaqueExpression_Behavior), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.OpaqueExpression_Body, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.OpaqueExpression_Body, __ImmutableArray.Create<__ModelProperty>(Uml.OpaqueExpression_Body), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.OpaqueExpression_Language, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.OpaqueExpression_Language, __ImmutableArray.Create<__ModelProperty>(Uml.OpaqueExpression_Language), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.OpaqueExpression_Result, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.OpaqueExpression_Result, __ImmutableArray.Create<__ModelProperty>(Uml.OpaqueExpression_Result), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.OpaqueExpression_IsIntegral, Uml.OpaqueExpression_IsNonNegative, Uml.OpaqueExpression_IsPositive, Uml.OpaqueExpression_Value);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.OpaqueExpression_IsIntegral, Uml.OpaqueExpression_IsNonNegative, Uml.OpaqueExpression_IsPositive, Uml.OpaqueExpression_Value, Uml.ValueSpecification_BooleanValue, Uml.ValueSpecification_IntegerValue, Uml.ValueSpecification_IsCompatibleWith, Uml.ValueSpecification_IsComputable, Uml.ValueSpecification_IsNull, Uml.ValueSpecification_RealValue, Uml.ValueSpecification_StringValue, Uml.ValueSpecification_UnlimitedValue, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsCompatibleWith, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.OpaqueExpression_IsIntegral, Uml.OpaqueExpression_IsNonNegative, Uml.OpaqueExpression_IsPositive, Uml.OpaqueExpression_Value, Uml.ValueSpecification_BooleanValue, Uml.ValueSpecification_IntegerValue, Uml.ValueSpecification_IsCompatibleWith, Uml.ValueSpecification_IsComputable, Uml.ValueSpecification_IsNull, Uml.ValueSpecification_RealValue, Uml.ValueSpecification_StringValue, Uml.ValueSpecification_UnlimitedValue, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.OpaqueExpression_IsIntegral, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.OpaqueExpression_IsNonNegative, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.OpaqueExpression_IsPositive, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.OpaqueExpression_Value, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
            ...
            public override __MetaType MetaType => typeof(OpaqueExpression);
            ...
            {
                var result = new OpaqueExpression_Impl(id);
            ...
            {
                return "Uml.OpaqueExpressionInfo";
            }
        }
    }
}
