...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class SendObjectAction_Impl : __MetaModelObject, SendObjectAction
    {
        private SendObjectAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.SendObjectAction(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public InputPin Request
        {
            get => MGet<InputPin>(Uml.SendObjectAction_Request);
            set => MSet<InputPin>(Uml.SendObjectAction_Request, value);
        }
    
        public InputPin Target
        {
            get => MGet<InputPin>(Uml.SendObjectAction_Target);
            set => MSet<InputPin>(Uml.SendObjectAction_Target, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.SendObjectAction_Request, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.SendObjectAction_Request, __ImmutableArray.Create<__ModelProperty>(Uml.SendObjectAction_Request, Uml.InvocationAction_Argument), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.InvocationAction_Argument), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.SendObjectAction_Target, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.SendObjectAction_Target, __ImmutableArray.Create<__ModelProperty>(Uml.SendObjectAction_Target), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InvocationAction_Argument, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.SendObjectAction_Request, __ImmutableArray.Create<__ModelProperty>(Uml.SendObjectAction_Request, Uml.InvocationAction_Argument), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.SendObjectAction_Request), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(SendObjectAction);
            ...
            {
                var result = new SendObjectAction_Impl(id);
            ...
            {
                return "Uml.SendObjectActionInfo";
            }
        }
    }
}
