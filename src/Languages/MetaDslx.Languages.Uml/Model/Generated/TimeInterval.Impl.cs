...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class TimeInterval_Impl : __MetaModelObject, TimeInterval
    {
        private TimeInterval_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.TimeInterval(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public TimeExpression Max
        {
            get => MGet<TimeExpression>(Uml.TimeInterval_Max);
            set => MSet<TimeExpression>(Uml.TimeInterval_Max, value);
        }
    
        public TimeExpression Min
        {
            get => MGet<TimeExpression>(Uml.TimeInterval_Min);
            set => MSet<TimeExpression>(Uml.TimeInterval_Min, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TimeInterval_Max, Uml.TimeInterval_Min);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TimeInterval_Max, Uml.TimeInterval_Min, Uml.Interval_Max, Uml.Interval_Min, Uml.PackageableElement_Visibility, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TimeInterval_Max, Uml.TimeInterval_Min, Uml.PackageableElement_Visibility, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Max", Uml.TimeInterval_Max);
                publicPropertiesByName.Add("Min", Uml.TimeInterval_Min);
                ...
                modelPropertyInfos.Add(Uml.TimeInterval_Max, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TimeInterval_Max, __ImmutableArray.Create<__ModelProperty>(Uml.TimeInterval_Max, Uml.Interval_Max), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Interval_Max), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Interval_Max), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.TimeInterval_Min, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TimeInterval_Min, __ImmutableArray.Create<__ModelProperty>(Uml.TimeInterval_Min, Uml.Interval_Min), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Interval_Min), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Interval_Min), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Interval_Max, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TimeInterval_Max, __ImmutableArray.Create<__ModelProperty>(Uml.TimeInterval_Max, Uml.Interval_Max), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.TimeInterval_Max), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.TimeInterval_Max)));
                modelPropertyInfos.Add(Uml.Interval_Min, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TimeInterval_Min, __ImmutableArray.Create<__ModelProperty>(Uml.TimeInterval_Min, Uml.Interval_Min), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.TimeInterval_Min), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.TimeInterval_Min)));
            ...
            public override __MetaType MetaType => typeof(TimeInterval);
            ...
            {
                var result = new TimeInterval_Impl(id);
