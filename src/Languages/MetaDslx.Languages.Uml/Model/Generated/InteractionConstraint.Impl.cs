...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class InteractionConstraint_Impl : __MetaModelObject, InteractionConstraint
    {
        private InteractionConstraint_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.InteractionConstraint(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public ValueSpecification Maxint
        {
            get => MGet<ValueSpecification>(Uml.InteractionConstraint_Maxint);
            set => MSet<ValueSpecification>(Uml.InteractionConstraint_Maxint, value);
        }
    
        public ValueSpecification Minint
        {
            get => MGet<ValueSpecification>(Uml.InteractionConstraint_Minint);
            set => MSet<ValueSpecification>(Uml.InteractionConstraint_Minint, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ConstraintInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ConstraintInfo, Uml.PackageableElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InteractionConstraint_Maxint, Uml.InteractionConstraint_Minint);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InteractionConstraint_Maxint, Uml.InteractionConstraint_Minint, Uml.Constraint_ConstrainedElement, Uml.Constraint_Context, Uml.Constraint_Specification, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InteractionConstraint_Maxint, Uml.InteractionConstraint_Minint, Uml.Constraint_ConstrainedElement, Uml.Constraint_Context, Uml.Constraint_Specification, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Maxint", Uml.InteractionConstraint_Maxint);
                publicPropertiesByName.Add("Minint", Uml.InteractionConstraint_Minint);
                ...
                publicPropertiesByName.Add("Specification", Uml.Constraint_Specification);
                ...
                modelPropertyInfos.Add(Uml.InteractionConstraint_Maxint, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InteractionConstraint_Maxint, __ImmutableArray.Create<__ModelProperty>(Uml.InteractionConstraint_Maxint), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InteractionConstraint_Minint, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InteractionConstraint_Minint, __ImmutableArray.Create<__ModelProperty>(Uml.InteractionConstraint_Minint), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Constraint_Specification, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Constraint_Specification, __ImmutableArray.Create<__ModelProperty>(Uml.Constraint_Specification), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(InteractionConstraint);
            ...
            {
                var result = new InteractionConstraint_Impl(id);
            ...
            {
                return "Uml.InteractionConstraintInfo";
            }
        }
    }
}
