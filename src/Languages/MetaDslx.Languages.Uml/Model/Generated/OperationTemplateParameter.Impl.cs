...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class OperationTemplateParameter_Impl : __MetaModelObject, OperationTemplateParameter
    {
        private OperationTemplateParameter_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.TemplateParameter(this);
            Uml.__CustomImpl.OperationTemplateParameter(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public Operation ParameteredElement
        {
            get => MGet<Operation>(Uml.OperationTemplateParameter_ParameteredElement);
            set => MSet<Operation>(Uml.OperationTemplateParameter_ParameteredElement, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                publicPropertiesByName.Add("ParameteredElement", Uml.OperationTemplateParameter_ParameteredElement);
                ...
                modelPropertyInfos.Add(Uml.OperationTemplateParameter_ParameteredElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.OperationTemplateParameter_ParameteredElement, __ImmutableArray.Create<__ModelProperty>(Uml.OperationTemplateParameter_ParameteredElement, Uml.TemplateParameter_ParameteredElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Operation_TemplateParameter), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.TemplateParameter_ParameteredElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.TemplateParameter_ParameteredElement), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.TemplateParameter_ParameteredElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.OperationTemplateParameter_ParameteredElement, __ImmutableArray.Create<__ModelProperty>(Uml.OperationTemplateParameter_ParameteredElement, Uml.TemplateParameter_ParameteredElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.ParameterableElement_TemplateParameter), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.TemplateParameter_OwnedParameteredElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.OperationTemplateParameter_ParameteredElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.OperationTemplateParameter_ParameteredElement)));
            ...
            public override __MetaType MetaType => typeof(OperationTemplateParameter);
            ...
            {
                var result = new OperationTemplateParameter_Impl(id);
            ...
            {
                return "Uml.OperationTemplateParameterInfo";
            }
        }
    }
}
