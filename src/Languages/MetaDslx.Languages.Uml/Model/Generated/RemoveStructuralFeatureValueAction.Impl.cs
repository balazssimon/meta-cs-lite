...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class RemoveStructuralFeatureValueAction_Impl : __MetaModelObject, RemoveStructuralFeatureValueAction
    {
        private RemoveStructuralFeatureValueAction_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.RemoveStructuralFeatureValueAction_IsRemoveDuplicates)?.Add((bool)false);
            ...
            Uml.__CustomImpl.StructuralFeatureAction(this);
            Uml.__CustomImpl.WriteStructuralFeatureAction(this);
            Uml.__CustomImpl.RemoveStructuralFeatureValueAction(this);
        }
        ...
        {
            get => MGet<bool>(Uml.RemoveStructuralFeatureValueAction_IsRemoveDuplicates);
            set => MSet<bool>(Uml.RemoveStructuralFeatureValueAction_IsRemoveDuplicates, value);
        }
    
        public InputPin RemoveAt
        {
            get => MGet<InputPin>(Uml.RemoveStructuralFeatureValueAction_RemoveAt);
            set => MSet<InputPin>(Uml.RemoveStructuralFeatureValueAction_RemoveAt, value);
        }
    
        public OutputPin Result
        {
            get => MGet<OutputPin>(Uml.WriteStructuralFeatureAction_Result);
            set => MSet<OutputPin>(Uml.WriteStructuralFeatureAction_Result, value);
        }
    
        public InputPin Value
        {
            get => MGet<InputPin>(Uml.WriteStructuralFeatureAction_Value);
            set => MSet<InputPin>(Uml.WriteStructuralFeatureAction_Value, value);
        }
    
        public InputPin Object
        {
            get => MGet<InputPin>(Uml.StructuralFeatureAction_Object);
            set => MSet<InputPin>(Uml.StructuralFeatureAction_Object, value);
        }
    
        public StructuralFeature StructuralFeature
        {
            get => MGet<StructuralFeature>(Uml.StructuralFeatureAction_StructuralFeature);
            set => MSet<StructuralFeature>(Uml.StructuralFeatureAction_StructuralFeature, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.WriteStructuralFeatureActionInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.WriteStructuralFeatureActionInfo, Uml.StructuralFeatureActionInfo, Uml.ActionInfo, Uml.ExecutableNodeInfo, Uml.ActivityNodeInfo, Uml.RedefinableElementInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.RemoveStructuralFeatureValueAction_IsRemoveDuplicates, Uml.RemoveStructuralFeatureValueAction_RemoveAt);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.RemoveStructuralFeatureValueAction_IsRemoveDuplicates, Uml.RemoveStructuralFeatureValueAction_RemoveAt, Uml.WriteStructuralFeatureAction_Result, Uml.WriteStructuralFeatureAction_Value, Uml.StructuralFeatureAction_Object, Uml.StructuralFeatureAction_StructuralFeature, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.RemoveStructuralFeatureValueAction_IsRemoveDuplicates, Uml.RemoveStructuralFeatureValueAction_RemoveAt, Uml.WriteStructuralFeatureAction_Result, Uml.WriteStructuralFeatureAction_Value, Uml.StructuralFeatureAction_Object, Uml.StructuralFeatureAction_StructuralFeature, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("IsRemoveDuplicates", Uml.RemoveStructuralFeatureValueAction_IsRemoveDuplicates);
                publicPropertiesByName.Add("RemoveAt", Uml.RemoveStructuralFeatureValueAction_RemoveAt);
                publicPropertiesByName.Add("Result", Uml.WriteStructuralFeatureAction_Result);
                publicPropertiesByName.Add("Value", Uml.WriteStructuralFeatureAction_Value);
                publicPropertiesByName.Add("Object", Uml.StructuralFeatureAction_Object);
                publicPropertiesByName.Add("StructuralFeature", Uml.StructuralFeatureAction_StructuralFeature);
                ...
                modelPropertyInfos.Add(Uml.RemoveStructuralFeatureValueAction_IsRemoveDuplicates, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.RemoveStructuralFeatureValueAction_IsRemoveDuplicates, __ImmutableArray.Create<__ModelProperty>(Uml.RemoveStructuralFeatureValueAction_IsRemoveDuplicates), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.RemoveStructuralFeatureValueAction_RemoveAt, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.RemoveStructuralFeatureValueAction_RemoveAt, __ImmutableArray.Create<__ModelProperty>(Uml.RemoveStructuralFeatureValueAction_RemoveAt), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.WriteStructuralFeatureAction_Result, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.WriteStructuralFeatureAction_Result, __ImmutableArray.Create<__ModelProperty>(Uml.WriteStructuralFeatureAction_Result), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Output), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.WriteStructuralFeatureAction_Value, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.WriteStructuralFeatureAction_Value, __ImmutableArray.Create<__ModelProperty>(Uml.WriteStructuralFeatureAction_Value), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.StructuralFeatureAction_Object, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.StructuralFeatureAction_Object, __ImmutableArray.Create<__ModelProperty>(Uml.StructuralFeatureAction_Object), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.StructuralFeatureAction_StructuralFeature, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.StructuralFeatureAction_StructuralFeature, __ImmutableArray.Create<__ModelProperty>(Uml.StructuralFeatureAction_StructuralFeature), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(RemoveStructuralFeatureValueAction);
            ...
            {
                var result = new RemoveStructuralFeatureValueAction_Impl(id);
            ...
            {
                return "Uml.RemoveStructuralFeatureValueActionInfo";
            }
        }
    }
}
