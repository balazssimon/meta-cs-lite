...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class TemplateParameter_Impl : __MetaModelObject, TemplateParameter
    {
        private TemplateParameter_Impl(string? id)
            : base(id)
        {
        ...
        public ParameterableElement ParameteredElement
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TemplateParameter_Default, Uml.TemplateParameter_OwnedDefault, Uml.TemplateParameter_OwnedParameteredElement, Uml.TemplateParameter_ParameteredElement, Uml.TemplateParameter_Signature);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TemplateParameter_Default, Uml.TemplateParameter_OwnedDefault, Uml.TemplateParameter_OwnedParameteredElement, Uml.TemplateParameter_ParameteredElement, Uml.TemplateParameter_Signature, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TemplateParameter_Default, Uml.TemplateParameter_OwnedDefault, Uml.TemplateParameter_OwnedParameteredElement, Uml.TemplateParameter_ParameteredElement, Uml.TemplateParameter_Signature, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                ...
                publicPropertiesByName.Add("ParameteredElement", Uml.TemplateParameter_ParameteredElement);
                ...
                modelPropertyInfos.Add(Uml.TemplateParameter_ParameteredElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TemplateParameter_ParameteredElement, __ImmutableArray.Create<__ModelProperty>(Uml.TemplateParameter_ParameteredElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.ParameterableElement_TemplateParameter), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.TemplateParameter_OwnedParameteredElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(TemplateParameter);
            ...
            {
                var result = new TemplateParameter_Impl(id);
            ...
            {
                return "Uml.TemplateParameterInfo";
            }
        }
    }
}
