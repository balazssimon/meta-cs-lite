...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ReadExtentAction_Impl : __MetaModelObject, ReadExtentAction
    {
        private ReadExtentAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ReadExtentAction(this);
        }
        ...
        {
            get => MGet<Classifier>(Uml.ReadExtentAction_Classifier);
            set => MSet<Classifier>(Uml.ReadExtentAction_Classifier, value);
        }
    
        public OutputPin Result
        {
            get => MGet<OutputPin>(Uml.ReadExtentAction_Result);
            set => MSet<OutputPin>(Uml.ReadExtentAction_Result, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(ReadExtentAction);
            ...
            {
                var result = new ReadExtentAction_Impl(id);
            ...
            {
                return "Uml.ReadExtentActionInfo";
            }
        }
    }
}
