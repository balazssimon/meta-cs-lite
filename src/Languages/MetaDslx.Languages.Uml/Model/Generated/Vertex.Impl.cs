...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Vertex_Impl : __MetaModelObject, Vertex
    {
        private Vertex_Impl(string? id)
            : base(id)
        {
        ...
        bool Vertex.IsConsistentWith(bool result, RedefinableElement redefiningElement) => Uml.__CustomImpl.Vertex_IsConsistentWith(this, result, redefiningElement);
        ...
        bool RedefinableElement.IsConsistentWith(bool result, RedefinableElement redefiningElement) => Uml.__CustomImpl.Vertex_IsConsistentWith(this, result, redefiningElement);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    ...
                    modelOperationInfos.Add(Uml.Vertex_IsConsistentWith, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.RedefinableElement_IsConsistentWith), __ImmutableArray.Create<__ModelOperation>()));
                    ...
                    modelOperationInfos.Add(Uml.RedefinableElement_IsConsistentWith, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.Vertex_IsConsistentWith)));
            ...
            public override __MetaType MetaType => typeof(Vertex);
