...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Vertex_Impl : __MetaModelObject, Vertex
    {
        ...
        bool Vertex.IsConsistentWith(RedefinableElement redefiningElement) => Uml.__CustomImpl.Vertex_IsConsistentWith(this, redefiningElement);
        ...
        bool RedefinableElement.IsConsistentWith(RedefinableElement redefiningElement) => Uml.__CustomImpl.Vertex_IsConsistentWith(this, redefiningElement);
