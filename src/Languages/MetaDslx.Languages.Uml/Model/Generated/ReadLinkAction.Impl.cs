...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ReadLinkAction_Impl : __MetaModelObject, ReadLinkAction
    {
        private ReadLinkAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ReadLinkAction(this);
        }
        ...
        {
            get => MGet<OutputPin>(Uml.ReadLinkAction_Result);
            set => MSet<OutputPin>(Uml.ReadLinkAction_Result, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<LinkEndData> EndData
        {
        ...
        global::System.Collections.Generic.IList<Property> ReadLinkAction.OpenEnd(global::System.Collections.Generic.IList<Property> result) => Uml.__CustomImpl.ReadLinkAction_OpenEnd(this, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(ReadLinkAction);
            ...
            {
                var result = new ReadLinkAction_Impl(id);
