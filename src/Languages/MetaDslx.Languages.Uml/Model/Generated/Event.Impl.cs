...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Event_Impl : __MetaModelObject, Event
    {
        private Event_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(Event);
