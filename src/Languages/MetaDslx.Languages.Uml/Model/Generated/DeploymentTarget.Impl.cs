...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class DeploymentTarget_Impl : __MetaModelObject, DeploymentTarget
    {
        private DeploymentTarget_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DeploymentTarget_DeployedElement, Uml.DeploymentTarget_Deployment);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DeploymentTarget_DeployedElement, Uml.DeploymentTarget_Deployment, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DeploymentTarget_DeployedElement, Uml.DeploymentTarget_Deployment, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
            ...
            public override __MetaType MetaType => typeof(DeploymentTarget);
            ...
            {
                var result = new DeploymentTarget_Impl(id);
            ...
            {
                return "Uml.DeploymentTargetInfo";
            }
        }
    }
}
