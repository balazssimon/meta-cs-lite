...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Signal_Impl : __MetaModelObject, Signal
    {
        private Signal_Impl(string? id)
            : base(id)
        {
        ...
        {
            get => MGetCollection<Property>(Uml.Signal_OwnedAttribute);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(Signal);
