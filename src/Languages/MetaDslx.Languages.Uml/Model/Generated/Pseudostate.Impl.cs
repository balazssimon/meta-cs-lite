    ...
    internal class Pseudostate_Impl : __MetaModelObject, Pseudostate
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.Pseudostate_Kind, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Pseudostate_Kind, __ImmutableArray.Create<__ModelProperty>(Uml.Pseudostate_Kind), , __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
