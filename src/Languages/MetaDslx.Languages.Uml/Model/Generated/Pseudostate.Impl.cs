...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Pseudostate_Impl : __MetaModelObject, Pseudostate
    {
        private Pseudostate_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.Pseudostate_Kind)?.Add((global::MetaDslx.Languages.Uml.Model.PseudostateKind)MetaDslx.Languages.Uml.Model.PseudostateKind.Initial);
            ...
            Uml.__CustomImpl.Pseudostate(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Languages.Uml.Model.PseudostateKind Kind
        {
            get => MGet<global::MetaDslx.Languages.Uml.Model.PseudostateKind>(Uml.Pseudostate_Kind);
            set => MSet<global::MetaDslx.Languages.Uml.Model.PseudostateKind>(Uml.Pseudostate_Kind, value);
        }
    
        public State State
        {
            get => MGet<State>(Uml.Pseudostate_State);
            set => MSet<State>(Uml.Pseudostate_State, value);
        }
    
        public StateMachine StateMachine
        {
            get => MGet<StateMachine>(Uml.Pseudostate_StateMachine);
            set => MSet<StateMachine>(Uml.Pseudostate_StateMachine, value);
        }
        ...
        bool Pseudostate.IsConsistentWith(RedefinableElement redefiningElement, bool result) => Uml.__CustomImpl.Pseudostate_IsConsistentWith(this, redefiningElement, result);
        StateMachine Vertex.ContainingStateMachine(StateMachine result) => Uml.__CustomImpl.Vertex_ContainingStateMachine(this, result);
        bool Vertex.IsConsistentWith(bool result, RedefinableElement redefiningElement) => Uml.__CustomImpl.Pseudostate_IsConsistentWith(this, redefiningElement, result);
        ...
        bool RedefinableElement.IsConsistentWith(bool result, RedefinableElement redefiningElement) => Uml.__CustomImpl.Pseudostate_IsConsistentWith(this, redefiningElement, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Pseudostate_Kind, Uml.Pseudostate_State, Uml.Pseudostate_StateMachine);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Pseudostate_Kind, Uml.Pseudostate_State, Uml.Pseudostate_StateMachine, Uml.Vertex_Container, Uml.Vertex_Incoming, Uml.Vertex_Outgoing, Uml.Vertex_RedefinedVertex, Uml.Vertex_RedefinitionContext, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Pseudostate_Kind, Uml.Pseudostate_State, Uml.Pseudostate_StateMachine, Uml.Vertex_Container, Uml.Vertex_Incoming, Uml.Vertex_Outgoing, Uml.Vertex_RedefinedVertex, Uml.Vertex_RedefinitionContext, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Kind", Uml.Pseudostate_Kind);
                publicPropertiesByName.Add("State", Uml.Pseudostate_State);
                publicPropertiesByName.Add("StateMachine", Uml.Pseudostate_StateMachine);
                ...
                modelPropertyInfos.Add(Uml.Pseudostate_Kind, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Pseudostate_Kind, __ImmutableArray.Create<__ModelProperty>(Uml.Pseudostate_Kind), MetaDslx.Languages.Uml.Model.PseudostateKind.Initial, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Pseudostate_State, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Pseudostate_State, __ImmutableArray.Create<__ModelProperty>(Uml.Pseudostate_State), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.State_ConnectionPoint), __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Pseudostate_StateMachine, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Pseudostate_StateMachine, __ImmutableArray.Create<__ModelProperty>(Uml.Pseudostate_StateMachine), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.StateMachine_ConnectionPoint), __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Pseudostate_IsConsistentWith);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Pseudostate_IsConsistentWith, Uml.Vertex_ContainingStateMachine, Uml.Vertex_IsConsistentWith, Uml.Vertex_IsContainedInRegion, Uml.Vertex_IsContainedInState, Uml.RedefinableElement_IsConsistentWith, Uml.RedefinableElement_IsRedefinitionContextValid, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Pseudostate_IsConsistentWith, Uml.Vertex_ContainingStateMachine, Uml.Vertex_IsContainedInRegion, Uml.Vertex_IsContainedInState, Uml.RedefinableElement_IsRedefinitionContextValid, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.Pseudostate_IsConsistentWith, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.Vertex_IsConsistentWith, Uml.RedefinableElement_IsConsistentWith), __ImmutableArray.Create<__ModelOperation>()));
                    ...
                    modelOperationInfos.Add(Uml.Vertex_IsConsistentWith, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.RedefinableElement_IsConsistentWith), __ImmutableArray.Create<__ModelOperation>(Uml.Pseudostate_IsConsistentWith)));
                    ...
                    modelOperationInfos.Add(Uml.RedefinableElement_IsConsistentWith, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.Pseudostate_IsConsistentWith, Uml.Vertex_IsConsistentWith)));
            ...
            public override __MetaType MetaType => typeof(Pseudostate);
            ...
            {
                var result = new Pseudostate_Impl(id);
