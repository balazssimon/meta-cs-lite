...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Pseudostate_Impl : __MetaModelObject, Pseudostate
    {
        ...
        bool Pseudostate.IsConsistentWith(RedefinableElement redefiningElement) => Uml.__CustomImpl.Pseudostate_IsConsistentWith(this, redefiningElement);
        StateMachine Vertex.ContainingStateMachine() => Uml.__CustomImpl.Vertex_ContainingStateMachine(this);
        bool Vertex.IsConsistentWith(RedefinableElement redefiningElement) => Uml.__CustomImpl.Pseudostate_IsConsistentWith(this, redefiningElement);
        ...
        bool RedefinableElement.IsConsistentWith(RedefinableElement redefiningElement) => Uml.__CustomImpl.Pseudostate_IsConsistentWith(this, redefiningElement);
