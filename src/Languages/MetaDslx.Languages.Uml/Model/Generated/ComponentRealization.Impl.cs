...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ComponentRealization_Impl : __MetaModelObject, ComponentRealization
    {
        private ComponentRealization_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ComponentRealization(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public Component Abstraction
        {
            get => MGet<Component>(Uml.ComponentRealization_Abstraction);
            set => MSet<Component>(Uml.ComponentRealization_Abstraction, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Classifier> RealizingClassifier
        {
            get => MGetCollection<Classifier>(Uml.ComponentRealization_RealizingClassifier);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ComponentRealization_Abstraction, Uml.ComponentRealization_RealizingClassifier);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ComponentRealization_Abstraction, Uml.ComponentRealization_RealizingClassifier, Uml.Abstraction_Mapping, Uml.Dependency_Client, Uml.Dependency_Supplier, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ComponentRealization_Abstraction, Uml.ComponentRealization_RealizingClassifier, Uml.Abstraction_Mapping, Uml.Dependency_Client, Uml.Dependency_Supplier, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Abstraction", Uml.ComponentRealization_Abstraction);
                publicPropertiesByName.Add("RealizingClassifier", Uml.ComponentRealization_RealizingClassifier);
                ...
                modelPropertyInfos.Add(Uml.ComponentRealization_Abstraction, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ComponentRealization_Abstraction, __ImmutableArray.Create<__ModelProperty>(Uml.ComponentRealization_Abstraction), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Component_Realization), __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Supplier, Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ComponentRealization_RealizingClassifier, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ComponentRealization_RealizingClassifier, __ImmutableArray.Create<__ModelProperty>(Uml.ComponentRealization_RealizingClassifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Client), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Dependency_Client, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Dependency_Client, __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Client), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_ClientDependency), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Source), __ImmutableArray.Create<__ModelProperty>(Uml.ComponentRealization_RealizingClassifier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Dependency_Supplier, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Dependency_Supplier, __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Supplier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Target), __ImmutableArray.Create<__ModelProperty>(Uml.ComponentRealization_Abstraction), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ComponentRealization);
            ...
            {
                var result = new ComponentRealization_Impl(id);
            ...
            {
                return "Uml.ComponentRealizationInfo";
            }
        }
    }
}
