...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class PrimitiveType_Impl : __MetaModelObject, PrimitiveType
    {
            ...
            : base(id)
        {
            ...
            Uml.__CustomImpl.PrimitiveType(this);
        }
