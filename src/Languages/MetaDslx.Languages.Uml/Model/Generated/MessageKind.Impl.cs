...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class __MessageKind_Info : __ModelEnumInfo
    {
        public static readonly __MessageKind_Info Instance = new __MessageKind_Info();
        ...
        private __MessageKind_Info()
        {
            _literals = __ImmutableArray.Create<string>("Complete", "Lost", "Found", "Unknown");
            var literalsByName = __ImmutableDictionary.CreateBuilder<string, __MetaSymbol>();
            literalsByName.Add("Complete", __MetaSymbol.FromValue(MessageKind.Complete));
            literalsByName.Add("Lost", __MetaSymbol.FromValue(MessageKind.Lost));
            literalsByName.Add("Found", __MetaSymbol.FromValue(MessageKind.Found));
            literalsByName.Add("Unknown", __MetaSymbol.FromValue(MessageKind.Unknown));
            _literalsByName = literalsByName.ToImmutable();
        }
    
        public override __MetaModel MetaModel => Uml.MInstance;
        public override __MetaType MetaType => typeof(MessageKind);
