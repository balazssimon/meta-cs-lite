...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class BehaviorExecutionSpecification_Impl : __MetaModelObject, BehaviorExecutionSpecification
    {
        private BehaviorExecutionSpecification_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.NamedElement(this);
            Uml.__CustomImpl.InteractionFragment(this);
            Uml.__CustomImpl.ExecutionSpecification(this);
            Uml.__CustomImpl.BehaviorExecutionSpecification(this);
        }
        ...
        {
            get => MGet<Behavior>(Uml.BehaviorExecutionSpecification_Behavior);
            set => MSet<Behavior>(Uml.BehaviorExecutionSpecification_Behavior, value);
        }
    
        public OccurrenceSpecification Finish
        {
            get => MGet<OccurrenceSpecification>(Uml.ExecutionSpecification_Finish);
            set => MSet<OccurrenceSpecification>(Uml.ExecutionSpecification_Finish, value);
        }
    
        public OccurrenceSpecification Start
        {
            get => MGet<OccurrenceSpecification>(Uml.ExecutionSpecification_Start);
            set => MSet<OccurrenceSpecification>(Uml.ExecutionSpecification_Start, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ExecutionSpecificationInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ExecutionSpecificationInfo, Uml.InteractionFragmentInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.BehaviorExecutionSpecification_Behavior);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.BehaviorExecutionSpecification_Behavior, Uml.ExecutionSpecification_Finish, Uml.ExecutionSpecification_Start, Uml.InteractionFragment_Covered, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.BehaviorExecutionSpecification_Behavior, Uml.ExecutionSpecification_Finish, Uml.ExecutionSpecification_Start, Uml.InteractionFragment_Covered, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Behavior", Uml.BehaviorExecutionSpecification_Behavior);
                publicPropertiesByName.Add("Finish", Uml.ExecutionSpecification_Finish);
                publicPropertiesByName.Add("Start", Uml.ExecutionSpecification_Start);
                ...
                modelPropertyInfos.Add(Uml.BehaviorExecutionSpecification_Behavior, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.BehaviorExecutionSpecification_Behavior, __ImmutableArray.Create<__ModelProperty>(Uml.BehaviorExecutionSpecification_Behavior), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ExecutionSpecification_Finish, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ExecutionSpecification_Finish, __ImmutableArray.Create<__ModelProperty>(Uml.ExecutionSpecification_Finish), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ExecutionSpecification_Start, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ExecutionSpecification_Start, __ImmutableArray.Create<__ModelProperty>(Uml.ExecutionSpecification_Start), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(BehaviorExecutionSpecification);
            ...
            {
                var result = new BehaviorExecutionSpecification_Impl(id);
            ...
            {
                return "Uml.BehaviorExecutionSpecificationInfo";
            }
        }
    }
}
