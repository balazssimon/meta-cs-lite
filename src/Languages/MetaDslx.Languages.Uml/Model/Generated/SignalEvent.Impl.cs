...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class SignalEvent_Impl : __MetaModelObject, SignalEvent
    {
        private SignalEvent_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.SignalEvent(this);
        }
        ...
        {
            get => MGet<Signal>(Uml.SignalEvent_Signal);
            set => MSet<Signal>(Uml.SignalEvent_Signal, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.SignalEvent_Signal);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.SignalEvent_Signal, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.SignalEvent_Signal, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Signal", Uml.SignalEvent_Signal);
                ...
                modelPropertyInfos.Add(Uml.SignalEvent_Signal, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.SignalEvent_Signal, __ImmutableArray.Create<__ModelProperty>(Uml.SignalEvent_Signal), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(SignalEvent);
            ...
            {
                var result = new SignalEvent_Impl(id);
