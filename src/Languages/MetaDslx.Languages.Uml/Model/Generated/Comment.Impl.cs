...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Comment_Impl : __MetaModelObject, Comment
    {
        ...
        {
            get => MGetCollection<Element>(Uml.Comment_AnnotatedElement);
        }
    
        public string Body
        {
            get => MGet<string>(Uml.Comment_Body);
            set => MSet<string>(Uml.Comment_Body, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Comment_AnnotatedElement, Uml.Comment_Body);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Comment_AnnotatedElement, Uml.Comment_Body, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Comment_AnnotatedElement, Uml.Comment_Body, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("AnnotatedElement", Uml.Comment_AnnotatedElement);
                publicPropertiesByName.Add("Body", Uml.Comment_Body);
