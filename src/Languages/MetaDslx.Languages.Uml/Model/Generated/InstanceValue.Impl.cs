...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class InstanceValue_Impl : __MetaModelObject, InstanceValue
    {
        private InstanceValue_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.InstanceValue(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public InstanceSpecification Instance
        {
            get => MGet<InstanceSpecification>(Uml.InstanceValue_Instance);
            set => MSet<InstanceSpecification>(Uml.InstanceValue_Instance, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.InstanceValue_Instance, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InstanceValue_Instance, __ImmutableArray.Create<__ModelProperty>(Uml.InstanceValue_Instance), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(InstanceValue);
            ...
            {
                var result = new InstanceValue_Impl(id);
