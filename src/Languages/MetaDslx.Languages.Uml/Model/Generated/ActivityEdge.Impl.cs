...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ActivityEdge_Impl : __MetaModelObject, ActivityEdge
    {
        private ActivityEdge_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.ActivityEdge_IsConsistentWith);
            ...
            public override __MetaType MetaType => typeof(ActivityEdge);
            ...
            {
                var result = new ActivityEdge_Impl(id);
