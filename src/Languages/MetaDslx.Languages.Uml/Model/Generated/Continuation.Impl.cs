...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Continuation_Impl : __MetaModelObject, Continuation
    {
        private Continuation_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.Continuation_Setting)?.Add((bool)true);
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.NamedElement(this);
            Uml.__CustomImpl.InteractionFragment(this);
            Uml.__CustomImpl.Continuation(this);
        }
        ...
        public bool Setting
        {
            get => MGet<bool>(Uml.Continuation_Setting);
            set => MSet<bool>(Uml.Continuation_Setting, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Continuation_Setting);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Continuation_Setting, Uml.InteractionFragment_Covered, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Continuation_Setting, Uml.InteractionFragment_Covered, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Setting", Uml.Continuation_Setting);
                ...
                modelPropertyInfos.Add(Uml.Continuation_Setting, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Continuation_Setting, __ImmutableArray.Create<__ModelProperty>(Uml.Continuation_Setting), true, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Continuation);
            ...
            {
                var result = new Continuation_Impl(id);
