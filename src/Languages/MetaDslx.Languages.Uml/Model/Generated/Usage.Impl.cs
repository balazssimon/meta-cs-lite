...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Usage_Impl : __MetaModelObject, Usage
    {
        private Usage_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(Usage);
