...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class AnyReceiveEvent_Impl : __MetaModelObject, AnyReceiveEvent
    {
        private AnyReceiveEvent_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.AnyReceiveEvent(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(AnyReceiveEvent);
            ...
            {
                var result = new AnyReceiveEvent_Impl(id);
            ...
            {
                return "Uml.AnyReceiveEventInfo";
            }
        }
    }
}
