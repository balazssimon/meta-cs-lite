...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ValuePin_Impl : __MetaModelObject, ValuePin
    {
        private ValuePin_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.Pin_IsControl)?.Add((bool)false);
            ...
            Uml.__CustomImpl.Pin(this);
            Uml.__CustomImpl.InputPin(this);
            Uml.__CustomImpl.ValuePin(this);
        }
        ...
        {
            get => MGet<ValueSpecification>(Uml.ValuePin_Value);
            set => MSet<ValueSpecification>(Uml.ValuePin_Value, value);
        }
    
        public bool IsControl
        {
            get => MGet<bool>(Uml.Pin_IsControl);
            set => MSet<bool>(Uml.Pin_IsControl, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.InputPinInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.InputPinInfo, Uml.PinInfo, Uml.MultiplicityElementInfo, Uml.ObjectNodeInfo, Uml.ActivityNodeInfo, Uml.RedefinableElementInfo, Uml.TypedElementInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ValuePin_Value);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ValuePin_Value, Uml.Pin_IsControl, Uml.MultiplicityElement_IsOrdered, Uml.MultiplicityElement_IsUnique, Uml.MultiplicityElement_Lower, Uml.MultiplicityElement_LowerValue, Uml.MultiplicityElement_Upper, Uml.MultiplicityElement_UpperValue, Uml.ObjectNode_InState, Uml.ObjectNode_IsControlType, Uml.ObjectNode_Ordering, Uml.ObjectNode_Selection, Uml.ObjectNode_UpperBound, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ValuePin_Value, Uml.Pin_IsControl, Uml.MultiplicityElement_IsOrdered, Uml.MultiplicityElement_IsUnique, Uml.MultiplicityElement_Lower, Uml.MultiplicityElement_LowerValue, Uml.MultiplicityElement_Upper, Uml.MultiplicityElement_UpperValue, Uml.ObjectNode_InState, Uml.ObjectNode_IsControlType, Uml.ObjectNode_Ordering, Uml.ObjectNode_Selection, Uml.ObjectNode_UpperBound, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Value", Uml.ValuePin_Value);
                publicPropertiesByName.Add("IsControl", Uml.Pin_IsControl);
                ...
                modelPropertyInfos.Add(Uml.ValuePin_Value, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ValuePin_Value, __ImmutableArray.Create<__ModelProperty>(Uml.ValuePin_Value), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Pin_IsControl, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Pin_IsControl, __ImmutableArray.Create<__ModelProperty>(Uml.Pin_IsControl), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Element_OwnedElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Element_OwnedElement, __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.ValuePin_Value, Uml.MultiplicityElement_LowerValue, Uml.MultiplicityElement_UpperValue, Uml.ObjectNode_UpperBound, Uml.NamedElement_NameExpression, Uml.Element_OwnedComment), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ValuePin);
            ...
            {
                var result = new ValuePin_Impl(id);
