...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Connector_Impl : __MetaModelObject, Connector
    {
        private Connector_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.Connector(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<Behavior> Contract
        {
            get => MGetCollection<Behavior>(Uml.Connector_Contract);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ConnectorEnd> End
        {
            get => MGetCollection<ConnectorEnd>(Uml.Connector_End);
        }
    
        public global::MetaDslx.Languages.Uml.Model.ConnectorKind Kind
        {
            get => Uml.__CustomImpl.Connector_Kind(this);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Connector> RedefinedConnector
        {
            get => MGetCollection<Connector>(Uml.Connector_RedefinedConnector);
        }
    
        public Association Type
        {
            get => MGet<Association>(Uml.Connector_Type);
            set => MSet<Association>(Uml.Connector_Type, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.FeatureInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.FeatureInfo, Uml.RedefinableElementInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Connector_Contract, Uml.Connector_End, Uml.Connector_Kind, Uml.Connector_RedefinedConnector, Uml.Connector_Type);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Connector_Contract, Uml.Connector_End, Uml.Connector_Kind, Uml.Connector_RedefinedConnector, Uml.Connector_Type, Uml.Feature_FeaturingClassifier, Uml.Feature_IsStatic, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Connector_Contract, Uml.Connector_End, Uml.Connector_Kind, Uml.Connector_RedefinedConnector, Uml.Connector_Type, Uml.Feature_FeaturingClassifier, Uml.Feature_IsStatic, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Contract", Uml.Connector_Contract);
                publicPropertiesByName.Add("End", Uml.Connector_End);
                publicPropertiesByName.Add("Kind", Uml.Connector_Kind);
                publicPropertiesByName.Add("RedefinedConnector", Uml.Connector_RedefinedConnector);
                publicPropertiesByName.Add("Type", Uml.Connector_Type);
                ...
                modelPropertyInfos.Add(Uml.Connector_Contract, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Connector_Contract, __ImmutableArray.Create<__ModelProperty>(Uml.Connector_Contract), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Connector_End, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Connector_End, __ImmutableArray.Create<__ModelProperty>(Uml.Connector_End), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.ConnectorEnd_Connector), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Connector_Kind, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Connector_Kind, __ImmutableArray.Create<__ModelProperty>(Uml.Connector_Kind), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.Single | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Connector_RedefinedConnector, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Connector_RedefinedConnector, __ImmutableArray.Create<__ModelProperty>(Uml.Connector_RedefinedConnector), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.RedefinableElement_RedefinedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Connector_Type, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Connector_Type, __ImmutableArray.Create<__ModelProperty>(Uml.Connector_Type), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Connector);
            ...
            {
                var result = new Connector_Impl(id);
