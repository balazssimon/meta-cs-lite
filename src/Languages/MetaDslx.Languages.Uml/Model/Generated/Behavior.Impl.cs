...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Behavior_Impl : __MetaModelObject, Behavior
    {
        private Behavior_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Behavior_BehavioredClassifier, Uml.Behavior_InputParameters, Uml.Behavior_OutputParameters);
            ...
            public override __MetaType MetaType => typeof(Behavior);
            ...
            {
                var result = new Behavior_Impl(id);
