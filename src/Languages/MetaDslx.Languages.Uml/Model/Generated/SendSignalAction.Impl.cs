...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class SendSignalAction_Impl : __MetaModelObject, SendSignalAction
    {
        private SendSignalAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.SendSignalAction(this);
        }
        ...
        {
            get => MGet<Signal>(Uml.SendSignalAction_Signal);
            set => MSet<Signal>(Uml.SendSignalAction_Signal, value);
        }
    
        public InputPin Target
        {
            get => MGet<InputPin>(Uml.SendSignalAction_Target);
            set => MSet<InputPin>(Uml.SendSignalAction_Target, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.SendSignalAction_Signal, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.SendSignalAction_Signal, __ImmutableArray.Create<__ModelProperty>(Uml.SendSignalAction_Signal), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.SendSignalAction_Target, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.SendSignalAction_Target, __ImmutableArray.Create<__ModelProperty>(Uml.SendSignalAction_Target), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(SendSignalAction);
            ...
            {
                var result = new SendSignalAction_Impl(id);
            ...
            {
                return "Uml.SendSignalActionInfo";
            }
        }
    }
}
