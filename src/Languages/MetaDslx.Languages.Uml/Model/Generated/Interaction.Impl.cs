...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Interaction_Impl : __MetaModelObject, Interaction
    {
        private Interaction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.Interaction(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<Action> Action
        {
            get => MGetCollection<Action>(Uml.Interaction_Action);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Gate> FormalGate
        {
            get => MGetCollection<Gate>(Uml.Interaction_FormalGate);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<InteractionFragment> Fragment
        {
            get => MGetCollection<InteractionFragment>(Uml.Interaction_Fragment);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Lifeline> Lifeline
        {
            get => MGetCollection<Lifeline>(Uml.Interaction_Lifeline);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Message> Message
        {
            get => MGetCollection<Message>(Uml.Interaction_Message);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.BehaviorInfo, Uml.InteractionFragmentInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.BehaviorInfo, Uml.ClassInfo, Uml.BehavioredClassifierInfo, Uml.EncapsulatedClassifierInfo, Uml.ClassifierInfo, Uml.InteractionFragmentInfo, Uml.StructuredClassifierInfo, Uml.NamespaceInfo, Uml.RedefinableElementInfo, Uml.TypeInfo, Uml.PackageableElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.TemplateableElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Interaction_Action, Uml.Interaction_FormalGate, Uml.Interaction_Fragment, Uml.Interaction_Lifeline, Uml.Interaction_Message);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Interaction_Action, Uml.Interaction_FormalGate, Uml.Interaction_Fragment, Uml.Interaction_Lifeline, Uml.Interaction_Message, Uml.Behavior_Context, Uml.Behavior_IsReentrant, Uml.Behavior_OwnedParameter, Uml.Behavior_OwnedParameterSet, Uml.Behavior_Postcondition, Uml.Behavior_Precondition, Uml.Behavior_RedefinedBehavior, Uml.Behavior_Specification, Uml.Class_Extension, Uml.Class_IsAbstract, Uml.Class_IsActive, Uml.Class_NestedClassifier, Uml.Class_OwnedAttribute, Uml.Class_OwnedOperation, Uml.Class_OwnedReception, Uml.Class_SuperClass, Uml.BehavioredClassifier_ClassifierBehavior, Uml.BehavioredClassifier_InterfaceRealization, Uml.BehavioredClassifier_OwnedBehavior, Uml.EncapsulatedClassifier_OwnedPort, Uml.Classifier_Attribute, Uml.Classifier_CollaborationUse, Uml.Classifier_Feature, Uml.Classifier_General, Uml.Classifier_Generalization, Uml.Classifier_InheritedMember, Uml.Classifier_IsAbstract, Uml.Classifier_IsFinalSpecialization, Uml.Classifier_OwnedTemplateSignature, Uml.Classifier_OwnedUseCase, Uml.Classifier_PowertypeExtent, Uml.Classifier_RedefinedClassifier, Uml.Classifier_Representation, Uml.Classifier_Substitution, Uml.Classifier_TemplateParameter, Uml.Classifier_UseCase, Uml.InteractionFragment_Covered, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.StructuredClassifier_OwnedAttribute, Uml.StructuredClassifier_OwnedConnector, Uml.StructuredClassifier_Part, Uml.StructuredClassifier_Role, Uml.Namespace_ElementImport, Uml.Namespace_ImportedMember, Uml.Namespace_Member, Uml.Namespace_OwnedMember, Uml.Namespace_OwnedRule, Uml.Namespace_PackageImport, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.Type_Package, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.TemplateableElement_OwnedTemplateSignature, Uml.TemplateableElement_TemplateBinding, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Interaction_Action, Uml.Interaction_FormalGate, Uml.Interaction_Fragment, Uml.Interaction_Lifeline, Uml.Interaction_Message, Uml.Behavior_Context, Uml.Behavior_IsReentrant, Uml.Behavior_OwnedParameter, Uml.Behavior_OwnedParameterSet, Uml.Behavior_Postcondition, Uml.Behavior_Precondition, Uml.Behavior_RedefinedBehavior, Uml.Behavior_Specification, Uml.Class_Extension, Uml.Class_IsAbstract, Uml.Class_IsActive, Uml.Class_NestedClassifier, Uml.Class_OwnedAttribute, Uml.Class_OwnedOperation, Uml.Class_OwnedReception, Uml.Class_SuperClass, Uml.BehavioredClassifier_ClassifierBehavior, Uml.BehavioredClassifier_InterfaceRealization, Uml.BehavioredClassifier_OwnedBehavior, Uml.EncapsulatedClassifier_OwnedPort, Uml.Classifier_Attribute, Uml.Classifier_CollaborationUse, Uml.Classifier_Feature, Uml.Classifier_General, Uml.Classifier_Generalization, Uml.Classifier_InheritedMember, Uml.Classifier_IsFinalSpecialization, Uml.Classifier_OwnedTemplateSignature, Uml.Classifier_OwnedUseCase, Uml.Classifier_PowertypeExtent, Uml.Classifier_RedefinedClassifier, Uml.Classifier_Representation, Uml.Classifier_Substitution, Uml.Classifier_TemplateParameter, Uml.Classifier_UseCase, Uml.InteractionFragment_Covered, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.StructuredClassifier_OwnedConnector, Uml.StructuredClassifier_Part, Uml.StructuredClassifier_Role, Uml.Namespace_ElementImport, Uml.Namespace_ImportedMember, Uml.Namespace_Member, Uml.Namespace_OwnedMember, Uml.Namespace_OwnedRule, Uml.Namespace_PackageImport, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.Type_Package, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.TemplateableElement_TemplateBinding, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Action", Uml.Interaction_Action);
                publicPropertiesByName.Add("FormalGate", Uml.Interaction_FormalGate);
                publicPropertiesByName.Add("Fragment", Uml.Interaction_Fragment);
                publicPropertiesByName.Add("Lifeline", Uml.Interaction_Lifeline);
                publicPropertiesByName.Add("Message", Uml.Interaction_Message);
                ...
                modelPropertyInfos.Add(Uml.Interaction_Action, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Interaction_Action, __ImmutableArray.Create<__ModelProperty>(Uml.Interaction_Action), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Interaction_FormalGate, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Interaction_FormalGate, __ImmutableArray.Create<__ModelProperty>(Uml.Interaction_FormalGate), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Interaction_Fragment, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Interaction_Fragment, __ImmutableArray.Create<__ModelProperty>(Uml.Interaction_Fragment), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.InteractionFragment_EnclosingInteraction), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Interaction_Lifeline, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Interaction_Lifeline, __ImmutableArray.Create<__ModelProperty>(Uml.Interaction_Lifeline), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Lifeline_Interaction), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Interaction_Message, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Interaction_Message, __ImmutableArray.Create<__ModelProperty>(Uml.Interaction_Message), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Message_Interaction), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Classifier_Feature, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Classifier_Feature, __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_Feature), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(Uml.Feature_FeaturingClassifier), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_Member), __ImmutableArray.Create<__ModelProperty>(Uml.Class_OwnedOperation, Uml.Class_OwnedReception, Uml.Classifier_Attribute, Uml.StructuredClassifier_OwnedConnector), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Namespace_Member, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Namespace_Member, __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_Member), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_Feature, Uml.Classifier_InheritedMember, Uml.StructuredClassifier_Role, Uml.Namespace_ImportedMember, Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Namespace_OwnedMember, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Namespace_OwnedMember, __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement, Uml.Namespace_Member), __ImmutableArray.Create<__ModelProperty>(Uml.Interaction_FormalGate, Uml.Interaction_Fragment, Uml.Interaction_Lifeline, Uml.Interaction_Message, Uml.Behavior_OwnedParameter, Uml.Behavior_OwnedParameterSet, Uml.Class_NestedClassifier, Uml.Class_OwnedAttribute, Uml.Class_OwnedOperation, Uml.Class_OwnedReception, Uml.BehavioredClassifier_OwnedBehavior, Uml.Classifier_OwnedUseCase, Uml.StructuredClassifier_OwnedAttribute, Uml.StructuredClassifier_OwnedConnector, Uml.Namespace_OwnedRule), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Element_OwnedElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Element_OwnedElement, __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Interaction_Action, Uml.BehavioredClassifier_InterfaceRealization, Uml.Classifier_CollaborationUse, Uml.Classifier_Generalization, Uml.Classifier_Substitution, Uml.InteractionFragment_GeneralOrdering, Uml.Namespace_ElementImport, Uml.Namespace_OwnedMember, Uml.Namespace_PackageImport, Uml.NamedElement_NameExpression, Uml.TemplateableElement_OwnedTemplateSignature, Uml.TemplateableElement_TemplateBinding, Uml.Element_OwnedComment), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Interaction);
            ...
            {
                var result = new Interaction_Impl(id);
