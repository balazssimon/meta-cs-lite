...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class WriteStructuralFeatureAction_Impl : __MetaModelObject, WriteStructuralFeatureAction
    {
        private WriteStructuralFeatureAction_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.StructuralFeatureActionInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.StructuralFeatureActionInfo, Uml.ActionInfo, Uml.ExecutableNodeInfo, Uml.ActivityNodeInfo, Uml.RedefinableElementInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.WriteStructuralFeatureAction_Result, Uml.WriteStructuralFeatureAction_Value);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.WriteStructuralFeatureAction_Result, Uml.WriteStructuralFeatureAction_Value, Uml.StructuralFeatureAction_Object, Uml.StructuralFeatureAction_StructuralFeature, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.WriteStructuralFeatureAction_Result, Uml.WriteStructuralFeatureAction_Value, Uml.StructuralFeatureAction_Object, Uml.StructuralFeatureAction_StructuralFeature, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
            ...
            public override __MetaType MetaType => typeof(WriteStructuralFeatureAction);
            ...
            {
                var result = new WriteStructuralFeatureAction_Impl(id);
            ...
            {
                return "Uml.WriteStructuralFeatureActionInfo";
            }
        }
    }
}
