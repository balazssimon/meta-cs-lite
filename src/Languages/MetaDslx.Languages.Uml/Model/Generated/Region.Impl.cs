...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Region_Impl : __MetaModelObject, Region
    {
        private Region_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.Region(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public Region ExtendedRegion
        {
            get => MGet<Region>(Uml.Region_ExtendedRegion);
            set => MSet<Region>(Uml.Region_ExtendedRegion, value);
        }
    
        public Classifier RedefinitionContext
        {
            get => Uml.__CustomImpl.Region_RedefinitionContext(this);
        }
    
        public State State
        {
            get => MGet<State>(Uml.Region_State);
            set => MSet<State>(Uml.Region_State, value);
        }
    
        public StateMachine StateMachine
        {
            get => MGet<StateMachine>(Uml.Region_StateMachine);
            set => MSet<StateMachine>(Uml.Region_StateMachine, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Vertex> Subvertex
        {
            get => MGetCollection<Vertex>(Uml.Region_Subvertex);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Transition> Transition
        {
            get => MGetCollection<Transition>(Uml.Region_Transition);
        }
        ...
        bool Region.BelongsToPSM() => Uml.__CustomImpl.Region_BelongsToPSM(this);
        StateMachine Region.ContainingStateMachine() => Uml.__CustomImpl.Region_ContainingStateMachine(this);
        bool Region.IsConsistentWith(RedefinableElement redefiningElement) => Uml.__CustomImpl.Region_IsConsistentWith(this, redefiningElement);
        bool Region.IsRedefinitionContextValid(RedefinableElement redefinedElement) => Uml.__CustomImpl.Region_IsRedefinitionContextValid(this, redefinedElement);
        ...
        bool RedefinableElement.IsConsistentWith(RedefinableElement redefiningElement) => Uml.__CustomImpl.Region_IsConsistentWith(this, redefiningElement);
        bool RedefinableElement.IsRedefinitionContextValid(RedefinableElement redefinedElement) => Uml.__CustomImpl.Region_IsRedefinitionContextValid(this, redefinedElement);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Region_ExtendedRegion, Uml.Region_RedefinitionContext, Uml.Region_State, Uml.Region_StateMachine, Uml.Region_Subvertex, Uml.Region_Transition);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Region_ExtendedRegion, Uml.Region_RedefinitionContext, Uml.Region_State, Uml.Region_StateMachine, Uml.Region_Subvertex, Uml.Region_Transition, Uml.Namespace_ElementImport, Uml.Namespace_ImportedMember, Uml.Namespace_Member, Uml.Namespace_OwnedMember, Uml.Namespace_OwnedRule, Uml.Namespace_PackageImport, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Region_ExtendedRegion, Uml.Region_RedefinitionContext, Uml.Region_State, Uml.Region_StateMachine, Uml.Region_Subvertex, Uml.Region_Transition, Uml.Namespace_ElementImport, Uml.Namespace_ImportedMember, Uml.Namespace_Member, Uml.Namespace_OwnedMember, Uml.Namespace_OwnedRule, Uml.Namespace_PackageImport, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("ExtendedRegion", Uml.Region_ExtendedRegion);
                publicPropertiesByName.Add("RedefinitionContext", Uml.Region_RedefinitionContext);
                publicPropertiesByName.Add("State", Uml.Region_State);
                publicPropertiesByName.Add("StateMachine", Uml.Region_StateMachine);
                publicPropertiesByName.Add("Subvertex", Uml.Region_Subvertex);
                publicPropertiesByName.Add("Transition", Uml.Region_Transition);
                ...
                modelPropertyInfos.Add(Uml.Region_ExtendedRegion, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Region_ExtendedRegion, __ImmutableArray.Create<__ModelProperty>(Uml.Region_ExtendedRegion), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.RedefinableElement_RedefinedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Region_RedefinitionContext, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Region_RedefinitionContext, __ImmutableArray.Create<__ModelProperty>(Uml.Region_RedefinitionContext, Uml.RedefinableElement_RedefinitionContext), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single | __ModelPropertyFlags.Collection | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.RedefinableElement_RedefinitionContext), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.RedefinableElement_RedefinitionContext), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Region_State, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Region_State, __ImmutableArray.Create<__ModelProperty>(Uml.Region_State), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.State_Region), __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Region_StateMachine, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Region_StateMachine, __ImmutableArray.Create<__ModelProperty>(Uml.Region_StateMachine), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.StateMachine_Region), __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Region_Subvertex, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Region_Subvertex, __ImmutableArray.Create<__ModelProperty>(Uml.Region_Subvertex), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Vertex_Container), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Region_Transition, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Region_Transition, __ImmutableArray.Create<__ModelProperty>(Uml.Region_Transition), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Transition_Container), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.RedefinableElement_RedefinedElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.RedefinableElement_RedefinedElement, __ImmutableArray.Create<__ModelProperty>(Uml.RedefinableElement_RedefinedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Region_ExtendedRegion), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.RedefinableElement_RedefinitionContext, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Region_RedefinitionContext, __ImmutableArray.Create<__ModelProperty>(Uml.Region_RedefinitionContext, Uml.RedefinableElement_RedefinitionContext), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single | __ModelPropertyFlags.Collection | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Region_RedefinitionContext), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Region_RedefinitionContext)));
                ...
                modelPropertyInfos.Add(Uml.NamedElement_Namespace, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.NamedElement_Namespace, __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(Uml.Region_State, Uml.Region_StateMachine), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Region_BelongsToPSM, Uml.Region_ContainingStateMachine, Uml.Region_IsConsistentWith, Uml.Region_IsRedefinitionContextValid);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Region_BelongsToPSM, Uml.Region_ContainingStateMachine, Uml.Region_IsConsistentWith, Uml.Region_IsRedefinitionContextValid, Uml.Namespace_ExcludeCollisions, Uml.Namespace_GetNamesOfMember, Uml.Namespace_ImportMembers, Uml.Namespace_MembersAreDistinguishable, Uml.RedefinableElement_IsConsistentWith, Uml.RedefinableElement_IsRedefinitionContextValid, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Region_BelongsToPSM, Uml.Region_ContainingStateMachine, Uml.Region_IsConsistentWith, Uml.Region_IsRedefinitionContextValid, Uml.Namespace_ExcludeCollisions, Uml.Namespace_GetNamesOfMember, Uml.Namespace_ImportMembers, Uml.Namespace_MembersAreDistinguishable, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.Region_BelongsToPSM, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.Region_ContainingStateMachine, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.Region_IsConsistentWith, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.RedefinableElement_IsConsistentWith), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.Region_IsRedefinitionContextValid, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.RedefinableElement_IsRedefinitionContextValid), __ImmutableArray.Create<__ModelOperation>()));
                    ...
                    modelOperationInfos.Add(Uml.RedefinableElement_IsConsistentWith, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.Region_IsConsistentWith)));
                    modelOperationInfos.Add(Uml.RedefinableElement_IsRedefinitionContextValid, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.Region_IsRedefinitionContextValid)));
            ...
            public override __MetaType MetaType => typeof(Region);
