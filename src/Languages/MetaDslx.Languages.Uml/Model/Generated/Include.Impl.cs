...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Include_Impl : __MetaModelObject, Include
    {
        private Include_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.Include(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public UseCase Addition
        {
            get => MGet<UseCase>(Uml.Include_Addition);
            set => MSet<UseCase>(Uml.Include_Addition, value);
        }
    
        public UseCase IncludingCase
        {
            get => MGet<UseCase>(Uml.Include_IncludingCase);
            set => MSet<UseCase>(Uml.Include_IncludingCase, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Include_Addition, Uml.Include_IncludingCase);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Include_Addition, Uml.Include_IncludingCase, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Include_Addition, Uml.Include_IncludingCase, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Addition", Uml.Include_Addition);
                publicPropertiesByName.Add("IncludingCase", Uml.Include_IncludingCase);
                ...
                modelPropertyInfos.Add(Uml.NamedElement_Namespace, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.NamedElement_Namespace, __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(Uml.Include_IncludingCase), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Include);
            ...
            {
                var result = new Include_Impl(id);
