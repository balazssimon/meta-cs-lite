...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class UnmarshallAction_Impl : __MetaModelObject, UnmarshallAction
    {
        private UnmarshallAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.UnmarshallAction(this);
        }
        ...
        {
            get => MGet<InputPin>(Uml.UnmarshallAction_Object);
            set => MSet<InputPin>(Uml.UnmarshallAction_Object, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<OutputPin> Result
        {
            get => MGetCollection<OutputPin>(Uml.UnmarshallAction_Result);
        }
    
        public Classifier UnmarshallType
        {
            get => MGet<Classifier>(Uml.UnmarshallAction_UnmarshallType);
            set => MSet<Classifier>(Uml.UnmarshallAction_UnmarshallType, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(UnmarshallAction);
            ...
            {
                var result = new UnmarshallAction_Impl(id);
            ...
            {
                return "Uml.UnmarshallActionInfo";
            }
        }
    }
}
