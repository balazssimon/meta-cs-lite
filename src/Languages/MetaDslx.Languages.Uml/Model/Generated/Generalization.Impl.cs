...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Generalization_Impl : __MetaModelObject, Generalization
    {
        private Generalization_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.Generalization_IsSubstitutable)?.Add((bool)true);
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.Relationship(this);
            Uml.__CustomImpl.DirectedRelationship(this);
            Uml.__CustomImpl.Generalization(this);
        }
        ...
        {
            get => MGet<Classifier>(Uml.Generalization_General);
            set => MSet<Classifier>(Uml.Generalization_General, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<GeneralizationSet> GeneralizationSet
        {
            get => MGetCollection<GeneralizationSet>(Uml.Generalization_GeneralizationSet);
        }
    
        public bool IsSubstitutable
        {
            get => MGet<bool>(Uml.Generalization_IsSubstitutable);
            set => MSet<bool>(Uml.Generalization_IsSubstitutable, value);
        }
    
        public Classifier Specific
        {
            get => MGet<Classifier>(Uml.Generalization_Specific);
            set => MSet<Classifier>(Uml.Generalization_Specific, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Generalization_General, Uml.Generalization_GeneralizationSet, Uml.Generalization_IsSubstitutable, Uml.Generalization_Specific);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Generalization_General, Uml.Generalization_GeneralizationSet, Uml.Generalization_IsSubstitutable, Uml.Generalization_Specific, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Generalization_General, Uml.Generalization_GeneralizationSet, Uml.Generalization_IsSubstitutable, Uml.Generalization_Specific, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("General", Uml.Generalization_General);
                publicPropertiesByName.Add("GeneralizationSet", Uml.Generalization_GeneralizationSet);
                publicPropertiesByName.Add("IsSubstitutable", Uml.Generalization_IsSubstitutable);
                publicPropertiesByName.Add("Specific", Uml.Generalization_Specific);
                ...
                modelPropertyInfos.Add(Uml.Generalization_General, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Generalization_General, __ImmutableArray.Create<__ModelProperty>(Uml.Generalization_General), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Target), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Generalization_GeneralizationSet, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Generalization_GeneralizationSet, __ImmutableArray.Create<__ModelProperty>(Uml.Generalization_GeneralizationSet), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.GeneralizationSet_Generalization), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Generalization_IsSubstitutable, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Generalization_IsSubstitutable, __ImmutableArray.Create<__ModelProperty>(Uml.Generalization_IsSubstitutable), true, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Generalization_Specific, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Generalization_Specific, __ImmutableArray.Create<__ModelProperty>(Uml.Generalization_Specific), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_Generalization), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Source, Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.DirectedRelationship_Source, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DirectedRelationship_Source, __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Source), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Relationship_RelatedElement), __ImmutableArray.Create<__ModelProperty>(Uml.Generalization_Specific), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.DirectedRelationship_Target, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DirectedRelationship_Target, __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Target), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Relationship_RelatedElement), __ImmutableArray.Create<__ModelProperty>(Uml.Generalization_General), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Generalization);
            ...
            {
                var result = new Generalization_Impl(id);
