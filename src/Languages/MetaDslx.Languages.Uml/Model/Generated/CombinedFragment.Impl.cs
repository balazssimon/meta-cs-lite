...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class CombinedFragment_Impl : __MetaModelObject, CombinedFragment
    {
        private CombinedFragment_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.InteractionFragmentInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.InteractionFragmentInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.CombinedFragment_CfragmentGate, Uml.CombinedFragment_InteractionOperator, Uml.CombinedFragment_Operand);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.CombinedFragment_CfragmentGate, Uml.CombinedFragment_InteractionOperator, Uml.CombinedFragment_Operand, Uml.InteractionFragment_Covered, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.CombinedFragment_CfragmentGate, Uml.CombinedFragment_InteractionOperator, Uml.CombinedFragment_Operand, Uml.InteractionFragment_Covered, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
            ...
            public override __MetaType MetaType => typeof(CombinedFragment);
            ...
            {
                var result = new CombinedFragment_Impl(id);
            ...
            {
                return "Uml.CombinedFragmentInfo";
            }
        }
    }
}
