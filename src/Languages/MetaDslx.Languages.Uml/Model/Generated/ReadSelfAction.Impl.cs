...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ReadSelfAction_Impl : __MetaModelObject, ReadSelfAction
    {
        private ReadSelfAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ReadSelfAction(this);
        }
        ...
        {
            get => MGet<OutputPin>(Uml.ReadSelfAction_Result);
            set => MSet<OutputPin>(Uml.ReadSelfAction_Result, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(ReadSelfAction);
            ...
            {
                var result = new ReadSelfAction_Impl(id);
