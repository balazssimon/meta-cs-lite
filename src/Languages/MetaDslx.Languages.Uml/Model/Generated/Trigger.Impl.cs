...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Trigger_Impl : __MetaModelObject, Trigger
    {
        private Trigger_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.NamedElement(this);
            Uml.__CustomImpl.Trigger(this);
        }
        ...
        public Event Event
        {
            get => MGet<Event>(Uml.Trigger_Event);
            set => MSet<Event>(Uml.Trigger_Event, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Port> Port
        {
            get => MGetCollection<Port>(Uml.Trigger_Port);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Trigger_Event, Uml.Trigger_Port);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Trigger_Event, Uml.Trigger_Port, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Trigger_Event, Uml.Trigger_Port, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Event", Uml.Trigger_Event);
                publicPropertiesByName.Add("Port", Uml.Trigger_Port);
                ...
                modelPropertyInfos.Add(Uml.Trigger_Event, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Trigger_Event, __ImmutableArray.Create<__ModelProperty>(Uml.Trigger_Event), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Trigger_Port, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Trigger_Port, __ImmutableArray.Create<__ModelProperty>(Uml.Trigger_Port), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Trigger);
            ...
            {
                var result = new Trigger_Impl(id);
