...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class FinalNode_Impl : __MetaModelObject, FinalNode
    {
        private FinalNode_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(FinalNode);
            ...
            {
                var result = new FinalNode_Impl(id);
