...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class StringExpression_Impl : __MetaModelObject, StringExpression
    {
            ...
            : base(id)
        {
            ...
            Uml.__CustomImpl.Expression(this);
            Uml.__CustomImpl.StringExpression(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public StringExpression OwningExpression
        {
            get => MGet<StringExpression>(Uml.StringExpression_OwningExpression);
            set => MSet<StringExpression>(Uml.StringExpression_OwningExpression, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<StringExpression> SubExpression
        {
            get => MGetCollection<StringExpression>(Uml.StringExpression_SubExpression);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ValueSpecification> Operand
        {
            get => MGetCollection<ValueSpecification>(Uml.Expression_Operand);
        }
    
        public string Symbol
        {
            get => MGet<string>(Uml.Expression_Symbol);
            set => MSet<string>(Uml.Expression_Symbol, value);
        }
        ...
        string StringExpression.StringValue(string result) => Uml.__CustomImpl.StringExpression_StringValue(this, result);
        ...
        string ValueSpecification.StringValue(string result) => Uml.__CustomImpl.StringExpression_StringValue(this, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ExpressionInfo, Uml.TemplateableElementInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ExpressionInfo, Uml.TemplateableElementInfo, Uml.ValueSpecificationInfo, Uml.PackageableElementInfo, Uml.TypedElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.StringExpression_OwningExpression, Uml.StringExpression_SubExpression);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.StringExpression_OwningExpression, Uml.StringExpression_SubExpression, Uml.Expression_Operand, Uml.Expression_Symbol, Uml.TemplateableElement_OwnedTemplateSignature, Uml.TemplateableElement_TemplateBinding, Uml.PackageableElement_Visibility, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.StringExpression_OwningExpression, Uml.StringExpression_SubExpression, Uml.Expression_Operand, Uml.Expression_Symbol, Uml.TemplateableElement_OwnedTemplateSignature, Uml.TemplateableElement_TemplateBinding, Uml.PackageableElement_Visibility, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("OwningExpression", Uml.StringExpression_OwningExpression);
                publicPropertiesByName.Add("SubExpression", Uml.StringExpression_SubExpression);
                publicPropertiesByName.Add("Operand", Uml.Expression_Operand);
                publicPropertiesByName.Add("Symbol", Uml.Expression_Symbol);
                ...
                modelPropertyInfos.Add(Uml.Element_OwnedElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Element_OwnedElement, __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.StringExpression_SubExpression, Uml.Expression_Operand, Uml.TemplateableElement_OwnedTemplateSignature, Uml.TemplateableElement_TemplateBinding, Uml.NamedElement_NameExpression, Uml.Element_OwnedComment), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Element_Owner, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Element_Owner, __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.StringExpression_OwningExpression, Uml.NamedElement_Namespace, Uml.ParameterableElement_OwningTemplateParameter), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                _modelPropertyInfos = modelPropertyInfos.ToImmutable();
    
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.StringExpression_StringValue);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.StringExpression_StringValue, Uml.TemplateableElement_IsTemplate, Uml.TemplateableElement_ParameterableElements, Uml.ValueSpecification_BooleanValue, Uml.ValueSpecification_IntegerValue, Uml.ValueSpecification_IsCompatibleWith, Uml.ValueSpecification_IsComputable, Uml.ValueSpecification_IsNull, Uml.ValueSpecification_RealValue, Uml.ValueSpecification_StringValue, Uml.ValueSpecification_UnlimitedValue, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsCompatibleWith, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.StringExpression_StringValue, Uml.TemplateableElement_IsTemplate, Uml.TemplateableElement_ParameterableElements, Uml.ValueSpecification_BooleanValue, Uml.ValueSpecification_IntegerValue, Uml.ValueSpecification_IsCompatibleWith, Uml.ValueSpecification_IsComputable, Uml.ValueSpecification_IsNull, Uml.ValueSpecification_RealValue, Uml.ValueSpecification_UnlimitedValue, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.StringExpression_StringValue, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.ValueSpecification_StringValue), __ImmutableArray.Create<__ModelOperation>()));
                    ...
                    modelOperationInfos.Add(Uml.ValueSpecification_StringValue, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.StringExpression_StringValue)));
            ...
            {
                return "Uml.StringExpressionInfo";
            }
        }
    }
}
