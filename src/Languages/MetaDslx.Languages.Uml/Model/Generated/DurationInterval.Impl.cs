...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class DurationInterval_Impl : __MetaModelObject, DurationInterval
    {
        private DurationInterval_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.Interval(this);
            Uml.__CustomImpl.DurationInterval(this);
        }
        ...
        public Duration Max
        {
            get => MGet<Duration>(Uml.DurationInterval_Max);
            set => MSet<Duration>(Uml.DurationInterval_Max, value);
        }
    
        public Duration Min
        {
            get => MGet<Duration>(Uml.DurationInterval_Min);
            set => MSet<Duration>(Uml.DurationInterval_Min, value);
        }
    
        [global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)]
        ValueSpecification Interval.Max
        {
            get => MGet<ValueSpecification>(Uml.Interval_Max);
            set => MSet<ValueSpecification>(Uml.Interval_Max, value);
        }
    
        [global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)]
        ValueSpecification Interval.Min
        {
            get => MGet<ValueSpecification>(Uml.Interval_Min);
            set => MSet<ValueSpecification>(Uml.Interval_Min, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.IntervalInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.IntervalInfo, Uml.ValueSpecificationInfo, Uml.PackageableElementInfo, Uml.TypedElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DurationInterval_Max, Uml.DurationInterval_Min);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DurationInterval_Max, Uml.DurationInterval_Min, Uml.Interval_Max, Uml.Interval_Min, Uml.PackageableElement_Visibility, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DurationInterval_Max, Uml.DurationInterval_Min, Uml.PackageableElement_Visibility, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Max", Uml.DurationInterval_Max);
                publicPropertiesByName.Add("Min", Uml.DurationInterval_Min);
                ...
                modelPropertyInfos.Add(Uml.DurationInterval_Max, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DurationInterval_Max, __ImmutableArray.Create<__ModelProperty>(Uml.DurationInterval_Max, Uml.Interval_Max), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Interval_Max), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Interval_Max), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.DurationInterval_Min, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DurationInterval_Min, __ImmutableArray.Create<__ModelProperty>(Uml.DurationInterval_Min, Uml.Interval_Min), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Interval_Min), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Interval_Min), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Interval_Max, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DurationInterval_Max, __ImmutableArray.Create<__ModelProperty>(Uml.DurationInterval_Max, Uml.Interval_Max), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.DurationInterval_Max), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.DurationInterval_Max)));
                modelPropertyInfos.Add(Uml.Interval_Min, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DurationInterval_Min, __ImmutableArray.Create<__ModelProperty>(Uml.DurationInterval_Min, Uml.Interval_Min), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.DurationInterval_Min), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.DurationInterval_Min)));
            ...
            public override __MetaType MetaType => typeof(DurationInterval);
            ...
            {
                var result = new DurationInterval_Impl(id);
            ...
            {
                return "Uml.DurationIntervalInfo";
            }
        }
    }
}
