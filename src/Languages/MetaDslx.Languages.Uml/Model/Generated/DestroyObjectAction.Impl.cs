...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class DestroyObjectAction_Impl : __MetaModelObject, DestroyObjectAction
    {
        private DestroyObjectAction_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.DestroyObjectAction_IsDestroyLinks)?.Add((bool)false);
            ((__IModelObject)this).MGetSlot(Uml.DestroyObjectAction_IsDestroyOwnedObjects)?.Add((bool)false);
            ...
            Uml.__CustomImpl.DestroyObjectAction(this);
        }
        ...
        {
            get => MGet<bool>(Uml.DestroyObjectAction_IsDestroyLinks);
            set => MSet<bool>(Uml.DestroyObjectAction_IsDestroyLinks, value);
        }
    
        public bool IsDestroyOwnedObjects
        {
            get => MGet<bool>(Uml.DestroyObjectAction_IsDestroyOwnedObjects);
            set => MSet<bool>(Uml.DestroyObjectAction_IsDestroyOwnedObjects, value);
        }
    
        public InputPin Target
        {
            get => MGet<InputPin>(Uml.DestroyObjectAction_Target);
            set => MSet<InputPin>(Uml.DestroyObjectAction_Target, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(DestroyObjectAction);
            ...
            {
                var result = new DestroyObjectAction_Impl(id);
            ...
            {
                return "Uml.DestroyObjectActionInfo";
            }
        }
    }
}
