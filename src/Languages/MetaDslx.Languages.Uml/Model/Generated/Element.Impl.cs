    ...
    internal class Element_Impl : __MetaModelObject, Element
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
