...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class DestroyLinkAction_Impl : __MetaModelObject, DestroyLinkAction
    {
        private DestroyLinkAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.DestroyLinkAction(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<LinkEndDestructionData> EndData
        {
            get => MGetCollection<LinkEndDestructionData>(Uml.DestroyLinkAction_EndData);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(DestroyLinkAction);
            ...
            {
                var result = new DestroyLinkAction_Impl(id);
            ...
            {
                return "Uml.DestroyLinkActionInfo";
            }
        }
    }
}
