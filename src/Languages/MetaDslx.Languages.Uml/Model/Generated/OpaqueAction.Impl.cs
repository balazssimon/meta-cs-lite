...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class OpaqueAction_Impl : __MetaModelObject, OpaqueAction
    {
        private OpaqueAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.OpaqueAction(this);
        }
        ...
        {
            get => MGetCollection<string>(Uml.OpaqueAction_Body);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<InputPin> InputValue
        {
            get => MGetCollection<InputPin>(Uml.OpaqueAction_InputValue);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<string> Language
        {
            get => MGetCollection<string>(Uml.OpaqueAction_Language);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<OutputPin> OutputValue
        {
            get => MGetCollection<OutputPin>(Uml.OpaqueAction_OutputValue);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.OpaqueAction_Body, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.OpaqueAction_Body, __ImmutableArray.Create<__ModelProperty>(Uml.OpaqueAction_Body), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.OpaqueAction_InputValue, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.OpaqueAction_InputValue, __ImmutableArray.Create<__ModelProperty>(Uml.OpaqueAction_InputValue), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.OpaqueAction_Language, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.OpaqueAction_Language, __ImmutableArray.Create<__ModelProperty>(Uml.OpaqueAction_Language), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.OpaqueAction_OutputValue, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.OpaqueAction_OutputValue, __ImmutableArray.Create<__ModelProperty>(Uml.OpaqueAction_OutputValue), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Output), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(OpaqueAction);
            ...
            {
                var result = new OpaqueAction_Impl(id);
