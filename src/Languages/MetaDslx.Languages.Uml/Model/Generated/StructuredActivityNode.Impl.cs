...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class StructuredActivityNode_Impl : __MetaModelObject, StructuredActivityNode
    {
        private StructuredActivityNode_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.StructuredActivityNode_AllActions, Uml.StructuredActivityNode_AllOwnedNodes, Uml.StructuredActivityNode_ContainingActivity, Uml.StructuredActivityNode_SourceNodes, Uml.StructuredActivityNode_TargetNodes);
            ...
            public override __MetaType MetaType => typeof(StructuredActivityNode);
            ...
            {
                var result = new StructuredActivityNode_Impl(id);
            ...
            {
                return "Uml.StructuredActivityNodeInfo";
            }
        }
    }
}
