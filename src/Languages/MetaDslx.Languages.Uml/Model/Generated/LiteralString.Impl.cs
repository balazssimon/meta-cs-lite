...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class LiteralString_Impl : __MetaModelObject, LiteralString
    {
        ...
        bool LiteralString.IsComputable() => Uml.__CustomImpl.LiteralString_IsComputable(this);
        string LiteralString.StringValue() => Uml.__CustomImpl.LiteralString_StringValue(this);
        ...
        bool ValueSpecification.IsComputable() => Uml.__CustomImpl.LiteralString_IsComputable(this);
        ...
        string ValueSpecification.StringValue() => Uml.__CustomImpl.LiteralString_StringValue(this);
