...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class LiteralString_Impl : __MetaModelObject, LiteralString
    {
        private LiteralString_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.LiteralString(this);
        }
        ...
        public string Value
        {
            get => MGet<string>(Uml.LiteralString_Value);
            set => MSet<string>(Uml.LiteralString_Value, value);
        }
        ...
        bool LiteralString.IsComputable(bool result) => Uml.__CustomImpl.LiteralString_IsComputable(this, result);
        string LiteralString.StringValue(string result) => Uml.__CustomImpl.LiteralString_StringValue(this, result);
        ...
        bool ValueSpecification.IsComputable(bool result) => Uml.__CustomImpl.LiteralString_IsComputable(this, result);
        ...
        string ValueSpecification.StringValue(string result) => Uml.__CustomImpl.LiteralString_StringValue(this, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.LiteralString_Value, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.LiteralString_Value, __ImmutableArray.Create<__ModelProperty>(Uml.LiteralString_Value), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LiteralString_IsComputable, Uml.LiteralString_StringValue);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LiteralString_IsComputable, Uml.LiteralString_StringValue, Uml.ValueSpecification_BooleanValue, Uml.ValueSpecification_IntegerValue, Uml.ValueSpecification_IsCompatibleWith, Uml.ValueSpecification_IsComputable, Uml.ValueSpecification_IsNull, Uml.ValueSpecification_RealValue, Uml.ValueSpecification_StringValue, Uml.ValueSpecification_UnlimitedValue, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsCompatibleWith, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LiteralString_IsComputable, Uml.LiteralString_StringValue, Uml.ValueSpecification_BooleanValue, Uml.ValueSpecification_IntegerValue, Uml.ValueSpecification_IsCompatibleWith, Uml.ValueSpecification_IsNull, Uml.ValueSpecification_RealValue, Uml.ValueSpecification_UnlimitedValue, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.LiteralString_IsComputable, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.ValueSpecification_IsComputable), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.LiteralString_StringValue, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.ValueSpecification_StringValue), __ImmutableArray.Create<__ModelOperation>()));
                    ...
                    modelOperationInfos.Add(Uml.ValueSpecification_IsComputable, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.LiteralString_IsComputable)));
                    ...
                    modelOperationInfos.Add(Uml.ValueSpecification_StringValue, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.LiteralString_StringValue)));
            ...
            public override __MetaType MetaType => typeof(LiteralString);
            ...
            {
                var result = new LiteralString_Impl(id);
