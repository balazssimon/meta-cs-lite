...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ReadIsClassifiedObjectAction_Impl : __MetaModelObject, ReadIsClassifiedObjectAction
    {
        private ReadIsClassifiedObjectAction_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.ReadIsClassifiedObjectAction_IsDirect)?.Add((bool)false);
            ...
            Uml.__CustomImpl.ReadIsClassifiedObjectAction(this);
        }
        ...
        {
            get => MGet<Classifier>(Uml.ReadIsClassifiedObjectAction_Classifier);
            set => MSet<Classifier>(Uml.ReadIsClassifiedObjectAction_Classifier, value);
        }
    
        public bool IsDirect
        {
            get => MGet<bool>(Uml.ReadIsClassifiedObjectAction_IsDirect);
            set => MSet<bool>(Uml.ReadIsClassifiedObjectAction_IsDirect, value);
        }
    
        public InputPin Object
        {
            get => MGet<InputPin>(Uml.ReadIsClassifiedObjectAction_Object);
            set => MSet<InputPin>(Uml.ReadIsClassifiedObjectAction_Object, value);
        }
    
        public OutputPin Result
        {
            get => MGet<OutputPin>(Uml.ReadIsClassifiedObjectAction_Result);
            set => MSet<OutputPin>(Uml.ReadIsClassifiedObjectAction_Result, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ReadIsClassifiedObjectAction_Classifier, Uml.ReadIsClassifiedObjectAction_IsDirect, Uml.ReadIsClassifiedObjectAction_Object, Uml.ReadIsClassifiedObjectAction_Result);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ReadIsClassifiedObjectAction_Classifier, Uml.ReadIsClassifiedObjectAction_IsDirect, Uml.ReadIsClassifiedObjectAction_Object, Uml.ReadIsClassifiedObjectAction_Result, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ReadIsClassifiedObjectAction_Classifier, Uml.ReadIsClassifiedObjectAction_IsDirect, Uml.ReadIsClassifiedObjectAction_Object, Uml.ReadIsClassifiedObjectAction_Result, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Classifier", Uml.ReadIsClassifiedObjectAction_Classifier);
                publicPropertiesByName.Add("IsDirect", Uml.ReadIsClassifiedObjectAction_IsDirect);
                publicPropertiesByName.Add("Object", Uml.ReadIsClassifiedObjectAction_Object);
                publicPropertiesByName.Add("Result", Uml.ReadIsClassifiedObjectAction_Result);
                ...
                modelPropertyInfos.Add(Uml.ReadIsClassifiedObjectAction_Classifier, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReadIsClassifiedObjectAction_Classifier, __ImmutableArray.Create<__ModelProperty>(Uml.ReadIsClassifiedObjectAction_Classifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ReadIsClassifiedObjectAction_IsDirect, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReadIsClassifiedObjectAction_IsDirect, __ImmutableArray.Create<__ModelProperty>(Uml.ReadIsClassifiedObjectAction_IsDirect), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ReadIsClassifiedObjectAction_Object, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReadIsClassifiedObjectAction_Object, __ImmutableArray.Create<__ModelProperty>(Uml.ReadIsClassifiedObjectAction_Object), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ReadIsClassifiedObjectAction_Result, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReadIsClassifiedObjectAction_Result, __ImmutableArray.Create<__ModelProperty>(Uml.ReadIsClassifiedObjectAction_Result), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Output), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ReadIsClassifiedObjectAction);
            ...
            {
                var result = new ReadIsClassifiedObjectAction_Impl(id);
            ...
            {
                return "Uml.ReadIsClassifiedObjectActionInfo";
            }
        }
    }
}
