...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class __ConnectorKind_Info : __ModelEnumInfo
    {
        public static readonly __ConnectorKind_Info Instance = new __ConnectorKind_Info();
        ...
        private __ConnectorKind_Info()
        {
            _literals = __ImmutableArray.Create<string>("Assembly", "Delegation");
            var literalsByName = __ImmutableDictionary.CreateBuilder<string, __MetaSymbol>();
            literalsByName.Add("Assembly", __MetaSymbol.FromValue(ConnectorKind.Assembly));
            literalsByName.Add("Delegation", __MetaSymbol.FromValue(ConnectorKind.Delegation));
            _literalsByName = literalsByName.ToImmutable();
        }
    
        public override __MetaModel MetaModel => Uml.MInstance;
        public override __MetaType MetaType => typeof(ConnectorKind);
