...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class LiteralInteger_Impl : __MetaModelObject, LiteralInteger
    {
        private LiteralInteger_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.LiteralInteger_Value)?.Add((int)0);
            ...
            Uml.__CustomImpl.LiteralInteger(this);
        }
        ...
        public int Value
        {
            get => MGet<int>(Uml.LiteralInteger_Value);
            set => MSet<int>(Uml.LiteralInteger_Value, value);
        }
        ...
        int LiteralInteger.IntegerValue(int result) => Uml.__CustomImpl.LiteralInteger_IntegerValue(this, result);
        bool LiteralInteger.IsComputable(bool result) => Uml.__CustomImpl.LiteralInteger_IsComputable(this, result);
        bool ValueSpecification.BooleanValue(bool result) => Uml.__CustomImpl.ValueSpecification_BooleanValue(this, result);
        int ValueSpecification.IntegerValue(int result) => Uml.__CustomImpl.LiteralInteger_IntegerValue(this, result);
        ...
        bool ValueSpecification.IsComputable(bool result) => Uml.__CustomImpl.LiteralInteger_IsComputable(this, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.LiteralInteger_Value, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.LiteralInteger_Value, __ImmutableArray.Create<__ModelProperty>(Uml.LiteralInteger_Value), 0, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LiteralInteger_IntegerValue, Uml.LiteralInteger_IsComputable);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LiteralInteger_IntegerValue, Uml.LiteralInteger_IsComputable, Uml.ValueSpecification_BooleanValue, Uml.ValueSpecification_IntegerValue, Uml.ValueSpecification_IsCompatibleWith, Uml.ValueSpecification_IsComputable, Uml.ValueSpecification_IsNull, Uml.ValueSpecification_RealValue, Uml.ValueSpecification_StringValue, Uml.ValueSpecification_UnlimitedValue, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsCompatibleWith, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LiteralInteger_IntegerValue, Uml.LiteralInteger_IsComputable, Uml.ValueSpecification_BooleanValue, Uml.ValueSpecification_IsCompatibleWith, Uml.ValueSpecification_IsNull, Uml.ValueSpecification_RealValue, Uml.ValueSpecification_StringValue, Uml.ValueSpecification_UnlimitedValue, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.LiteralInteger_IntegerValue, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.ValueSpecification_IntegerValue), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.LiteralInteger_IsComputable, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.ValueSpecification_IsComputable), __ImmutableArray.Create<__ModelOperation>()));
                    ...
                    modelOperationInfos.Add(Uml.ValueSpecification_IntegerValue, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.LiteralInteger_IntegerValue)));
                    ...
                    modelOperationInfos.Add(Uml.ValueSpecification_IsComputable, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.LiteralInteger_IsComputable)));
