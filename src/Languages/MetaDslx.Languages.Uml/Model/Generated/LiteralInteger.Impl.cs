...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class LiteralInteger_Impl : __MetaModelObject, LiteralInteger
    {
        ...
        int LiteralInteger.IntegerValue() => Uml.__CustomImpl.LiteralInteger_IntegerValue(this);
        bool LiteralInteger.IsComputable() => Uml.__CustomImpl.LiteralInteger_IsComputable(this);
        bool ValueSpecification.BooleanValue() => Uml.__CustomImpl.ValueSpecification_BooleanValue(this);
        int ValueSpecification.IntegerValue() => Uml.__CustomImpl.LiteralInteger_IntegerValue(this);
        ...
        bool ValueSpecification.IsComputable() => Uml.__CustomImpl.LiteralInteger_IsComputable(this);
