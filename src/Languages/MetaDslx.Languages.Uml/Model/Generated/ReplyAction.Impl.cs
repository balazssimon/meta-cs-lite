...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ReplyAction_Impl : __MetaModelObject, ReplyAction
    {
        private ReplyAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ReplyAction(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public Trigger ReplyToCall
        {
            get => MGet<Trigger>(Uml.ReplyAction_ReplyToCall);
            set => MSet<Trigger>(Uml.ReplyAction_ReplyToCall, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<InputPin> ReplyValue
        {
            get => MGetCollection<InputPin>(Uml.ReplyAction_ReplyValue);
        }
    
        public InputPin ReturnInformation
        {
            get => MGet<InputPin>(Uml.ReplyAction_ReturnInformation);
            set => MSet<InputPin>(Uml.ReplyAction_ReturnInformation, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.ReplyAction_ReplyToCall, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReplyAction_ReplyToCall, __ImmutableArray.Create<__ModelProperty>(Uml.ReplyAction_ReplyToCall), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ReplyAction_ReplyValue, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReplyAction_ReplyValue, __ImmutableArray.Create<__ModelProperty>(Uml.ReplyAction_ReplyValue), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ReplyAction_ReturnInformation, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReplyAction_ReturnInformation, __ImmutableArray.Create<__ModelProperty>(Uml.ReplyAction_ReturnInformation), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ReplyAction);
            ...
            {
                var result = new ReplyAction_Impl(id);
