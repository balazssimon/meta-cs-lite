...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class CommunicationPath_Impl : __MetaModelObject, CommunicationPath
    {
        private CommunicationPath_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.CommunicationPath(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(CommunicationPath);
            ...
            {
                var result = new CommunicationPath_Impl(id);
            ...
            {
                return "Uml.CommunicationPathInfo";
            }
        }
    }
}
