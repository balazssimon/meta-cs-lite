    ...
    internal class PackageImport_Impl : __MetaModelObject, PackageImport
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.PackageImport_Visibility, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.PackageImport_Visibility, __ImmutableArray.Create<__ModelProperty>(Uml.PackageImport_Visibility), , __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
