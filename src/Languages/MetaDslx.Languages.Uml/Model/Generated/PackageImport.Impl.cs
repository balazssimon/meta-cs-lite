...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class PackageImport_Impl : __MetaModelObject, PackageImport
    {
        private PackageImport_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.PackageImport_Visibility)?.Add((global::MetaDslx.Languages.Uml.Model.VisibilityKind)MetaDslx.Languages.Uml.Model.VisibilityKind.Public);
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.Relationship(this);
            Uml.__CustomImpl.DirectedRelationship(this);
            Uml.__CustomImpl.PackageImport(this);
        }
        ...
        {
            get => MGet<Package>(Uml.PackageImport_ImportedPackage);
            set => MSet<Package>(Uml.PackageImport_ImportedPackage, value);
        }
    
        public Namespace ImportingNamespace
        {
            get => MGet<Namespace>(Uml.PackageImport_ImportingNamespace);
            set => MSet<Namespace>(Uml.PackageImport_ImportingNamespace, value);
        }
    
        public global::MetaDslx.Languages.Uml.Model.VisibilityKind Visibility
        {
            get => MGet<global::MetaDslx.Languages.Uml.Model.VisibilityKind>(Uml.PackageImport_Visibility);
            set => MSet<global::MetaDslx.Languages.Uml.Model.VisibilityKind>(Uml.PackageImport_Visibility, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.PackageImport_ImportedPackage, Uml.PackageImport_ImportingNamespace, Uml.PackageImport_Visibility);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.PackageImport_ImportedPackage, Uml.PackageImport_ImportingNamespace, Uml.PackageImport_Visibility, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.PackageImport_ImportedPackage, Uml.PackageImport_ImportingNamespace, Uml.PackageImport_Visibility, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("ImportedPackage", Uml.PackageImport_ImportedPackage);
                publicPropertiesByName.Add("ImportingNamespace", Uml.PackageImport_ImportingNamespace);
                publicPropertiesByName.Add("Visibility", Uml.PackageImport_Visibility);
                ...
                modelPropertyInfos.Add(Uml.PackageImport_ImportedPackage, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.PackageImport_ImportedPackage, __ImmutableArray.Create<__ModelProperty>(Uml.PackageImport_ImportedPackage), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Target), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.PackageImport_ImportingNamespace, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.PackageImport_ImportingNamespace, __ImmutableArray.Create<__ModelProperty>(Uml.PackageImport_ImportingNamespace), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_PackageImport), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Source, Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.PackageImport_Visibility, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.PackageImport_Visibility, __ImmutableArray.Create<__ModelProperty>(Uml.PackageImport_Visibility), MetaDslx.Languages.Uml.Model.VisibilityKind.Public, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.DirectedRelationship_Source, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DirectedRelationship_Source, __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Source), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Relationship_RelatedElement), __ImmutableArray.Create<__ModelProperty>(Uml.PackageImport_ImportingNamespace), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.DirectedRelationship_Target, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DirectedRelationship_Target, __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Target), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Relationship_RelatedElement), __ImmutableArray.Create<__ModelProperty>(Uml.PackageImport_ImportedPackage), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(PackageImport);
            ...
            {
                var result = new PackageImport_Impl(id);
