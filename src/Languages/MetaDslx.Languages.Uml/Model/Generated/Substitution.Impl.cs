...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Substitution_Impl : __MetaModelObject, Substitution
    {
        private Substitution_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.Substitution(this);
        }
        ...
        {
            get => MGet<Classifier>(Uml.Substitution_Contract);
            set => MSet<Classifier>(Uml.Substitution_Contract, value);
        }
    
        public Classifier SubstitutingClassifier
        {
            get => MGet<Classifier>(Uml.Substitution_SubstitutingClassifier);
            set => MSet<Classifier>(Uml.Substitution_SubstitutingClassifier, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Substitution_Contract, Uml.Substitution_SubstitutingClassifier);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Substitution_Contract, Uml.Substitution_SubstitutingClassifier, Uml.Abstraction_Mapping, Uml.Dependency_Client, Uml.Dependency_Supplier, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Substitution_Contract, Uml.Substitution_SubstitutingClassifier, Uml.Abstraction_Mapping, Uml.Dependency_Client, Uml.Dependency_Supplier, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Contract", Uml.Substitution_Contract);
                publicPropertiesByName.Add("SubstitutingClassifier", Uml.Substitution_SubstitutingClassifier);
                ...
                modelPropertyInfos.Add(Uml.Substitution_Contract, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Substitution_Contract, __ImmutableArray.Create<__ModelProperty>(Uml.Substitution_Contract), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Supplier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Substitution_SubstitutingClassifier, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Substitution_SubstitutingClassifier, __ImmutableArray.Create<__ModelProperty>(Uml.Substitution_SubstitutingClassifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_Substitution), __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Client, Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Dependency_Client, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Dependency_Client, __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Client), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_ClientDependency), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Source), __ImmutableArray.Create<__ModelProperty>(Uml.Substitution_SubstitutingClassifier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Dependency_Supplier, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Dependency_Supplier, __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Supplier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Target), __ImmutableArray.Create<__ModelProperty>(Uml.Substitution_Contract), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Substitution);
            ...
            {
                var result = new Substitution_Impl(id);
