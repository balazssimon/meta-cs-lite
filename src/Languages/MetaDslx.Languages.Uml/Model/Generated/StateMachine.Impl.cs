...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class StateMachine_Impl : __MetaModelObject, StateMachine
    {
        private StateMachine_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.StateMachine_ConnectionPoint, Uml.StateMachine_ExtendedStateMachine, Uml.StateMachine_Region, Uml.StateMachine_SubmachineState);
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.StateMachine_Ancestor, Uml.StateMachine_IsConsistentWith, Uml.StateMachine_IsRedefinitionContextValid, Uml.StateMachine_LCA, Uml.StateMachine_LCAState);
            ...
            public override __MetaType MetaType => typeof(StateMachine);
            ...
            {
                var result = new StateMachine_Impl(id);
