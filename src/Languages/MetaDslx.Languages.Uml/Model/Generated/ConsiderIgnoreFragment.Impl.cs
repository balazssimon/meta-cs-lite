    ...
    internal class ConsiderIgnoreFragment_Impl : __MetaModelObject, ConsiderIgnoreFragment
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.CombinedFragment_InteractionOperator, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.CombinedFragment_InteractionOperator, __ImmutableArray.Create<__ModelProperty>(Uml.CombinedFragment_InteractionOperator), , __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
