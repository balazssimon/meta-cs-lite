...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ConsiderIgnoreFragment_Impl : __MetaModelObject, ConsiderIgnoreFragment
    {
        private ConsiderIgnoreFragment_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.CombinedFragment_InteractionOperator)?.Add((global::MetaDslx.Languages.Uml.Model.InteractionOperatorKind)MetaDslx.Languages.Uml.Model.InteractionOperatorKind.Seq);
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.NamedElement(this);
            Uml.__CustomImpl.InteractionFragment(this);
            Uml.__CustomImpl.CombinedFragment(this);
            Uml.__CustomImpl.ConsiderIgnoreFragment(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<NamedElement> Message
        {
            get => MGetCollection<NamedElement>(Uml.ConsiderIgnoreFragment_Message);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Gate> CfragmentGate
        {
            get => MGetCollection<Gate>(Uml.CombinedFragment_CfragmentGate);
        }
    
        public global::MetaDslx.Languages.Uml.Model.InteractionOperatorKind InteractionOperator
        {
            get => MGet<global::MetaDslx.Languages.Uml.Model.InteractionOperatorKind>(Uml.CombinedFragment_InteractionOperator);
            set => MSet<global::MetaDslx.Languages.Uml.Model.InteractionOperatorKind>(Uml.CombinedFragment_InteractionOperator, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<InteractionOperand> Operand
        {
            get => MGetCollection<InteractionOperand>(Uml.CombinedFragment_Operand);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.CombinedFragmentInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.CombinedFragmentInfo, Uml.InteractionFragmentInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ConsiderIgnoreFragment_Message);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ConsiderIgnoreFragment_Message, Uml.CombinedFragment_CfragmentGate, Uml.CombinedFragment_InteractionOperator, Uml.CombinedFragment_Operand, Uml.InteractionFragment_Covered, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ConsiderIgnoreFragment_Message, Uml.CombinedFragment_CfragmentGate, Uml.CombinedFragment_InteractionOperator, Uml.CombinedFragment_Operand, Uml.InteractionFragment_Covered, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Message", Uml.ConsiderIgnoreFragment_Message);
                publicPropertiesByName.Add("CfragmentGate", Uml.CombinedFragment_CfragmentGate);
                publicPropertiesByName.Add("InteractionOperator", Uml.CombinedFragment_InteractionOperator);
                publicPropertiesByName.Add("Operand", Uml.CombinedFragment_Operand);
                ...
                modelPropertyInfos.Add(Uml.ConsiderIgnoreFragment_Message, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ConsiderIgnoreFragment_Message, __ImmutableArray.Create<__ModelProperty>(Uml.ConsiderIgnoreFragment_Message), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.CombinedFragment_CfragmentGate, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.CombinedFragment_CfragmentGate, __ImmutableArray.Create<__ModelProperty>(Uml.CombinedFragment_CfragmentGate), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Gate_CombinedFragment), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.CombinedFragment_InteractionOperator, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.CombinedFragment_InteractionOperator, __ImmutableArray.Create<__ModelProperty>(Uml.CombinedFragment_InteractionOperator), MetaDslx.Languages.Uml.Model.InteractionOperatorKind.Seq, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.CombinedFragment_Operand, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.CombinedFragment_Operand, __ImmutableArray.Create<__ModelProperty>(Uml.CombinedFragment_Operand), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.InteractionOperand_CombinedFragment), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ConsiderIgnoreFragment);
            ...
            {
                var result = new ConsiderIgnoreFragment_Impl(id);
            ...
            {
                return "Uml.ConsiderIgnoreFragmentInfo";
            }
        }
    }
}
