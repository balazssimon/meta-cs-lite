...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class RaiseExceptionAction_Impl : __MetaModelObject, RaiseExceptionAction
    {
        private RaiseExceptionAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.RaiseExceptionAction(this);
        }
        ...
        {
            get => MGet<InputPin>(Uml.RaiseExceptionAction_Exception);
            set => MSet<InputPin>(Uml.RaiseExceptionAction_Exception, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.RaiseExceptionAction_Exception, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.RaiseExceptionAction_Exception, __ImmutableArray.Create<__ModelProperty>(Uml.RaiseExceptionAction_Exception), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(RaiseExceptionAction);
            ...
            {
                var result = new RaiseExceptionAction_Impl(id);
            ...
            {
                return "Uml.RaiseExceptionActionInfo";
            }
        }
    }
}
