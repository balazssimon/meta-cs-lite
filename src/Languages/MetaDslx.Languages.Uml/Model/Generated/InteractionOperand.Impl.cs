...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class InteractionOperand_Impl : __MetaModelObject, InteractionOperand
    {
        ...
        {
            get => MGet<CombinedFragment>(Uml.InteractionOperand_CombinedFragment);
            set => MSet<CombinedFragment>(Uml.InteractionOperand_CombinedFragment, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.InteractionOperand_CombinedFragment, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InteractionOperand_CombinedFragment, __ImmutableArray.Create<__ModelProperty>(Uml.InteractionOperand_CombinedFragment), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.CombinedFragment_Operand), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
