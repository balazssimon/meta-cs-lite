...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class RemoveVariableValueAction_Impl : __MetaModelObject, RemoveVariableValueAction
    {
        private RemoveVariableValueAction_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.RemoveVariableValueAction_IsRemoveDuplicates)?.Add((bool)false);
            ...
            Uml.__CustomImpl.VariableAction(this);
            Uml.__CustomImpl.WriteVariableAction(this);
            Uml.__CustomImpl.RemoveVariableValueAction(this);
        }
        ...
        {
            get => MGet<bool>(Uml.RemoveVariableValueAction_IsRemoveDuplicates);
            set => MSet<bool>(Uml.RemoveVariableValueAction_IsRemoveDuplicates, value);
        }
    
        public InputPin RemoveAt
        {
            get => MGet<InputPin>(Uml.RemoveVariableValueAction_RemoveAt);
            set => MSet<InputPin>(Uml.RemoveVariableValueAction_RemoveAt, value);
        }
    
        public InputPin Value
        {
            get => MGet<InputPin>(Uml.WriteVariableAction_Value);
            set => MSet<InputPin>(Uml.WriteVariableAction_Value, value);
        }
    
        public Variable Variable
        {
            get => MGet<Variable>(Uml.VariableAction_Variable);
            set => MSet<Variable>(Uml.VariableAction_Variable, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.WriteVariableActionInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.WriteVariableActionInfo, Uml.VariableActionInfo, Uml.ActionInfo, Uml.ExecutableNodeInfo, Uml.ActivityNodeInfo, Uml.RedefinableElementInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.RemoveVariableValueAction_IsRemoveDuplicates, Uml.RemoveVariableValueAction_RemoveAt);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.RemoveVariableValueAction_IsRemoveDuplicates, Uml.RemoveVariableValueAction_RemoveAt, Uml.WriteVariableAction_Value, Uml.VariableAction_Variable, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.RemoveVariableValueAction_IsRemoveDuplicates, Uml.RemoveVariableValueAction_RemoveAt, Uml.WriteVariableAction_Value, Uml.VariableAction_Variable, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("IsRemoveDuplicates", Uml.RemoveVariableValueAction_IsRemoveDuplicates);
                publicPropertiesByName.Add("RemoveAt", Uml.RemoveVariableValueAction_RemoveAt);
                publicPropertiesByName.Add("Value", Uml.WriteVariableAction_Value);
                publicPropertiesByName.Add("Variable", Uml.VariableAction_Variable);
                ...
                modelPropertyInfos.Add(Uml.RemoveVariableValueAction_IsRemoveDuplicates, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.RemoveVariableValueAction_IsRemoveDuplicates, __ImmutableArray.Create<__ModelProperty>(Uml.RemoveVariableValueAction_IsRemoveDuplicates), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.RemoveVariableValueAction_RemoveAt, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.RemoveVariableValueAction_RemoveAt, __ImmutableArray.Create<__ModelProperty>(Uml.RemoveVariableValueAction_RemoveAt), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.WriteVariableAction_Value, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.WriteVariableAction_Value, __ImmutableArray.Create<__ModelProperty>(Uml.WriteVariableAction_Value), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.VariableAction_Variable, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.VariableAction_Variable, __ImmutableArray.Create<__ModelProperty>(Uml.VariableAction_Variable), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(RemoveVariableValueAction);
            ...
            {
                var result = new RemoveVariableValueAction_Impl(id);
            ...
            {
                return "Uml.RemoveVariableValueActionInfo";
            }
        }
    }
}
