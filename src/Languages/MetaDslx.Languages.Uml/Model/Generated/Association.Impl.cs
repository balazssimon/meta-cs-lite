...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Association_Impl : __MetaModelObject, Association
    {
        private Association_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ClassifierInfo, Uml.RelationshipInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ClassifierInfo, Uml.NamespaceInfo, Uml.RedefinableElementInfo, Uml.RelationshipInfo, Uml.TemplateableElementInfo, Uml.TypeInfo, Uml.PackageableElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Association_EndType, Uml.Association_IsDerived, Uml.Association_MemberEnd, Uml.Association_NavigableOwnedEnd, Uml.Association_OwnedEnd);
            ...
            public override __MetaType MetaType => typeof(Association);
            ...
            {
                var result = new Association_Impl(id);
