...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Observation_Impl : __MetaModelObject, Observation
    {
        private Observation_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(Observation);
            ...
            {
                var result = new Observation_Impl(id);
