...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ControlFlow_Impl : __MetaModelObject, ControlFlow
    {
        private ControlFlow_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ControlFlow(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            {
                var result = new ControlFlow_Impl(id);
