...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class FunctionBehavior_Impl : __MetaModelObject, FunctionBehavior
    {
        private FunctionBehavior_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.OpaqueBehavior(this);
            Uml.__CustomImpl.FunctionBehavior(this);
        }
        ...
        {
            get => MGetCollection<string>(Uml.OpaqueBehavior_Body);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<string> Language
        {
            get => MGetCollection<string>(Uml.OpaqueBehavior_Language);
        }
        ...
        bool FunctionBehavior.HasAllDataTypeAttributes(bool result, DataType d) => Uml.__CustomImpl.FunctionBehavior_HasAllDataTypeAttributes(this, result, d);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            {
                var result = new FunctionBehavior_Impl(id);
            ...
            {
                return "Uml.FunctionBehaviorInfo";
            }
        }
    }
}
