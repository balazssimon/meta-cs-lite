...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ChangeEvent_Impl : __MetaModelObject, ChangeEvent
    {
        private ChangeEvent_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ChangeEvent(this);
        }
        ...
        {
            get => MGet<ValueSpecification>(Uml.ChangeEvent_ChangeExpression);
            set => MSet<ValueSpecification>(Uml.ChangeEvent_ChangeExpression, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(ChangeEvent);
            ...
            {
                var result = new ChangeEvent_Impl(id);
