...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class OpaqueBehavior_Impl : __MetaModelObject, OpaqueBehavior
    {
        private OpaqueBehavior_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.OpaqueBehavior_Body, Uml.OpaqueBehavior_Language);
            ...
            public override __MetaType MetaType => typeof(OpaqueBehavior);
            ...
            {
                var result = new OpaqueBehavior_Impl(id);
