...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class EncapsulatedClassifier_Impl : __MetaModelObject, EncapsulatedClassifier
    {
        private EncapsulatedClassifier_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(EncapsulatedClassifier);
            ...
            {
                var result = new EncapsulatedClassifier_Impl(id);
            ...
            {
                return "Uml.EncapsulatedClassifierInfo";
            }
        }
    }
}
