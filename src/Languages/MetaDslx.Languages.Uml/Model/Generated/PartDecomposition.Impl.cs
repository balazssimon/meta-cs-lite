...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class PartDecomposition_Impl : __MetaModelObject, PartDecomposition
    {
        private PartDecomposition_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.PartDecomposition(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.InteractionUseInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.InteractionUseInfo, Uml.InteractionFragmentInfo, Uml.NamedElementInfo, Uml.ElementInfo);
            ...
            public override __MetaType MetaType => typeof(PartDecomposition);
            ...
            {
                var result = new PartDecomposition_Impl(id);
            ...
            {
                return "Uml.PartDecompositionInfo";
            }
        }
    }
}
