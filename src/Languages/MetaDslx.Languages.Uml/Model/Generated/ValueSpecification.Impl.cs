...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ValueSpecification_Impl : __MetaModelObject, ValueSpecification
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.PackageableElementInfo, Uml.TypedElementInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.PackageableElementInfo, Uml.TypedElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.ElementInfo);
            ...
            {
                return "Uml.ValueSpecificationInfo";
            }
        }
    }
}
