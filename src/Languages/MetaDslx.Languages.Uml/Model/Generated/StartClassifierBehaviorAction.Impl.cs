...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class StartClassifierBehaviorAction_Impl : __MetaModelObject, StartClassifierBehaviorAction
    {
        private StartClassifierBehaviorAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.StartClassifierBehaviorAction(this);
        }
        ...
        {
            get => MGet<InputPin>(Uml.StartClassifierBehaviorAction_Object);
            set => MSet<InputPin>(Uml.StartClassifierBehaviorAction_Object, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.StartClassifierBehaviorAction_Object, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.StartClassifierBehaviorAction_Object, __ImmutableArray.Create<__ModelProperty>(Uml.StartClassifierBehaviorAction_Object), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(StartClassifierBehaviorAction);
            ...
            {
                var result = new StartClassifierBehaviorAction_Impl(id);
            ...
            {
                return "Uml.StartClassifierBehaviorActionInfo";
            }
        }
    }
}
