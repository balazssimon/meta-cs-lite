...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Lifeline_Impl : __MetaModelObject, Lifeline
    {
        private Lifeline_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.NamedElement(this);
            Uml.__CustomImpl.Lifeline(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<InteractionFragment> CoveredBy
        {
            get => MGetCollection<InteractionFragment>(Uml.Lifeline_CoveredBy);
        }
    
        public PartDecomposition DecomposedAs
        {
            get => MGet<PartDecomposition>(Uml.Lifeline_DecomposedAs);
            set => MSet<PartDecomposition>(Uml.Lifeline_DecomposedAs, value);
        }
    
        public Interaction Interaction
        {
            get => MGet<Interaction>(Uml.Lifeline_Interaction);
            set => MSet<Interaction>(Uml.Lifeline_Interaction, value);
        }
    
        public ConnectableElement Represents
        {
            get => MGet<ConnectableElement>(Uml.Lifeline_Represents);
            set => MSet<ConnectableElement>(Uml.Lifeline_Represents, value);
        }
    
        public ValueSpecification Selector
        {
            get => MGet<ValueSpecification>(Uml.Lifeline_Selector);
            set => MSet<ValueSpecification>(Uml.Lifeline_Selector, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Lifeline_CoveredBy, Uml.Lifeline_DecomposedAs, Uml.Lifeline_Interaction, Uml.Lifeline_Represents, Uml.Lifeline_Selector);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Lifeline_CoveredBy, Uml.Lifeline_DecomposedAs, Uml.Lifeline_Interaction, Uml.Lifeline_Represents, Uml.Lifeline_Selector, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Lifeline_CoveredBy, Uml.Lifeline_DecomposedAs, Uml.Lifeline_Interaction, Uml.Lifeline_Represents, Uml.Lifeline_Selector, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("CoveredBy", Uml.Lifeline_CoveredBy);
                publicPropertiesByName.Add("DecomposedAs", Uml.Lifeline_DecomposedAs);
                publicPropertiesByName.Add("Interaction", Uml.Lifeline_Interaction);
                publicPropertiesByName.Add("Represents", Uml.Lifeline_Represents);
                publicPropertiesByName.Add("Selector", Uml.Lifeline_Selector);
                ...
                modelPropertyInfos.Add(Uml.Lifeline_CoveredBy, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Lifeline_CoveredBy, __ImmutableArray.Create<__ModelProperty>(Uml.Lifeline_CoveredBy), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.InteractionFragment_Covered), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Lifeline_DecomposedAs, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Lifeline_DecomposedAs, __ImmutableArray.Create<__ModelProperty>(Uml.Lifeline_DecomposedAs), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Lifeline_Interaction, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Lifeline_Interaction, __ImmutableArray.Create<__ModelProperty>(Uml.Lifeline_Interaction), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Interaction_Lifeline), __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Lifeline_Represents, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Lifeline_Represents, __ImmutableArray.Create<__ModelProperty>(Uml.Lifeline_Represents), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Lifeline_Selector, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Lifeline_Selector, __ImmutableArray.Create<__ModelProperty>(Uml.Lifeline_Selector), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.NamedElement_Namespace, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.NamedElement_Namespace, __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(Uml.Lifeline_Interaction), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Lifeline);
            ...
            {
                var result = new Lifeline_Impl(id);
