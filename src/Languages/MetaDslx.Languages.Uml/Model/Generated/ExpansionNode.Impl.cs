    ...
    internal class ExpansionNode_Impl : __MetaModelObject, ExpansionNode
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.ObjectNode_Ordering, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ObjectNode_Ordering, __ImmutableArray.Create<__ModelProperty>(Uml.ObjectNode_Ordering), , __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
