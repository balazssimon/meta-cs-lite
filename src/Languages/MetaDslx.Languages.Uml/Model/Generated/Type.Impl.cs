...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Type_Impl : __MetaModelObject, Type
    {
        private Type_Impl(string? id)
            : base(id)
        {
        ...
        bool Type.ConformsTo(bool result, Type other) => Uml.__CustomImpl.Type_ConformsTo(this, result, other);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Type_Package);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Type_Package, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Type_Package, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Type_ConformsTo);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Type_ConformsTo, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsCompatibleWith, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Type_ConformsTo, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsCompatibleWith, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.Type_ConformsTo, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
            ...
            public override __MetaType MetaType => typeof(Type);
