...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ClearStructuralFeatureAction_Impl : __MetaModelObject, ClearStructuralFeatureAction
    {
        private ClearStructuralFeatureAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ClearStructuralFeatureAction(this);
        }
        ...
        {
            get => MGet<OutputPin>(Uml.ClearStructuralFeatureAction_Result);
            set => MSet<OutputPin>(Uml.ClearStructuralFeatureAction_Result, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.ClearStructuralFeatureAction_Result, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ClearStructuralFeatureAction_Result, __ImmutableArray.Create<__ModelProperty>(Uml.ClearStructuralFeatureAction_Result), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Output), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ClearStructuralFeatureAction);
            ...
            {
                var result = new ClearStructuralFeatureAction_Impl(id);
            ...
            {
                return "Uml.ClearStructuralFeatureActionInfo";
            }
        }
    }
}
