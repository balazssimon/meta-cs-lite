...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Port_Impl : __MetaModelObject, Port
    {
        private Port_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.Port_IsBehavior)?.Add((bool)false);
            ((__IModelObject)this).MGetSlot(Uml.Port_IsConjugated)?.Add((bool)false);
            ((__IModelObject)this).MGetSlot(Uml.Port_IsService)?.Add((bool)true);
        ...
        {
            get => MGet<bool>(Uml.Port_IsBehavior);
            set => MSet<bool>(Uml.Port_IsBehavior, value);
        }
    
        public bool IsConjugated
        {
            get => MGet<bool>(Uml.Port_IsConjugated);
            set => MSet<bool>(Uml.Port_IsConjugated, value);
        }
    
        public bool IsService
        {
            get => MGet<bool>(Uml.Port_IsService);
            set => MSet<bool>(Uml.Port_IsService, value);
        }
    
        public ProtocolStateMachine Protocol
        {
            get => MGet<ProtocolStateMachine>(Uml.Port_Protocol);
            set => MSet<ProtocolStateMachine>(Uml.Port_Protocol, value);
        }
    
        public global::System.Collections.Generic.IList<Interface> Provided
        {
            get => Uml.__CustomImpl.Port_Provided(this);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Port> RedefinedPort
        {
            get => MGetCollection<Port>(Uml.Port_RedefinedPort);
        }
    
        public global::System.Collections.Generic.IList<Interface> Required
        {
            get => Uml.__CustomImpl.Port_Required(this);
        }
        ...
        global::System.Collections.Generic.IList<Interface> Port.BasicProvided(global::System.Collections.Generic.IList<Interface> result) => Uml.__CustomImpl.Port_BasicProvided(this, result);
        global::System.Collections.Generic.IList<Interface> Port.BasicRequired(global::System.Collections.Generic.IList<Interface> result) => Uml.__CustomImpl.Port_BasicRequired(this, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Port_IsBehavior, Uml.Port_IsConjugated, Uml.Port_IsService, Uml.Port_Protocol, Uml.Port_Provided, Uml.Port_RedefinedPort, Uml.Port_Required);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Port_IsBehavior, Uml.Port_IsConjugated, Uml.Port_IsService, Uml.Port_Protocol, Uml.Port_Provided, Uml.Port_RedefinedPort, Uml.Port_Required, Uml.Property_Aggregation, Uml.Property_Association, Uml.Property_AssociationEnd, Uml.Property_Class, Uml.Property_Datatype, Uml.Property_DefaultValue, Uml.Property_Interface, Uml.Property_IsComposite, Uml.Property_IsDerived, Uml.Property_IsDerivedUnion, Uml.Property_IsID, Uml.Property_Opposite, Uml.Property_OwningAssociation, Uml.Property_Qualifier, Uml.Property_RedefinedProperty, Uml.Property_SubsettedProperty, Uml.ConnectableElement_End, Uml.ConnectableElement_TemplateParameter, Uml.DeploymentTarget_DeployedElement, Uml.DeploymentTarget_Deployment, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.StructuralFeature_IsReadOnly, Uml.Feature_FeaturingClassifier, Uml.Feature_IsStatic, Uml.MultiplicityElement_IsOrdered, Uml.MultiplicityElement_IsUnique, Uml.MultiplicityElement_Lower, Uml.MultiplicityElement_LowerValue, Uml.MultiplicityElement_Upper, Uml.MultiplicityElement_UpperValue, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Port_IsBehavior, Uml.Port_IsConjugated, Uml.Port_IsService, Uml.Port_Protocol, Uml.Port_Provided, Uml.Port_RedefinedPort, Uml.Port_Required, Uml.Property_Aggregation, Uml.Property_Association, Uml.Property_AssociationEnd, Uml.Property_Class, Uml.Property_Datatype, Uml.Property_DefaultValue, Uml.Property_Interface, Uml.Property_IsComposite, Uml.Property_IsDerived, Uml.Property_IsDerivedUnion, Uml.Property_IsID, Uml.Property_Opposite, Uml.Property_OwningAssociation, Uml.Property_Qualifier, Uml.Property_RedefinedProperty, Uml.Property_SubsettedProperty, Uml.ConnectableElement_End, Uml.ConnectableElement_TemplateParameter, Uml.DeploymentTarget_DeployedElement, Uml.DeploymentTarget_Deployment, Uml.ParameterableElement_OwningTemplateParameter, Uml.StructuralFeature_IsReadOnly, Uml.Feature_FeaturingClassifier, Uml.Feature_IsStatic, Uml.MultiplicityElement_IsOrdered, Uml.MultiplicityElement_IsUnique, Uml.MultiplicityElement_Lower, Uml.MultiplicityElement_LowerValue, Uml.MultiplicityElement_Upper, Uml.MultiplicityElement_UpperValue, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("IsBehavior", Uml.Port_IsBehavior);
                publicPropertiesByName.Add("IsConjugated", Uml.Port_IsConjugated);
                publicPropertiesByName.Add("IsService", Uml.Port_IsService);
                publicPropertiesByName.Add("Protocol", Uml.Port_Protocol);
                publicPropertiesByName.Add("Provided", Uml.Port_Provided);
                publicPropertiesByName.Add("RedefinedPort", Uml.Port_RedefinedPort);
                publicPropertiesByName.Add("Required", Uml.Port_Required);
                ...
                modelPropertyInfos.Add(Uml.Port_IsBehavior, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Port_IsBehavior, __ImmutableArray.Create<__ModelProperty>(Uml.Port_IsBehavior), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Port_IsConjugated, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Port_IsConjugated, __ImmutableArray.Create<__ModelProperty>(Uml.Port_IsConjugated), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Port_IsService, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Port_IsService, __ImmutableArray.Create<__ModelProperty>(Uml.Port_IsService), true, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Port_Protocol, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Port_Protocol, __ImmutableArray.Create<__ModelProperty>(Uml.Port_Protocol), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Port_Provided, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Port_Provided, __ImmutableArray.Create<__ModelProperty>(Uml.Port_Provided), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Port_RedefinedPort, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Port_RedefinedPort, __ImmutableArray.Create<__ModelProperty>(Uml.Port_RedefinedPort), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Property_RedefinedProperty), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Port_Required, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Port_Required, __ImmutableArray.Create<__ModelProperty>(Uml.Port_Required), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Property_Aggregation, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Property_Aggregation, __ImmutableArray.Create<__ModelProperty>(Uml.Property_Aggregation), , __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Element_OwnedElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Element_OwnedElement, __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Property_DefaultValue, Uml.Property_Qualifier, Uml.DeploymentTarget_Deployment, Uml.MultiplicityElement_LowerValue, Uml.MultiplicityElement_UpperValue, Uml.NamedElement_NameExpression, Uml.Element_OwnedComment), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Port_BasicProvided, Uml.Port_BasicRequired);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Port_BasicProvided, Uml.Port_BasicRequired, Uml.Property_IsAttribute, Uml.Property_IsCompatibleWith, Uml.Property_IsConsistentWith, Uml.Property_IsNavigable, Uml.Property_SubsettingContext, Uml.ParameterableElement_IsCompatibleWith, Uml.ParameterableElement_IsTemplateParameter, Uml.MultiplicityElement_CompatibleWith, Uml.MultiplicityElement_IncludesMultiplicity, Uml.MultiplicityElement_Is, Uml.MultiplicityElement_IsMultivalued, Uml.MultiplicityElement_LowerBound, Uml.MultiplicityElement_UpperBound, Uml.RedefinableElement_IsConsistentWith, Uml.RedefinableElement_IsRedefinitionContextValid, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Port_BasicProvided, Uml.Port_BasicRequired, Uml.Property_IsAttribute, Uml.Property_IsCompatibleWith, Uml.Property_IsConsistentWith, Uml.Property_IsNavigable, Uml.Property_SubsettingContext, Uml.ParameterableElement_IsTemplateParameter, Uml.MultiplicityElement_CompatibleWith, Uml.MultiplicityElement_IncludesMultiplicity, Uml.MultiplicityElement_Is, Uml.MultiplicityElement_IsMultivalued, Uml.MultiplicityElement_LowerBound, Uml.MultiplicityElement_UpperBound, Uml.RedefinableElement_IsRedefinitionContextValid, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.Port_BasicProvided, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.Port_BasicRequired, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
            ...
            public override __MetaType MetaType => typeof(Port);
