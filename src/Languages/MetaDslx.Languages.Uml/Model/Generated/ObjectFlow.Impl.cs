...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ObjectFlow_Impl : __MetaModelObject, ObjectFlow
    {
        private ObjectFlow_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.ObjectFlow_IsMulticast)?.Add((bool)false);
            ((__IModelObject)this).MGetSlot(Uml.ObjectFlow_IsMultireceive)?.Add((bool)false);
            ...
            Uml.__CustomImpl.ActivityEdge(this);
            Uml.__CustomImpl.ObjectFlow(this);
        }
        ...
        {
            get => MGet<bool>(Uml.ObjectFlow_IsMulticast);
            set => MSet<bool>(Uml.ObjectFlow_IsMulticast, value);
        }
    
        public bool IsMultireceive
        {
            get => MGet<bool>(Uml.ObjectFlow_IsMultireceive);
            set => MSet<bool>(Uml.ObjectFlow_IsMultireceive, value);
        }
    
        public Behavior Selection
        {
            get => MGet<Behavior>(Uml.ObjectFlow_Selection);
            set => MSet<Behavior>(Uml.ObjectFlow_Selection, value);
        }
    
        public Behavior Transformation
        {
            get => MGet<Behavior>(Uml.ObjectFlow_Transformation);
            set => MSet<Behavior>(Uml.ObjectFlow_Transformation, value);
        }
    
        public Activity Activity
        {
            get => MGet<Activity>(Uml.ActivityEdge_Activity);
            set => MSet<Activity>(Uml.ActivityEdge_Activity, value);
        }
    
        public ValueSpecification Guard
        {
            get => MGet<ValueSpecification>(Uml.ActivityEdge_Guard);
            set => MSet<ValueSpecification>(Uml.ActivityEdge_Guard, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ActivityGroup> InGroup
        {
            get => MGetCollection<ActivityGroup>(Uml.ActivityEdge_InGroup);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ActivityPartition> InPartition
        {
            get => MGetCollection<ActivityPartition>(Uml.ActivityEdge_InPartition);
        }
    
        public StructuredActivityNode InStructuredNode
        {
            get => MGet<StructuredActivityNode>(Uml.ActivityEdge_InStructuredNode);
            set => MSet<StructuredActivityNode>(Uml.ActivityEdge_InStructuredNode, value);
        }
    
        public InterruptibleActivityRegion Interrupts
        {
            get => MGet<InterruptibleActivityRegion>(Uml.ActivityEdge_Interrupts);
            set => MSet<InterruptibleActivityRegion>(Uml.ActivityEdge_Interrupts, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ActivityEdge> RedefinedEdge
        {
            get => MGetCollection<ActivityEdge>(Uml.ActivityEdge_RedefinedEdge);
        }
    
        public ActivityNode Source
        {
            get => MGet<ActivityNode>(Uml.ActivityEdge_Source);
            set => MSet<ActivityNode>(Uml.ActivityEdge_Source, value);
        }
    
        public ActivityNode Target
        {
            get => MGet<ActivityNode>(Uml.ActivityEdge_Target);
            set => MSet<ActivityNode>(Uml.ActivityEdge_Target, value);
        }
    
        public ValueSpecification Weight
        {
            get => MGet<ValueSpecification>(Uml.ActivityEdge_Weight);
            set => MSet<ValueSpecification>(Uml.ActivityEdge_Weight, value);
        }
        ...
        bool ActivityEdge.IsConsistentWith(bool result, RedefinableElement redefiningElement) => Uml.__CustomImpl.ActivityEdge_IsConsistentWith(this, result, redefiningElement);
        bool RedefinableElement.IsConsistentWith(bool result, RedefinableElement redefiningElement) => Uml.__CustomImpl.ActivityEdge_IsConsistentWith(this, result, redefiningElement);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ActivityEdgeInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ActivityEdgeInfo, Uml.RedefinableElementInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ObjectFlow_IsMulticast, Uml.ObjectFlow_IsMultireceive, Uml.ObjectFlow_Selection, Uml.ObjectFlow_Transformation);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ObjectFlow_IsMulticast, Uml.ObjectFlow_IsMultireceive, Uml.ObjectFlow_Selection, Uml.ObjectFlow_Transformation, Uml.ActivityEdge_Activity, Uml.ActivityEdge_Guard, Uml.ActivityEdge_InGroup, Uml.ActivityEdge_InPartition, Uml.ActivityEdge_InStructuredNode, Uml.ActivityEdge_Interrupts, Uml.ActivityEdge_RedefinedEdge, Uml.ActivityEdge_Source, Uml.ActivityEdge_Target, Uml.ActivityEdge_Weight, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ObjectFlow_IsMulticast, Uml.ObjectFlow_IsMultireceive, Uml.ObjectFlow_Selection, Uml.ObjectFlow_Transformation, Uml.ActivityEdge_Activity, Uml.ActivityEdge_Guard, Uml.ActivityEdge_InGroup, Uml.ActivityEdge_InPartition, Uml.ActivityEdge_InStructuredNode, Uml.ActivityEdge_Interrupts, Uml.ActivityEdge_RedefinedEdge, Uml.ActivityEdge_Source, Uml.ActivityEdge_Target, Uml.ActivityEdge_Weight, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("IsMulticast", Uml.ObjectFlow_IsMulticast);
                publicPropertiesByName.Add("IsMultireceive", Uml.ObjectFlow_IsMultireceive);
                publicPropertiesByName.Add("Selection", Uml.ObjectFlow_Selection);
                publicPropertiesByName.Add("Transformation", Uml.ObjectFlow_Transformation);
                publicPropertiesByName.Add("Activity", Uml.ActivityEdge_Activity);
                publicPropertiesByName.Add("Guard", Uml.ActivityEdge_Guard);
                publicPropertiesByName.Add("InGroup", Uml.ActivityEdge_InGroup);
                publicPropertiesByName.Add("InPartition", Uml.ActivityEdge_InPartition);
                publicPropertiesByName.Add("InStructuredNode", Uml.ActivityEdge_InStructuredNode);
                publicPropertiesByName.Add("Interrupts", Uml.ActivityEdge_Interrupts);
                publicPropertiesByName.Add("RedefinedEdge", Uml.ActivityEdge_RedefinedEdge);
                publicPropertiesByName.Add("Source", Uml.ActivityEdge_Source);
                publicPropertiesByName.Add("Target", Uml.ActivityEdge_Target);
                publicPropertiesByName.Add("Weight", Uml.ActivityEdge_Weight);
                ...
                modelPropertyInfos.Add(Uml.ObjectFlow_IsMulticast, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ObjectFlow_IsMulticast, __ImmutableArray.Create<__ModelProperty>(Uml.ObjectFlow_IsMulticast), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ObjectFlow_IsMultireceive, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ObjectFlow_IsMultireceive, __ImmutableArray.Create<__ModelProperty>(Uml.ObjectFlow_IsMultireceive), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ObjectFlow_Selection, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ObjectFlow_Selection, __ImmutableArray.Create<__ModelProperty>(Uml.ObjectFlow_Selection), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ObjectFlow_Transformation, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ObjectFlow_Transformation, __ImmutableArray.Create<__ModelProperty>(Uml.ObjectFlow_Transformation), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ActivityEdge_Activity, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ActivityEdge_Activity, __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_Activity), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Activity_Edge), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ActivityEdge_Guard, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ActivityEdge_Guard, __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_Guard), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ActivityEdge_InGroup, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ActivityEdge_InGroup, __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_InGroup), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityGroup_ContainedEdge), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_InPartition, Uml.ActivityEdge_InStructuredNode), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ActivityEdge_InPartition, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ActivityEdge_InPartition, __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_InPartition), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityPartition_Edge), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_InGroup), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ActivityEdge_InStructuredNode, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ActivityEdge_InStructuredNode, __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_InStructuredNode), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.StructuredActivityNode_Edge), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_InGroup, Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ActivityEdge_Interrupts, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ActivityEdge_Interrupts, __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_Interrupts), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.InterruptibleActivityRegion_InterruptingEdge), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ActivityEdge_RedefinedEdge, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ActivityEdge_RedefinedEdge, __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_RedefinedEdge), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.RedefinableElement_RedefinedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ActivityEdge_Source, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ActivityEdge_Source, __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_Source), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityNode_Outgoing), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ActivityEdge_Target, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ActivityEdge_Target, __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_Target), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityNode_Incoming), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ActivityEdge_Weight, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ActivityEdge_Weight, __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_Weight), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.RedefinableElement_RedefinedElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.RedefinableElement_RedefinedElement, __ImmutableArray.Create<__ModelProperty>(Uml.RedefinableElement_RedefinedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_RedefinedEdge), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Element_OwnedElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Element_OwnedElement, __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_Guard, Uml.ActivityEdge_Weight, Uml.NamedElement_NameExpression, Uml.Element_OwnedComment), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Element_Owner, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Element_Owner, __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_Activity, Uml.ActivityEdge_InStructuredNode, Uml.NamedElement_Namespace), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                _modelPropertyInfos = modelPropertyInfos.ToImmutable();
    
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>();
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.ActivityEdge_IsConsistentWith, Uml.RedefinableElement_IsConsistentWith, Uml.RedefinableElement_IsRedefinitionContextValid, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.ActivityEdge_IsConsistentWith, Uml.RedefinableElement_IsRedefinitionContextValid, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.ActivityEdge_IsConsistentWith, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.RedefinableElement_IsConsistentWith), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.RedefinableElement_IsConsistentWith, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.ActivityEdge_IsConsistentWith)));
            ...
            public override __MetaType MetaType => typeof(ObjectFlow);
            ...
            {
                var result = new ObjectFlow_Impl(id);
