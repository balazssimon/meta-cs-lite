...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ConditionalNode_Impl : __MetaModelObject, ConditionalNode
    {
        private ConditionalNode_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.ConditionalNode_IsAssured)?.Add((bool)false);
            ((__IModelObject)this).MGetSlot(Uml.ConditionalNode_IsDeterminate)?.Add((bool)false);
            ...
            Uml.__CustomImpl.ConditionalNode(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<Clause> Clause
        {
            get => MGetCollection<Clause>(Uml.ConditionalNode_Clause);
        }
    
        public bool IsAssured
        {
            get => MGet<bool>(Uml.ConditionalNode_IsAssured);
            set => MSet<bool>(Uml.ConditionalNode_IsAssured, value);
        }
    
        public bool IsDeterminate
        {
            get => MGet<bool>(Uml.ConditionalNode_IsDeterminate);
            set => MSet<bool>(Uml.ConditionalNode_IsDeterminate, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<OutputPin> Result
        {
            get => MGetCollection<OutputPin>(Uml.ConditionalNode_Result);
        }
        ...
        global::System.Collections.Generic.IList<Action> ConditionalNode.AllActions(global::System.Collections.Generic.IList<Action> result) => Uml.__CustomImpl.ConditionalNode_AllActions(this, result);
        global::System.Collections.Generic.IList<Action> StructuredActivityNode.AllActions(global::System.Collections.Generic.IList<Action> result) => Uml.__CustomImpl.ConditionalNode_AllActions(this, result);
        ...
        global::System.Collections.Generic.IList<ActivityNode> StructuredActivityNode.SourceNodes(global::System.Collections.Generic.IList<ActivityNode> result) => Uml.__CustomImpl.StructuredActivityNode_SourceNodes(this, result);
        ...
        global::System.Collections.Generic.IList<Action> Action.AllActions(global::System.Collections.Generic.IList<Action> result) => Uml.__CustomImpl.ConditionalNode_AllActions(this, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.ConditionalNode_Clause, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ConditionalNode_Clause, __ImmutableArray.Create<__ModelProperty>(Uml.ConditionalNode_Clause), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ConditionalNode_IsAssured, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ConditionalNode_IsAssured, __ImmutableArray.Create<__ModelProperty>(Uml.ConditionalNode_IsAssured), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ConditionalNode_IsDeterminate, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ConditionalNode_IsDeterminate, __ImmutableArray.Create<__ModelProperty>(Uml.ConditionalNode_IsDeterminate), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ConditionalNode_Result, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ConditionalNode_Result, __ImmutableArray.Create<__ModelProperty>(Uml.ConditionalNode_Result, Uml.StructuredActivityNode_StructuredNodeOutput), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.StructuredActivityNode_StructuredNodeOutput), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.StructuredActivityNode_StructuredNodeOutput, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ConditionalNode_Result, __ImmutableArray.Create<__ModelProperty>(Uml.ConditionalNode_Result, Uml.StructuredActivityNode_StructuredNodeOutput), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Output), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.ConditionalNode_Result), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.ConditionalNode_AllActions);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.ConditionalNode_AllActions, Uml.StructuredActivityNode_AllActions, Uml.StructuredActivityNode_AllOwnedNodes, Uml.StructuredActivityNode_ContainingActivity, Uml.StructuredActivityNode_SourceNodes, Uml.StructuredActivityNode_TargetNodes, Uml.Action_AllActions, Uml.Action_AllOwnedNodes, Uml.Action_ContainingBehavior, Uml.ActivityGroup_ContainingActivity, Uml.ActivityNode_ContainingActivity, Uml.ActivityNode_IsConsistentWith, Uml.Namespace_ExcludeCollisions, Uml.Namespace_GetNamesOfMember, Uml.Namespace_ImportMembers, Uml.Namespace_MembersAreDistinguishable, Uml.RedefinableElement_IsConsistentWith, Uml.RedefinableElement_IsRedefinitionContextValid, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.ConditionalNode_AllActions, Uml.StructuredActivityNode_AllOwnedNodes, Uml.StructuredActivityNode_ContainingActivity, Uml.StructuredActivityNode_SourceNodes, Uml.StructuredActivityNode_TargetNodes, Uml.Action_ContainingBehavior, Uml.ActivityNode_IsConsistentWith, Uml.Namespace_ExcludeCollisions, Uml.Namespace_GetNamesOfMember, Uml.Namespace_ImportMembers, Uml.Namespace_MembersAreDistinguishable, Uml.RedefinableElement_IsRedefinitionContextValid, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.ConditionalNode_AllActions, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.StructuredActivityNode_AllActions, Uml.Action_AllActions), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.StructuredActivityNode_AllActions, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.Action_AllActions), __ImmutableArray.Create<__ModelOperation>(Uml.ConditionalNode_AllActions)));
                    ...
                    modelOperationInfos.Add(Uml.Action_AllActions, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.ConditionalNode_AllActions, Uml.StructuredActivityNode_AllActions)));
            ...
            public override __MetaType MetaType => typeof(ConditionalNode);
            ...
            {
                var result = new ConditionalNode_Impl(id);
            ...
            {
                return "Uml.ConditionalNodeInfo";
            }
        }
    }
}
