...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class StateInvariant_Impl : __MetaModelObject, StateInvariant
    {
        private StateInvariant_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.NamedElement(this);
            Uml.__CustomImpl.InteractionFragment(this);
            Uml.__CustomImpl.StateInvariant(this);
        }
        ...
        {
            get => MGet<Lifeline>(Uml.StateInvariant_Covered);
            set => MSet<Lifeline>(Uml.StateInvariant_Covered, value);
        }
    
        public Constraint Invariant
        {
            get => MGet<Constraint>(Uml.StateInvariant_Invariant);
            set => MSet<Constraint>(Uml.StateInvariant_Invariant, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.StateInvariant_Covered, Uml.StateInvariant_Invariant);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.StateInvariant_Covered, Uml.StateInvariant_Invariant, Uml.InteractionFragment_Covered, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.StateInvariant_Covered, Uml.StateInvariant_Invariant, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Covered", Uml.StateInvariant_Covered);
                publicPropertiesByName.Add("Invariant", Uml.StateInvariant_Invariant);
                ...
                modelPropertyInfos.Add(Uml.StateInvariant_Covered, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.StateInvariant_Covered, __ImmutableArray.Create<__ModelProperty>(Uml.StateInvariant_Covered, Uml.InteractionFragment_Covered), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.InteractionFragment_Covered), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.InteractionFragment_Covered), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.StateInvariant_Invariant, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.StateInvariant_Invariant, __ImmutableArray.Create<__ModelProperty>(Uml.StateInvariant_Invariant), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InteractionFragment_Covered, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.StateInvariant_Covered, __ImmutableArray.Create<__ModelProperty>(Uml.StateInvariant_Covered, Uml.InteractionFragment_Covered), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Lifeline_CoveredBy), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.StateInvariant_Covered), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.StateInvariant_Covered)));
            ...
            public override __MetaType MetaType => typeof(StateInvariant);
            ...
            {
                var result = new StateInvariant_Impl(id);
