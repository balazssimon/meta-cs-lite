...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Activity_Impl : __MetaModelObject, Activity
    {
        private Activity_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.Activity_IsReadOnly)?.Add((bool)false);
            ((__IModelObject)this).MGetSlot(Uml.Activity_IsSingleExecution)?.Add((bool)false);
            ...
            Uml.__CustomImpl.Activity(this);
        }
        ...
        {
            get => MGetCollection<ActivityEdge>(Uml.Activity_Edge);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ActivityGroup> Group
        {
            get => MGetCollection<ActivityGroup>(Uml.Activity_Group);
        }
    
        public bool IsReadOnly
        {
            get => MGet<bool>(Uml.Activity_IsReadOnly);
            set => MSet<bool>(Uml.Activity_IsReadOnly, value);
        }
    
        public bool IsSingleExecution
        {
            get => MGet<bool>(Uml.Activity_IsSingleExecution);
            set => MSet<bool>(Uml.Activity_IsSingleExecution, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ActivityNode> Node
        {
            get => MGetCollection<ActivityNode>(Uml.Activity_Node);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ActivityPartition> Partition
        {
            get => MGetCollection<ActivityPartition>(Uml.Activity_Partition);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<StructuredActivityNode> StructuredNode
        {
            get => MGetCollection<StructuredActivityNode>(Uml.Activity_StructuredNode);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Variable> Variable
        {
            get => MGetCollection<Variable>(Uml.Activity_Variable);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.Activity_Edge, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Activity_Edge, __ImmutableArray.Create<__ModelProperty>(Uml.Activity_Edge), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityEdge_Activity), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Activity_Group, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Activity_Group, __ImmutableArray.Create<__ModelProperty>(Uml.Activity_Group), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityGroup_InActivity), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(Uml.Activity_Partition, Uml.Activity_StructuredNode), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Activity_IsReadOnly, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Activity_IsReadOnly, __ImmutableArray.Create<__ModelProperty>(Uml.Activity_IsReadOnly), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Activity_IsSingleExecution, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Activity_IsSingleExecution, __ImmutableArray.Create<__ModelProperty>(Uml.Activity_IsSingleExecution), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Activity_Node, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Activity_Node, __ImmutableArray.Create<__ModelProperty>(Uml.Activity_Node), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.ActivityNode_Activity), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(Uml.Activity_StructuredNode), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Activity_Partition, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Activity_Partition, __ImmutableArray.Create<__ModelProperty>(Uml.Activity_Partition), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Activity_Group), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Activity_StructuredNode, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Activity_StructuredNode, __ImmutableArray.Create<__ModelProperty>(Uml.Activity_StructuredNode), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.StructuredActivityNode_Activity), __ImmutableArray.Create<__ModelProperty>(Uml.Activity_Group, Uml.Activity_Node), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Activity_Variable, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Activity_Variable, __ImmutableArray.Create<__ModelProperty>(Uml.Activity_Variable), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Variable_ActivityScope), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Behavior_RedefinedBehavior, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Behavior_RedefinedBehavior, __ImmutableArray.Create<__ModelProperty>(Uml.Behavior_RedefinedBehavior), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_RedefinedClassifier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Activity);
            ...
            {
                var result = new Activity_Impl(id);
