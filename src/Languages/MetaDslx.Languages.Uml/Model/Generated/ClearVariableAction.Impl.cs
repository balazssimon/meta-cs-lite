...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ClearVariableAction_Impl : __MetaModelObject, ClearVariableAction
    {
        private ClearVariableAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ClearVariableAction(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(ClearVariableAction);
            ...
            {
                var result = new ClearVariableAction_Impl(id);
            ...
            {
                return "Uml.ClearVariableActionInfo";
            }
        }
    }
}
