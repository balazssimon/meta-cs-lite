...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class InteractionUse_Impl : __MetaModelObject, InteractionUse
    {
        private InteractionUse_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.NamedElement(this);
            Uml.__CustomImpl.InteractionFragment(this);
            Uml.__CustomImpl.InteractionUse(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<Gate> ActualGate
        {
            get => MGetCollection<Gate>(Uml.InteractionUse_ActualGate);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ValueSpecification> Argument
        {
            get => MGetCollection<ValueSpecification>(Uml.InteractionUse_Argument);
        }
    
        public Interaction RefersTo
        {
            get => MGet<Interaction>(Uml.InteractionUse_RefersTo);
            set => MSet<Interaction>(Uml.InteractionUse_RefersTo, value);
        }
    
        public ValueSpecification ReturnValue
        {
            get => MGet<ValueSpecification>(Uml.InteractionUse_ReturnValue);
            set => MSet<ValueSpecification>(Uml.InteractionUse_ReturnValue, value);
        }
    
        public Property ReturnValueRecipient
        {
            get => MGet<Property>(Uml.InteractionUse_ReturnValueRecipient);
            set => MSet<Property>(Uml.InteractionUse_ReturnValueRecipient, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InteractionUse_ActualGate, Uml.InteractionUse_Argument, Uml.InteractionUse_RefersTo, Uml.InteractionUse_ReturnValue, Uml.InteractionUse_ReturnValueRecipient);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InteractionUse_ActualGate, Uml.InteractionUse_Argument, Uml.InteractionUse_RefersTo, Uml.InteractionUse_ReturnValue, Uml.InteractionUse_ReturnValueRecipient, Uml.InteractionFragment_Covered, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InteractionUse_ActualGate, Uml.InteractionUse_Argument, Uml.InteractionUse_RefersTo, Uml.InteractionUse_ReturnValue, Uml.InteractionUse_ReturnValueRecipient, Uml.InteractionFragment_Covered, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("ActualGate", Uml.InteractionUse_ActualGate);
                publicPropertiesByName.Add("Argument", Uml.InteractionUse_Argument);
                publicPropertiesByName.Add("RefersTo", Uml.InteractionUse_RefersTo);
                publicPropertiesByName.Add("ReturnValue", Uml.InteractionUse_ReturnValue);
                publicPropertiesByName.Add("ReturnValueRecipient", Uml.InteractionUse_ReturnValueRecipient);
                ...
                modelPropertyInfos.Add(Uml.InteractionUse_ActualGate, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InteractionUse_ActualGate, __ImmutableArray.Create<__ModelProperty>(Uml.InteractionUse_ActualGate), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Gate_InteractionUse), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InteractionUse_Argument, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InteractionUse_Argument, __ImmutableArray.Create<__ModelProperty>(Uml.InteractionUse_Argument), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InteractionUse_RefersTo, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InteractionUse_RefersTo, __ImmutableArray.Create<__ModelProperty>(Uml.InteractionUse_RefersTo), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InteractionUse_ReturnValue, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InteractionUse_ReturnValue, __ImmutableArray.Create<__ModelProperty>(Uml.InteractionUse_ReturnValue), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.InteractionUse_ReturnValueRecipient, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InteractionUse_ReturnValueRecipient, __ImmutableArray.Create<__ModelProperty>(Uml.InteractionUse_ReturnValueRecipient), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(InteractionUse);
            ...
            {
                var result = new InteractionUse_Impl(id);
