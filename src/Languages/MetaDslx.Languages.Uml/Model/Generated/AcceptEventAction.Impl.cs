...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class AcceptEventAction_Impl : __MetaModelObject, AcceptEventAction
    {
        private AcceptEventAction_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(AcceptEventAction);
            ...
            {
                var result = new AcceptEventAction_Impl(id);
            ...
            {
                return "Uml.AcceptEventActionInfo";
            }
        }
    }
}
