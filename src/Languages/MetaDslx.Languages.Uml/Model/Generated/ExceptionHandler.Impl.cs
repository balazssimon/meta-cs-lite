...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ExceptionHandler_Impl : __MetaModelObject, ExceptionHandler
    {
        private ExceptionHandler_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.ExceptionHandler(this);
        }
        ...
        {
            get => MGet<ObjectNode>(Uml.ExceptionHandler_ExceptionInput);
            set => MSet<ObjectNode>(Uml.ExceptionHandler_ExceptionInput, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Classifier> ExceptionType
        {
            get => MGetCollection<Classifier>(Uml.ExceptionHandler_ExceptionType);
        }
    
        public ExecutableNode HandlerBody
        {
            get => MGet<ExecutableNode>(Uml.ExceptionHandler_HandlerBody);
            set => MSet<ExecutableNode>(Uml.ExceptionHandler_HandlerBody, value);
        }
    
        public ExecutableNode ProtectedNode
        {
            get => MGet<ExecutableNode>(Uml.ExceptionHandler_ProtectedNode);
            set => MSet<ExecutableNode>(Uml.ExceptionHandler_ProtectedNode, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ExceptionHandler_ExceptionInput, Uml.ExceptionHandler_ExceptionType, Uml.ExceptionHandler_HandlerBody, Uml.ExceptionHandler_ProtectedNode);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ExceptionHandler_ExceptionInput, Uml.ExceptionHandler_ExceptionType, Uml.ExceptionHandler_HandlerBody, Uml.ExceptionHandler_ProtectedNode, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ExceptionHandler_ExceptionInput, Uml.ExceptionHandler_ExceptionType, Uml.ExceptionHandler_HandlerBody, Uml.ExceptionHandler_ProtectedNode, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("ExceptionInput", Uml.ExceptionHandler_ExceptionInput);
                publicPropertiesByName.Add("ExceptionType", Uml.ExceptionHandler_ExceptionType);
                publicPropertiesByName.Add("HandlerBody", Uml.ExceptionHandler_HandlerBody);
                publicPropertiesByName.Add("ProtectedNode", Uml.ExceptionHandler_ProtectedNode);
                ...
                modelPropertyInfos.Add(Uml.ExceptionHandler_ExceptionInput, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ExceptionHandler_ExceptionInput, __ImmutableArray.Create<__ModelProperty>(Uml.ExceptionHandler_ExceptionInput), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ExceptionHandler_ExceptionType, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ExceptionHandler_ExceptionType, __ImmutableArray.Create<__ModelProperty>(Uml.ExceptionHandler_ExceptionType), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ExceptionHandler_HandlerBody, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ExceptionHandler_HandlerBody, __ImmutableArray.Create<__ModelProperty>(Uml.ExceptionHandler_HandlerBody), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ExceptionHandler_ProtectedNode, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ExceptionHandler_ProtectedNode, __ImmutableArray.Create<__ModelProperty>(Uml.ExceptionHandler_ProtectedNode), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.ExecutableNode_Handler), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ExceptionHandler);
            ...
            {
                var result = new ExceptionHandler_Impl(id);
            ...
            {
                return "Uml.ExceptionHandlerInfo";
            }
        }
    }
}
