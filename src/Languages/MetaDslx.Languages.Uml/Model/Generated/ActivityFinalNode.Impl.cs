...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ActivityFinalNode_Impl : __MetaModelObject, ActivityFinalNode
    {
        private ActivityFinalNode_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.FinalNode(this);
            Uml.__CustomImpl.ActivityFinalNode(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.FinalNodeInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.FinalNodeInfo, Uml.ControlNodeInfo, Uml.ActivityNodeInfo, Uml.RedefinableElementInfo, Uml.NamedElementInfo, Uml.ElementInfo);
            ...
            public override __MetaType MetaType => typeof(ActivityFinalNode);
            ...
            {
                var result = new ActivityFinalNode_Impl(id);
            ...
            {
                return "Uml.ActivityFinalNodeInfo";
            }
        }
    }
}
