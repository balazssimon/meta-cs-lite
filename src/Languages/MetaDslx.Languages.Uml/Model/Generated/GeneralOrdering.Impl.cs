...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class GeneralOrdering_Impl : __MetaModelObject, GeneralOrdering
    {
        private GeneralOrdering_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.NamedElement(this);
            Uml.__CustomImpl.GeneralOrdering(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public OccurrenceSpecification After
        {
            get => MGet<OccurrenceSpecification>(Uml.GeneralOrdering_After);
            set => MSet<OccurrenceSpecification>(Uml.GeneralOrdering_After, value);
        }
    
        public OccurrenceSpecification Before
        {
            get => MGet<OccurrenceSpecification>(Uml.GeneralOrdering_Before);
            set => MSet<OccurrenceSpecification>(Uml.GeneralOrdering_Before, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.GeneralOrdering_After, Uml.GeneralOrdering_Before);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.GeneralOrdering_After, Uml.GeneralOrdering_Before, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.GeneralOrdering_After, Uml.GeneralOrdering_Before, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("After", Uml.GeneralOrdering_After);
                publicPropertiesByName.Add("Before", Uml.GeneralOrdering_Before);
                ...
                modelPropertyInfos.Add(Uml.GeneralOrdering_After, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.GeneralOrdering_After, __ImmutableArray.Create<__ModelProperty>(Uml.GeneralOrdering_After), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.OccurrenceSpecification_ToBefore), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.GeneralOrdering_Before, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.GeneralOrdering_Before, __ImmutableArray.Create<__ModelProperty>(Uml.GeneralOrdering_Before), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.OccurrenceSpecification_ToAfter), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(GeneralOrdering);
            ...
            {
                var result = new GeneralOrdering_Impl(id);
            ...
            {
                return "Uml.GeneralOrderingInfo";
            }
        }
    }
}
