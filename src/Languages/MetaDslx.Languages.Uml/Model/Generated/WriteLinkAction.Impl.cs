...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class WriteLinkAction_Impl : __MetaModelObject, WriteLinkAction
    {
        private WriteLinkAction_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(WriteLinkAction);
            ...
            {
                var result = new WriteLinkAction_Impl(id);
            ...
            {
                return "Uml.WriteLinkActionInfo";
            }
        }
    }
}
