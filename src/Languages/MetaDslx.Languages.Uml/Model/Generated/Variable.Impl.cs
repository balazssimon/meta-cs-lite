...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Variable_Impl : __MetaModelObject, Variable
    {
            ...
            : base(id)
        {
            ...
            Uml.__CustomImpl.Variable(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public Activity ActivityScope
        {
            get => MGet<Activity>(Uml.Variable_ActivityScope);
            set => MSet<Activity>(Uml.Variable_ActivityScope, value);
        }
    
        public StructuredActivityNode Scope
        {
            get => MGet<StructuredActivityNode>(Uml.Variable_Scope);
            set => MSet<StructuredActivityNode>(Uml.Variable_Scope, value);
        }
        ...
        bool Variable.IsAccessibleBy(bool result, Action a) => Uml.__CustomImpl.Variable_IsAccessibleBy(this, result, a);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Variable_ActivityScope, Uml.Variable_Scope);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Variable_ActivityScope, Uml.Variable_Scope, Uml.ConnectableElement_End, Uml.ConnectableElement_TemplateParameter, Uml.MultiplicityElement_IsOrdered, Uml.MultiplicityElement_IsUnique, Uml.MultiplicityElement_Lower, Uml.MultiplicityElement_LowerValue, Uml.MultiplicityElement_Upper, Uml.MultiplicityElement_UpperValue, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Variable_ActivityScope, Uml.Variable_Scope, Uml.ConnectableElement_End, Uml.ConnectableElement_TemplateParameter, Uml.MultiplicityElement_IsOrdered, Uml.MultiplicityElement_IsUnique, Uml.MultiplicityElement_Lower, Uml.MultiplicityElement_LowerValue, Uml.MultiplicityElement_Upper, Uml.MultiplicityElement_UpperValue, Uml.ParameterableElement_OwningTemplateParameter, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("ActivityScope", Uml.Variable_ActivityScope);
                publicPropertiesByName.Add("Scope", Uml.Variable_Scope);
                ...
                modelPropertyInfos.Add(Uml.Variable_ActivityScope, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Variable_ActivityScope, __ImmutableArray.Create<__ModelProperty>(Uml.Variable_ActivityScope), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Activity_Variable), __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Variable_Scope, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Variable_Scope, __ImmutableArray.Create<__ModelProperty>(Uml.Variable_Scope), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.StructuredActivityNode_Variable), __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.NamedElement_Namespace, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.NamedElement_Namespace, __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(Uml.Variable_ActivityScope, Uml.Variable_Scope), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
