...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class InitialNode_Impl : __MetaModelObject, InitialNode
    {
        private InitialNode_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.InitialNode(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(InitialNode);
            ...
            {
                var result = new InitialNode_Impl(id);
