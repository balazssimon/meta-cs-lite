...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class __TransitionKind_Info : __ModelEnumInfo
    {
        public static readonly __TransitionKind_Info Instance = new __TransitionKind_Info();
        ...
        private __TransitionKind_Info()
        {
            _literals = __ImmutableArray.Create<string>("Internal", "Local", "External");
            var literalsByName = __ImmutableDictionary.CreateBuilder<string, __MetaSymbol>();
            literalsByName.Add("Internal", __MetaSymbol.FromValue(TransitionKind.Internal));
            literalsByName.Add("Local", __MetaSymbol.FromValue(TransitionKind.Local));
            literalsByName.Add("External", __MetaSymbol.FromValue(TransitionKind.External));
            _literalsByName = literalsByName.ToImmutable();
        }
    
        public override __MetaModel MetaModel => Uml.MInstance;
        public override __MetaType MetaType => typeof(TransitionKind);
