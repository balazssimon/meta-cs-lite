...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Dependency_Impl : __MetaModelObject, Dependency
    {
        private Dependency_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Client, Uml.Dependency_Supplier);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Client, Uml.Dependency_Supplier, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Client, Uml.Dependency_Supplier, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
            ...
            public override __MetaType MetaType => typeof(Dependency);
            ...
            {
                var result = new Dependency_Impl(id);
