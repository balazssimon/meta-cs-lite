...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ActionInputPin_Impl : __MetaModelObject, ActionInputPin
    {
        private ActionInputPin_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ActionInputPin(this);
        }
        ...
        {
            get => MGet<Action>(Uml.ActionInputPin_FromAction);
            set => MSet<Action>(Uml.ActionInputPin_FromAction, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.Element_OwnedElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Element_OwnedElement, __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.ActionInputPin_FromAction, Uml.MultiplicityElement_LowerValue, Uml.MultiplicityElement_UpperValue, Uml.ObjectNode_UpperBound, Uml.NamedElement_NameExpression, Uml.Element_OwnedComment), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ActionInputPin);
            ...
            {
                var result = new ActionInputPin_Impl(id);
