...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class CreateLinkObjectAction_Impl : __MetaModelObject, CreateLinkObjectAction
    {
        private CreateLinkObjectAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.LinkAction(this);
            Uml.__CustomImpl.WriteLinkAction(this);
            Uml.__CustomImpl.CreateLinkAction(this);
            Uml.__CustomImpl.CreateLinkObjectAction(this);
        }
        ...
        {
            get => MGet<OutputPin>(Uml.CreateLinkObjectAction_Result);
            set => MSet<OutputPin>(Uml.CreateLinkObjectAction_Result, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<LinkEndCreationData> EndData
        {
            get => MGetCollection<LinkEndCreationData>(Uml.CreateLinkAction_EndData);
        }
    
        [global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)]
        global::MetaDslx.Modeling.ICollectionSlot<LinkEndData> LinkAction.EndData
        {
            get => MGetCollection<LinkEndData>(Uml.LinkAction_EndData);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<InputPin> InputValue
        {
            get => MGetCollection<InputPin>(Uml.LinkAction_InputValue);
        }
        ...
        Association LinkAction.Association(Association result) => Uml.__CustomImpl.LinkAction_Association(this, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.CreateLinkActionInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.CreateLinkActionInfo, Uml.WriteLinkActionInfo, Uml.LinkActionInfo, Uml.ActionInfo, Uml.ExecutableNodeInfo, Uml.ActivityNodeInfo, Uml.RedefinableElementInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.CreateLinkObjectAction_Result);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.CreateLinkObjectAction_Result, Uml.CreateLinkAction_EndData, Uml.LinkAction_EndData, Uml.LinkAction_InputValue, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.CreateLinkObjectAction_Result, Uml.CreateLinkAction_EndData, Uml.LinkAction_InputValue, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Result", Uml.CreateLinkObjectAction_Result);
                publicPropertiesByName.Add("EndData", Uml.CreateLinkAction_EndData);
                publicPropertiesByName.Add("InputValue", Uml.LinkAction_InputValue);
                ...
                modelPropertyInfos.Add(Uml.CreateLinkObjectAction_Result, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.CreateLinkObjectAction_Result, __ImmutableArray.Create<__ModelProperty>(Uml.CreateLinkObjectAction_Result), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Output), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.CreateLinkAction_EndData, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.CreateLinkAction_EndData, __ImmutableArray.Create<__ModelProperty>(Uml.CreateLinkAction_EndData, Uml.LinkAction_EndData), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.LinkAction_EndData), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.LinkAction_EndData), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.LinkAction_EndData, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.CreateLinkAction_EndData, __ImmutableArray.Create<__ModelProperty>(Uml.CreateLinkAction_EndData, Uml.LinkAction_EndData), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.CreateLinkAction_EndData), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.CreateLinkAction_EndData)));
                modelPropertyInfos.Add(Uml.LinkAction_InputValue, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.LinkAction_InputValue, __ImmutableArray.Create<__ModelProperty>(Uml.LinkAction_InputValue), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(CreateLinkObjectAction);
            ...
            {
                var result = new CreateLinkObjectAction_Impl(id);
            ...
            {
                return "Uml.CreateLinkObjectActionInfo";
            }
        }
    }
}
