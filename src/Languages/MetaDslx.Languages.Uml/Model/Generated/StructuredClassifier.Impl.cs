...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class StructuredClassifier_Impl : __MetaModelObject, StructuredClassifier
    {
        private StructuredClassifier_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.StructuredClassifier_OwnedAttribute, Uml.StructuredClassifier_OwnedConnector, Uml.StructuredClassifier_Part, Uml.StructuredClassifier_Role);
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.StructuredClassifier_AllRoles);
            ...
            public override __MetaType MetaType => typeof(StructuredClassifier);
            ...
            {
                var result = new StructuredClassifier_Impl(id);
            ...
            {
                return "Uml.StructuredClassifierInfo";
            }
        }
    }
}
