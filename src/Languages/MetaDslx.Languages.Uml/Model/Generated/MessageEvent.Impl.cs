...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class MessageEvent_Impl : __MetaModelObject, MessageEvent
    {
        private MessageEvent_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(MessageEvent);
            ...
            {
                var result = new MessageEvent_Impl(id);
