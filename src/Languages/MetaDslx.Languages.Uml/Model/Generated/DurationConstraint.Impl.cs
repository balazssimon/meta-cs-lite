...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class DurationConstraint_Impl : __MetaModelObject, DurationConstraint
    {
        private DurationConstraint_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.Constraint(this);
            Uml.__CustomImpl.IntervalConstraint(this);
            Uml.__CustomImpl.DurationConstraint(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<bool> FirstEvent
        {
            get => MGetCollection<bool>(Uml.DurationConstraint_FirstEvent);
        }
    
        public DurationInterval Specification
        {
            get => MGet<DurationInterval>(Uml.DurationConstraint_Specification);
            set => MSet<DurationInterval>(Uml.DurationConstraint_Specification, value);
        }
    
        [global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)]
        Interval IntervalConstraint.Specification
        {
            get => MGet<Interval>(Uml.IntervalConstraint_Specification);
            set => MSet<Interval>(Uml.IntervalConstraint_Specification, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Element> ConstrainedElement
        {
            get => MGetCollection<Element>(Uml.Constraint_ConstrainedElement);
        }
    
        public Namespace Context
        {
            get => MGet<Namespace>(Uml.Constraint_Context);
            set => MSet<Namespace>(Uml.Constraint_Context, value);
        }
    
        [global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)]
        ValueSpecification Constraint.Specification
        {
            get => MGet<ValueSpecification>(Uml.Constraint_Specification);
            set => MSet<ValueSpecification>(Uml.Constraint_Specification, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.IntervalConstraintInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.IntervalConstraintInfo, Uml.ConstraintInfo, Uml.PackageableElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DurationConstraint_FirstEvent, Uml.DurationConstraint_Specification);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DurationConstraint_FirstEvent, Uml.DurationConstraint_Specification, Uml.IntervalConstraint_Specification, Uml.Constraint_ConstrainedElement, Uml.Constraint_Context, Uml.Constraint_Specification, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DurationConstraint_FirstEvent, Uml.DurationConstraint_Specification, Uml.Constraint_ConstrainedElement, Uml.Constraint_Context, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("FirstEvent", Uml.DurationConstraint_FirstEvent);
                publicPropertiesByName.Add("Specification", Uml.DurationConstraint_Specification);
                publicPropertiesByName.Add("ConstrainedElement", Uml.Constraint_ConstrainedElement);
                publicPropertiesByName.Add("Context", Uml.Constraint_Context);
                ...
                modelPropertyInfos.Add(Uml.DurationConstraint_FirstEvent, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DurationConstraint_FirstEvent, __ImmutableArray.Create<__ModelProperty>(Uml.DurationConstraint_FirstEvent), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.DurationConstraint_Specification, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DurationConstraint_Specification, __ImmutableArray.Create<__ModelProperty>(Uml.DurationConstraint_Specification, Uml.IntervalConstraint_Specification, Uml.Constraint_Specification), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.IntervalConstraint_Specification), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.IntervalConstraint_Specification, Uml.Constraint_Specification), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.IntervalConstraint_Specification, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DurationConstraint_Specification, __ImmutableArray.Create<__ModelProperty>(Uml.DurationConstraint_Specification, Uml.IntervalConstraint_Specification, Uml.Constraint_Specification), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Constraint_Specification), __ImmutableArray.Create<__ModelProperty>(Uml.DurationConstraint_Specification), __ImmutableArray.Create<__ModelProperty>(Uml.Constraint_Specification), __ImmutableArray.Create<__ModelProperty>(Uml.DurationConstraint_Specification)));
                modelPropertyInfos.Add(Uml.Constraint_ConstrainedElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Constraint_ConstrainedElement, __ImmutableArray.Create<__ModelProperty>(Uml.Constraint_ConstrainedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Constraint_Context, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Constraint_Context, __ImmutableArray.Create<__ModelProperty>(Uml.Constraint_Context), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedRule), __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Constraint_Specification, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DurationConstraint_Specification, __ImmutableArray.Create<__ModelProperty>(Uml.DurationConstraint_Specification, Uml.IntervalConstraint_Specification, Uml.Constraint_Specification), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.IntervalConstraint_Specification), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.DurationConstraint_Specification, Uml.IntervalConstraint_Specification)));
                ...
                modelPropertyInfos.Add(Uml.NamedElement_Namespace, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.NamedElement_Namespace, __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(Uml.Constraint_Context), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            {
                var result = new DurationConstraint_Impl(id);
            ...
            {
                return "Uml.DurationConstraintInfo";
            }
        }
    }
}
