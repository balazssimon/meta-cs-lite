...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Device_Impl : __MetaModelObject, Device
    {
        private Device_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(Device);
