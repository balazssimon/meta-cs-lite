...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class InstanceSpecification_Impl : __MetaModelObject, InstanceSpecification
    {
        private InstanceSpecification_Impl(string? id)
            : base(id)
        {
        ...
        public global::MetaDslx.Modeling.ICollectionSlot<Classifier> Classifier
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.DeployedArtifactInfo, Uml.DeploymentTargetInfo, Uml.PackageableElementInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.DeployedArtifactInfo, Uml.DeploymentTargetInfo, Uml.PackageableElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InstanceSpecification_Classifier, Uml.InstanceSpecification_Slot, Uml.InstanceSpecification_Specification);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InstanceSpecification_Classifier, Uml.InstanceSpecification_Slot, Uml.InstanceSpecification_Specification, Uml.DeploymentTarget_DeployedElement, Uml.DeploymentTarget_Deployment, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.InstanceSpecification_Classifier, Uml.InstanceSpecification_Slot, Uml.InstanceSpecification_Specification, Uml.DeploymentTarget_DeployedElement, Uml.DeploymentTarget_Deployment, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Classifier", Uml.InstanceSpecification_Classifier);
                ...
                modelPropertyInfos.Add(Uml.InstanceSpecification_Classifier, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.InstanceSpecification_Classifier, __ImmutableArray.Create<__ModelProperty>(Uml.InstanceSpecification_Classifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(InstanceSpecification);
            ...
            {
                var result = new InstanceSpecification_Impl(id);
            ...
            {
                return "Uml.InstanceSpecificationInfo";
            }
        }
    }
}
