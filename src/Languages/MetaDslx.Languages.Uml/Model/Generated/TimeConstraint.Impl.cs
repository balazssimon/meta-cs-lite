...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class TimeConstraint_Impl : __MetaModelObject, TimeConstraint
    {
        private TimeConstraint_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.TimeConstraint_FirstEvent)?.Add((bool)true);
            ...
            Uml.__CustomImpl.TimeConstraint(this);
        }
        ...
        {
            get => MGet<bool>(Uml.TimeConstraint_FirstEvent);
            set => MSet<bool>(Uml.TimeConstraint_FirstEvent, value);
        }
    
        public TimeInterval Specification
        {
            get => MGet<TimeInterval>(Uml.TimeConstraint_Specification);
            set => MSet<TimeInterval>(Uml.TimeConstraint_Specification, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TimeConstraint_FirstEvent, Uml.TimeConstraint_Specification);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TimeConstraint_FirstEvent, Uml.TimeConstraint_Specification, Uml.IntervalConstraint_Specification, Uml.Constraint_ConstrainedElement, Uml.Constraint_Context, Uml.Constraint_Specification, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TimeConstraint_FirstEvent, Uml.TimeConstraint_Specification, Uml.Constraint_ConstrainedElement, Uml.Constraint_Context, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("FirstEvent", Uml.TimeConstraint_FirstEvent);
                publicPropertiesByName.Add("Specification", Uml.TimeConstraint_Specification);
                ...
                modelPropertyInfos.Add(Uml.TimeConstraint_FirstEvent, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TimeConstraint_FirstEvent, __ImmutableArray.Create<__ModelProperty>(Uml.TimeConstraint_FirstEvent), true, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.TimeConstraint_Specification, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TimeConstraint_Specification, __ImmutableArray.Create<__ModelProperty>(Uml.TimeConstraint_Specification, Uml.IntervalConstraint_Specification, Uml.Constraint_Specification), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.IntervalConstraint_Specification), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.IntervalConstraint_Specification, Uml.Constraint_Specification), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.IntervalConstraint_Specification, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TimeConstraint_Specification, __ImmutableArray.Create<__ModelProperty>(Uml.TimeConstraint_Specification, Uml.IntervalConstraint_Specification, Uml.Constraint_Specification), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Constraint_Specification), __ImmutableArray.Create<__ModelProperty>(Uml.TimeConstraint_Specification), __ImmutableArray.Create<__ModelProperty>(Uml.Constraint_Specification), __ImmutableArray.Create<__ModelProperty>(Uml.TimeConstraint_Specification)));
                ...
                modelPropertyInfos.Add(Uml.Constraint_Specification, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TimeConstraint_Specification, __ImmutableArray.Create<__ModelProperty>(Uml.TimeConstraint_Specification, Uml.IntervalConstraint_Specification, Uml.Constraint_Specification), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.IntervalConstraint_Specification), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.TimeConstraint_Specification, Uml.IntervalConstraint_Specification)));
            ...
            public override __MetaType MetaType => typeof(TimeConstraint);
            ...
            {
                var result = new TimeConstraint_Impl(id);
