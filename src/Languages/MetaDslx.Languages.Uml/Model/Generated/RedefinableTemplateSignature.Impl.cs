...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class RedefinableTemplateSignature_Impl : __MetaModelObject, RedefinableTemplateSignature
    {
        ...
        bool RedefinableTemplateSignature.IsConsistentWith(bool result, RedefinableElement redefiningElement) => Uml.__CustomImpl.RedefinableTemplateSignature_IsConsistentWith(this, result, redefiningElement);
        bool RedefinableElement.IsConsistentWith(bool result, RedefinableElement redefiningElement) => Uml.__CustomImpl.RedefinableTemplateSignature_IsConsistentWith(this, result, redefiningElement);
