...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class DurationObservation_Impl : __MetaModelObject, DurationObservation
    {
        private DurationObservation_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.Observation(this);
            Uml.__CustomImpl.DurationObservation(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<NamedElement> Event
        {
            get => MGetCollection<NamedElement>(Uml.DurationObservation_Event);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<bool> FirstEvent
        {
            get => MGetCollection<bool>(Uml.DurationObservation_FirstEvent);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ObservationInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ObservationInfo, Uml.PackageableElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DurationObservation_Event, Uml.DurationObservation_FirstEvent);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DurationObservation_Event, Uml.DurationObservation_FirstEvent, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DurationObservation_Event, Uml.DurationObservation_FirstEvent, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Event", Uml.DurationObservation_Event);
                publicPropertiesByName.Add("FirstEvent", Uml.DurationObservation_FirstEvent);
                ...
                modelPropertyInfos.Add(Uml.DurationObservation_Event, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DurationObservation_Event, __ImmutableArray.Create<__ModelProperty>(Uml.DurationObservation_Event), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.DurationObservation_FirstEvent, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DurationObservation_FirstEvent, __ImmutableArray.Create<__ModelProperty>(Uml.DurationObservation_FirstEvent), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(DurationObservation);
            ...
            {
                var result = new DurationObservation_Impl(id);
            ...
            {
                return "Uml.DurationObservationInfo";
            }
        }
    }
}
