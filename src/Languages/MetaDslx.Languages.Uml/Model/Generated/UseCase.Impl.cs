...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class UseCase_Impl : __MetaModelObject, UseCase
    {
        private UseCase_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.UseCase(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<Extend> Extend
        {
            get => MGetCollection<Extend>(Uml.UseCase_Extend);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ExtensionPoint> ExtensionPoint
        {
            get => MGetCollection<ExtensionPoint>(Uml.UseCase_ExtensionPoint);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Include> Include
        {
            get => MGetCollection<Include>(Uml.UseCase_Include);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Classifier> Subject
        {
            get => MGetCollection<Classifier>(Uml.UseCase_Subject);
        }
        ...
        global::System.Collections.Generic.IList<UseCase> UseCase.AllIncludedUseCases(global::System.Collections.Generic.IList<UseCase> result) => Uml.__CustomImpl.UseCase_AllIncludedUseCases(this, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.UseCase_Extend, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.UseCase_Extend, __ImmutableArray.Create<__ModelProperty>(Uml.UseCase_Extend), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Extend_Extension), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.UseCase_ExtensionPoint, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.UseCase_ExtensionPoint, __ImmutableArray.Create<__ModelProperty>(Uml.UseCase_ExtensionPoint), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.ExtensionPoint_UseCase), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.UseCase_Include, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.UseCase_Include, __ImmutableArray.Create<__ModelProperty>(Uml.UseCase_Include), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Include_IncludingCase), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.UseCase_Subject, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.UseCase_Subject, __ImmutableArray.Create<__ModelProperty>(Uml.UseCase_Subject), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_UseCase), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(UseCase);
            ...
            {
                var result = new UseCase_Impl(id);
