...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ReclassifyObjectAction_Impl : __MetaModelObject, ReclassifyObjectAction
    {
        private ReclassifyObjectAction_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.ReclassifyObjectAction_IsReplaceAll)?.Add((bool)false);
            ...
            Uml.__CustomImpl.ReclassifyObjectAction(this);
        }
        ...
        {
            get => MGet<bool>(Uml.ReclassifyObjectAction_IsReplaceAll);
            set => MSet<bool>(Uml.ReclassifyObjectAction_IsReplaceAll, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Classifier> NewClassifier
        {
            get => MGetCollection<Classifier>(Uml.ReclassifyObjectAction_NewClassifier);
        }
    
        public InputPin Object
        {
            get => MGet<InputPin>(Uml.ReclassifyObjectAction_Object);
            set => MSet<InputPin>(Uml.ReclassifyObjectAction_Object, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Classifier> OldClassifier
        {
            get => MGetCollection<Classifier>(Uml.ReclassifyObjectAction_OldClassifier);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ActionInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ActionInfo, Uml.ExecutableNodeInfo, Uml.ActivityNodeInfo, Uml.RedefinableElementInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ReclassifyObjectAction_IsReplaceAll, Uml.ReclassifyObjectAction_NewClassifier, Uml.ReclassifyObjectAction_Object, Uml.ReclassifyObjectAction_OldClassifier);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ReclassifyObjectAction_IsReplaceAll, Uml.ReclassifyObjectAction_NewClassifier, Uml.ReclassifyObjectAction_Object, Uml.ReclassifyObjectAction_OldClassifier, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ReclassifyObjectAction_IsReplaceAll, Uml.ReclassifyObjectAction_NewClassifier, Uml.ReclassifyObjectAction_Object, Uml.ReclassifyObjectAction_OldClassifier, Uml.Action_Context, Uml.Action_Input, Uml.Action_IsLocallyReentrant, Uml.Action_LocalPostcondition, Uml.Action_LocalPrecondition, Uml.Action_Output, Uml.ExecutableNode_Handler, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("IsReplaceAll", Uml.ReclassifyObjectAction_IsReplaceAll);
                publicPropertiesByName.Add("NewClassifier", Uml.ReclassifyObjectAction_NewClassifier);
                publicPropertiesByName.Add("Object", Uml.ReclassifyObjectAction_Object);
                publicPropertiesByName.Add("OldClassifier", Uml.ReclassifyObjectAction_OldClassifier);
                ...
                modelPropertyInfos.Add(Uml.ReclassifyObjectAction_IsReplaceAll, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReclassifyObjectAction_IsReplaceAll, __ImmutableArray.Create<__ModelProperty>(Uml.ReclassifyObjectAction_IsReplaceAll), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ReclassifyObjectAction_NewClassifier, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReclassifyObjectAction_NewClassifier, __ImmutableArray.Create<__ModelProperty>(Uml.ReclassifyObjectAction_NewClassifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ReclassifyObjectAction_Object, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReclassifyObjectAction_Object, __ImmutableArray.Create<__ModelProperty>(Uml.ReclassifyObjectAction_Object), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ReclassifyObjectAction_OldClassifier, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReclassifyObjectAction_OldClassifier, __ImmutableArray.Create<__ModelProperty>(Uml.ReclassifyObjectAction_OldClassifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ReclassifyObjectAction);
            ...
            {
                var result = new ReclassifyObjectAction_Impl(id);
            ...
            {
                return "Uml.ReclassifyObjectActionInfo";
            }
        }
    }
}
