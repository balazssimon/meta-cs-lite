...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class LinkAction_Impl : __MetaModelObject, LinkAction
    {
        private LinkAction_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LinkAction_Association);
            ...
            public override __MetaType MetaType => typeof(LinkAction);
            ...
            {
                var result = new LinkAction_Impl(id);
