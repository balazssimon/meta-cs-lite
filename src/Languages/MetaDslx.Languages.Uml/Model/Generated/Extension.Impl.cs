...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Extension_Impl : __MetaModelObject, Extension
    {
        private Extension_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.Association_IsDerived)?.Add((bool)false);
            ...
            Uml.__CustomImpl.Association(this);
            Uml.__CustomImpl.Extension(this);
        }
        ...
        {
            get => Uml.__CustomImpl.Extension_IsRequired(this);
        }
    
        public Class Metaclass
        {
            get => Uml.__CustomImpl.Extension_Metaclass(this);
        }
    
        public ExtensionEnd OwnedEnd
        {
            get => MGet<ExtensionEnd>(Uml.Extension_OwnedEnd);
            set => MSet<ExtensionEnd>(Uml.Extension_OwnedEnd, value);
        }
    
        public global::System.Collections.Generic.IList<Type> EndType
        {
            get => Uml.__CustomImpl.Association_EndType(this);
        }
    
        public bool IsDerived
        {
            get => MGet<bool>(Uml.Association_IsDerived);
            set => MSet<bool>(Uml.Association_IsDerived, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Property> MemberEnd
        {
            get => MGetCollection<Property>(Uml.Association_MemberEnd);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Property> NavigableOwnedEnd
        {
            get => MGetCollection<Property>(Uml.Association_NavigableOwnedEnd);
        }
    
        [global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)]
        global::MetaDslx.Modeling.ICollectionSlot<Property> Association.OwnedEnd
        {
            get => MGetCollection<Property>(Uml.Association_OwnedEnd);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.AssociationInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.AssociationInfo, Uml.ClassifierInfo, Uml.NamespaceInfo, Uml.RedefinableElementInfo, Uml.RelationshipInfo, Uml.TemplateableElementInfo, Uml.TypeInfo, Uml.PackageableElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Extension_IsRequired, Uml.Extension_Metaclass, Uml.Extension_OwnedEnd);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Extension_IsRequired, Uml.Extension_Metaclass, Uml.Extension_OwnedEnd, Uml.Association_EndType, Uml.Association_IsDerived, Uml.Association_MemberEnd, Uml.Association_NavigableOwnedEnd, Uml.Association_OwnedEnd, Uml.Classifier_Attribute, Uml.Classifier_CollaborationUse, Uml.Classifier_Feature, Uml.Classifier_General, Uml.Classifier_Generalization, Uml.Classifier_InheritedMember, Uml.Classifier_IsAbstract, Uml.Classifier_IsFinalSpecialization, Uml.Classifier_OwnedTemplateSignature, Uml.Classifier_OwnedUseCase, Uml.Classifier_PowertypeExtent, Uml.Classifier_RedefinedClassifier, Uml.Classifier_Representation, Uml.Classifier_Substitution, Uml.Classifier_TemplateParameter, Uml.Classifier_UseCase, Uml.Namespace_ElementImport, Uml.Namespace_ImportedMember, Uml.Namespace_Member, Uml.Namespace_OwnedMember, Uml.Namespace_OwnedRule, Uml.Namespace_PackageImport, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.Relationship_RelatedElement, Uml.TemplateableElement_OwnedTemplateSignature, Uml.TemplateableElement_TemplateBinding, Uml.Type_Package, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Extension_IsRequired, Uml.Extension_Metaclass, Uml.Extension_OwnedEnd, Uml.Association_EndType, Uml.Association_IsDerived, Uml.Association_MemberEnd, Uml.Association_NavigableOwnedEnd, Uml.Classifier_Attribute, Uml.Classifier_CollaborationUse, Uml.Classifier_Feature, Uml.Classifier_General, Uml.Classifier_Generalization, Uml.Classifier_InheritedMember, Uml.Classifier_IsAbstract, Uml.Classifier_IsFinalSpecialization, Uml.Classifier_OwnedTemplateSignature, Uml.Classifier_OwnedUseCase, Uml.Classifier_PowertypeExtent, Uml.Classifier_RedefinedClassifier, Uml.Classifier_Representation, Uml.Classifier_Substitution, Uml.Classifier_TemplateParameter, Uml.Classifier_UseCase, Uml.Namespace_ElementImport, Uml.Namespace_ImportedMember, Uml.Namespace_Member, Uml.Namespace_OwnedMember, Uml.Namespace_OwnedRule, Uml.Namespace_PackageImport, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.Relationship_RelatedElement, Uml.TemplateableElement_TemplateBinding, Uml.Type_Package, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("IsRequired", Uml.Extension_IsRequired);
                publicPropertiesByName.Add("Metaclass", Uml.Extension_Metaclass);
                publicPropertiesByName.Add("OwnedEnd", Uml.Extension_OwnedEnd);
                publicPropertiesByName.Add("EndType", Uml.Association_EndType);
                publicPropertiesByName.Add("IsDerived", Uml.Association_IsDerived);
                publicPropertiesByName.Add("MemberEnd", Uml.Association_MemberEnd);
                publicPropertiesByName.Add("NavigableOwnedEnd", Uml.Association_NavigableOwnedEnd);
                ...
                modelPropertyInfos.Add(Uml.Extension_IsRequired, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Extension_IsRequired, __ImmutableArray.Create<__ModelProperty>(Uml.Extension_IsRequired), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Extension_Metaclass, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Extension_Metaclass, __ImmutableArray.Create<__ModelProperty>(Uml.Extension_Metaclass), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(Uml.Class_Extension), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Extension_OwnedEnd, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Extension_OwnedEnd, __ImmutableArray.Create<__ModelProperty>(Uml.Extension_OwnedEnd, Uml.Association_OwnedEnd), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Association_OwnedEnd), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Association_OwnedEnd), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Association_EndType, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Association_EndType, __ImmutableArray.Create<__ModelProperty>(Uml.Association_EndType), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Relationship_RelatedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Association_IsDerived, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Association_IsDerived, __ImmutableArray.Create<__ModelProperty>(Uml.Association_IsDerived), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Association_MemberEnd, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Association_MemberEnd, __ImmutableArray.Create<__ModelProperty>(Uml.Association_MemberEnd), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Property_Association), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_Member), __ImmutableArray.Create<__ModelProperty>(Uml.Association_OwnedEnd), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Association_NavigableOwnedEnd, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Association_NavigableOwnedEnd, __ImmutableArray.Create<__ModelProperty>(Uml.Association_NavigableOwnedEnd), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Association_OwnedEnd), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Association_OwnedEnd, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Extension_OwnedEnd, __ImmutableArray.Create<__ModelProperty>(Uml.Extension_OwnedEnd, Uml.Association_OwnedEnd), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Property_OwningAssociation), __ImmutableArray.Create<__ModelProperty>(Uml.Association_MemberEnd, Uml.Classifier_Feature, Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(Uml.Association_NavigableOwnedEnd), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Extension_OwnedEnd), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Extension_OwnedEnd)));
                ...
                modelPropertyInfos.Add(Uml.Classifier_Feature, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Classifier_Feature, __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_Feature), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(Uml.Feature_FeaturingClassifier), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_Member), __ImmutableArray.Create<__ModelProperty>(Uml.Association_OwnedEnd, Uml.Classifier_Attribute), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Extension);
            ...
            {
                var result = new Extension_Impl(id);
