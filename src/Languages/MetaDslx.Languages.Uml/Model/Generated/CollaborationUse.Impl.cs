...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class CollaborationUse_Impl : __MetaModelObject, CollaborationUse
    {
        private CollaborationUse_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.NamedElement(this);
            Uml.__CustomImpl.CollaborationUse(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<Dependency> RoleBinding
        {
            get => MGetCollection<Dependency>(Uml.CollaborationUse_RoleBinding);
        }
    
        public Collaboration Type
        {
            get => MGet<Collaboration>(Uml.CollaborationUse_Type);
            set => MSet<Collaboration>(Uml.CollaborationUse_Type, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.CollaborationUse_RoleBinding, Uml.CollaborationUse_Type);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.CollaborationUse_RoleBinding, Uml.CollaborationUse_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.CollaborationUse_RoleBinding, Uml.CollaborationUse_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("RoleBinding", Uml.CollaborationUse_RoleBinding);
                publicPropertiesByName.Add("Type", Uml.CollaborationUse_Type);
                ...
                modelPropertyInfos.Add(Uml.CollaborationUse_RoleBinding, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.CollaborationUse_RoleBinding, __ImmutableArray.Create<__ModelProperty>(Uml.CollaborationUse_RoleBinding), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.CollaborationUse_Type, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.CollaborationUse_Type, __ImmutableArray.Create<__ModelProperty>(Uml.CollaborationUse_Type), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(CollaborationUse);
            ...
            {
                var result = new CollaborationUse_Impl(id);
            ...
            {
                return "Uml.CollaborationUseInfo";
            }
        }
    }
}
