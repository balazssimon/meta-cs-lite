...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ConnectableElement_Impl : __MetaModelObject, ConnectableElement
    {
        private ConnectableElement_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ParameterableElementInfo, Uml.TypedElementInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.ParameterableElementInfo, Uml.TypedElementInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ConnectableElement_End, Uml.ConnectableElement_TemplateParameter);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ConnectableElement_End, Uml.ConnectableElement_TemplateParameter, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ConnectableElement_End, Uml.ConnectableElement_TemplateParameter, Uml.ParameterableElement_OwningTemplateParameter, Uml.TypedElement_Type, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
            ...
            public override __MetaType MetaType => typeof(ConnectableElement);
            ...
            {
                var result = new ConnectableElement_Impl(id);
            ...
            {
                return "Uml.ConnectableElementInfo";
            }
        }
    }
}
