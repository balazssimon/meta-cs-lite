...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class StructuralFeatureAction_Impl : __MetaModelObject, StructuralFeatureAction
    {
        private StructuralFeatureAction_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(StructuralFeatureAction);
            ...
            {
                var result = new StructuralFeatureAction_Impl(id);
            ...
            {
                return "Uml.StructuralFeatureActionInfo";
            }
        }
    }
}
