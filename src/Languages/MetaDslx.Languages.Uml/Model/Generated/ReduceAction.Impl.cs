...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ReduceAction_Impl : __MetaModelObject, ReduceAction
    {
        private ReduceAction_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.ReduceAction_IsOrdered)?.Add((bool)false);
            ...
            Uml.__CustomImpl.ReduceAction(this);
        }
        ...
        {
            get => MGet<InputPin>(Uml.ReduceAction_Collection);
            set => MSet<InputPin>(Uml.ReduceAction_Collection, value);
        }
    
        public bool IsOrdered
        {
            get => MGet<bool>(Uml.ReduceAction_IsOrdered);
            set => MSet<bool>(Uml.ReduceAction_IsOrdered, value);
        }
    
        public Behavior Reducer
        {
            get => MGet<Behavior>(Uml.ReduceAction_Reducer);
            set => MSet<Behavior>(Uml.ReduceAction_Reducer, value);
        }
    
        public OutputPin Result
        {
            get => MGet<OutputPin>(Uml.ReduceAction_Result);
            set => MSet<OutputPin>(Uml.ReduceAction_Result, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.ReduceAction_Collection, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReduceAction_Collection, __ImmutableArray.Create<__ModelProperty>(Uml.ReduceAction_Collection), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ReduceAction_IsOrdered, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReduceAction_IsOrdered, __ImmutableArray.Create<__ModelProperty>(Uml.ReduceAction_IsOrdered), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ReduceAction_Reducer, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReduceAction_Reducer, __ImmutableArray.Create<__ModelProperty>(Uml.ReduceAction_Reducer), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ReduceAction_Result, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReduceAction_Result, __ImmutableArray.Create<__ModelProperty>(Uml.ReduceAction_Result), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Output), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ReduceAction);
            ...
            {
                var result = new ReduceAction_Impl(id);
