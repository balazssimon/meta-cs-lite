...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class TestIdentityAction_Impl : __MetaModelObject, TestIdentityAction
    {
        private TestIdentityAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.TestIdentityAction(this);
        }
        ...
        {
            get => MGet<InputPin>(Uml.TestIdentityAction_First);
            set => MSet<InputPin>(Uml.TestIdentityAction_First, value);
        }
    
        public OutputPin Result
        {
            get => MGet<OutputPin>(Uml.TestIdentityAction_Result);
            set => MSet<OutputPin>(Uml.TestIdentityAction_Result, value);
        }
    
        public InputPin Second
        {
            get => MGet<InputPin>(Uml.TestIdentityAction_Second);
            set => MSet<InputPin>(Uml.TestIdentityAction_Second, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.TestIdentityAction_First, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TestIdentityAction_First, __ImmutableArray.Create<__ModelProperty>(Uml.TestIdentityAction_First), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.TestIdentityAction_Result, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TestIdentityAction_Result, __ImmutableArray.Create<__ModelProperty>(Uml.TestIdentityAction_Result), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Output), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.TestIdentityAction_Second, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TestIdentityAction_Second, __ImmutableArray.Create<__ModelProperty>(Uml.TestIdentityAction_Second), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Input), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(TestIdentityAction);
            ...
            {
                var result = new TestIdentityAction_Impl(id);
            ...
            {
                return "Uml.TestIdentityActionInfo";
            }
        }
    }
}
