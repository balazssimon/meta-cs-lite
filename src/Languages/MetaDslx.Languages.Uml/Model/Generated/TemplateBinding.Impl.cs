...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class TemplateBinding_Impl : __MetaModelObject, TemplateBinding
    {
        private TemplateBinding_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.Relationship(this);
            Uml.__CustomImpl.DirectedRelationship(this);
            Uml.__CustomImpl.TemplateBinding(this);
        }
        ...
        {
            get => MGet<TemplateableElement>(Uml.TemplateBinding_BoundElement);
            set => MSet<TemplateableElement>(Uml.TemplateBinding_BoundElement, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<TemplateParameterSubstitution> ParameterSubstitution
        {
            get => MGetCollection<TemplateParameterSubstitution>(Uml.TemplateBinding_ParameterSubstitution);
        }
    
        public TemplateSignature Signature
        {
            get => MGet<TemplateSignature>(Uml.TemplateBinding_Signature);
            set => MSet<TemplateSignature>(Uml.TemplateBinding_Signature, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TemplateBinding_BoundElement, Uml.TemplateBinding_ParameterSubstitution, Uml.TemplateBinding_Signature);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TemplateBinding_BoundElement, Uml.TemplateBinding_ParameterSubstitution, Uml.TemplateBinding_Signature, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TemplateBinding_BoundElement, Uml.TemplateBinding_ParameterSubstitution, Uml.TemplateBinding_Signature, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("BoundElement", Uml.TemplateBinding_BoundElement);
                publicPropertiesByName.Add("ParameterSubstitution", Uml.TemplateBinding_ParameterSubstitution);
                publicPropertiesByName.Add("Signature", Uml.TemplateBinding_Signature);
                ...
                modelPropertyInfos.Add(Uml.TemplateBinding_BoundElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TemplateBinding_BoundElement, __ImmutableArray.Create<__ModelProperty>(Uml.TemplateBinding_BoundElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.TemplateableElement_TemplateBinding), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Source, Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.TemplateBinding_ParameterSubstitution, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TemplateBinding_ParameterSubstitution, __ImmutableArray.Create<__ModelProperty>(Uml.TemplateBinding_ParameterSubstitution), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.TemplateParameterSubstitution_TemplateBinding), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.TemplateBinding_Signature, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TemplateBinding_Signature, __ImmutableArray.Create<__ModelProperty>(Uml.TemplateBinding_Signature), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Target), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.DirectedRelationship_Source, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DirectedRelationship_Source, __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Source), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Relationship_RelatedElement), __ImmutableArray.Create<__ModelProperty>(Uml.TemplateBinding_BoundElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.DirectedRelationship_Target, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DirectedRelationship_Target, __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Target), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Relationship_RelatedElement), __ImmutableArray.Create<__ModelProperty>(Uml.TemplateBinding_Signature), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(TemplateBinding);
            ...
            {
                var result = new TemplateBinding_Impl(id);
            ...
            {
                return "Uml.TemplateBindingInfo";
            }
        }
    }
}
