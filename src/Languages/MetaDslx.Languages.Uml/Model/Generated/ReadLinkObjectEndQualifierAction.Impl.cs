...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ReadLinkObjectEndQualifierAction_Impl : __MetaModelObject, ReadLinkObjectEndQualifierAction
    {
        private ReadLinkObjectEndQualifierAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ReadLinkObjectEndQualifierAction(this);
        }
        ...
        {
            get => MGet<InputPin>(Uml.ReadLinkObjectEndQualifierAction_Object);
            set => MSet<InputPin>(Uml.ReadLinkObjectEndQualifierAction_Object, value);
        }
    
        public Property Qualifier
        {
            get => MGet<Property>(Uml.ReadLinkObjectEndQualifierAction_Qualifier);
            set => MSet<Property>(Uml.ReadLinkObjectEndQualifierAction_Qualifier, value);
        }
    
        public OutputPin Result
        {
            get => MGet<OutputPin>(Uml.ReadLinkObjectEndQualifierAction_Result);
            set => MSet<OutputPin>(Uml.ReadLinkObjectEndQualifierAction_Result, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(ReadLinkObjectEndQualifierAction);
            ...
            {
                var result = new ReadLinkObjectEndQualifierAction_Impl(id);
            ...
            {
                return "Uml.ReadLinkObjectEndQualifierActionInfo";
            }
        }
    }
}
