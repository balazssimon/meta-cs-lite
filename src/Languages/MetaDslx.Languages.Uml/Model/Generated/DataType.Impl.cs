...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class DataType_Impl : __MetaModelObject, DataType
    {
        private DataType_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DataType_OwnedAttribute, Uml.DataType_OwnedOperation);
            ...
            public override __MetaType MetaType => typeof(DataType);
            ...
            {
                var result = new DataType_Impl(id);
