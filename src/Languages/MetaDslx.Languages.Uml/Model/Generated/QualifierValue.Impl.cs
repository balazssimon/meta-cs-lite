...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class QualifierValue_Impl : __MetaModelObject, QualifierValue
    {
        private QualifierValue_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.QualifierValue(this);
        }
        ...
        {
            get => MGet<Property>(Uml.QualifierValue_Qualifier);
            set => MSet<Property>(Uml.QualifierValue_Qualifier, value);
        }
    
        public InputPin Value
        {
            get => MGet<InputPin>(Uml.QualifierValue_Value);
            set => MSet<InputPin>(Uml.QualifierValue_Value, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.QualifierValue_Qualifier, Uml.QualifierValue_Value);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.QualifierValue_Qualifier, Uml.QualifierValue_Value, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.QualifierValue_Qualifier, Uml.QualifierValue_Value, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Qualifier", Uml.QualifierValue_Qualifier);
                publicPropertiesByName.Add("Value", Uml.QualifierValue_Value);
                ...
                modelPropertyInfos.Add(Uml.QualifierValue_Qualifier, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.QualifierValue_Qualifier, __ImmutableArray.Create<__ModelProperty>(Uml.QualifierValue_Qualifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.QualifierValue_Value, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.QualifierValue_Value, __ImmutableArray.Create<__ModelProperty>(Uml.QualifierValue_Value), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(QualifierValue);
            ...
            {
                var result = new QualifierValue_Impl(id);
