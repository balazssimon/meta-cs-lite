...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class CreateObjectAction_Impl : __MetaModelObject, CreateObjectAction
    {
        private CreateObjectAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.CreateObjectAction(this);
        }
        ...
        {
            get => MGet<Classifier>(Uml.CreateObjectAction_Classifier);
            set => MSet<Classifier>(Uml.CreateObjectAction_Classifier, value);
        }
    
        public OutputPin Result
        {
            get => MGet<OutputPin>(Uml.CreateObjectAction_Result);
            set => MSet<OutputPin>(Uml.CreateObjectAction_Result, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.CreateObjectAction_Classifier, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.CreateObjectAction_Classifier, __ImmutableArray.Create<__ModelProperty>(Uml.CreateObjectAction_Classifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.CreateObjectAction_Result, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.CreateObjectAction_Result, __ImmutableArray.Create<__ModelProperty>(Uml.CreateObjectAction_Result), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Output), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(CreateObjectAction);
            ...
            {
                var result = new CreateObjectAction_Impl(id);
            ...
            {
                return "Uml.CreateObjectActionInfo";
            }
        }
    }
}
