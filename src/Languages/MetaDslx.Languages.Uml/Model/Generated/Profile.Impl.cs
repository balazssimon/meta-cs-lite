...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Profile_Impl : __MetaModelObject, Profile
    {
        private Profile_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.Profile(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<ElementImport> MetaclassReference
        {
            get => MGetCollection<ElementImport>(Uml.Profile_MetaclassReference);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<PackageImport> MetamodelReference
        {
            get => MGetCollection<PackageImport>(Uml.Profile_MetamodelReference);
        }
    
        public global::System.Collections.Generic.IList<Package> NestedPackage
        {
            get => Uml.__CustomImpl.Package_NestedPackage(this);
        }
        ...
        public global::System.Collections.Generic.IList<Stereotype> OwnedStereotype
        {
            get => Uml.__CustomImpl.Package_OwnedStereotype(this);
        }
    
        public global::System.Collections.Generic.IList<Type> OwnedType
        {
            get => Uml.__CustomImpl.Package_OwnedType(this);
        }
        ...
        global::System.Collections.Generic.IList<Stereotype> Package.AllApplicableStereotypes() => Uml.__CustomImpl.Package_AllApplicableStereotypes(this);
        Profile Package.ContainingProfile() => Uml.__CustomImpl.Package_ContainingProfile(this);
        bool Package.MakesVisible(NamedElement el) => Uml.__CustomImpl.Package_MakesVisible(this, el);
        bool Package.MustBeOwned() => Uml.__CustomImpl.Package_MustBeOwned(this);
        global::System.Collections.Generic.IList<PackageableElement> Package.VisibleMembers() => Uml.__CustomImpl.Package_VisibleMembers(this);
        ...
        bool Element.MustBeOwned() => Uml.__CustomImpl.Package_MustBeOwned(this);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.Profile_MetaclassReference, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Profile_MetaclassReference, __ImmutableArray.Create<__ModelProperty>(Uml.Profile_MetaclassReference), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_ElementImport), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Profile_MetamodelReference, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Profile_MetamodelReference, __ImmutableArray.Create<__ModelProperty>(Uml.Profile_MetamodelReference), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_PackageImport), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Package_NestedPackage, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Package_NestedPackage, __ImmutableArray.Create<__ModelProperty>(Uml.Package_NestedPackage), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(Uml.Package_NestingPackage), __ImmutableArray.Create<__ModelProperty>(Uml.Package_PackagedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Package_OwnedStereotype, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Package_OwnedStereotype, __ImmutableArray.Create<__ModelProperty>(Uml.Package_OwnedStereotype), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Package_PackagedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Package_OwnedType, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Package_OwnedType, __ImmutableArray.Create<__ModelProperty>(Uml.Package_OwnedType), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(Uml.Type_Package), __ImmutableArray.Create<__ModelProperty>(Uml.Package_PackagedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Profile);
            ...
            {
                var result = new Profile_Impl(id);
