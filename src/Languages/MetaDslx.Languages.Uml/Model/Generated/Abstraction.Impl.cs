...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Abstraction_Impl : __MetaModelObject, Abstraction
    {
        private Abstraction_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Abstraction_Mapping);
            ...
            public override __MetaType MetaType => typeof(Abstraction);
            ...
            {
                var result = new Abstraction_Impl(id);
