...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class BehavioredClassifier_Impl : __MetaModelObject, BehavioredClassifier
    {
        private BehavioredClassifier_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.BehavioredClassifier_ClassifierBehavior, Uml.BehavioredClassifier_InterfaceRealization, Uml.BehavioredClassifier_OwnedBehavior);
            ...
            public override __MetaType MetaType => typeof(BehavioredClassifier);
            ...
            {
                var result = new BehavioredClassifier_Impl(id);
            ...
            {
                return "Uml.BehavioredClassifierInfo";
            }
        }
    }
}
