...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class InputPin_Impl : __MetaModelObject, InputPin
    {
        private InputPin_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(InputPin);
            ...
            {
                var result = new InputPin_Impl(id);
