...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Image_Impl : __MetaModelObject, Image
    {
        private Image_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.Image(this);
        }
        ...
        {
            get => MGet<string>(Uml.Image_Content);
            set => MSet<string>(Uml.Image_Content, value);
        }
    
        public string Format
        {
            get => MGet<string>(Uml.Image_Format);
            set => MSet<string>(Uml.Image_Format, value);
        }
    
        public string Location
        {
            get => MGet<string>(Uml.Image_Location);
            set => MSet<string>(Uml.Image_Location, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Image_Content, Uml.Image_Format, Uml.Image_Location);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Image_Content, Uml.Image_Format, Uml.Image_Location, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Image_Content, Uml.Image_Format, Uml.Image_Location, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Content", Uml.Image_Content);
                publicPropertiesByName.Add("Format", Uml.Image_Format);
                publicPropertiesByName.Add("Location", Uml.Image_Location);
                ...
                modelPropertyInfos.Add(Uml.Image_Content, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Image_Content, __ImmutableArray.Create<__ModelProperty>(Uml.Image_Content), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Image_Format, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Image_Format, __ImmutableArray.Create<__ModelProperty>(Uml.Image_Format), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Image_Location, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Image_Location, __ImmutableArray.Create<__ModelProperty>(Uml.Image_Location), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Image);
