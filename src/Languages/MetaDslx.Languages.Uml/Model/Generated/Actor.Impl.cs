...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Actor_Impl : __MetaModelObject, Actor
    {
        private Actor_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(Actor);
