...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ExecutionOccurrenceSpecification_Impl : __MetaModelObject, ExecutionOccurrenceSpecification
    {
        private ExecutionOccurrenceSpecification_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ExecutionOccurrenceSpecification(this);
        }
        ...
        {
            get => MGet<ExecutionSpecification>(Uml.ExecutionOccurrenceSpecification_Execution);
            set => MSet<ExecutionSpecification>(Uml.ExecutionOccurrenceSpecification_Execution, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.OccurrenceSpecificationInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.OccurrenceSpecificationInfo, Uml.InteractionFragmentInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ExecutionOccurrenceSpecification_Execution);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ExecutionOccurrenceSpecification_Execution, Uml.OccurrenceSpecification_Covered, Uml.OccurrenceSpecification_ToAfter, Uml.OccurrenceSpecification_ToBefore, Uml.InteractionFragment_Covered, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ExecutionOccurrenceSpecification_Execution, Uml.OccurrenceSpecification_Covered, Uml.OccurrenceSpecification_ToAfter, Uml.OccurrenceSpecification_ToBefore, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Execution", Uml.ExecutionOccurrenceSpecification_Execution);
                ...
                modelPropertyInfos.Add(Uml.ExecutionOccurrenceSpecification_Execution, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ExecutionOccurrenceSpecification_Execution, __ImmutableArray.Create<__ModelProperty>(Uml.ExecutionOccurrenceSpecification_Execution), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ExecutionOccurrenceSpecification);
            ...
            {
                var result = new ExecutionOccurrenceSpecification_Impl(id);
            ...
            {
                return "Uml.ExecutionOccurrenceSpecificationInfo";
            }
        }
    }
}
