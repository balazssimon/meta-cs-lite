...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class MergeNode_Impl : __MetaModelObject, MergeNode
    {
        private MergeNode_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.MergeNode(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(MergeNode);
            ...
            {
                var result = new MergeNode_Impl(id);
