...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ValueSpecificationAction_Impl : __MetaModelObject, ValueSpecificationAction
    {
        private ValueSpecificationAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ValueSpecificationAction(this);
        }
        ...
        {
            get => MGet<OutputPin>(Uml.ValueSpecificationAction_Result);
            set => MSet<OutputPin>(Uml.ValueSpecificationAction_Result, value);
        }
    
        public ValueSpecification Value
        {
            get => MGet<ValueSpecification>(Uml.ValueSpecificationAction_Value);
            set => MSet<ValueSpecification>(Uml.ValueSpecificationAction_Value, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(ValueSpecificationAction);
            ...
            {
                var result = new ValueSpecificationAction_Impl(id);
            ...
            {
                return "Uml.ValueSpecificationActionInfo";
            }
        }
    }
}
