...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ProtocolTransition_Impl : __MetaModelObject, ProtocolTransition
    {
        private ProtocolTransition_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ProtocolTransition(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public Constraint PostCondition
        {
            get => MGet<Constraint>(Uml.ProtocolTransition_PostCondition);
            set => MSet<Constraint>(Uml.ProtocolTransition_PostCondition, value);
        }
    
        public Constraint PreCondition
        {
            get => MGet<Constraint>(Uml.ProtocolTransition_PreCondition);
            set => MSet<Constraint>(Uml.ProtocolTransition_PreCondition, value);
        }
    
        public global::System.Collections.Generic.IList<Operation> Referred
        {
            get => Uml.__CustomImpl.ProtocolTransition_Referred(this);
        }
        ...
        StateMachine Transition.ContainingStateMachine(StateMachine result) => Uml.__CustomImpl.Transition_ContainingStateMachine(this, result);
        bool Transition.IsConsistentWith(bool result, RedefinableElement redefiningElement) => Uml.__CustomImpl.Transition_IsConsistentWith(this, result, redefiningElement);
        ...
        bool RedefinableElement.IsConsistentWith(bool result, RedefinableElement redefiningElement) => Uml.__CustomImpl.Transition_IsConsistentWith(this, result, redefiningElement);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.TransitionInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.TransitionInfo, Uml.NamespaceInfo, Uml.RedefinableElementInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ProtocolTransition_PostCondition, Uml.ProtocolTransition_PreCondition, Uml.ProtocolTransition_Referred);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ProtocolTransition_PostCondition, Uml.ProtocolTransition_PreCondition, Uml.ProtocolTransition_Referred, Uml.Transition_Container, Uml.Transition_Effect, Uml.Transition_Guard, Uml.Transition_Kind, Uml.Transition_RedefinedTransition, Uml.Transition_RedefinitionContext, Uml.Transition_Source, Uml.Transition_Target, Uml.Transition_Trigger, Uml.Namespace_ElementImport, Uml.Namespace_ImportedMember, Uml.Namespace_Member, Uml.Namespace_OwnedMember, Uml.Namespace_OwnedRule, Uml.Namespace_PackageImport, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ProtocolTransition_PostCondition, Uml.ProtocolTransition_PreCondition, Uml.ProtocolTransition_Referred, Uml.Transition_Container, Uml.Transition_Effect, Uml.Transition_Guard, Uml.Transition_Kind, Uml.Transition_RedefinedTransition, Uml.Transition_RedefinitionContext, Uml.Transition_Source, Uml.Transition_Target, Uml.Transition_Trigger, Uml.Namespace_ElementImport, Uml.Namespace_ImportedMember, Uml.Namespace_Member, Uml.Namespace_OwnedMember, Uml.Namespace_OwnedRule, Uml.Namespace_PackageImport, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("PostCondition", Uml.ProtocolTransition_PostCondition);
                publicPropertiesByName.Add("PreCondition", Uml.ProtocolTransition_PreCondition);
                publicPropertiesByName.Add("Referred", Uml.ProtocolTransition_Referred);
                ...
                modelPropertyInfos.Add(Uml.Transition_Guard, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Transition_Guard, __ImmutableArray.Create<__ModelProperty>(Uml.Transition_Guard), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedRule), __ImmutableArray.Create<__ModelProperty>(Uml.ProtocolTransition_PreCondition), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Transition_Kind, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Transition_Kind, __ImmutableArray.Create<__ModelProperty>(Uml.Transition_Kind), , __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Element_OwnedElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Element_OwnedElement, __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Transition_Effect, Uml.Transition_Trigger, Uml.Namespace_ElementImport, Uml.Namespace_OwnedMember, Uml.Namespace_PackageImport, Uml.NamedElement_NameExpression, Uml.Element_OwnedComment), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ProtocolTransition);
            ...
            {
                var result = new ProtocolTransition_Impl(id);
            ...
            {
                return "Uml.ProtocolTransitionInfo";
            }
        }
    }
}
