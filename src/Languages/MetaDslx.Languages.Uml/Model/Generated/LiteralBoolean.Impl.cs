...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class LiteralBoolean_Impl : __MetaModelObject, LiteralBoolean
    {
        private LiteralBoolean_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.LiteralBoolean_Value)?.Add((bool)false);
            ...
            Uml.__CustomImpl.LiteralBoolean(this);
        }
        ...
        public bool Value
        {
            get => MGet<bool>(Uml.LiteralBoolean_Value);
            set => MSet<bool>(Uml.LiteralBoolean_Value, value);
        }
        ...
        bool LiteralBoolean.BooleanValue(bool result) => Uml.__CustomImpl.LiteralBoolean_BooleanValue(this, result);
        bool LiteralBoolean.IsComputable(bool result) => Uml.__CustomImpl.LiteralBoolean_IsComputable(this, result);
        bool ValueSpecification.BooleanValue(bool result) => Uml.__CustomImpl.LiteralBoolean_BooleanValue(this, result);
        ...
        bool ValueSpecification.IsComputable(bool result) => Uml.__CustomImpl.LiteralBoolean_IsComputable(this, result);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.LiteralBoolean_Value, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.LiteralBoolean_Value, __ImmutableArray.Create<__ModelProperty>(Uml.LiteralBoolean_Value), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LiteralBoolean_BooleanValue, Uml.LiteralBoolean_IsComputable);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LiteralBoolean_BooleanValue, Uml.LiteralBoolean_IsComputable, Uml.ValueSpecification_BooleanValue, Uml.ValueSpecification_IntegerValue, Uml.ValueSpecification_IsCompatibleWith, Uml.ValueSpecification_IsComputable, Uml.ValueSpecification_IsNull, Uml.ValueSpecification_RealValue, Uml.ValueSpecification_StringValue, Uml.ValueSpecification_UnlimitedValue, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsCompatibleWith, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.LiteralBoolean_BooleanValue, Uml.LiteralBoolean_IsComputable, Uml.ValueSpecification_IntegerValue, Uml.ValueSpecification_IsCompatibleWith, Uml.ValueSpecification_IsNull, Uml.ValueSpecification_RealValue, Uml.ValueSpecification_StringValue, Uml.ValueSpecification_UnlimitedValue, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.ParameterableElement_IsTemplateParameter, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.LiteralBoolean_BooleanValue, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.ValueSpecification_BooleanValue), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.LiteralBoolean_IsComputable, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.ValueSpecification_IsComputable), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.ValueSpecification_BooleanValue, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.LiteralBoolean_BooleanValue)));
                    ...
                    modelOperationInfos.Add(Uml.ValueSpecification_IsComputable, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.LiteralBoolean_IsComputable)));
            ...
            public override __MetaType MetaType => typeof(LiteralBoolean);
            ...
            {
                var result = new LiteralBoolean_Impl(id);
