...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ReadVariableAction_Impl : __MetaModelObject, ReadVariableAction
    {
        private ReadVariableAction_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ReadVariableAction(this);
        }
        ...
        {
            get => MGet<OutputPin>(Uml.ReadVariableAction_Result);
            set => MSet<OutputPin>(Uml.ReadVariableAction_Result, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.ReadVariableAction_Result, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ReadVariableAction_Result, __ImmutableArray.Create<__ModelProperty>(Uml.ReadVariableAction_Result), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Action_Output), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ReadVariableAction);
            ...
            {
                var result = new ReadVariableAction_Impl(id);
            ...
            {
                return "Uml.ReadVariableActionInfo";
            }
        }
    }
}
