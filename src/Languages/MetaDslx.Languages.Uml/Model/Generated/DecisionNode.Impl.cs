...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class DecisionNode_Impl : __MetaModelObject, DecisionNode
    {
        private DecisionNode_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.DecisionNode(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public Behavior DecisionInput
        {
            get => MGet<Behavior>(Uml.DecisionNode_DecisionInput);
            set => MSet<Behavior>(Uml.DecisionNode_DecisionInput, value);
        }
    
        public ObjectFlow DecisionInputFlow
        {
            get => MGet<ObjectFlow>(Uml.DecisionNode_DecisionInputFlow);
            set => MSet<ObjectFlow>(Uml.DecisionNode_DecisionInputFlow, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DecisionNode_DecisionInput, Uml.DecisionNode_DecisionInputFlow);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DecisionNode_DecisionInput, Uml.DecisionNode_DecisionInputFlow, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.DecisionNode_DecisionInput, Uml.DecisionNode_DecisionInputFlow, Uml.ActivityNode_Activity, Uml.ActivityNode_Incoming, Uml.ActivityNode_InGroup, Uml.ActivityNode_InInterruptibleRegion, Uml.ActivityNode_InPartition, Uml.ActivityNode_InStructuredNode, Uml.ActivityNode_Outgoing, Uml.ActivityNode_RedefinedNode, Uml.RedefinableElement_IsLeaf, Uml.RedefinableElement_RedefinedElement, Uml.RedefinableElement_RedefinitionContext, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("DecisionInput", Uml.DecisionNode_DecisionInput);
                publicPropertiesByName.Add("DecisionInputFlow", Uml.DecisionNode_DecisionInputFlow);
                ...
                modelPropertyInfos.Add(Uml.DecisionNode_DecisionInput, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DecisionNode_DecisionInput, __ImmutableArray.Create<__ModelProperty>(Uml.DecisionNode_DecisionInput), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.DecisionNode_DecisionInputFlow, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DecisionNode_DecisionInputFlow, __ImmutableArray.Create<__ModelProperty>(Uml.DecisionNode_DecisionInputFlow), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(DecisionNode);
            ...
            {
                var result = new DecisionNode_Impl(id);
