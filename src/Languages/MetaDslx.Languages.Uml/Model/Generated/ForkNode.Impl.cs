...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ForkNode_Impl : __MetaModelObject, ForkNode
    {
        private ForkNode_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ForkNode(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(ForkNode);
            ...
            {
                var result = new ForkNode_Impl(id);
