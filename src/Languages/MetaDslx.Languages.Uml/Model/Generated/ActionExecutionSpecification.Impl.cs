...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ActionExecutionSpecification_Impl : __MetaModelObject, ActionExecutionSpecification
    {
        private ActionExecutionSpecification_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.ActionExecutionSpecification(this);
        }
        ...
        {
            get => MGet<Action>(Uml.ActionExecutionSpecification_Action);
            set => MSet<Action>(Uml.ActionExecutionSpecification_Action, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ActionExecutionSpecification_Action);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ActionExecutionSpecification_Action, Uml.ExecutionSpecification_Finish, Uml.ExecutionSpecification_Start, Uml.InteractionFragment_Covered, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ActionExecutionSpecification_Action, Uml.ExecutionSpecification_Finish, Uml.ExecutionSpecification_Start, Uml.InteractionFragment_Covered, Uml.InteractionFragment_EnclosingInteraction, Uml.InteractionFragment_EnclosingOperand, Uml.InteractionFragment_GeneralOrdering, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Action", Uml.ActionExecutionSpecification_Action);
                ...
                modelPropertyInfos.Add(Uml.ActionExecutionSpecification_Action, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ActionExecutionSpecification_Action, __ImmutableArray.Create<__ModelProperty>(Uml.ActionExecutionSpecification_Action), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ActionExecutionSpecification);
            ...
            {
                var result = new ActionExecutionSpecification_Impl(id);
            ...
            {
                return "Uml.ActionExecutionSpecificationInfo";
            }
        }
    }
}
