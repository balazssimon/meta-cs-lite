...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class CentralBufferNode_Impl : __MetaModelObject, CentralBufferNode
    {
        private CentralBufferNode_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(CentralBufferNode);
            ...
            {
                var result = new CentralBufferNode_Impl(id);
            ...
            {
                return "Uml.CentralBufferNodeInfo";
            }
        }
    }
}
