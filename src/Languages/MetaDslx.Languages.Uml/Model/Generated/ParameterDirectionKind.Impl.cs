...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class __ParameterDirectionKind_Info : __ModelEnumInfo
    {
        ...
        {
            _literals = __ImmutableArray.Create<string>("In", "Inout", "Out", "Return");
            ...
            literalsByName.Add("Inout", __MetaSymbol.FromValue(ParameterDirectionKind.Inout));
            literalsByName.Add("Out", __MetaSymbol.FromValue(ParameterDirectionKind.Out));
