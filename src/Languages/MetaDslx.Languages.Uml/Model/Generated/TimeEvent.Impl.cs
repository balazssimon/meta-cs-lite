...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class TimeEvent_Impl : __MetaModelObject, TimeEvent
    {
        private TimeEvent_Impl(string? id)
            : base(id)
        {
            ((__IModelObject)this).MGetSlot(Uml.TimeEvent_IsRelative)?.Add((bool)false);
            ...
            Uml.__CustomImpl.TimeEvent(this);
        }
        ...
        {
            get => MGet<bool>(Uml.TimeEvent_IsRelative);
            set => MSet<bool>(Uml.TimeEvent_IsRelative, value);
        }
    
        public TimeExpression When
        {
            get => MGet<TimeExpression>(Uml.TimeEvent_When);
            set => MSet<TimeExpression>(Uml.TimeEvent_When, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.EventInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.EventInfo, Uml.PackageableElementInfo, Uml.NamedElementInfo, Uml.ParameterableElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TimeEvent_IsRelative, Uml.TimeEvent_When);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TimeEvent_IsRelative, Uml.TimeEvent_When, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.TimeEvent_IsRelative, Uml.TimeEvent_When, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("IsRelative", Uml.TimeEvent_IsRelative);
                publicPropertiesByName.Add("When", Uml.TimeEvent_When);
                ...
                modelPropertyInfos.Add(Uml.TimeEvent_IsRelative, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TimeEvent_IsRelative, __ImmutableArray.Create<__ModelProperty>(Uml.TimeEvent_IsRelative), false, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.TimeEvent_When, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.TimeEvent_When, __ImmutableArray.Create<__ModelProperty>(Uml.TimeEvent_When), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(TimeEvent);
            ...
            {
                var result = new TimeEvent_Impl(id);
