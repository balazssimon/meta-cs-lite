...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Gate_Impl : __MetaModelObject, Gate
    {
        private Gate_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.NamedElement(this);
            Uml.__CustomImpl.MessageEnd(this);
            Uml.__CustomImpl.Gate(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public CombinedFragment CombinedFragment
        {
            get => MGet<CombinedFragment>(Uml.Gate_CombinedFragment);
            set => MSet<CombinedFragment>(Uml.Gate_CombinedFragment, value);
        }
    
        public Interaction Interaction
        {
            get => MGet<Interaction>(Uml.Gate_Interaction);
            set => MSet<Interaction>(Uml.Gate_Interaction, value);
        }
    
        public InteractionUse InteractionUse
        {
            get => MGet<InteractionUse>(Uml.Gate_InteractionUse);
            set => MSet<InteractionUse>(Uml.Gate_InteractionUse, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.MessageEndInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.MessageEndInfo, Uml.NamedElementInfo, Uml.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Gate_CombinedFragment, Uml.Gate_Interaction, Uml.Gate_InteractionUse);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Gate_CombinedFragment, Uml.Gate_Interaction, Uml.Gate_InteractionUse, Uml.MessageEnd_Message, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Gate_CombinedFragment, Uml.Gate_Interaction, Uml.Gate_InteractionUse, Uml.MessageEnd_Message, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("CombinedFragment", Uml.Gate_CombinedFragment);
                publicPropertiesByName.Add("Interaction", Uml.Gate_Interaction);
                publicPropertiesByName.Add("InteractionUse", Uml.Gate_InteractionUse);
                ...
                modelPropertyInfos.Add(Uml.Gate_CombinedFragment, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Gate_CombinedFragment, __ImmutableArray.Create<__ModelProperty>(Uml.Gate_CombinedFragment), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.CombinedFragment_CfragmentGate), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Gate_Interaction, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Gate_Interaction, __ImmutableArray.Create<__ModelProperty>(Uml.Gate_Interaction), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Interaction_FormalGate), __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Gate_InteractionUse, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Gate_InteractionUse, __ImmutableArray.Create<__ModelProperty>(Uml.Gate_InteractionUse), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.InteractionUse_ActualGate), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.NamedElement_Namespace, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.NamedElement_Namespace, __ImmutableArray.Create<__ModelProperty>(Uml.NamedElement_Namespace), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), __ImmutableArray.Create<__ModelProperty>(Uml.Gate_Interaction), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Element_Owner, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Element_Owner, __ImmutableArray.Create<__ModelProperty>(Uml.Element_Owner), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Gate_CombinedFragment, Uml.Gate_InteractionUse, Uml.NamedElement_Namespace), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                _modelPropertyInfos = modelPropertyInfos.ToImmutable();
    
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Gate_GetName, Uml.Gate_GetOperand, Uml.Gate_IsActual, Uml.Gate_IsDistinguishableFrom, Uml.Gate_IsFormal, Uml.Gate_IsInsideCF, Uml.Gate_IsOutsideCF, Uml.Gate_Matches);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Gate_GetName, Uml.Gate_GetOperand, Uml.Gate_IsActual, Uml.Gate_IsDistinguishableFrom, Uml.Gate_IsFormal, Uml.Gate_IsInsideCF, Uml.Gate_IsOutsideCF, Uml.Gate_Matches, Uml.MessageEnd_EnclosingFragment, Uml.MessageEnd_IsReceive, Uml.MessageEnd_IsSend, Uml.MessageEnd_OppositeEnd, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_IsDistinguishableFrom, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Uml.Gate_GetName, Uml.Gate_GetOperand, Uml.Gate_IsActual, Uml.Gate_IsDistinguishableFrom, Uml.Gate_IsFormal, Uml.Gate_IsInsideCF, Uml.Gate_IsOutsideCF, Uml.Gate_Matches, Uml.MessageEnd_EnclosingFragment, Uml.MessageEnd_IsReceive, Uml.MessageEnd_IsSend, Uml.MessageEnd_OppositeEnd, Uml.NamedElement_AllNamespaces, Uml.NamedElement_AllOwningPackages, Uml.NamedElement_Separator, Uml.Element_AllOwnedElements, Uml.Element_MustBeOwned);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Uml.Gate_GetName, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.Gate_GetOperand, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.Gate_IsActual, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.Gate_IsDistinguishableFrom, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(Uml.NamedElement_IsDistinguishableFrom), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.Gate_IsFormal, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.Gate_IsInsideCF, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.Gate_IsOutsideCF, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Uml.Gate_Matches, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    ...
                    modelOperationInfos.Add(Uml.NamedElement_IsDistinguishableFrom, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>(Uml.Gate_IsDistinguishableFrom)));
            ...
            public override __MetaType MetaType => typeof(Gate);
