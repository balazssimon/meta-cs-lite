...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Enumeration_Impl : __MetaModelObject, Enumeration
    {
        private Enumeration_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.DataType(this);
            Uml.__CustomImpl.Enumeration(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<EnumerationLiteral> OwnedLiteral
        {
            get => MGetCollection<EnumerationLiteral>(Uml.Enumeration_OwnedLiteral);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Property> OwnedAttribute
        {
            get => MGetCollection<Property>(Uml.DataType_OwnedAttribute);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Operation> OwnedOperation
        {
            get => MGetCollection<Operation>(Uml.DataType_OwnedOperation);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Uml.Enumeration_OwnedLiteral, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Enumeration_OwnedLiteral, __ImmutableArray.Create<__ModelProperty>(Uml.Enumeration_OwnedLiteral), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.EnumerationLiteral_Enumeration), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.DataType_OwnedAttribute, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DataType_OwnedAttribute, __ImmutableArray.Create<__ModelProperty>(Uml.DataType_OwnedAttribute), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Property_Datatype), __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_Attribute, Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.DataType_OwnedOperation, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.DataType_OwnedOperation, __ImmutableArray.Create<__ModelProperty>(Uml.DataType_OwnedOperation), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Operation_Datatype), __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_Feature, Uml.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.Classifier_Attribute, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Classifier_Attribute, __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_Attribute), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_Feature), __ImmutableArray.Create<__ModelProperty>(Uml.DataType_OwnedAttribute), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Classifier_Feature, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Classifier_Feature, __ImmutableArray.Create<__ModelProperty>(Uml.Classifier_Feature), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.DerivedUnion), __ImmutableArray.Create<__ModelProperty>(Uml.Feature_FeaturingClassifier), __ImmutableArray.Create<__ModelProperty>(Uml.Namespace_Member), __ImmutableArray.Create<__ModelProperty>(Uml.DataType_OwnedOperation, Uml.Classifier_Attribute), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Enumeration);
            ...
            {
                var result = new Enumeration_Impl(id);
