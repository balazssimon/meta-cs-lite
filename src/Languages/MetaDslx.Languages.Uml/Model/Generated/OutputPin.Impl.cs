...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class OutputPin_Impl : __MetaModelObject, OutputPin
    {
        private OutputPin_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.OutputPin(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.PinInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Uml.PinInfo, Uml.MultiplicityElementInfo, Uml.ObjectNodeInfo, Uml.ActivityNodeInfo, Uml.RedefinableElementInfo, Uml.TypedElementInfo, Uml.NamedElementInfo, Uml.ElementInfo);
            ...
            public override __MetaType MetaType => typeof(OutputPin);
            ...
            {
                var result = new OutputPin_Impl(id);
