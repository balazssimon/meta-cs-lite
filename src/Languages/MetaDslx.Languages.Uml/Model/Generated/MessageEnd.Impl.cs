...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class MessageEnd_Impl : __MetaModelObject, MessageEnd
    {
        private MessageEnd_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.MessageEnd_Message);
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Uml.MessageEnd_EnclosingFragment, Uml.MessageEnd_IsReceive, Uml.MessageEnd_IsSend, Uml.MessageEnd_OppositeEnd);
            ...
            public override __MetaType MetaType => typeof(MessageEnd);
            ...
            {
                var result = new MessageEnd_Impl(id);
