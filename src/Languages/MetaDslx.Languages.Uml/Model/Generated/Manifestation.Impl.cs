...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class Manifestation_Impl : __MetaModelObject, Manifestation
    {
        private Manifestation_Impl(string? id)
            : base(id)
        {
            ...
            Uml.__CustomImpl.Manifestation(this);
        }
        ...
        {
            get => MGet<PackageableElement>(Uml.Manifestation_UtilizedElement);
            set => MSet<PackageableElement>(Uml.Manifestation_UtilizedElement, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Manifestation_UtilizedElement);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Manifestation_UtilizedElement, Uml.Abstraction_Mapping, Uml.Dependency_Client, Uml.Dependency_Supplier, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.Manifestation_UtilizedElement, Uml.Abstraction_Mapping, Uml.Dependency_Client, Uml.Dependency_Supplier, Uml.DirectedRelationship_Source, Uml.DirectedRelationship_Target, Uml.PackageableElement_Visibility, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.ParameterableElement_OwningTemplateParameter, Uml.ParameterableElement_TemplateParameter, Uml.Relationship_RelatedElement, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("UtilizedElement", Uml.Manifestation_UtilizedElement);
                ...
                modelPropertyInfos.Add(Uml.Manifestation_UtilizedElement, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Manifestation_UtilizedElement, __ImmutableArray.Create<__ModelProperty>(Uml.Manifestation_UtilizedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Supplier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Uml.Dependency_Supplier, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.Dependency_Supplier, __ImmutableArray.Create<__ModelProperty>(Uml.Dependency_Supplier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.DirectedRelationship_Target), __ImmutableArray.Create<__ModelProperty>(Uml.Manifestation_UtilizedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Manifestation);
            ...
            {
                var result = new Manifestation_Impl(id);
