...
namespace MetaDslx.Languages.Uml.Model.__Impl
{
    ...
    internal class ParameterSet_Impl : __MetaModelObject, ParameterSet
    {
        private ParameterSet_Impl(string? id)
            : base(id)
        {
            Uml.__CustomImpl.Element(this);
            Uml.__CustomImpl.NamedElement(this);
            Uml.__CustomImpl.ParameterSet(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<Constraint> Condition
        {
            get => MGetCollection<Constraint>(Uml.ParameterSet_Condition);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Parameter> Parameter
        {
            get => MGetCollection<Parameter>(Uml.ParameterSet_Parameter);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ParameterSet_Condition, Uml.ParameterSet_Parameter);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ParameterSet_Condition, Uml.ParameterSet_Parameter, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Uml.ParameterSet_Condition, Uml.ParameterSet_Parameter, Uml.NamedElement_ClientDependency, Uml.NamedElement_Name, Uml.NamedElement_NameExpression, Uml.NamedElement_Namespace, Uml.NamedElement_QualifiedName, Uml.NamedElement_Visibility, Uml.Element_OwnedComment, Uml.Element_OwnedElement, Uml.Element_Owner);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Condition", Uml.ParameterSet_Condition);
                publicPropertiesByName.Add("Parameter", Uml.ParameterSet_Parameter);
                ...
                modelPropertyInfos.Add(Uml.ParameterSet_Condition, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ParameterSet_Condition, __ImmutableArray.Create<__ModelProperty>(Uml.ParameterSet_Condition), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Uml.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Uml.ParameterSet_Parameter, new __ModelPropertyInfo(new __ModelPropertySlot(Uml.ParameterSet_Parameter, __ImmutableArray.Create<__ModelProperty>(Uml.ParameterSet_Parameter), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Uml.Parameter_ParameterSet), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ParameterSet);
            ...
            {
                var result = new ParameterSet_Impl(id);
