...
namespace MetaDslx.Languages.Ecore.Model.__Impl
{
    ...
    internal class EDataType_Impl : __MetaModelObject, EDataType
    {
        private EDataType_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.EDataType_Serializable);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.EDataType_Serializable, Ecore.EClassifier_DefaultValue, Ecore.EClassifier_EPackage, Ecore.EClassifier_ETypeParameters, Ecore.EClassifier_InstanceClass, Ecore.EClassifier_InstanceClassName, Ecore.EClassifier_InstanceTypeName, Ecore.ENamedElement_Name, Ecore.EModelElement_EAnnotations);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.EDataType_Serializable, Ecore.EClassifier_DefaultValue, Ecore.EClassifier_EPackage, Ecore.EClassifier_ETypeParameters, Ecore.EClassifier_InstanceClass, Ecore.EClassifier_InstanceClassName, Ecore.EClassifier_InstanceTypeName, Ecore.ENamedElement_Name, Ecore.EModelElement_EAnnotations);
            ...
            public override __MetaType MetaType => typeof(EDataType);
            ...
            {
                var result = new EDataType_Impl(id);
