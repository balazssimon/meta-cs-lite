...
namespace MetaDslx.Languages.Ecore.Model.__Impl
{
    ...
    internal class ENamedElement_Impl : __MetaModelObject, ENamedElement
    {
        private ENamedElement_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.ENamedElement_Name);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.ENamedElement_Name, Ecore.EModelElement_EAnnotations);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.ENamedElement_Name, Ecore.EModelElement_EAnnotations);
            ...
            public override __MetaType MetaType => typeof(ENamedElement);
            ...
            {
                var result = new ENamedElement_Impl(id);
            ...
            {
                return "Ecore.ENamedElementInfo";
            }
        }
    }
}
