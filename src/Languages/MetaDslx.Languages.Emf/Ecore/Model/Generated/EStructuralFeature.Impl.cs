...
namespace MetaDslx.Languages.Ecore.Model.__Impl
{
    ...
    internal class EStructuralFeature_Impl : __MetaModelObject, EStructuralFeature
    {
        private EStructuralFeature_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Ecore.EStructuralFeature_GetContainerClass, Ecore.EStructuralFeature_GetFeatureID);
            ...
            public override __MetaType MetaType => typeof(EStructuralFeature);
            ...
            {
                var result = new EStructuralFeature_Impl(id);
            ...
            {
                return "Ecore.EStructuralFeatureInfo";
            }
        }
    }
}
