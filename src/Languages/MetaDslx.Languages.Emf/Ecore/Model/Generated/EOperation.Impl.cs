...
namespace MetaDslx.Languages.Ecore.Model.__Impl
{
    ...
    internal class EOperation_Impl : __MetaModelObject, EOperation
    {
        private EOperation_Impl(string? id)
            : base(id)
        {
            ...
            Ecore.__CustomImpl.EOperation(this);
        }
        ...
        {
            get => MGet<EClass>(Ecore.EOperation_EContainingClass);
            set => MSet<EClass>(Ecore.EOperation_EContainingClass, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<EClassifier> EExceptions
        {
            get => MGetCollection<EClassifier>(Ecore.EOperation_EExceptions);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<EGenericType> EGenericExceptions
        {
            get => MGetCollection<EGenericType>(Ecore.EOperation_EGenericExceptions);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<EParameter> EParameters
        {
            get => MGetCollection<EParameter>(Ecore.EOperation_EParameters);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<ETypeParameter> ETypeParameters
        {
            get => MGetCollection<ETypeParameter>(Ecore.EOperation_ETypeParameters);
        }
        ...
        int EOperation.GetOperationID() => Ecore.__CustomImpl.EOperation_GetOperationID(this);
        bool EOperation.IsOverrideOf(EOperation someOperation) => Ecore.__CustomImpl.EOperation_IsOverrideOf(this, someOperation);
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.EOperation_EContainingClass, Ecore.EOperation_EExceptions, Ecore.EOperation_EGenericExceptions, Ecore.EOperation_EParameters, Ecore.EOperation_ETypeParameters);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.EOperation_EContainingClass, Ecore.EOperation_EExceptions, Ecore.EOperation_EGenericExceptions, Ecore.EOperation_EParameters, Ecore.EOperation_ETypeParameters, Ecore.ETypedElement_EGenericType, Ecore.ETypedElement_EType, Ecore.ETypedElement_LowerBound, Ecore.ETypedElement_Many, Ecore.ETypedElement_Ordered, Ecore.ETypedElement_Required, Ecore.ETypedElement_Unique, Ecore.ETypedElement_UpperBound, Ecore.ENamedElement_Name, Ecore.EModelElement_EAnnotations);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.EOperation_EContainingClass, Ecore.EOperation_EExceptions, Ecore.EOperation_EGenericExceptions, Ecore.EOperation_EParameters, Ecore.EOperation_ETypeParameters, Ecore.ETypedElement_EGenericType, Ecore.ETypedElement_EType, Ecore.ETypedElement_LowerBound, Ecore.ETypedElement_Many, Ecore.ETypedElement_Ordered, Ecore.ETypedElement_Required, Ecore.ETypedElement_Unique, Ecore.ETypedElement_UpperBound, Ecore.ENamedElement_Name, Ecore.EModelElement_EAnnotations);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("EContainingClass", Ecore.EOperation_EContainingClass);
                publicPropertiesByName.Add("EExceptions", Ecore.EOperation_EExceptions);
                publicPropertiesByName.Add("EGenericExceptions", Ecore.EOperation_EGenericExceptions);
                publicPropertiesByName.Add("EParameters", Ecore.EOperation_EParameters);
                publicPropertiesByName.Add("ETypeParameters", Ecore.EOperation_ETypeParameters);
                ...
                modelPropertyInfos.Add(Ecore.EOperation_EContainingClass, new __ModelPropertyInfo(new __ModelPropertySlot(Ecore.EOperation_EContainingClass, __ImmutableArray.Create<__ModelProperty>(Ecore.EOperation_EContainingClass), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Ecore.EClass_EOperations), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Ecore.EOperation_EExceptions, new __ModelPropertyInfo(new __ModelPropertySlot(Ecore.EOperation_EExceptions, __ImmutableArray.Create<__ModelProperty>(Ecore.EOperation_EExceptions), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Ecore.EOperation_EGenericExceptions, new __ModelPropertyInfo(new __ModelPropertySlot(Ecore.EOperation_EGenericExceptions, __ImmutableArray.Create<__ModelProperty>(Ecore.EOperation_EGenericExceptions), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Ecore.EOperation_EParameters, new __ModelPropertyInfo(new __ModelPropertySlot(Ecore.EOperation_EParameters, __ImmutableArray.Create<__ModelProperty>(Ecore.EOperation_EParameters), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Ecore.EParameter_EOperation), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Ecore.EOperation_ETypeParameters, new __ModelPropertyInfo(new __ModelPropertySlot(Ecore.EOperation_ETypeParameters, __ImmutableArray.Create<__ModelProperty>(Ecore.EOperation_ETypeParameters), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Ecore.EOperation_GetOperationID, Ecore.EOperation_IsOverrideOf);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Ecore.EOperation_GetOperationID, Ecore.EOperation_IsOverrideOf, Ecore.EModelElement_GetEAnnotation);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Ecore.EOperation_GetOperationID, Ecore.EOperation_IsOverrideOf, Ecore.EModelElement_GetEAnnotation);
                var modelOperationInfos = __ImmutableDictionary.CreateBuilder<__ModelOperation, __ModelOperationInfo>();
                    modelOperationInfos.Add(Ecore.EOperation_GetOperationID, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
                    modelOperationInfos.Add(Ecore.EOperation_IsOverrideOf, new __ModelOperationInfo(__ImmutableArray.Create<__ModelOperation>(), __ImmutableArray.Create<__ModelOperation>()));
            ...
            public override __MetaType MetaType => typeof(EOperation);
            ...
            {
                var result = new EOperation_Impl(id);
