...
namespace MetaDslx.Languages.Ecore.Model.__Impl
{
    ...
    internal class ETypedElement_Impl : __MetaModelObject, ETypedElement
    {
        private ETypedElement_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.ETypedElement_EGenericType, Ecore.ETypedElement_EType, Ecore.ETypedElement_LowerBound, Ecore.ETypedElement_Many, Ecore.ETypedElement_Ordered, Ecore.ETypedElement_Required, Ecore.ETypedElement_Unique, Ecore.ETypedElement_UpperBound);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.ETypedElement_EGenericType, Ecore.ETypedElement_EType, Ecore.ETypedElement_LowerBound, Ecore.ETypedElement_Many, Ecore.ETypedElement_Ordered, Ecore.ETypedElement_Required, Ecore.ETypedElement_Unique, Ecore.ETypedElement_UpperBound, Ecore.ENamedElement_Name, Ecore.EModelElement_EAnnotations);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.ETypedElement_EGenericType, Ecore.ETypedElement_EType, Ecore.ETypedElement_LowerBound, Ecore.ETypedElement_Many, Ecore.ETypedElement_Ordered, Ecore.ETypedElement_Required, Ecore.ETypedElement_Unique, Ecore.ETypedElement_UpperBound, Ecore.ENamedElement_Name, Ecore.EModelElement_EAnnotations);
            ...
            public override __MetaType MetaType => typeof(ETypedElement);
            ...
            {
                var result = new ETypedElement_Impl(id);
            ...
            {
                return "Ecore.ETypedElementInfo";
            }
        }
    }
}
