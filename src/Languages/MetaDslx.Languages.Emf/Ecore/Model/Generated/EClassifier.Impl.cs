...
namespace MetaDslx.Languages.Ecore.Model.__Impl
{
    ...
    internal class EClassifier_Impl : __MetaModelObject, EClassifier
    {
        private EClassifier_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.EClassifier_DefaultValue, Ecore.EClassifier_EPackage, Ecore.EClassifier_ETypeParameters, Ecore.EClassifier_InstanceClass, Ecore.EClassifier_InstanceClassName, Ecore.EClassifier_InstanceTypeName);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.EClassifier_DefaultValue, Ecore.EClassifier_EPackage, Ecore.EClassifier_ETypeParameters, Ecore.EClassifier_InstanceClass, Ecore.EClassifier_InstanceClassName, Ecore.EClassifier_InstanceTypeName, Ecore.ENamedElement_Name, Ecore.EModelElement_EAnnotations);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.EClassifier_DefaultValue, Ecore.EClassifier_EPackage, Ecore.EClassifier_ETypeParameters, Ecore.EClassifier_InstanceClass, Ecore.EClassifier_InstanceClassName, Ecore.EClassifier_InstanceTypeName, Ecore.ENamedElement_Name, Ecore.EModelElement_EAnnotations);
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Ecore.EClassifier_GetClassifierID, Ecore.EClassifier_IsInstance);
                _allDeclaredOperations = __ImmutableArray.Create<__ModelOperation>(Ecore.EClassifier_GetClassifierID, Ecore.EClassifier_IsInstance, Ecore.EModelElement_GetEAnnotation);
                _publicOperations = __ImmutableArray.Create<__ModelOperation>(Ecore.EClassifier_GetClassifierID, Ecore.EClassifier_IsInstance, Ecore.EModelElement_GetEAnnotation);
            ...
            public override __MetaType MetaType => typeof(EClassifier);
            ...
            {
                var result = new EClassifier_Impl(id);
