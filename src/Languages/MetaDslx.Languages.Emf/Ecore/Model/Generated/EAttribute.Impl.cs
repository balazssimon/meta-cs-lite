...
namespace MetaDslx.Languages.Ecore.Model.__Impl
{
    ...
    internal class EAttribute_Impl : __MetaModelObject, EAttribute
    {
        private EAttribute_Impl(string? id)
            : base(id)
        {
            ...
            Ecore.__CustomImpl.EAttribute(this);
        }
        ...
        {
            get => Ecore.__CustomImpl.EAttribute_EAttributeType(this);
        }
    
        public bool ID
        {
            get => MGet<bool>(Ecore.EAttribute_ID);
            set => MSet<bool>(Ecore.EAttribute_ID, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.EAttribute_EAttributeType, Ecore.EAttribute_ID);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.EAttribute_EAttributeType, Ecore.EAttribute_ID, Ecore.EStructuralFeature_Changeable, Ecore.EStructuralFeature_DefaultValue, Ecore.EStructuralFeature_DefaultValueLiteral, Ecore.EStructuralFeature_Derived, Ecore.EStructuralFeature_EContainingClass, Ecore.EStructuralFeature_Transient, Ecore.EStructuralFeature_Unsettable, Ecore.EStructuralFeature_Volatile, Ecore.ETypedElement_EGenericType, Ecore.ETypedElement_EType, Ecore.ETypedElement_LowerBound, Ecore.ETypedElement_Many, Ecore.ETypedElement_Ordered, Ecore.ETypedElement_Required, Ecore.ETypedElement_Unique, Ecore.ETypedElement_UpperBound, Ecore.ENamedElement_Name, Ecore.EModelElement_EAnnotations);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Ecore.EAttribute_EAttributeType, Ecore.EAttribute_ID, Ecore.EStructuralFeature_Changeable, Ecore.EStructuralFeature_DefaultValue, Ecore.EStructuralFeature_DefaultValueLiteral, Ecore.EStructuralFeature_Derived, Ecore.EStructuralFeature_EContainingClass, Ecore.EStructuralFeature_Transient, Ecore.EStructuralFeature_Unsettable, Ecore.EStructuralFeature_Volatile, Ecore.ETypedElement_EGenericType, Ecore.ETypedElement_EType, Ecore.ETypedElement_LowerBound, Ecore.ETypedElement_Many, Ecore.ETypedElement_Ordered, Ecore.ETypedElement_Required, Ecore.ETypedElement_Unique, Ecore.ETypedElement_UpperBound, Ecore.ENamedElement_Name, Ecore.EModelElement_EAnnotations);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("EAttributeType", Ecore.EAttribute_EAttributeType);
                publicPropertiesByName.Add("ID", Ecore.EAttribute_ID);
                ...
                modelPropertyInfos.Add(Ecore.EAttribute_EAttributeType, new __ModelPropertyInfo(new __ModelPropertySlot(Ecore.EAttribute_EAttributeType, __ImmutableArray.Create<__ModelProperty>(Ecore.EAttribute_EAttributeType), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Ecore.EAttribute_ID, new __ModelPropertyInfo(new __ModelPropertySlot(Ecore.EAttribute_ID, __ImmutableArray.Create<__ModelProperty>(Ecore.EAttribute_ID), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(EAttribute);
            ...
            {
                var result = new EAttribute_Impl(id);
