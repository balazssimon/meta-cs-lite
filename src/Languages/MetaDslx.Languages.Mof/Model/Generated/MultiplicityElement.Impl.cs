    ...
    internal class MultiplicityElement_Impl : __MetaModelObject, MultiplicityElement
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.MultiplicityElement_IsOrdered, Mof.MultiplicityElement_IsUnique, Mof.MultiplicityElement_Lower, Mof.MultiplicityElement_LowerValue, Mof.MultiplicityElement_Upper, Mof.MultiplicityElement_UpperValue);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.MultiplicityElement_IsOrdered, Mof.MultiplicityElement_IsUnique, Mof.MultiplicityElement_Lower, Mof.MultiplicityElement_LowerValue, Mof.MultiplicityElement_Upper, Mof.MultiplicityElement_UpperValue, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.MultiplicityElement_IsOrdered, Mof.MultiplicityElement_IsUnique, Mof.MultiplicityElement_Lower, Mof.MultiplicityElement_LowerValue, Mof.MultiplicityElement_Upper, Mof.MultiplicityElement_UpperValue, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
            ...
            {
                return "Mof.MultiplicityElementInfo";
            }
        }
    }
}
