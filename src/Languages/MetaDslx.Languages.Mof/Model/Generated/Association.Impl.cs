...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class Association_Impl : __MetaModelObject, Association
    {
            ...
            : base(id)
        {
            ...
            Mof.__CustomImpl.Association(this);
        }
        ...
        {
            get => MGet<bool>(Mof.Association_IsDerived);
            set => MSet<bool>(Mof.Association_IsDerived, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Property> MemberEnd
        {
            get => MGetCollection<Property>(Mof.Association_MemberEnd);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Property> NavigableOwnedEnd
        {
            get => MGetCollection<Property>(Mof.Association_NavigableOwnedEnd);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Property> OwnedEnd
        {
            get => MGetCollection<Property>(Mof.Association_OwnedEnd);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.ClassifierInfo, Mof.RelationshipInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.ClassifierInfo, Mof.NamespaceInfo, Mof.RelationshipInfo, Mof.TypeInfo, Mof.PackageableElementInfo, Mof.NamedElementInfo, Mof.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Association_IsDerived, Mof.Association_MemberEnd, Mof.Association_NavigableOwnedEnd, Mof.Association_OwnedEnd);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Association_IsDerived, Mof.Association_MemberEnd, Mof.Association_NavigableOwnedEnd, Mof.Association_OwnedEnd, Mof.Classifier_Generalization, Mof.Classifier_IsAbstract, Mof.Namespace_Member, Mof.Namespace_OwnedMember, Mof.Namespace_OwnedRule, Mof.Namespace_PackageImport, Mof.Relationship_RelatedElement, Mof.Type_Package, Mof.Type_TypedElement, Mof.PackageableElement_OwningPackage, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Association_IsDerived, Mof.Association_MemberEnd, Mof.Association_NavigableOwnedEnd, Mof.Association_OwnedEnd, Mof.Classifier_Generalization, Mof.Classifier_IsAbstract, Mof.Namespace_Member, Mof.Namespace_OwnedMember, Mof.Namespace_OwnedRule, Mof.Namespace_PackageImport, Mof.Relationship_RelatedElement, Mof.Type_Package, Mof.Type_TypedElement, Mof.PackageableElement_OwningPackage, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("IsDerived", Mof.Association_IsDerived);
                publicPropertiesByName.Add("MemberEnd", Mof.Association_MemberEnd);
                publicPropertiesByName.Add("NavigableOwnedEnd", Mof.Association_NavigableOwnedEnd);
                publicPropertiesByName.Add("OwnedEnd", Mof.Association_OwnedEnd);
                ...
                modelPropertyInfos.Add(Mof.Association_IsDerived, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.Association_IsDerived, __ImmutableArray.Create<__ModelProperty>(Mof.Association_IsDerived), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Mof.Association_MemberEnd, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.Association_MemberEnd, __ImmutableArray.Create<__ModelProperty>(Mof.Association_MemberEnd), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Mof.Property_Association), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.Association_OwnedEnd), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Mof.Association_NavigableOwnedEnd, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.Association_NavigableOwnedEnd, __ImmutableArray.Create<__ModelProperty>(Mof.Association_NavigableOwnedEnd), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.Association_OwnedEnd), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Mof.Association_OwnedEnd, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.Association_OwnedEnd, __ImmutableArray.Create<__ModelProperty>(Mof.Association_OwnedEnd), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Mof.Property_OwningAssociation), __ImmutableArray.Create<__ModelProperty>(Mof.Association_MemberEnd, Mof.Namespace_OwnedMember), __ImmutableArray.Create<__ModelProperty>(Mof.Association_NavigableOwnedEnd), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Mof.Relationship_RelatedElement, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.Relationship_RelatedElement, __ImmutableArray.Create<__ModelProperty>(Mof.Relationship_RelatedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(Mof.Element_Relationship), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
