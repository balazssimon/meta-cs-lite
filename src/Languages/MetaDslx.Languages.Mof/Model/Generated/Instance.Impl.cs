...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class Instance_Impl : __MetaModelObject, Instance
    {
        private Instance_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Instance_Classifier);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Instance_Classifier, Mof.InstanceSpecification_Slot, Mof.PackageableElement_OwningPackage, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Instance_Classifier, Mof.InstanceSpecification_Slot, Mof.PackageableElement_OwningPackage, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
            ...
            public override __MetaType MetaType => typeof(Instance);
            ...
            {
                var result = new Instance_Impl(id);
