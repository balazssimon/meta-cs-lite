...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class Enumeration_Impl : __MetaModelObject, Enumeration
    {
            ...
            : base(id)
        {
            ...
            Mof.__CustomImpl.Enumeration(this);
        }
        ...
        {
            get => MGetCollection<EnumerationLiteral>(Mof.Enumeration_OwnedLiteral);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Mof.Enumeration_OwnedLiteral, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.Enumeration_OwnedLiteral, __ImmutableArray.Create<__ModelProperty>(Mof.Enumeration_OwnedLiteral), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Mof.EnumerationLiteral_Enumeration), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
