...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class Extent_Impl : __MetaModelObject, Extent
    {
        private Extent_Impl(string? id)
            : base(id)
        {
            Mof.__CustomImpl.Extent(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(Extent);
