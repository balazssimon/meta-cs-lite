...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class DirectedRelationship_Impl : __MetaModelObject, DirectedRelationship
    {
        private DirectedRelationship_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.RelationshipInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.RelationshipInfo, Mof.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.DirectedRelationship_Source, Mof.DirectedRelationship_Target);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.DirectedRelationship_Source, Mof.DirectedRelationship_Target, Mof.Relationship_RelatedElement, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.DirectedRelationship_Source, Mof.DirectedRelationship_Target, Mof.Relationship_RelatedElement, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
            ...
            public override __MetaType MetaType => typeof(DirectedRelationship);
            ...
            {
                var result = new DirectedRelationship_Impl(id);
            ...
            {
                return "Mof.DirectedRelationshipInfo";
            }
        }
    }
}
