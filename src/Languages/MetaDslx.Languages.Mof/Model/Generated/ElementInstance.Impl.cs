...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class ElementInstance_Impl : __MetaModelObject, ElementInstance
    {
        private ElementInstance_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.InstanceInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.InstanceInfo, Mof.InstanceSpecificationInfo, Mof.PackageableElementInfo, Mof.NamedElementInfo, Mof.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.ElementInstance_Slot);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.ElementInstance_Slot, Mof.Instance_Classifier, Mof.InstanceSpecification_Slot, Mof.PackageableElement_OwningPackage, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.ElementInstance_Slot, Mof.Instance_Classifier, Mof.PackageableElement_OwningPackage, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Slot", Mof.ElementInstance_Slot);
                publicPropertiesByName.Add("Classifier", Mof.Instance_Classifier);
                ...
                modelPropertyInfos.Add(Mof.Instance_Classifier, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.Instance_Classifier, __ImmutableArray.Create<__ModelProperty>(Mof.Instance_Classifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(ElementInstance);
            ...
            {
                var result = new ElementInstance_Impl(id);
            ...
            {
                return "Mof.ElementInstanceInfo";
            }
        }
    }
}
