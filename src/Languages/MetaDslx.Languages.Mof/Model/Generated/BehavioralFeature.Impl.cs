...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class BehavioralFeature_Impl : __MetaModelObject, BehavioralFeature
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.FeatureInfo, Mof.NamespaceInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.FeatureInfo, Mof.NamespaceInfo, Mof.NamedElementInfo, Mof.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.BehavioralFeature_IsReadOnly);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.BehavioralFeature_IsReadOnly, Mof.Namespace_Member, Mof.Namespace_OwnedMember, Mof.Namespace_OwnedRule, Mof.Namespace_PackageImport, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.BehavioralFeature_IsReadOnly, Mof.Namespace_Member, Mof.Namespace_OwnedMember, Mof.Namespace_OwnedRule, Mof.Namespace_PackageImport, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
            ...
            {
                return "Mof.BehavioralFeatureInfo";
            }
        }
    }
}
