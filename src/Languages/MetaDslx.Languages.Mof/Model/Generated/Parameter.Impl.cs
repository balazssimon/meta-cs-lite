...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class Parameter_Impl : __MetaModelObject, Parameter
    {
            ...
            : base(id)
        {
            ...
            Mof.__CustomImpl.Parameter(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Languages.Mof.Model.ParameterDirectionKind Direction
        {
            get => MGet<global::MetaDslx.Languages.Mof.Model.ParameterDirectionKind>(Mof.Parameter_Direction);
            set => MSet<global::MetaDslx.Languages.Mof.Model.ParameterDirectionKind>(Mof.Parameter_Direction, value);
        }
    
        public bool IsStream
        {
            get => MGet<bool>(Mof.Parameter_IsStream);
            set => MSet<bool>(Mof.Parameter_IsStream, value);
        }
    
        public Operation Operation
        {
            get => MGet<Operation>(Mof.Parameter_Operation);
            set => MSet<Operation>(Mof.Parameter_Operation, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.MultiplicityElementInfo, Mof.TypedElementInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.MultiplicityElementInfo, Mof.TypedElementInfo, Mof.NamedElementInfo, Mof.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Parameter_Direction, Mof.Parameter_IsStream, Mof.Parameter_Operation);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Parameter_Direction, Mof.Parameter_IsStream, Mof.Parameter_Operation, Mof.MultiplicityElement_IsOrdered, Mof.MultiplicityElement_IsUnique, Mof.MultiplicityElement_Lower, Mof.MultiplicityElement_LowerValue, Mof.MultiplicityElement_Upper, Mof.MultiplicityElement_UpperValue, Mof.TypedElement_Type, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Parameter_Direction, Mof.Parameter_IsStream, Mof.Parameter_Operation, Mof.MultiplicityElement_IsOrdered, Mof.MultiplicityElement_IsUnique, Mof.MultiplicityElement_Lower, Mof.MultiplicityElement_LowerValue, Mof.MultiplicityElement_Upper, Mof.MultiplicityElement_UpperValue, Mof.TypedElement_Type, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Direction", Mof.Parameter_Direction);
                publicPropertiesByName.Add("IsStream", Mof.Parameter_IsStream);
                publicPropertiesByName.Add("Operation", Mof.Parameter_Operation);
                ...
                modelPropertyInfos.Add(Mof.Parameter_Direction, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.Parameter_Direction, __ImmutableArray.Create<__ModelProperty>(Mof.Parameter_Direction), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Mof.Parameter_IsStream, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.Parameter_IsStream, __ImmutableArray.Create<__ModelProperty>(Mof.Parameter_IsStream), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Mof.Parameter_Operation, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.Parameter_Operation, __ImmutableArray.Create<__ModelProperty>(Mof.Parameter_Operation), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Mof.Operation_OwnedParameter), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
