...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class Classifier_Impl : __MetaModelObject, Classifier
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.NamespaceInfo, Mof.TypeInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.NamespaceInfo, Mof.TypeInfo, Mof.PackageableElementInfo, Mof.NamedElementInfo, Mof.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Classifier_Generalization, Mof.Classifier_IsAbstract);
