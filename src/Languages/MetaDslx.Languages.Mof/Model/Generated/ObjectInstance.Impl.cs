...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class ObjectInstance_Impl : __MetaModelObject, ObjectInstance
    {
        private ObjectInstance_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(ObjectInstance);
            ...
            {
                var result = new ObjectInstance_Impl(id);
