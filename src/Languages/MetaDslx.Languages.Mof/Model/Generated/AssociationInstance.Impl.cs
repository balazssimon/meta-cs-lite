...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class AssociationInstance_Impl : __MetaModelObject, AssociationInstance
    {
        private AssociationInstance_Impl(string? id)
            : base(id)
        {
            ...
            Mof.__CustomImpl.InstanceSpecification(this);
            Mof.__CustomImpl.Instance(this);
            Mof.__CustomImpl.ObjectInstance(this);
            Mof.__CustomImpl.AssociationInstance(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public Association Classifier
        {
            get => MGet<Association>(Mof.AssociationInstance_Classifier);
            set => MSet<Association>(Mof.AssociationInstance_Classifier, value);
        }
    
        public LinkSlot FirstSlot
        {
            get => MGet<LinkSlot>(Mof.AssociationInstance_FirstSlot);
            set => MSet<LinkSlot>(Mof.AssociationInstance_FirstSlot, value);
        }
    
        public LinkSlot SecondSlot
        {
            get => MGet<LinkSlot>(Mof.AssociationInstance_SecondSlot);
            set => MSet<LinkSlot>(Mof.AssociationInstance_SecondSlot, value);
        }
    
        [global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)]
        Classifier Instance.Classifier
        {
            get => MGet<Classifier>(Mof.Instance_Classifier);
            set => MSet<Classifier>(Mof.Instance_Classifier, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Slot> Slot
        {
            get => MGetCollection<Slot>(Mof.InstanceSpecification_Slot);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.ObjectInstanceInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.ObjectInstanceInfo, Mof.InstanceInfo, Mof.InstanceSpecificationInfo, Mof.PackageableElementInfo, Mof.NamedElementInfo, Mof.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.AssociationInstance_Classifier, Mof.AssociationInstance_FirstSlot, Mof.AssociationInstance_SecondSlot);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.AssociationInstance_Classifier, Mof.AssociationInstance_FirstSlot, Mof.AssociationInstance_SecondSlot, Mof.Instance_Classifier, Mof.InstanceSpecification_Slot, Mof.PackageableElement_OwningPackage, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.AssociationInstance_Classifier, Mof.AssociationInstance_FirstSlot, Mof.AssociationInstance_SecondSlot, Mof.InstanceSpecification_Slot, Mof.PackageableElement_OwningPackage, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Classifier", Mof.AssociationInstance_Classifier);
                publicPropertiesByName.Add("FirstSlot", Mof.AssociationInstance_FirstSlot);
                publicPropertiesByName.Add("SecondSlot", Mof.AssociationInstance_SecondSlot);
                publicPropertiesByName.Add("Slot", Mof.InstanceSpecification_Slot);
                ...
                modelPropertyInfos.Add(Mof.AssociationInstance_Classifier, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.AssociationInstance_Classifier, __ImmutableArray.Create<__ModelProperty>(Mof.AssociationInstance_Classifier, Mof.Instance_Classifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.Instance_Classifier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.Instance_Classifier), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Mof.AssociationInstance_FirstSlot, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.AssociationInstance_FirstSlot, __ImmutableArray.Create<__ModelProperty>(Mof.AssociationInstance_FirstSlot), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Mof.LinkSlot_OwningInstance), __ImmutableArray.Create<__ModelProperty>(Mof.InstanceSpecification_Slot), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Mof.AssociationInstance_SecondSlot, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.AssociationInstance_SecondSlot, __ImmutableArray.Create<__ModelProperty>(Mof.AssociationInstance_SecondSlot), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Mof.LinkSlot_OwningInstance), __ImmutableArray.Create<__ModelProperty>(Mof.InstanceSpecification_Slot), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Mof.Instance_Classifier, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.AssociationInstance_Classifier, __ImmutableArray.Create<__ModelProperty>(Mof.AssociationInstance_Classifier, Mof.Instance_Classifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.AssociationInstance_Classifier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.AssociationInstance_Classifier)));
                modelPropertyInfos.Add(Mof.InstanceSpecification_Slot, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.InstanceSpecification_Slot, __ImmutableArray.Create<__ModelProperty>(Mof.InstanceSpecification_Slot), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(Mof.AssociationInstance_FirstSlot, Mof.AssociationInstance_SecondSlot), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Mof.Element_OwnedElement, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.Element_OwnedElement, __ImmutableArray.Create<__ModelProperty>(Mof.Element_OwnedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Mof.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.InstanceSpecification_Slot), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(AssociationInstance);
            ...
            {
                var result = new AssociationInstance_Impl(id);
            ...
            {
                return "Mof.AssociationInstanceInfo";
            }
        }
    }
}
