...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class PrimitiveDataValue_Impl : __MetaModelObject, PrimitiveDataValue
    {
        private PrimitiveDataValue_Impl(string? id)
            : base(id)
        {
            ...
            Mof.__CustomImpl.ElementInstance(this);
            Mof.__CustomImpl.DataValue(this);
            Mof.__CustomImpl.PrimitiveDataValue(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public PrimitiveType Classifier
        {
            get => MGet<PrimitiveType>(Mof.PrimitiveDataValue_Classifier);
            set => MSet<PrimitiveType>(Mof.PrimitiveDataValue_Classifier, value);
        }
    
        [global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)]
        DataType DataValue.Classifier
        {
            get => MGet<DataType>(Mof.DataValue_Classifier);
            set => MSet<DataType>(Mof.DataValue_Classifier, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<StructureSlot> Slot
        {
            get => MGetCollection<StructureSlot>(Mof.ElementInstance_Slot);
        }
        ...
        [global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)]
        global::MetaDslx.Modeling.ICollectionSlot<Slot> InstanceSpecification.Slot
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.DataValueInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.DataValueInfo, Mof.ElementInstanceInfo, Mof.InstanceInfo, Mof.InstanceSpecificationInfo, Mof.ValueSpecificationInfo, Mof.PackageableElementInfo, Mof.TypedElementInfo, Mof.NamedElementInfo, Mof.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.PrimitiveDataValue_Classifier);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.PrimitiveDataValue_Classifier, Mof.DataValue_Classifier, Mof.ElementInstance_Slot, Mof.Instance_Classifier, Mof.InstanceSpecification_Slot, Mof.ValueSpecification_OwningConstraint, Mof.ValueSpecification_OwningLower, Mof.ValueSpecification_OwningProperty, Mof.ValueSpecification_OwningUpper, Mof.PackageableElement_OwningPackage, Mof.TypedElement_Type, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.PrimitiveDataValue_Classifier, Mof.ElementInstance_Slot, Mof.ValueSpecification_OwningConstraint, Mof.ValueSpecification_OwningLower, Mof.ValueSpecification_OwningProperty, Mof.ValueSpecification_OwningUpper, Mof.PackageableElement_OwningPackage, Mof.TypedElement_Type, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Classifier", Mof.PrimitiveDataValue_Classifier);
                publicPropertiesByName.Add("Slot", Mof.ElementInstance_Slot);
                ...
                modelPropertyInfos.Add(Mof.PrimitiveDataValue_Classifier, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.PrimitiveDataValue_Classifier, __ImmutableArray.Create<__ModelProperty>(Mof.PrimitiveDataValue_Classifier, Mof.DataValue_Classifier, Mof.Instance_Classifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.Instance_Classifier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.DataValue_Classifier, Mof.Instance_Classifier), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Mof.DataValue_Classifier, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.PrimitiveDataValue_Classifier, __ImmutableArray.Create<__ModelProperty>(Mof.PrimitiveDataValue_Classifier, Mof.DataValue_Classifier, Mof.Instance_Classifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.Instance_Classifier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.Instance_Classifier), __ImmutableArray.Create<__ModelProperty>(Mof.PrimitiveDataValue_Classifier)));
                modelPropertyInfos.Add(Mof.ElementInstance_Slot, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.ElementInstance_Slot, __ImmutableArray.Create<__ModelProperty>(Mof.ElementInstance_Slot, Mof.InstanceSpecification_Slot, Mof.Element_OwnedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Mof.StructureSlot_OwningInstance), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.Element_OwnedElement, Mof.InstanceSpecification_Slot), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.InstanceSpecification_Slot), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Mof.Instance_Classifier, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.PrimitiveDataValue_Classifier, __ImmutableArray.Create<__ModelProperty>(Mof.PrimitiveDataValue_Classifier, Mof.DataValue_Classifier, Mof.Instance_Classifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.PrimitiveDataValue_Classifier, Mof.DataValue_Classifier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.PrimitiveDataValue_Classifier, Mof.DataValue_Classifier)));
                modelPropertyInfos.Add(Mof.InstanceSpecification_Slot, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.ElementInstance_Slot, __ImmutableArray.Create<__ModelProperty>(Mof.ElementInstance_Slot, Mof.InstanceSpecification_Slot, Mof.Element_OwnedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.ElementInstance_Slot), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.ElementInstance_Slot)));
                ...
                modelPropertyInfos.Add(Mof.Element_OwnedElement, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.ElementInstance_Slot, __ImmutableArray.Create<__ModelProperty>(Mof.ElementInstance_Slot, Mof.InstanceSpecification_Slot, Mof.Element_OwnedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Mof.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.InstanceSpecification_Slot), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.ElementInstance_Slot), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(PrimitiveDataValue);
            ...
            {
                var result = new PrimitiveDataValue_Impl(id);
            ...
            {
                return "Mof.PrimitiveDataValueInfo";
            }
        }
    }
}
