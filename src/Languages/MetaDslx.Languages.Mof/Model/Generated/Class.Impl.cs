...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class Class_Impl : __MetaModelObject, Class
    {
        private Class_Impl(string? id)
            : base(id)
        {
        ...
        {
            get => MGetCollection<Property>(Mof.Class_OwnedAttribute);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<Operation> OwnedOperation
        {
            get => MGetCollection<Operation>(Mof.Class_OwnedOperation);
        }
    
        public global::System.Collections.Generic.IList<Class> SuperClass
        {
            get => Mof.__CustomImpl.Class_SuperClass(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.ClassifierInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.ClassifierInfo, Mof.NamespaceInfo, Mof.TypeInfo, Mof.PackageableElementInfo, Mof.NamedElementInfo, Mof.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Class_OwnedAttribute, Mof.Class_OwnedOperation, Mof.Class_SuperClass);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Class_OwnedAttribute, Mof.Class_OwnedOperation, Mof.Class_SuperClass, Mof.Classifier_Generalization, Mof.Classifier_IsAbstract, Mof.Namespace_Member, Mof.Namespace_OwnedMember, Mof.Namespace_OwnedRule, Mof.Namespace_PackageImport, Mof.Type_Package, Mof.Type_TypedElement, Mof.PackageableElement_OwningPackage, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Class_OwnedAttribute, Mof.Class_OwnedOperation, Mof.Class_SuperClass, Mof.Classifier_Generalization, Mof.Classifier_IsAbstract, Mof.Namespace_Member, Mof.Namespace_OwnedMember, Mof.Namespace_OwnedRule, Mof.Namespace_PackageImport, Mof.Type_Package, Mof.Type_TypedElement, Mof.PackageableElement_OwningPackage, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("OwnedAttribute", Mof.Class_OwnedAttribute);
                publicPropertiesByName.Add("OwnedOperation", Mof.Class_OwnedOperation);
                publicPropertiesByName.Add("SuperClass", Mof.Class_SuperClass);
                ...
                modelPropertyInfos.Add(Mof.Class_OwnedAttribute, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.Class_OwnedAttribute, __ImmutableArray.Create<__ModelProperty>(Mof.Class_OwnedAttribute), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Mof.Property_Class), __ImmutableArray.Create<__ModelProperty>(Mof.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Mof.Class_OwnedOperation, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.Class_OwnedOperation, __ImmutableArray.Create<__ModelProperty>(Mof.Class_OwnedOperation), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Mof.Operation_Class), __ImmutableArray.Create<__ModelProperty>(Mof.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Mof.Class_SuperClass, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.Class_SuperClass, __ImmutableArray.Create<__ModelProperty>(Mof.Class_SuperClass), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Collection | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Mof.Element_OwnedElement, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.Element_OwnedElement, __ImmutableArray.Create<__ModelProperty>(Mof.Element_OwnedElement), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Mof.Element_Owner), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.Class_OwnedAttribute, Mof.Class_OwnedOperation), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Class);
