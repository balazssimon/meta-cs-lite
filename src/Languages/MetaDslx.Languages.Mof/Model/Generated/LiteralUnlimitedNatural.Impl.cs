...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class LiteralUnlimitedNatural_Impl : __MetaModelObject, LiteralUnlimitedNatural
    {
            ...
            : base(id)
        {
            ...
            Mof.__CustomImpl.LiteralUnlimitedNatural(this);
        }
        ...
        public long Value
        {
            get => MGet<long>(Mof.LiteralUnlimitedNatural_Value);
            set => MSet<long>(Mof.LiteralUnlimitedNatural_Value, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.LiteralUnlimitedNatural_Value);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.LiteralUnlimitedNatural_Value, Mof.ValueSpecification_OwningConstraint, Mof.ValueSpecification_OwningLower, Mof.ValueSpecification_OwningProperty, Mof.ValueSpecification_OwningUpper, Mof.PackageableElement_OwningPackage, Mof.TypedElement_Type, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.LiteralUnlimitedNatural_Value, Mof.ValueSpecification_OwningConstraint, Mof.ValueSpecification_OwningLower, Mof.ValueSpecification_OwningProperty, Mof.ValueSpecification_OwningUpper, Mof.PackageableElement_OwningPackage, Mof.TypedElement_Type, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Value", Mof.LiteralUnlimitedNatural_Value);
                ...
                modelPropertyInfos.Add(Mof.LiteralUnlimitedNatural_Value, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.LiteralUnlimitedNatural_Value, __ImmutableArray.Create<__ModelProperty>(Mof.LiteralUnlimitedNatural_Value), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            {
                return "Mof.LiteralUnlimitedNaturalInfo";
            }
        }
    }
}
