...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class Generalization_Impl : __MetaModelObject, Generalization
    {
            ...
            : base(id)
        {
            ...
            Mof.__CustomImpl.Generalization(this);
        }
        ...
        {
            get => MGet<Classifier>(Mof.Generalization_General);
            set => MSet<Classifier>(Mof.Generalization_General, value);
        }
    
        public Classifier Specific
        {
            get => MGet<Classifier>(Mof.Generalization_Specific);
            set => MSet<Classifier>(Mof.Generalization_Specific, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Generalization_General, Mof.Generalization_Specific);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Generalization_General, Mof.Generalization_Specific, Mof.DirectedRelationship_Source, Mof.DirectedRelationship_Target, Mof.Relationship_RelatedElement, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Generalization_General, Mof.Generalization_Specific, Mof.DirectedRelationship_Source, Mof.DirectedRelationship_Target, Mof.Relationship_RelatedElement, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("General", Mof.Generalization_General);
                publicPropertiesByName.Add("Specific", Mof.Generalization_Specific);
