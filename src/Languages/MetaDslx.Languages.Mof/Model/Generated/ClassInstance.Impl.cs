...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class ClassInstance_Impl : __MetaModelObject, ClassInstance
    {
        private ClassInstance_Impl(string? id)
            : base(id)
        {
            ...
            Mof.__CustomImpl.ClassInstance(this);
        }
        ...
        {
            get => MGet<Class>(Mof.ClassInstance_Classifier);
            set => MSet<Class>(Mof.ClassInstance_Classifier, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.ElementInstanceInfo, Mof.ObjectInstanceInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.ElementInstanceInfo, Mof.ObjectInstanceInfo, Mof.InstanceInfo, Mof.InstanceSpecificationInfo, Mof.PackageableElementInfo, Mof.NamedElementInfo, Mof.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.ClassInstance_Classifier);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.ClassInstance_Classifier, Mof.ElementInstance_Slot, Mof.Instance_Classifier, Mof.InstanceSpecification_Slot, Mof.PackageableElement_OwningPackage, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.ClassInstance_Classifier, Mof.ElementInstance_Slot, Mof.PackageableElement_OwningPackage, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Classifier", Mof.ClassInstance_Classifier);
                ...
                modelPropertyInfos.Add(Mof.ClassInstance_Classifier, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.ClassInstance_Classifier, __ImmutableArray.Create<__ModelProperty>(Mof.ClassInstance_Classifier, Mof.Instance_Classifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.Instance_Classifier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.Instance_Classifier), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Mof.Instance_Classifier, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.ClassInstance_Classifier, __ImmutableArray.Create<__ModelProperty>(Mof.ClassInstance_Classifier, Mof.Instance_Classifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.ClassInstance_Classifier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.ClassInstance_Classifier)));
            ...
            public override __MetaType MetaType => typeof(ClassInstance);
            ...
            {
                var result = new ClassInstance_Impl(id);
