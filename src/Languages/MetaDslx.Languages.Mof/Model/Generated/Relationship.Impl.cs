...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class Relationship_Impl : __MetaModelObject, Relationship
    {
        private Relationship_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Relationship_RelatedElement);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Relationship_RelatedElement, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Relationship_RelatedElement, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
            ...
            public override __MetaType MetaType => typeof(Relationship);
            ...
            {
                var result = new Relationship_Impl(id);
