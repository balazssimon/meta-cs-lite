...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class LiteralString_Impl : __MetaModelObject, LiteralString
    {
            ...
            : base(id)
        {
            ...
            Mof.__CustomImpl.LiteralString(this);
        }
        ...
        public string Value
        {
            get => MGet<string>(Mof.LiteralString_Value);
            set => MSet<string>(Mof.LiteralString_Value, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.LiteralString_Value);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.LiteralString_Value, Mof.ValueSpecification_OwningConstraint, Mof.ValueSpecification_OwningLower, Mof.ValueSpecification_OwningProperty, Mof.ValueSpecification_OwningUpper, Mof.PackageableElement_OwningPackage, Mof.TypedElement_Type, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.LiteralString_Value, Mof.ValueSpecification_OwningConstraint, Mof.ValueSpecification_OwningLower, Mof.ValueSpecification_OwningProperty, Mof.ValueSpecification_OwningUpper, Mof.PackageableElement_OwningPackage, Mof.TypedElement_Type, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Value", Mof.LiteralString_Value);
                ...
                modelPropertyInfos.Add(Mof.LiteralString_Value, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.LiteralString_Value, __ImmutableArray.Create<__ModelProperty>(Mof.LiteralString_Value), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
