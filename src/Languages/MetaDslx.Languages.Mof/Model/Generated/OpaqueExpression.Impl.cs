...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class OpaqueExpression_Impl : __MetaModelObject, OpaqueExpression
    {
            ...
            : base(id)
        {
            ...
            Mof.__CustomImpl.OpaqueExpression(this);
        }
        ...
        public string Body
        {
            get => MGet<string>(Mof.OpaqueExpression_Body);
            set => MSet<string>(Mof.OpaqueExpression_Body, value);
        }
    
        public string Language
        {
            get => MGet<string>(Mof.OpaqueExpression_Language);
            set => MSet<string>(Mof.OpaqueExpression_Language, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.ValueSpecificationInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.ValueSpecificationInfo, Mof.PackageableElementInfo, Mof.TypedElementInfo, Mof.NamedElementInfo, Mof.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.OpaqueExpression_Body, Mof.OpaqueExpression_Language);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.OpaqueExpression_Body, Mof.OpaqueExpression_Language, Mof.ValueSpecification_OwningConstraint, Mof.ValueSpecification_OwningLower, Mof.ValueSpecification_OwningProperty, Mof.ValueSpecification_OwningUpper, Mof.PackageableElement_OwningPackage, Mof.TypedElement_Type, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.OpaqueExpression_Body, Mof.OpaqueExpression_Language, Mof.ValueSpecification_OwningConstraint, Mof.ValueSpecification_OwningLower, Mof.ValueSpecification_OwningProperty, Mof.ValueSpecification_OwningUpper, Mof.PackageableElement_OwningPackage, Mof.TypedElement_Type, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Body", Mof.OpaqueExpression_Body);
                publicPropertiesByName.Add("Language", Mof.OpaqueExpression_Language);
                ...
                modelPropertyInfos.Add(Mof.OpaqueExpression_Body, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.OpaqueExpression_Body, __ImmutableArray.Create<__ModelProperty>(Mof.OpaqueExpression_Body), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Mof.OpaqueExpression_Language, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.OpaqueExpression_Language, __ImmutableArray.Create<__ModelProperty>(Mof.OpaqueExpression_Language), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            {
                return "Mof.OpaqueExpressionInfo";
            }
        }
    }
}
