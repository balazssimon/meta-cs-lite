...
namespace MetaDslx.Languages.Mof.Model
{
    ...
    public interface Constraint : global::MetaDslx.Languages.Mof.Model.PackageableElement
    {
        Operation BodyContext { get; set; }
        global::MetaDslx.Modeling.ICollectionSlot<Element> ConstrainedElement { get; }
        Namespace Context { get; set; }
        Operation PostContext { get; set; }
        Operation PreContext { get; set; }
