...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class EnumerationLiteral_Impl : __MetaModelObject, EnumerationLiteral
    {
            ...
            : base(id)
        {
            ...
            Mof.__CustomImpl.EnumerationLiteral(this);
        }
        ...
        {
            get => MGet<Enumeration>(Mof.EnumerationLiteral_Enumeration);
            set => MSet<Enumeration>(Mof.EnumerationLiteral_Enumeration, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.InstanceSpecificationInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.InstanceSpecificationInfo, Mof.PackageableElementInfo, Mof.NamedElementInfo, Mof.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.EnumerationLiteral_Enumeration);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.EnumerationLiteral_Enumeration, Mof.InstanceSpecification_Slot, Mof.PackageableElement_OwningPackage, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.EnumerationLiteral_Enumeration, Mof.InstanceSpecification_Slot, Mof.PackageableElement_OwningPackage, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Enumeration", Mof.EnumerationLiteral_Enumeration);
                ...
                modelPropertyInfos.Add(Mof.EnumerationLiteral_Enumeration, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.EnumerationLiteral_Enumeration, __ImmutableArray.Create<__ModelProperty>(Mof.EnumerationLiteral_Enumeration), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Mof.Enumeration_OwnedLiteral), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Mof.InstanceSpecification_Slot, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.InstanceSpecification_Slot, __ImmutableArray.Create<__ModelProperty>(Mof.InstanceSpecification_Slot), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.Element_OwnedElement), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            {
                return "Mof.EnumerationLiteralInfo";
            }
        }
    }
}
