...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class PackageImport_Impl : __MetaModelObject, PackageImport
    {
            ...
            : base(id)
        {
            ...
            Mof.__CustomImpl.PackageImport(this);
        }
        ...
        {
            get => MGet<Package>(Mof.PackageImport_ImportedPackage);
            set => MSet<Package>(Mof.PackageImport_ImportedPackage, value);
        }
    
        public Namespace ImportingNamespace
        {
            get => MGet<Namespace>(Mof.PackageImport_ImportingNamespace);
            set => MSet<Namespace>(Mof.PackageImport_ImportingNamespace, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.PackageImport_ImportedPackage, Mof.PackageImport_ImportingNamespace);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.PackageImport_ImportedPackage, Mof.PackageImport_ImportingNamespace, Mof.DirectedRelationship_Source, Mof.DirectedRelationship_Target, Mof.Relationship_RelatedElement, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.PackageImport_ImportedPackage, Mof.PackageImport_ImportingNamespace, Mof.DirectedRelationship_Source, Mof.DirectedRelationship_Target, Mof.Relationship_RelatedElement, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("ImportedPackage", Mof.PackageImport_ImportedPackage);
                publicPropertiesByName.Add("ImportingNamespace", Mof.PackageImport_ImportingNamespace);
