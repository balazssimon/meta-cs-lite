...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class LiteralSpecification_Impl : __MetaModelObject, LiteralSpecification
    {
        private LiteralSpecification_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(LiteralSpecification);
            ...
            {
                var result = new LiteralSpecification_Impl(id);
            ...
            {
                return "Mof.LiteralSpecificationInfo";
            }
        }
    }
}
