    ...
    internal class Slot_Impl : __MetaModelObject, Slot
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Slot_OwningInstance, Mof.Slot_Value);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Slot_OwningInstance, Mof.Slot_Value);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.Slot_OwningInstance, Mof.Slot_Value);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("OwningInstance", Mof.Slot_OwningInstance);
                publicPropertiesByName.Add("Value", Mof.Slot_Value);
                _publicPropertiesByName = publicPropertiesByName.ToImmutable();
                var modelPropertyInfos = __ImmutableDictionary.CreateBuilder<__ModelProperty, __ModelPropertyInfo>();
                modelPropertyInfos.Add(Mof.Slot_OwningInstance, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.Slot_OwningInstance, __ImmutableArray.Create<__ModelProperty>(Mof.Slot_OwningInstance), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
