...
namespace MetaDslx.Languages.Mof.Model.__Impl
{
    ...
    internal class DataValue_Impl : __MetaModelObject, DataValue
    {
        private DataValue_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.ElementInstanceInfo, Mof.ValueSpecificationInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Mof.ElementInstanceInfo, Mof.InstanceInfo, Mof.InstanceSpecificationInfo, Mof.ValueSpecificationInfo, Mof.PackageableElementInfo, Mof.TypedElementInfo, Mof.NamedElementInfo, Mof.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.DataValue_Classifier);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Mof.DataValue_Classifier, Mof.ElementInstance_Slot, Mof.Instance_Classifier, Mof.InstanceSpecification_Slot, Mof.ValueSpecification_OwningConstraint, Mof.ValueSpecification_OwningLower, Mof.ValueSpecification_OwningProperty, Mof.ValueSpecification_OwningUpper, Mof.PackageableElement_OwningPackage, Mof.TypedElement_Type, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Mof.DataValue_Classifier, Mof.ElementInstance_Slot, Mof.ValueSpecification_OwningConstraint, Mof.ValueSpecification_OwningLower, Mof.ValueSpecification_OwningProperty, Mof.ValueSpecification_OwningUpper, Mof.PackageableElement_OwningPackage, Mof.TypedElement_Type, Mof.NamedElement_MemberNamespace, Mof.NamedElement_Name, Mof.NamedElement_Namespace, Mof.NamedElement_QualifiedName, Mof.NamedElement_Visibility, Mof.Element_Comment, Mof.Element_OwnedComment, Mof.Element_OwnedElement, Mof.Element_Owner, Mof.Element_Relationship, Mof.Element_Tag);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Classifier", Mof.DataValue_Classifier);
                ...
                modelPropertyInfos.Add(Mof.Instance_Classifier, new __ModelPropertyInfo(new __ModelPropertySlot(Mof.DataValue_Classifier, __ImmutableArray.Create<__ModelProperty>(Mof.DataValue_Classifier, Mof.Instance_Classifier), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.DataValue_Classifier), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Mof.DataValue_Classifier)));
            ...
            public override __MetaType MetaType => typeof(DataValue);
            ...
            {
                var result = new DataValue_Impl(id);
