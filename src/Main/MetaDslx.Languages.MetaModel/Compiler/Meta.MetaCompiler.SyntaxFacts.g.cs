...
namespace MetaDslx.Languages.MetaModel.Compiler.Syntax
{
	...
	return "TypeReferenceTokens";
				case MetaSyntaxKind.SimpleTypeReferenceAlt2: 
	...
	return "Identifier";
				case MetaSyntaxKind.EnumBodyEnumLiteralsBlock: 
	return "EnumBodyEnumLiteralsBlock";
				case MetaSyntaxKind.BaseClassesBaseTypesBlock: 
	return "BaseClassesBaseTypesBlock";
	...
	return "PropertyRedefines";
				case MetaSyntaxKind.PropertyOppositeOppositePropertiesBlock: 
	return "PropertyOppositeOppositePropertiesBlock";
				case MetaSyntaxKind.PropertySubsetsSubsettedPropertiesBlock: 
	return "PropertySubsetsSubsettedPropertiesBlock";
				case MetaSyntaxKind.PropertyRedefinesRedefinedPropertiesBlock: 
	return "PropertyRedefinesRedefinedPropertiesBlock";
				case MetaSyntaxKind.MetaOperationParameterListBlock: 
	return "MetaOperationParameterListBlock";
				case MetaSyntaxKind.QualifierQualifierBlock: 
	return "QualifierQualifierBlock";
default:
	return string.Empty;
}
}
