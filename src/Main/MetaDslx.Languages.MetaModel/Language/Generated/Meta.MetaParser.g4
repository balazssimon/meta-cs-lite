...
pr_MetaClass
    ...
    ;
pr_MetaProperty
    :  E_Block=pr_MetaPropertyBlock1?  E_type=pr_MetaTypeReference  E_Block1=pr_MetaPropertyBlock2  E_Block2+=pr_MetaPropertyBlock3*  E_TSemicolon=LR_TSemicolon
    ;
pr_MetaOperation
...
pr_MetaPropertyBlock3
    :  E_KOpposite=LR_KOpposite   E_oppositeProperties1=pr_Qualifier(E_TComma1+=LR_TComma E_oppositeProperties2+=pr_Qualifier)* #pr_MetaPropertyBlock3Alt1
    |  E_KSubsets=LR_KSubsets   E_subsettedProperties1=pr_Qualifier(E_TComma2+=LR_TComma E_subsettedProperties2+=pr_Qualifier)* #pr_MetaPropertyBlock3Alt2
    |  E_KRedefines=LR_KRedefines   E_redefinedProperties1=pr_Qualifier(E_TComma3+=LR_TComma E_redefinedProperties2+=pr_Qualifier)* #pr_MetaPropertyBlock3Alt3
    ;
pr_MetaPropertyBlock3Alt1oppositePropertiesBlock
    :  E_TComma1=LR_TComma  E_oppositeProperties2=pr_Qualifier
    ;
pr_MetaPropertyBlock3Alt2subsettedPropertiesBlock
    :  E_TComma2=LR_TComma  E_subsettedProperties2=pr_Qualifier
    ;
pr_MetaPropertyBlock3Alt3redefinedPropertiesBlock
