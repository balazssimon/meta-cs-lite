...
namespace MetaDslx.Languages.MetaModel.Model.__Impl
{
    ...
    internal class MetaEnum_Impl : __MetaModelObject, MetaEnum
    {
        ...
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Languages.MetaModel.Model.MetaEnumLiteral> Literals
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Meta.MetaEnum_Literals, Meta.MetaDeclaration_FullName, Meta.MetaDeclaration_Name, Meta.MetaDeclaration_Namespace);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Meta.MetaEnum_Literals, Meta.MetaDeclaration_FullName, Meta.MetaDeclaration_Name, Meta.MetaDeclaration_Namespace);
