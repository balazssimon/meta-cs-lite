...
namespace MetaDslx.Languages.MetaModel.Model.__Impl
{
    ...
    internal class MetaProperty_Impl : __MetaModelObject, MetaProperty
    {
        ...
        public bool IsLazy
        {
            get => MGet<bool>(Meta.MetaProperty_IsLazy);
            set => MSet<bool>(Meta.MetaProperty_IsLazy, value);
        }
        ...
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Languages.MetaModel.Model.MetaProperty> OppositeProperties
        {
            get => MGetCollection<MetaProperty>(Meta.MetaProperty_OppositeProperties);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Languages.MetaModel.Model.MetaProperty> RedefinedProperties
        {
            get => MGetCollection<MetaProperty>(Meta.MetaProperty_RedefinedProperties);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Languages.MetaModel.Model.MetaProperty> SubsettedProperties
        {
        ...
        public MetaDslx.Languages.MetaModel.Model.MetaTypeReference Type
        {
            get => MGet<MetaDslx.Languages.MetaModel.Model.MetaTypeReference>(Meta.MetaProperty_Type);
            set => MSet<MetaDslx.Languages.MetaModel.Model.MetaTypeReference>(Meta.MetaProperty_Type, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                publicPropertiesByName.Add("IsLazy", Meta.MetaProperty_IsLazy);
                ...
                modelPropertyInfos.Add(Meta.MetaProperty_IsLazy, new __ModelPropertyInfo(new __ModelPropertySlot(Meta.MetaProperty_IsLazy, __ImmutableArray.Create<__ModelProperty>(Meta.MetaProperty_IsLazy), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Meta.MetaProperty_Type, new __ModelPropertyInfo(new __ModelPropertySlot(Meta.MetaProperty_Type, __ImmutableArray.Create<__ModelProperty>(Meta.MetaProperty_Type), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
