...
namespace MetaDslx.Languages.MetaModel.Model.__Impl
{
    ...
    internal class MetaParameter_Impl : __MetaModelObject, MetaParameter
    {
        ...
        {
            get => MGet<MetaDslx.Languages.MetaModel.Model.MetaTypeReference>(Meta.MetaParameter_Type);
            set => MSet<MetaDslx.Languages.MetaModel.Model.MetaTypeReference>(Meta.MetaParameter_Type, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                modelPropertyInfos.Add(Meta.MetaParameter_Type, new __ModelPropertyInfo(new __ModelPropertySlot(Meta.MetaParameter_Type, __ImmutableArray.Create<__ModelProperty>(Meta.MetaParameter_Type), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
