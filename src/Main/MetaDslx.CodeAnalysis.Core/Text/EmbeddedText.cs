...
namespace MetaDslx.CodeAnalysis
{
    ...
    public sealed class EmbeddedText
    {
        ...
        public static EmbeddedText FromSource(string filePath, SourceText text)
        {
            ...
            {
                throw new ArgumentException(ExceptionMessages.SourceTextCannotBeEmbedded, nameof(text));
            }
        ...
        private static void ValidateFilePath(string filePath)
        {
            ...
            {
                throw new ArgumentException(ExceptionMessages.ArgumentCannotBeEmpty, nameof(filePath));
            }
        }
        ...
        internal static ImmutableArray<byte> CreateBlob(Stream stream)
        {
            ...
            {
                throw new IOException(ExceptionMessages.StreamIsTooLong);
            }
