...
namespace MetaDslx.CodeAnalysis.Parsers.Antlr
{
    ...
    public class DefaultErrorStrategy : IAntlrErrorStrategy
    {
        ...
        protected internal virtual IToken ConstructToken(ITokenSource tokenSource, int expectedTokenType, string tokenText, IToken current)
        {
            ...
            return factory.Create(Tuple.Create(tokenSource, tokenSource.InputStream), expectedTokenType, tokenText, TokenConstants.DefaultChannel, tokenSource.Line, tokenSource.Column, tokenSource.Line, tokenSource.Column);
        }
