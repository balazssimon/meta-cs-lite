...
namespace MetaDslx.Languages.MetaSymbols.Compiler.Syntax.InternalSyntax
{
    internal class SymbolInternalSyntaxVisitor : global::MetaDslx.CodeAnalysis.Syntax.InternalSyntax.InternalSyntaxVisitor
    {
        ...
        public virtual void VisitSymbolBlock1baseTypesBlockGreen(SymbolBlock1baseTypesBlockGreen node) => this.DefaultVisit(node);
        ...
        public virtual void VisitOperationBlock1parametersBlockGreen(OperationBlock1parametersBlockGreen node) => this.DefaultVisit(node);
    ...
    internal class SymbolInternalSyntaxVisitor<TResult> : global::MetaDslx.CodeAnalysis.Syntax.InternalSyntax.InternalSyntaxVisitor<TResult>
    {
        ...
        public virtual TResult VisitSymbolBlock1baseTypesBlockGreen(SymbolBlock1baseTypesBlockGreen node) => this.DefaultVisit(node);
        ...
        public virtual TResult VisitOperationBlock1parametersBlockGreen(OperationBlock1parametersBlockGreen node) => this.DefaultVisit(node);
