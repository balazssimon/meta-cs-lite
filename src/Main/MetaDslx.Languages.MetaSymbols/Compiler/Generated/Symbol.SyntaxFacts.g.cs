    ...
    public class SymbolSyntaxFacts : global::MetaDslx.CodeAnalysis.Syntax.SyntaxFacts
    {
        ...
        public SymbolSyntaxKind GetFixedTokenKind(string text)
        {
            switch (text)
            {
                ...
                case "cached": 
                    return SymbolSyntaxKind.KCached;
                case "object": 
                ...
                case "plain": 
                    return SymbolSyntaxKind.KPlain;
                case "derived": 
        ...
        public string GetKindText(SymbolSyntaxKind kind)
        {
            switch (kind)
            {
                ...
                case SymbolSyntaxKind.PropertyBlock1Alt3: 
                    return "PropertyBlock1Alt3";
                case SymbolSyntaxKind.PropertyBlock1Alt1Block1Alt1: 
                    return "PropertyBlock1Alt1Block1Alt1";
                case SymbolSyntaxKind.PropertyBlock1Alt1Block1Alt2: 
                    return "PropertyBlock1Alt1Block1Alt2";
                ...
                case SymbolSyntaxKind.OperationAlt2Block2: 
                    return "OperationAlt2Block2";
        ...
        public global::System.Collections.Generic.IEnumerable<SymbolSyntaxKind> GetReservedKeywordKinds()
        {
            ...
            yield return SymbolSyntaxKind.KCached;
