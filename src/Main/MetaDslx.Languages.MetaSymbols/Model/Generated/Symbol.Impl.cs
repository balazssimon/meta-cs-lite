    ...
    internal class Symbol_Impl : __MetaModelObject, Symbol
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Symbols.Symbol_BaseTypes, Symbols.Symbol_IsAbstract, Symbols.Symbol_Operations, Symbols.Symbol_Properties, Symbols.Declaration_Declarations, Symbols.Declaration_FullName, Symbols.Declaration_Name, Symbols.Declaration_Parent);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Symbols.Symbol_BaseTypes, Symbols.Symbol_IsAbstract, Symbols.Symbol_Operations, Symbols.Symbol_Properties, Symbols.Declaration_Declarations, Symbols.Declaration_FullName, Symbols.Declaration_Name, Symbols.Declaration_Parent);
