...
namespace MetaDslx.Languages.MetaSymbols.Model
{
    ...
    public sealed class Symbols : __MetaModel, ISymbols
    {
        ...
        private Symbols()
        {
            ...
            obj39.Name = "IsPhase";
            obj39.Parent = obj11;
            obj40.Type = __MetaType.FromModelObject(obj9);
            obj40.Name = "ReturnType";
            obj40.Parent = obj11;
            obj41.MChildren.Add(obj42);
            obj41.IsContainment = true;
            obj41.RedefinedProperties.Add(obj15);
            obj41.Type = __MetaType.FromModelObject(obj42);
            obj41.Name = "Parameters";
            obj41.Parent = obj11;
            obj42.ItemType = __MetaType.FromModelObject(obj12);
