    ...
    public readonly struct TextLine : IEquatable<TextLine>
    {
        ...
        public static TextLine FromSpan(SourceText text, TextSpan span)
        {
            ...
            if (text.Length > 0)
            {
                ...
                {
                    throw new ArgumentOutOfRangeException(nameof(span), ExceptionMessages.SpanDoesNotIncludeStartOfLine);
                }
                ...
                {
                    throw new ArgumentOutOfRangeException(nameof(span), ExceptionMessages.SpanDoesNotIncludeEndOfLine);
                }
