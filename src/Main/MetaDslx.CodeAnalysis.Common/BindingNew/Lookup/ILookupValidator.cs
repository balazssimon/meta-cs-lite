...
namespace MetaDslx.CodeAnalysis.Binding
{
    public interface ILookupValidator
    {
        ...
        /// If <see cref="IsViable(LookupContext, DeclarationSymbol)"/> returns false,
        ...
        /// <see cref="IsViable(LookupContext, DeclarationSymbol)"/> should return true 
        /// and <see cref="ValidateResult(LookupContext, DeclarationSymbol, DeclarationSymbol)"/>
        ...
        /// <returns></returns>
        bool IsViable(LookupContext context, DeclarationSymbol symbol);
