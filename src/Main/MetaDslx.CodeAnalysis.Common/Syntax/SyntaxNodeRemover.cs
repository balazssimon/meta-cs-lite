...
namespace MetaDslx.CodeAnalysis.Syntax
{
    internal static class SyntaxNodeRemover
    {
        ...
        private class SyntaxRemover : SyntaxRewriter
        {
            ...
            /// <summary>
            /// Returns whether the specified <see cref="SyntaxTrivia"/> token is also the end of the line.
            /// </summary>
            ...
            public override SyntaxToken VisitToken(SyntaxToken token)
            {
                ...
                if (result.RawKind != (int)InternalSyntaxKind.None && _residualTrivia != null && _residualTrivia.Count > 0)
                {
            ...
            public override SeparatedSyntaxList<TNode> VisitList<TNode>(SeparatedSyntaxList<TNode> list)
            {
                ...
                for (int i = 0, n = withSeps.Count; i < n; i++)
                {
                    ...
                    if (alternate != null && visited.RawKind != (int)InternalSyntaxKind.None)
                    {
