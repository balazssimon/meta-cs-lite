...
namespace MetaDslx.CodeAnalysis.Symbols.Implementation
{
    ...
    {
        public ImportSymbolImpl(Symbol? container, Compilation? compilation, MergedDeclaration? declaration, __IModelObject? modelObject, __ISymbol? csharpSymbol, ErrorSymbolInfo? errorInfo)
