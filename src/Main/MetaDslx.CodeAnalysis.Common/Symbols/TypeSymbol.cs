    ...
    public abstract partial class TypeSymbol : NamespaceOrTypeSymbol
    {
        ...
        private class BaseTypeInfo
        {
            ...
            internal readonly static MultiDictionary<NamedTypeSymbol, NamedTypeSymbol> EmptyBaseTypesAndTheirBaseTypes =
                new MultiDictionary<NamedTypeSymbol, NamedTypeSymbol>(0, TypeEqualityComparer.CLRSignature);
        ...
        /// </summary>
        public bool IsDerivedFrom(TypeSymbol type, TypeEqualityComparer comparison, ref HashSet<DiagnosticInfo> useSiteDiagnostics)
        {
        ...
        /// </summary>
        public bool IsEqualToOrDerivedFrom(TypeSymbol type, TypeEqualityComparer comparison, ref HashSet<DiagnosticInfo> useSiteDiagnostics)
        {
            return this.Equals(type, comparison) || this.IsDerivedFrom(type, comparison, ref useSiteDiagnostics);
        }


        public static bool Equals(TypeSymbol left, TypeSymbol right, TypeEqualityComparer comparison)
        {
            if (left is null)
            {
        ...
        public virtual bool Equals(TypeSymbol t2, TypeEqualityComparer comparison)
        {
            return comparison.Equals(this, t2);
        }
        ...
        public sealed override bool Equals(object obj)
        {
            ...
            return this.Equals(t2, TypeEqualityComparer.ConsiderEverything);
        }
        ...
        {
            var resultBuilder = new MultiDictionary<NamedTypeSymbol, NamedTypeSymbol>(declaredBaseTypes.Length, TypeEqualityComparer.CLRSignature);
        ...
        /// </summary>
        protected override DiagnosticDescriptor HighestPriorityUseSiteError => ErrorCode.ERR_BogusType;
        ...
        public sealed override bool HasUnsupportedMetadata
        {
            get
            {
                ...
                return info.Descriptor == ErrorCode.ERR_BogusType;
            }
        }
        ...
        /// </summary>
        public virtual void CheckAllConstraints(Compilation compilation, Location location, DiagnosticBag diagnostics)
        {
            // TODO:MetaDslx
        }

        public bool CheckAllConstraints(Compilation compilation)
        {
