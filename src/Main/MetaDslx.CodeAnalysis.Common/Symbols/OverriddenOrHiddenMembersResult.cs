    ...
    public sealed class OverriddenOrHiddenMembersResult
    {
        ...
        internal static MemberSymbol GetOverriddenMember(MemberSymbol substitutedOverridingMember, MemberSymbol overriddenByDefinitionMember)
        {
            ...
            if ((object)overriddenByDefinitionMember != null)
            {
                ...
                {
                    if (TypeSymbol.Equals(baseType.OriginalDefinition, overriddenByDefinitionContainingTypeDefinition, TypeEqualityComparer.ConsiderEverything))
                    {
                        if (TypeSymbol.Equals(baseType, overriddenByDefinitionContaining, TypeEqualityComparer.ConsiderEverything))
                        {
