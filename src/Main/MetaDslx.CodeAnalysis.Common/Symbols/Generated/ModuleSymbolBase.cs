namespace MetaDslx.CodeAnalysis.Symbols.__Impl
{
    ...
    public partial class ModuleSymbolInst : global::MetaDslx.CodeAnalysis.Symbols.SymbolInst, ModuleSymbol
    {
        ...
        public ModuleSymbolInst(__Symbol container, __Model model) 
        ...
        public ModuleSymbolInst(__Symbol container, __Compilation compilation) 
            : base(container, compilation)
        {
        }

        public ModuleSymbolInst(__Symbol container, __Compilation? compilation = null, __MergedDeclaration? declaration = null, __Model? model = null, __IModelObject? modelObject = null, __ISymbol csharpSymbol = null, string? name = default, string? metadataName = default, __ImmutableAttributeSymbols attributes = default, global::MetaDslx.CodeAnalysis.Symbols.ISymbolFactory symbolFactory = default) 
