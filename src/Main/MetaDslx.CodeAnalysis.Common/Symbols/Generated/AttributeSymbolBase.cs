namespace MetaDslx.CodeAnalysis.Symbols.__Impl
{
    ...
    public partial class AttributeSymbolInst : global::MetaDslx.CodeAnalysis.Symbols.SymbolInst, AttributeSymbol
    {
        ...
        public AttributeSymbolInst(__Symbol container, __Model model) 
        ...
        public AttributeSymbolInst(__Symbol container, __Compilation compilation) 
            : base(container, compilation)
        {
        }

        public AttributeSymbolInst(__Symbol container, __Compilation? compilation = null, __MergedDeclaration? declaration = null, __Model? model = null, __IModelObject? modelObject = null, __ISymbol csharpSymbol = null, string? name = default, string? metadataName = default, __ImmutableAttributeSymbols attributes = default, TypeSymbol attributeClass = default) 
