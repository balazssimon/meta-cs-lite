...
#pragma warning restore CA1200 // Avoid using cref tags with a prefix
        ...
        /// <summary>
        /// Indicates that the type is <see cref="MetaType"/>.
        /// </summary>
        MetaDslx_CodeAnalysis_MetaType = 47,

        /// <summary>
        /// Indicates that the type is <see cref="MetaSymbol"/>.
        /// </summary>
        MetaDslx_CodeAnalysis_MetaSymbol = 48,

        /// <summary>
        /// Indicates that the type is <see cref="Modeling.Model"/>.
        /// </summary>
        MetaDslx_Modeling_Model = 49,

        /// <summary>
        /// Indicates that the type is <see cref="Modeling.ModelGroup"/>.
        /// </summary>
        MetaDslx_Modeling_ModelGroup = 50,

        /// <summary>
        /// Indicates that the type is <see cref="Modeling.MetaModel"/>.
        /// </summary>
        MetaDslx_Modeling_MetaModel = 51,

        /// <summary>
        /// Indicates that the type is <see cref="Modeling.IModelObject"/>.
        /// </summary>
        MetaDslx_Modeling_IModelObject = 52,

        /// <summary>
        /// Indicates that the type is <see cref="Modeling.ModelObject"/>.
        /// </summary>
        MetaDslx_Modeling_ModelObject = 53,

        /// <summary>
        /// Indicates that the type is <see cref="Modeling.ModelProperty"/>.
        /// </summary>
        MetaDslx_Modeling_ModelProperty = 54,

        /// <summary>
        /// Indicates that the type is <see cref="Modeling.IModelCollection"/>.
        /// </summary>
        MetaDslx_Modeling_IModelCollection = 55,

        /// <summary>
        /// Indicates that the type is <see cref="Symbols.Symbol"/>.
        /// </summary>
        MetaDslx_CodeAnalysis_Symbol = 56,

        /// <summary>
        /// Indicates that the type is <see cref="Symbols.AssemblySymbol"/>.
        /// </summary>
        MetaDslx_CodeAnalysis_AssemblySymbol = 57,

        /// <summary>
        /// Indicates that the type is <see cref="Symbols.ModuleSymbol"/>.
        /// </summary>
        MetaDslx_CodeAnalysis_ModuleSymbol = 58,

        /// <summary>
        /// Indicates that the type is <see cref="Symbols.TypeSymbol"/>.
        /// </summary>
        MetaDslx_CodeAnalysis_TypeSymbol = 59,

        /// <summary>
        /// Indicates that the type is <see cref="Symbols.NamespaceSymbol"/>.
        /// </summary>
        MetaDslx_CodeAnalysis_NamespaceSymbol = 60,

        /// <summary>
        /// Count of special types. This is not a count of enum members.
        /// </summary>
        Count = MetaDslx_CodeAnalysis_NamespaceSymbol
    }
}
