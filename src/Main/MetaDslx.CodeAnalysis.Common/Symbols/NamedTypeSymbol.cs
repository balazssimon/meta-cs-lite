...
namespace MetaDslx.CodeAnalysis.Symbols
{
    public abstract class NamedTypeSymbol : TypeSymbol
    {
        ...
        */
        ...
        /// </summary>
        public override bool Equals(TypeSymbol t2, TypeEqualityComparer comparison)
        {
            // TODO:MetaDslx
            ...
            if ((thisIsOriginalDefinition || otherIsOriginalDefinition) && 
                !comparison.IgnoreCustomModifiers && !comparison.IgnoreNullability)
            {
                return false;
            }
            ...
            if (!TypeSymbol.Equals(thisOriginalDefinition, otherOriginalDefinition, TypeEqualityComparer.ConsiderEverything))
            {
                return false;
            }
        ...
        /// </summary>
        protected virtual bool EqualsComplicatedCases(NamedTypeSymbol other, TypeEqualityComparer comparison)
        {
            return true;
        }
