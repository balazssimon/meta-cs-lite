...
namespace Microsoft.CodeAnalysis
{
    ...
    public class DiagnosticBag
    {
        ...
        private static ImmutableArray<TDiagnostic> ToReadOnlyCore<TDiagnostic>(ConcurrentQueue<Diagnostic>? oldBag) where TDiagnostic : Diagnostic
        {
            ...
            {
                if (diagnostic.Descriptor != InternalDiagnosticDescriptors.Void)
                {
                    Debug.Assert(diagnostic.Descriptor != InternalDiagnosticDescriptors.Unknown); //Info access should have forced resolution.
