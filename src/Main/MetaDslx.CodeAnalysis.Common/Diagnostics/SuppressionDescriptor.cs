...
namespace MetaDslx.CodeAnalysis
{
    ...
    public sealed class SuppressionDescriptor : IEquatable<SuppressionDescriptor?>
    {
            ...
            string justification)
        {
            ...
            {
                throw new ArgumentException(ExceptionMessages.SuppressionIdCantBeNullOrWhitespace, nameof(id));
            }

            if (string.IsNullOrWhiteSpace(suppressedDiagnosticId))
            {
                throw new ArgumentException(ExceptionMessages.DiagnosticIdCantBeNullOrWhitespace, nameof(suppressedDiagnosticId));
            }
