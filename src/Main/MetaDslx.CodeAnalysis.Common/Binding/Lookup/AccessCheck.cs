...
namespace MetaDslx.CodeAnalysis.Binding
{
    ...
    public class AccessCheck
    {
        ...
        /// </summary>
        public virtual bool IsSymbolAccessible(
            Symbol symbol,
            ...
            ConsList<TypeSymbol> basesBeingResolved = null)
        {
            ...
            if (symbol is AssemblySymbol || symbol is ModuleSymbol /*TODO:MetaDslx || symbol is DynamicTypeSymbol*/ || symbol is NamespaceSymbol)
            {
            ...
            /* TODO:MetaDslx else if (symbol is DiscardExpressionSymbol discardSymbol)
            {
        ...
        /*
        internal DiagnosticDescriptor GetProtectedMemberInSealedTypeError(NamedTypeSymbol containingType)
        {
