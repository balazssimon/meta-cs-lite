...
namespace MetaDslx.Languages.MetaCompiler.Compiler.Syntax.InternalSyntax
{
    ...
    public partial class CompilerInternalSyntaxFactory : global::MetaDslx.CodeAnalysis.Syntax.InternalSyntax.InternalSyntaxFactory
    {
        ...
        internal MainGreen Main(__InternalSyntaxToken kNamespace, QualifierGreen qualifier, __InternalSyntaxToken tSemicolon, global::MetaDslx.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<MainBlock1Green> block1, MainBlock2Green block2, __InternalSyntaxToken endOfFileToken)
        {
            #if DEBUG
        ...
        internal UsingAlt2Green UsingAlt2(QualifierGreen namespaces)
        {
            ...
            #endif
            int hash;
            var cached = __SyntaxNodeCache.TryGetNode((int)(CompilerSyntaxKind)CompilerSyntaxKind.UsingAlt2, namespaces, out hash);
            if (cached != null) return (UsingAlt2Green)cached;
        
            var result = new UsingAlt2Green(CompilerSyntaxKind.UsingAlt2, namespaces);
            if (hash >= 0)
            {
                __SyntaxNodeCache.AddNode(result, hash);
            }
        ...
        internal MainBlock1Green MainBlock1(__InternalSyntaxToken kUsing, UsingGreen @using, __InternalSyntaxToken tSemicolon)
        {
            ...
            #endif
            int hash;
            var cached = __SyntaxNodeCache.TryGetNode((int)(CompilerSyntaxKind)CompilerSyntaxKind.MainBlock1, kUsing, @using, tSemicolon, out hash);
            if (cached != null) return (MainBlock1Green)cached;
        
            var result = new MainBlock1Green(CompilerSyntaxKind.MainBlock1, kUsing, @using, tSemicolon);
            if (hash >= 0)
            {
                __SyntaxNodeCache.AddNode(result, hash);
            }
        ...
        internal AlternativeBlock1Block1Alt1Green AlternativeBlock1Block1Alt1(TypeReferenceIdentifierGreen returnType)
        {
            ...
            #endif
            int hash;
            var cached = __SyntaxNodeCache.TryGetNode((int)(CompilerSyntaxKind)CompilerSyntaxKind.AlternativeBlock1Block1Alt1, returnType, out hash);
            if (cached != null) return (AlternativeBlock1Block1Alt1Green)cached;
        
            var result = new AlternativeBlock1Block1Alt1Green(CompilerSyntaxKind.AlternativeBlock1Block1Alt1, returnType);
            if (hash >= 0)
            {
                __SyntaxNodeCache.AddNode(result, hash);
            }
        ...
        internal AlternativeBlock1Block1Alt2Green AlternativeBlock1Block1Alt2(IdentifierGreen identifier, __InternalSyntaxToken kReturns, TypeReferenceGreen returnType)
        {
            ...
            #endif
            int hash;
            var cached = __SyntaxNodeCache.TryGetNode((int)(CompilerSyntaxKind)CompilerSyntaxKind.AlternativeBlock1Block1Alt2, identifier, kReturns, returnType, out hash);
            if (cached != null) return (AlternativeBlock1Block1Alt2Green)cached;
        
            var result = new AlternativeBlock1Block1Alt2Green(CompilerSyntaxKind.AlternativeBlock1Block1Alt2, identifier, kReturns, returnType);
            if (hash >= 0)
            {
                __SyntaxNodeCache.AddNode(result, hash);
            }
