namespace MetaDslx.Languages.MetaCompiler.Symbols
{
    ...
    public abstract partial class PReferenceSymbol: MetaDslx.CodeAnalysis.Symbols.Impl.DeclarationSymbolImpl
    {
        ...
        public PReferenceSymbol(__Symbol? container, __Compilation? compilation = null, __MergedDeclaration? declaration = null, __Model? model = null, __IModelObject? modelObject = null, __ISymbol csharpSymbol = null, __ErrorSymbolInfo? errorInfo = null, bool fixedSymbol = false, string? name = default, string? metadataName = default, global::System.Collections.Immutable.ImmutableArray<AttributeSymbol> attributes = default, global::MetaDslx.CodeAnalysis.MetaSymbol rule = default, global::System.Collections.Immutable.ImmutableArray<global::MetaDslx.CodeAnalysis.MetaType> referencedTypes = default) 
