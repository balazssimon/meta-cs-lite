...
namespace MetaDslx.Languages.MetaCompiler.Model.__Impl
{
    ...
    internal class AnnotationArgument_Impl : __MetaModelObject, AnnotationArgument
    {
        ...
        {
            get => MGet<global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.CodeAnalysis.MetaSymbol>>(Compiler.AnnotationArgument_NamedParameter);
            set => MSet<global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.CodeAnalysis.MetaSymbol>>(Compiler.AnnotationArgument_NamedParameter, value);
        }
