...
namespace MetaDslx.Languages.MetaCompiler.Model.__Impl
{
    ...
    internal class Alternative_Impl : __MetaModelObject, Alternative
    {
        ...
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Languages.MetaCompiler.Model.Element> Elements
        {
        ...
        public MetaDslx.Languages.MetaCompiler.Model.Expression ReturnValue
        {
            get => MGet<MetaDslx.Languages.MetaCompiler.Model.Expression>(Compiler.Alternative_ReturnValue);
            set => MSet<MetaDslx.Languages.MetaCompiler.Model.Expression>(Compiler.Alternative_ReturnValue, value);
        }
