...
namespace MetaDslx.Languages.MetaCompiler.Model
{
    ...
    public sealed class Compiler : __MetaModel, ICompiler
    {
        ...
        static Compiler()
        {
            ...
            _Alternative_ReturnValue = new __ModelProperty(typeof(Alternative), "ReturnValue", typeof(MetaDslx.Languages.MetaCompiler.Model.Expression), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single, "ReturnValue");
            ...
            _AnnotationArgument_NamedParameter = new __ModelProperty(typeof(AnnotationArgument), "NamedParameter", typeof(MetaDslx.CodeAnalysis.MetaSymbol), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Collection, "NamedParameter");
            ...
            _AnnotationArgument_Value = new __ModelProperty(typeof(AnnotationArgument), "Value", typeof(MetaDslx.Languages.MetaCompiler.Model.Expression), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single, "Value");
            ...
            _BinderArgument_Values = new __ModelProperty(typeof(BinderArgument), "Values", typeof(string), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single, null);
            ...
            _Element_Assignment = new __ModelProperty(typeof(Element), "Assignment", typeof(MetaDslx.Languages.MetaCompiler.Model.Assignment), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Single, "Assignment");
            ...
            _Element_Value = new __ModelProperty(typeof(Element), "Value", typeof(MetaDslx.Languages.MetaCompiler.Model.ElementValue), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single, "Value");
            ...
            _ElementValue_Multiplicity = new __ModelProperty(typeof(ElementValue), "Multiplicity", typeof(MetaDslx.Languages.MetaCompiler.Model.Multiplicity), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Single, null);
            ...
            _Grammar_Language = new __ModelProperty(typeof(Grammar), "Language", typeof(MetaDslx.Languages.MetaCompiler.Model.Language), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Single | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived, null);
            ...
            _GrammarRule_Grammar = new __ModelProperty(typeof(GrammarRule), "Grammar", typeof(MetaDslx.Languages.MetaCompiler.Model.Grammar), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Single | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived, null);
            _GrammarRule_Language = new __ModelProperty(typeof(GrammarRule), "Language", typeof(MetaDslx.Languages.MetaCompiler.Model.Language), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Single | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived, null);
            ...
            _Language_BaseLanguages = new __ModelProperty(typeof(Language), "BaseLanguages", typeof(MetaDslx.CodeAnalysis.MetaType), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Collection, null);
            _Language_Grammar = new __ModelProperty(typeof(Language), "Grammar", typeof(MetaDslx.Languages.MetaCompiler.Model.Grammar), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single, null);
            ...
            _LElement_Multiplicity = new __ModelProperty(typeof(LElement), "Multiplicity", typeof(MetaDslx.Languages.MetaCompiler.Model.Multiplicity), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Single, null);
            _LElement_Value = new __ModelProperty(typeof(LElement), "Value", typeof(MetaDslx.Languages.MetaCompiler.Model.LElementValue), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single, null);
            ...
            _LReference_Rule = new __ModelProperty(typeof(LReference), "Rule", typeof(MetaDslx.Languages.MetaCompiler.Model.LexerRule), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Single, null);
            ...
            _RuleRef_GrammarRule = new __ModelProperty(typeof(RuleRef), "GrammarRule", typeof(MetaDslx.Languages.MetaCompiler.Model.GrammarRule), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Single, "Rule");
            ...
            _RuleRef_ReferencedTypes = new __ModelProperty(typeof(RuleRef), "ReferencedTypes", typeof(MetaDslx.CodeAnalysis.MetaType), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Collection, "ReferencedTypes");
            ...
            _SeparatedList_RepeatedBlock = new __ModelProperty(typeof(SeparatedList), "RepeatedBlock", typeof(MetaDslx.Languages.MetaCompiler.Model.Element), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single, null);
            _SeparatedList_RepeatedItem = new __ModelProperty(typeof(SeparatedList), "RepeatedItem", typeof(MetaDslx.Languages.MetaCompiler.Model.Element), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Single, null);
            _SeparatedList_RepeatedSeparator = new __ModelProperty(typeof(SeparatedList), "RepeatedSeparator", typeof(MetaDslx.Languages.MetaCompiler.Model.Element), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Single, null);
