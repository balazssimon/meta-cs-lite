...
namespace MetaDslx.Examples.Soal.Model.__Impl
{
    ...
    internal class ParameterList_Impl : __MetaModelObject, ParameterList
    {
        ...
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Examples.Soal.Model.Parameter> Parameters
        {
            get => MGetCollection<Parameter>(Soal.ParameterList_Parameters);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                publicPropertiesByName.Add("Parameters", Soal.ParameterList_Parameters);
                _publicPropertiesByName = publicPropertiesByName.ToImmutable();
                var modelPropertyInfos = __ImmutableDictionary.CreateBuilder<__ModelProperty, __ModelPropertyInfo>();
                modelPropertyInfos.Add(Soal.ParameterList_Parameters, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.ParameterList_Parameters, __ImmutableArray.Create<__ModelProperty>(Soal.ParameterList_Parameters), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            {
                var result = new ParameterList_Impl(id);
