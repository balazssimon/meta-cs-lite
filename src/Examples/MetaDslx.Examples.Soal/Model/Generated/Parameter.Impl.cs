...
namespace MetaDslx.Examples.Soal.Model.__Impl
{
    ...
    internal class Parameter_Impl : __MetaModelObject, Parameter
    {
            ...
            : base(id)
        {
            ...
            Soal.__CustomImpl.Parameter(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.VariableInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.VariableInfo, Soal.DeclarationInfo, Soal.NamedElementInfo, Soal.TypedElementInfo, Soal.ElementInfo);
