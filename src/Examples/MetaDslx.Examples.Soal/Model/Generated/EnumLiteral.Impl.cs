namespace MetaDslx.Examples.Soal.Model.__Impl
{
    ...
    internal class EnumLiteral_Impl : __MetaModelObject, EnumLiteral
    {
        private EnumLiteral_Impl(string? id)
            : base(id)
        {
            Soal.__CustomImpl.Element(this);
            Soal.__CustomImpl.NamedElement(this);
            Soal.__CustomImpl.EnumLiteral(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public MetaDslx.Examples.Soal.Model.EnumType Enum
        {
            get => MGet<MetaDslx.Examples.Soal.Model.EnumType>(Soal.EnumLiteral_Enum);
            set => MSet<MetaDslx.Examples.Soal.Model.EnumType>(Soal.EnumLiteral_Enum, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.NamedElementInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.NamedElementInfo, Soal.ElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.EnumLiteral_Enum);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.EnumLiteral_Enum, Soal.NamedElement_Documentation, Soal.NamedElement_HoverDocumentation, Soal.NamedElement_Name, Soal.NamedElement_UniqueName);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.EnumLiteral_Enum, Soal.NamedElement_Documentation, Soal.NamedElement_HoverDocumentation, Soal.NamedElement_Name, Soal.NamedElement_UniqueName);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Enum", Soal.EnumLiteral_Enum);
                ...
                modelPropertyInfos.Add(Soal.EnumLiteral_Enum, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.EnumLiteral_Enum, __ImmutableArray.Create<__ModelProperty>(Soal.EnumLiteral_Enum), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Soal.EnumType_Literals), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(EnumLiteral);
            ...
            {
                var result = new EnumLiteral_Impl(id);
