...
namespace MetaDslx.Examples.Soal.Model.__Impl
{
    ...
    internal class BuiltInType_Impl : __MetaModelObject, BuiltInType
    {
        private BuiltInType_Impl(string? id)
            : base(id)
        {
            ...
            Soal.__CustomImpl.BuiltInType(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public MetaDslx.Examples.Soal.Model.BuiltInTypeKind Kind
        {
            get => MGet<MetaDslx.Examples.Soal.Model.BuiltInTypeKind>(Soal.BuiltInType_Kind);
            set => MSet<MetaDslx.Examples.Soal.Model.BuiltInTypeKind>(Soal.BuiltInType_Kind, value);
        }
    
        public string Name
        {
            get => Soal.__CustomImpl.BuiltInType_Name(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.BuiltInType_Kind, Soal.BuiltInType_Name);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.BuiltInType_Kind, Soal.BuiltInType_Name, Soal.NamedElement_Documentation, Soal.NamedElement_HoverDocumentation, Soal.NamedElement_Name, Soal.NamedElement_UniqueName);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.BuiltInType_Kind, Soal.BuiltInType_Name, Soal.NamedElement_Documentation, Soal.NamedElement_HoverDocumentation, Soal.NamedElement_UniqueName);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Kind", Soal.BuiltInType_Kind);
                publicPropertiesByName.Add("Name", Soal.BuiltInType_Name);
                ...
                modelPropertyInfos.Add(Soal.BuiltInType_Kind, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.BuiltInType_Kind, __ImmutableArray.Create<__ModelProperty>(Soal.BuiltInType_Kind), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Soal.BuiltInType_Name, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.BuiltInType_Name, __ImmutableArray.Create<__ModelProperty>(Soal.BuiltInType_Name), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single | __ModelPropertyFlags.ReadOnly | __ModelPropertyFlags.Derived), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Soal.NamedElement_Name), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(BuiltInType);
            ...
            {
                var result = new BuiltInType_Impl(id);
