...
namespace MetaDslx.Examples.Soal.Model.__Impl
{
    ...
    internal class NamedType_Impl : __MetaModelObject, NamedType
    {
        private NamedType_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.DeclarationInfo, Soal.TypeInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.DeclarationInfo, Soal.NamedElementInfo, Soal.ElementInfo, Soal.TypeInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>();
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.NamedElement_Documentation, Soal.NamedElement_HoverDocumentation, Soal.NamedElement_Name, Soal.NamedElement_UniqueName);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.NamedElement_Documentation, Soal.NamedElement_HoverDocumentation, Soal.NamedElement_Name, Soal.NamedElement_UniqueName);
            ...
            public override __MetaType MetaType => typeof(NamedType);
            ...
            {
                var result = new NamedType_Impl(id);
