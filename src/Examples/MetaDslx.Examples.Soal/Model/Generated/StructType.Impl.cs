...
namespace MetaDslx.Examples.Soal.Model.__Impl
{
    ...
    internal class StructType_Impl : __MetaModelObject, StructType
    {
        private StructType_Impl(string? id)
            : base(id)
        {
            ...
            Soal.__CustomImpl.StructType(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public MetaDslx.Examples.Soal.Model.StructType BaseType
        {
            get => MGet<MetaDslx.Examples.Soal.Model.StructType>(Soal.StructType_BaseType);
            set => MSet<MetaDslx.Examples.Soal.Model.StructType>(Soal.StructType_BaseType, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Examples.Soal.Model.Property> Fields
        {
            get => MGetCollection<Property>(Soal.StructType_Fields);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.StructType_BaseType, Soal.StructType_Fields);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.StructType_BaseType, Soal.StructType_Fields, Soal.NamedElement_Documentation, Soal.NamedElement_HoverDocumentation, Soal.NamedElement_Name, Soal.NamedElement_UniqueName);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.StructType_BaseType, Soal.StructType_Fields, Soal.NamedElement_Documentation, Soal.NamedElement_HoverDocumentation, Soal.NamedElement_Name, Soal.NamedElement_UniqueName);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("BaseType", Soal.StructType_BaseType);
                publicPropertiesByName.Add("Fields", Soal.StructType_Fields);
                ...
                modelPropertyInfos.Add(Soal.StructType_BaseType, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.StructType_BaseType, __ImmutableArray.Create<__ModelProperty>(Soal.StructType_BaseType), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Soal.StructType_Fields, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.StructType_Fields, __ImmutableArray.Create<__ModelProperty>(Soal.StructType_Fields), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(StructType);
            ...
            {
                var result = new StructType_Impl(id);
